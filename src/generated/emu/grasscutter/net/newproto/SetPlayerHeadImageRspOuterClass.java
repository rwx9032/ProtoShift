...
public final class SetPlayerHeadImageRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.internal_static_SetPlayerHeadImageRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.internal_static_SetPlayerHeadImageRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp.class, emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp other = (emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.internal_static_SetPlayerHeadImageRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp build() {
        emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp buildPartial() {
        emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp result = new emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp(this);
        if (profilePictureBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp other) {
        if (other == emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp();
    }

    public static emu.grasscutter.net.newproto.SetPlayerHeadImageRspOuterClass.SetPlayerHeadImageRsp getDefaultInstance() {
