...
public final class SceneForceLockNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.internal_static_SceneForceLockNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.internal_static_SceneForceLockNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify.class, emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify other = (emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.internal_static_SceneForceLockNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify build() {
        emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify buildPartial() {
        emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify result = new emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify other) {
        if (other == emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify();
    }

    public static emu.grasscutter.net.newproto.SceneForceLockNotifyOuterClass.SceneForceLockNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ceLockNotify\022\025\n\rforce_id_list\030\001 \003(\rB\036\n\034e" +
