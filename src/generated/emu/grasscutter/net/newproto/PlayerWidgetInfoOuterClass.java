...
public final class PlayerWidgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.internal_static_PlayerWidgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.internal_static_PlayerWidgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.class, emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo other = (emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.internal_static_PlayerWidgetInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo build() {
        emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo buildPartial() {
        emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo result = new emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo other) {
        if (other == emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        if (slotListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo();
    }

    public static emu.grasscutter.net.newproto.PlayerWidgetInfoOuterClass.PlayerWidgetInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\"\n\tslot_list\030\004 \003(\0132\017.WidgetSlotDataB\036\n\034e" +
