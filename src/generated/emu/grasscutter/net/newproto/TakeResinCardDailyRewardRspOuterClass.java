...
public final class TakeResinCardDailyRewardRspOuterClass {
  ...
  public interface TakeResinCardDailyRewardRspOrBuilder extends
     ...
     * <code>repeated .ItemParam item_vec = 15;</code>
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getItemVec(int index);
    /**
     * <code>repeated .ItemParam item_vec = 15;</code>
     */
    int getItemVecCount();
     ...
     * <code>repeated .ItemParam item_vec = 15;</code>
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getItemVecOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.internal_static_TakeResinCardDailyRewardRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.internal_static_TakeResinCardDailyRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.class, emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam> itemVec_;
    /**
     * <code>repeated .ItemParam item_vec = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam> getItemVecList() {
      return itemVec_;
    }
    /**
     * <code>repeated .ItemParam item_vec = 15;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getItemVec(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getItemVecOrBuilder(
        int index) {
      return itemVec_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp other = (emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.internal_static_TakeResinCardDailyRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp build() {
        emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp buildPartial() {
        emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp result = new emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp other) {
        if (other == emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.getDefaultInstance()) return this;
      ...
      private void ensureItemVecIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          itemVec_ = new java.util.ArrayList<emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam>(itemVec_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder> itemVecBuilder_;
       ...
       * <code>repeated .ItemParam item_vec = 15;</code>
       */
      public Builder addItemVec(emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam value) {
        if (itemVecBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam item_vec = 15;</code>
       */
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder getItemVecBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam item_vec = 15;</code>
       */
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder addItemVecBuilder() {
    ...
    private static final emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp();
    }

    public static emu.grasscutter.net.newproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      ".ItemParam\022\031\n\021product_config_id\030\r \001(\rB\036\n" +
