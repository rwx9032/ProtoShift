...
public final class AvatarDelNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.internal_static_AvatarDelNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.internal_static_AvatarDelNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify.class, emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify other = (emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.internal_static_AvatarDelNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify build() {
        emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify buildPartial() {
        emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify result = new emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify other) {
        if (other == emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify();
    }

    public static emu.grasscutter.net.newproto.AvatarDelNotifyOuterClass.AvatarDelNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "fy\022\030\n\020avatar_guid_list\030\006 \003(\004B\036\n\034emu.gras" +
