...
public final class GCGPlayerGCGStateOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.internal_static_GCGPlayerGCGState_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.internal_static_GCGPlayerGCGState_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState.class, emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState other = (emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGStateOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.internal_static_GCGPlayerGCGState_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState build() {
        emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState buildPartial() {
        emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState result = new emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState(this);
        result.uid_ = uid_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState other) {
        if (other == emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    private static final emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState();
    }

    public static emu.grasscutter.net.newproto.GCGPlayerGCGStateOuterClass.GCGPlayerGCGState getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "AA\030\013 \001(\010\022\033\n\023Unk3300_DEKGMKCCGEG\030\004 \001(\010B\036\n" +
