...
public final class SummerTimeDungeonInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.internal_static_SummerTimeDungeonInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.internal_static_SummerTimeDungeonInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.class, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo other = (emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.internal_static_SummerTimeDungeonInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo build() {
        emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo buildPartial() {
        emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo result = new emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo other) {
        if (other == emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo();
    }

    public static emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\033\n\023Unk3300_EGGFJCICOBD\030\014 \001(\rB\036\n\034emu.g" +
