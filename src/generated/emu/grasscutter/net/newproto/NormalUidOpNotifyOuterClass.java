...
public final class NormalUidOpNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.internal_static_NormalUidOpNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.internal_static_NormalUidOpNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.class, emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify other = (emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.internal_static_NormalUidOpNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify build() {
        emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify buildPartial() {
        emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify result = new emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify other) {
        if (other == emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify();
    }

    public static emu.grasscutter.net.newproto.NormalUidOpNotifyOuterClass.NormalUidOpNotify getDefaultInstance() {
