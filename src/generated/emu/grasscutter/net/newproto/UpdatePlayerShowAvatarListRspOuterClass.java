...
public final class UpdatePlayerShowAvatarListRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.internal_static_UpdatePlayerShowAvatarListRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.internal_static_UpdatePlayerShowAvatarListRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.class, emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp other = (emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.internal_static_UpdatePlayerShowAvatarListRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp build() {
        emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp buildPartial() {
        emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp result = new emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp other) {
        if (other == emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp();
    }

    public static emu.grasscutter.net.newproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "is_show_avatar\030\002 \001(\010B\036\n\034emu.grasscutter." +
