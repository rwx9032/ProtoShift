...
public final class HomeTransferDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeTransferDataOuterClass.internal_static_HomeTransferData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeTransferDataOuterClass.internal_static_HomeTransferData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData.class, emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData other = (emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeTransferDataOuterClass.internal_static_HomeTransferData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData build() {
        emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData buildPartial() {
        emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData result = new emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData(this);
        if (spawnPosBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData other) {
        if (other == emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData();
    }

    public static emu.grasscutter.net.newproto.HomeTransferDataOuterClass.HomeTransferData getDefaultInstance() {
