...
public final class ReliquaryDecomposeReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.internal_static_ReliquaryDecomposeReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.internal_static_ReliquaryDecomposeReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq.class, emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq other = (emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq) obj;
    ...
    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.internal_static_ReliquaryDecomposeReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq build() {
        emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq buildPartial() {
        emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq result = new emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq) {
          return mergeFrom((emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq other) {
        if (other == emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq();
    }

    public static emu.grasscutter.net.newproto.ReliquaryDecomposeReqOuterClass.ReliquaryDecomposeReq getDefaultInstance() {
