...
public final class PlayerLoginRspOuterClass {
  ...
  public interface PlayerLoginRspOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> 
        getShortAbilityHashMapList();
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
     */
    emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair getShortAbilityHashMap(int index);
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
     */
     ...
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> 
        getShortAbilityHashMapOrBuilderList();
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
     */
    emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder getShortAbilityHashMapOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig getNextResVersionConfig();
    /**
     * <code>.ResVersionConfig next_res_version_config = 1688;</code>
     */
    emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getNextResVersionConfigOrBuilder();
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo>
    getBlockInfoMap();
    /**
     * <code>map&lt;uint32, .BlockInfo&gt; block_info_map = 2018;</code>
     */
    ...
    /* nullable */
emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo defaultValue);
    /**
     * <code>map&lt;uint32, .BlockInfo&gt; block_info_map = 2018;</code>
     */

    emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrThrow(
        int key);
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> 
        getFeatureBlockInfoListList();
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
     */
    emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo getFeatureBlockInfoList(int index);
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
     */
     ...
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> 
        getFeatureBlockInfoListOrBuilderList();
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
     */
    emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder getFeatureBlockInfoListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp.class, emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> shortAbilityHashMap_;
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> getShortAbilityHashMapList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> 
        getShortAbilityHashMapOrBuilderList() {
      return shortAbilityHashMap_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair getShortAbilityHashMap(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder getShortAbilityHashMapOrBuilder(
        int index) {
      return shortAbilityHashMap_.get(index);
    }
    ...
    private emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig nextResVersionConfig_;
    /**
     * <code>.ResVersionConfig next_res_version_config = 1688;</code>
     * @return Whether the nextResVersionConfig field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig getNextResVersionConfig() {
      return nextResVersionConfig_ == null ? emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance() : nextResVersionConfig_;
    }
    /**
     * <code>.ResVersionConfig next_res_version_config = 1688;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getNextResVersionConfigOrBuilder() {
    ...
    private static final class BlockInfoMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo>newDefaultInstance(
                  emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_BlockInfoMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> blockInfoMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> getBlockInfoMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> getBlockInfoMapMap() {
    ...
    public emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrDefault(
        int key,
        emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> map =
    ...
    public emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrThrow(
        int key) {
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.String, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.String, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_AbilityHashMapEntry_descriptor, 
    ...
    private java.util.List<emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> featureBlockInfoList_;
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> getFeatureBlockInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> 
        getFeatureBlockInfoListOrBuilderList() {
      return featureBlockInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo getFeatureBlockInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder getFeatureBlockInfoListOrBuilder(
        int index) {
      return featureBlockInfoList_.get(index);
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> entry
        ...
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp other = (emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp build() {
        emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp buildPartial() {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp other) {
        if (other == emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 1106: {
                emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.parser(),
                        extensionRegistry);
                if (featureBlockInfoListBuilder_ == null) {
                  ensureFeatureBlockInfoListIsMutable();
              ...
              case 10986: {
                emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.parser(),
                        extensionRegistry);
                if (shortAbilityHashMapBuilder_ == null) {
                  ensureShortAbilityHashMapIsMutable();
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureShortAbilityHashMapIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          shortAbilityHashMap_ = new java.util.ArrayList<emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair>(shortAbilityHashMap_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> shortAbilityHashMapBuilder_;
      ...
      public Builder setShortAbilityHashMap(
          int index, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair value) {
        if (shortAbilityHashMapBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShortAbilityHashMap(
          int index, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder builderForValue) {
        if (shortAbilityHashMapBuilder_ == null) {
          ensureShortAbilityHashMapIsMutable();
       ...
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
       */
      public Builder addShortAbilityHashMap(emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair value) {
        if (shortAbilityHashMapBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShortAbilityHashMap(
          emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder builderForValue) {
        if (shortAbilityHashMapBuilder_ == null) {
          ensureShortAbilityHashMapIsMutable();
      ...
      public Builder addAllShortAbilityHashMap(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> values) {
        if (shortAbilityHashMapBuilder_ == null) {
          ensureShortAbilityHashMapIsMutable();
       ...
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
       */
      public emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder getShortAbilityHashMapBuilder(
          int index) {
       ...
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
       */
      public emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder addShortAbilityHashMapBuilder() {
        return getShortAbilityHashMapFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.getDefaultInstance());
      }
      /**
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
       */
      public emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder addShortAbilityHashMapBuilder(
          int index) {
        return getShortAbilityHashMapFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.getDefaultInstance());
      }
      /**
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 1373;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder> 
           getShortAbilityHashMapBuilderList() {
        return getShortAbilityHashMapFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder, emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
      ...
      private emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig nextResVersionConfig_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig, emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.Builder, emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder> nextResVersionConfigBuilder_;
      /**
       * <code>.ResVersionConfig next_res_version_config = 1688;</code>
       * @return Whether the nextResVersionConfig field is set.
       */
       ...
       * <code>.ResVersionConfig next_res_version_config = 1688;</code>
       */
      public Builder setNextResVersionConfig(emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig value) {
        if (nextResVersionConfigBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.ResVersionConfig next_res_version_config = 1688;</code>
       */
      public Builder mergeNextResVersionConfig(emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig value) {
        if (nextResVersionConfigBuilder_ == null) {
          if (nextResVersionConfig_ != null) {
            nextResVersionConfig_ =
              emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.newBuilder(nextResVersionConfig_).mergeFrom(value).buildPartial();
          } else {
            nextResVersionConfig_ = value;
          }
          onChanged();
       ...
       * <code>.ResVersionConfig next_res_version_config = 1688;</code>
       */
      public emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.Builder getNextResVersionConfigBuilder() {
      ...
      public emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getNextResVersionConfigOrBuilder() {
        if (nextResVersionConfigBuilder_ != null) {
          ...
          return nextResVersionConfig_ == null ?
              emu.grasscutter.net.newproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance() : nextResVersionConfig_;
        }
      }
      /**
       * <code>.ResVersionConfig next_res_version_config = 1688;</code>
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo>
      ...
      public Builder putBlockInfoMap(
          int key,
          emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllBlockInfoMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.BlockInfoOuterClass.BlockInfo> values) {
        internalGetMutableBlockInfoMap().getMutableMap()
            .putAll(values);
        return this;
      }
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureFeatureBlockInfoListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          featureBlockInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo>(featureBlockInfoList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> featureBlockInfoListBuilder_;
      ...
      public Builder setFeatureBlockInfoList(
          int index, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo value) {
        if (featureBlockInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setFeatureBlockInfoList(
          int index, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder builderForValue) {
        if (featureBlockInfoListBuilder_ == null) {
          ensureFeatureBlockInfoListIsMutable();
       ...
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
       */
      public Builder addFeatureBlockInfoList(emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo value) {
        if (featureBlockInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFeatureBlockInfoList(
          emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder builderForValue) {
        if (featureBlockInfoListBuilder_ == null) {
          ensureFeatureBlockInfoListIsMutable();
      ...
      public Builder addAllFeatureBlockInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> values) {
        if (featureBlockInfoListBuilder_ == null) {
          ensureFeatureBlockInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
       */
      public emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder getFeatureBlockInfoListBuilder(
          int index) {
       ...
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
       */
      public emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder addFeatureBlockInfoListBuilder() {
        return getFeatureBlockInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
       */
      public emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder addFeatureBlockInfoListBuilder(
          int index) {
        return getFeatureBlockInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 138;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder> 
           getFeatureBlockInfoListBuilderList() {
        return getFeatureBlockInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder, emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp();
    }

    public static emu.grasscutter.net.newproto.PlayerLoginRspOuterClass.PlayerLoginRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.BlockInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.FeatureBlockInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.ResVersionConfigOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.ShortAbilityHashPairOuterClass.getDescriptor(),
        });
    internal_static_PlayerLoginRsp_descriptor =
