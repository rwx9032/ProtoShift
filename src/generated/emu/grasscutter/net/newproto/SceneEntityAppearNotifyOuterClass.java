...
public final class SceneEntityAppearNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.internal_static_SceneEntityAppearNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.internal_static_SceneEntityAppearNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.class, emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify other = (emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.internal_static_SceneEntityAppearNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify build() {
        emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify buildPartial() {
        emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify result = new emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify other) {
        if (other == emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify.getDefaultInstance()) return this;
        if (entityListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify();
    }

    public static emu.grasscutter.net.newproto.SceneEntityAppearNotifyOuterClass.SceneEntityAppearNotify getDefaultInstance() {
