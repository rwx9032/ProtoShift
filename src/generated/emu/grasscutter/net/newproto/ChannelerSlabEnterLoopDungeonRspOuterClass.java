...
public final class ChannelerSlabEnterLoopDungeonRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.internal_static_ChannelerSlabEnterLoopDungeonRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.internal_static_ChannelerSlabEnterLoopDungeonRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp.class, emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp other = (emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.internal_static_ChannelerSlabEnterLoopDungeonRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp build() {
        emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp buildPartial() {
        emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp result = new emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp other) {
        if (other == emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp();
    }

    public static emu.grasscutter.net.newproto.ChannelerSlabEnterLoopDungeonRspOuterClass.ChannelerSlabEnterLoopDungeonRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\021condition_id_list\030\007 \003(\rB\036\n\034emu.grasscu" +
