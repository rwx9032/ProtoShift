...
public final class OtherCustomDungeonBriefOuterClass {
  ...
  public interface OtherCustomDungeonBriefOrBuilder extends
     ...
     * @return The social.
     */
    emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial getSocial();
    /**
     * <code>.CustomDungeonSocial social = 14;</code>
     */
    emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder getSocialOrBuilder();
     ...
     * @return The abstract.
     */
    emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract getAbstract();
    /**
     * <code>.CustomDungeonAbstract abstract = 4;</code>
     */
    emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder getAbstractOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail getCreatorDetail();
    /**
     * <code>.SocialDetail creator_detail = 11;</code>
     */
    emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetailOrBuilder getCreatorDetailOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.internal_static_OtherCustomDungeonBrief_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.internal_static_OtherCustomDungeonBrief_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.class, emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial social_;
    /**
     * <code>.CustomDungeonSocial social = 14;</code>
     * @return Whether the social field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial getSocial() {
      return social_ == null ? emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.getDefaultInstance() : social_;
    }
    /**
     * <code>.CustomDungeonSocial social = 14;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder getSocialOrBuilder() {
      return getSocial();
    }

    public static final int ABSTRACT_FIELD_NUMBER = 4;
    private emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract abstract_;
    /**
     * <code>.CustomDungeonAbstract abstract = 4;</code>
     * @return Whether the abstract field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract getAbstract() {
      return abstract_ == null ? emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.getDefaultInstance() : abstract_;
    }
    /**
     * <code>.CustomDungeonAbstract abstract = 4;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder getAbstractOrBuilder() {
      return getAbstract();
    }

    public static final int CREATOR_DETAIL_FIELD_NUMBER = 11;
    private emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail creatorDetail_;
    /**
     * <code>.SocialDetail creator_detail = 11;</code>
     * @return Whether the creatorDetail field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail getCreatorDetail() {
      return creatorDetail_ == null ? emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance() : creatorDetail_;
    }
    /**
     * <code>.SocialDetail creator_detail = 11;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetailOrBuilder getCreatorDetailOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief other = (emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief) obj;
    ...
    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(
    ...
    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(
    ...
    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBriefOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.internal_static_OtherCustomDungeonBrief_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief build() {
        emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief buildPartial() {
        emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief result = new emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief) {
          return mergeFrom((emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief other) {
        if (other == emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.getDefaultInstance()) return this;
      ...
      private emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial social_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial, emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder, emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder> socialBuilder_;
      /**
       * <code>.CustomDungeonSocial social = 14;</code>
       * @return Whether the social field is set.
       */
       ...
       * <code>.CustomDungeonSocial social = 14;</code>
       */
      public Builder setSocial(emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial value) {
        if (socialBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setSocial(
          emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder builderForValue) {
        if (socialBuilder_ == null) {
       ...
       * <code>.CustomDungeonSocial social = 14;</code>
       */
      public Builder mergeSocial(emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial value) {
        if (socialBuilder_ == null) {
          if (social_ != null) {
            social_ =
              emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.newBuilder(social_).mergeFrom(value).buildPartial();
          } else {
            social_ = value;
          }
          onChanged();
       ...
       * <code>.CustomDungeonSocial social = 14;</code>
       */
      public emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder getSocialBuilder() {
      ...
      public emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder getSocialOrBuilder() {
        if (socialBuilder_ != null) {
          ...
          return social_ == null ?
              emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.getDefaultInstance() : social_;
        }
      }
      /**
       * <code>.CustomDungeonSocial social = 14;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial, emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder, emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder> 
      ...
      private emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract abstract_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract, emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder, emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder> abstractBuilder_;
      /**
       * <code>.CustomDungeonAbstract abstract = 4;</code>
       * @return Whether the abstract field is set.
       */
       ...
       * <code>.CustomDungeonAbstract abstract = 4;</code>
       */
      public Builder setAbstract(emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract value) {
        if (abstractBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setAbstract(
          emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder builderForValue) {
        if (abstractBuilder_ == null) {
       ...
       * <code>.CustomDungeonAbstract abstract = 4;</code>
       */
      public Builder mergeAbstract(emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract value) {
        if (abstractBuilder_ == null) {
          if (abstract_ != null) {
            abstract_ =
              emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.newBuilder(abstract_).mergeFrom(value).buildPartial();
          } else {
            abstract_ = value;
          }
          onChanged();
       ...
       * <code>.CustomDungeonAbstract abstract = 4;</code>
       */
      public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder getAbstractBuilder() {
      ...
      public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder getAbstractOrBuilder() {
        if (abstractBuilder_ != null) {
          ...
          return abstract_ == null ?
              emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.getDefaultInstance() : abstract_;
        }
      }
      /**
       * <code>.CustomDungeonAbstract abstract = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract, emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder, emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder> 
      ...
      private emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail creatorDetail_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail, emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.Builder, emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetailOrBuilder> creatorDetailBuilder_;
      /**
       * <code>.SocialDetail creator_detail = 11;</code>
       * @return Whether the creatorDetail field is set.
       */
       ...
       * <code>.SocialDetail creator_detail = 11;</code>
       */
      public Builder setCreatorDetail(emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail value) {
        if (creatorDetailBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.SocialDetail creator_detail = 11;</code>
       */
      public Builder mergeCreatorDetail(emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail value) {
        if (creatorDetailBuilder_ == null) {
          if (creatorDetail_ != null) {
            creatorDetail_ =
              emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.newBuilder(creatorDetail_).mergeFrom(value).buildPartial();
          } else {
            creatorDetail_ = value;
          }
          onChanged();
       ...
       * <code>.SocialDetail creator_detail = 11;</code>
       */
      public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.Builder getCreatorDetailBuilder() {
      ...
      public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetailOrBuilder getCreatorDetailOrBuilder() {
        if (creatorDetailBuilder_ != null) {
          ...
          return creatorDetail_ == null ?
              emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance() : creatorDetail_;
        }
      }
      /**
       * <code>.SocialDetail creator_detail = 11;</code>
    ...
    private static final emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief();
    }

    public static emu.grasscutter.net.newproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.CustomDungeonSocialOuterClass.getDescriptor(),
