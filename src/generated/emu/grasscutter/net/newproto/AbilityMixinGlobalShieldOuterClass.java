...
public final class AbilityMixinGlobalShieldOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.internal_static_AbilityMixinGlobalShield_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.internal_static_AbilityMixinGlobalShield_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.class, emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield other = (emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShieldOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.internal_static_AbilityMixinGlobalShield_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield build() {
        emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield buildPartial() {
        emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield result = new emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield other) {
        if (other == emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield();
    }

    public static emu.grasscutter.net.newproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "vatar_id\030\003 \001(\r\022\025\n\rheight_offset\030\001 \001(\002B\036\n" +
