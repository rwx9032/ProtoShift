...
public final class GetActivityInfoRspOuterClass {
  ...
  public interface GetActivityInfoRspOrBuilder extends
     ...
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getDisableTransferPointInteractionList(int index);
    /**
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
     */
     ...
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getDisableTransferPointInteractionListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo> 
        getActivityInfoListList();
    /**
     * <code>repeated .ActivityInfo activity_info_list = 2;</code>
     */
    emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo getActivityInfoList(int index);
    /**
     * <code>repeated .ActivityInfo activity_info_list = 2;</code>
     */
     ...
     * <code>repeated .ActivityInfo activity_info_list = 2;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> 
        getActivityInfoListOrBuilderList();
    /**
     * <code>repeated .ActivityInfo activity_info_list = 2;</code>
     */
    emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfoOrBuilder getActivityInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.internal_static_GetActivityInfoRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.internal_static_GetActivityInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.class, emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.Builder.class);
    }

    public static final int DISABLE_TRANSFER_POINT_INTERACTION_LIST_FIELD_NUMBER = 10;
    private java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> disableTransferPointInteractionList_;
    /**
     * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> getDisableTransferPointInteractionListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getDisableTransferPointInteractionList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getDisableTransferPointInteractionListOrBuilder(
        int index) {
      return disableTransferPointInteractionList_.get(index);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo> activityInfoList_;
    /**
     * <code>repeated .ActivityInfo activity_info_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo> getActivityInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> 
        getActivityInfoListOrBuilderList() {
      return activityInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo getActivityInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfoOrBuilder getActivityInfoListOrBuilder(
        int index) {
      return activityInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp other = (emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.internal_static_GetActivityInfoRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp build() {
        emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp buildPartial() {
        emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp result = new emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp other) {
        if (other == emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.getDefaultInstance()) return this;
        if (disableTransferPointInteractionListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.parser(),
                        extensionRegistry);
                if (activityInfoListBuilder_ == null) {
                  ensureActivityInfoListIsMutable();
      ...
      private void ensureDisableTransferPointInteractionListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          disableTransferPointInteractionList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair>(disableTransferPointInteractionList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder> disableTransferPointInteractionListBuilder_;
       ...
       * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
       */
      public Builder addDisableTransferPointInteractionList(emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair value) {
        if (disableTransferPointInteractionListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder getDisableTransferPointInteractionListBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair disable_transfer_point_interaction_list = 10;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder addDisableTransferPointInteractionListBuilder() {
      ...
      private void ensureActivityInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          activityInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo>(activityInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> activityInfoListBuilder_;
      ...
      public Builder setActivityInfoList(
          int index, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo value) {
        if (activityInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setActivityInfoList(
          int index, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder builderForValue) {
        if (activityInfoListBuilder_ == null) {
          ensureActivityInfoListIsMutable();
       ...
       * <code>repeated .ActivityInfo activity_info_list = 2;</code>
       */
      public Builder addActivityInfoList(emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo value) {
        if (activityInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addActivityInfoList(
          emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder builderForValue) {
        if (activityInfoListBuilder_ == null) {
          ensureActivityInfoListIsMutable();
      ...
      public Builder addAllActivityInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo> values) {
        if (activityInfoListBuilder_ == null) {
          ensureActivityInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .ActivityInfo activity_info_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder getActivityInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ActivityInfo activity_info_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder addActivityInfoListBuilder() {
        return getActivityInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ActivityInfo activity_info_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder addActivityInfoListBuilder(
          int index) {
        return getActivityInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ActivityInfo activity_info_list = 2;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder> 
           getActivityInfoListBuilderList() {
        return getActivityInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfo.Builder, emu.grasscutter.net.newproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp();
    }

    public static emu.grasscutter.net.newproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.ActivityInfoOuterClass.getDescriptor(),
