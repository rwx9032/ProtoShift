...
public final class CustomCommonNodeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.internal_static_CustomCommonNodeInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.internal_static_CustomCommonNodeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.class, emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo other = (emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.internal_static_CustomCommonNodeInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo build() {
        emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo buildPartial() {
        emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo result = new emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo other) {
        if (other == emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo();
    }

    public static emu.grasscutter.net.newproto.CustomCommonNodeInfoOuterClass.CustomCommonNodeInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nfig_id\030\002 \001(\r\022\027\n\017slot_identifier\030\003 \001(\tB\036" +
