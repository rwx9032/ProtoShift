...
public final class PlatformChangeRouteNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.internal_static_PlatformChangeRouteNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.internal_static_PlatformChangeRouteNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify.class, emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify other = (emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.internal_static_PlatformChangeRouteNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify build() {
        emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify buildPartial() {
        emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify result = new emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify other) {
        if (other == emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify();
    }

    public static emu.grasscutter.net.newproto.PlatformChangeRouteNotifyOuterClass.PlatformChangeRouteNotify getDefaultInstance() {
