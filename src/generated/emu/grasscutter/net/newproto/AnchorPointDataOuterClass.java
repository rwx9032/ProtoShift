...
public final class AnchorPointDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData.class, emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData other = (emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData) obj;
    ...
    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData build() {
        emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData buildPartial() {
        emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData result = new emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData) {
          return mergeFrom((emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData other) {
        if (other == emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData();
    }

    public static emu.grasscutter.net.newproto.AnchorPointDataOuterClass.AnchorPointData getDefaultInstance() {
