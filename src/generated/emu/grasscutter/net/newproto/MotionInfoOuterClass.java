...
public final class MotionInfoOuterClass {
  ...
  public interface MotionInfoOrBuilder extends
     ...
     * @return The speed.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getSpeed();
    /**
     * <code>.Vector speed = 3;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getSpeedOrBuilder();
     ...
     * @return The state.
     */
    emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState getState();
     ...
     * <code>repeated .Vector params = 5;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getParams(int index);
    /**
     * <code>repeated .Vector params = 5;</code>
     */
    int getParamsCount();
     ...
     * <code>repeated .Vector params = 5;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getParamsOrBuilder(
        int index);
     ...
     * @return The refPos.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getRefPos();
    /**
     * <code>.Vector ref_pos = 6;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getRefPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MotionInfoOuterClass.internal_static_MotionInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MotionInfoOuterClass.internal_static_MotionInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo.class, emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector speed_;
    /**
     * <code>.Vector speed = 3;</code>
     * @return Whether the speed field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getSpeed() {
      return speed_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : speed_;
    }
    /**
     * <code>.Vector speed = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getSpeedOrBuilder() {
      return getSpeed();
    }
     ...
     * @return The state.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState getState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState result = emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState.valueOf(state_);
      return result == null ? emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState.UNRECOGNIZED : result;
    }

    public static final int PARAMS_FIELD_NUMBER = 5;
    private java.util.List<emu.grasscutter.net.newproto.VectorOuterClass.Vector> params_;
    /**
     * <code>repeated .Vector params = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.VectorOuterClass.Vector> getParamsList() {
      return params_;
    }
    /**
     * <code>repeated .Vector params = 5;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getParams(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getParamsOrBuilder(
        int index) {
      return params_.get(index);
    }

    public static final int REF_POS_FIELD_NUMBER = 6;
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector refPos_;
    /**
     * <code>.Vector ref_pos = 6;</code>
     * @return Whether the refPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getRefPos() {
      return refPos_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : refPos_;
    }
    /**
     * <code>.Vector ref_pos = 6;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getRefPosOrBuilder() {
      return getRefPos();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState.MOTION_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo other = (emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MotionInfoOuterClass.internal_static_MotionInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo build() {
        emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo buildPartial() {
        emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo result = new emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo other) {
        if (other == emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo.getDefaultInstance()) return this;
        if (other.hasPos()) {
      ...
      private emu.grasscutter.net.newproto.VectorOuterClass.Vector speed_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> speedBuilder_;
      /**
       * <code>.Vector speed = 3;</code>
       * @return Whether the speed field is set.
       */
       ...
       * <code>.Vector speed = 3;</code>
       */
      public Builder setSpeed(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (speedBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector speed = 3;</code>
       */
      public Builder mergeSpeed(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (speedBuilder_ == null) {
          if (speed_ != null) {
            speed_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(speed_).mergeFrom(value).buildPartial();
          } else {
            speed_ = value;
          }
          onChanged();
       ...
       * <code>.Vector speed = 3;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getSpeedBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getSpeedOrBuilder() {
        if (speedBuilder_ != null) {
          ...
          return speed_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : speed_;
        }
      }
      /**
       * <code>.Vector speed = 3;</code>
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState getState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState result = emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState.valueOf(state_);
        return result == null ? emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.grasscutter.net.newproto.MotionStateOuterClass.MotionState value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private void ensureParamsIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          params_ = new java.util.ArrayList<emu.grasscutter.net.newproto.VectorOuterClass.Vector>(params_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> paramsBuilder_;
       ...
       * <code>repeated .Vector params = 5;</code>
       */
      public Builder addParams(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (paramsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Vector params = 5;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getParamsBuilder(
          int index) {
       ...
       * <code>repeated .Vector params = 5;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder addParamsBuilder() {
      ...
      private emu.grasscutter.net.newproto.VectorOuterClass.Vector refPos_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> refPosBuilder_;
      /**
       * <code>.Vector ref_pos = 6;</code>
       * @return Whether the refPos field is set.
       */
       ...
       * <code>.Vector ref_pos = 6;</code>
       */
      public Builder setRefPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (refPosBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector ref_pos = 6;</code>
       */
      public Builder mergeRefPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (refPosBuilder_ == null) {
          if (refPos_ != null) {
            refPos_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(refPos_).mergeFrom(value).buildPartial();
          } else {
            refPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector ref_pos = 6;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getRefPosBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getRefPosOrBuilder() {
        if (refPosBuilder_ != null) {
          ...
          return refPos_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : refPos_;
        }
      }
      /**
       * <code>.Vector ref_pos = 6;</code>
    ...
    private static final emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo();
    }

    public static emu.grasscutter.net.newproto.MotionInfoOuterClass.MotionInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "time\030\010 \001(\r\022\031\n\021interval_velocity\030\t \001(\004B\036\n" +
      "\034emu.grasscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.MotionStateOuterClass.getDescriptor(),
