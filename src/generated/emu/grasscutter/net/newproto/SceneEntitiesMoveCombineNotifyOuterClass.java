...
public final class SceneEntitiesMoveCombineNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.internal_static_SceneEntitiesMoveCombineNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.internal_static_SceneEntitiesMoveCombineNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify.class, emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify other = (emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.internal_static_SceneEntitiesMoveCombineNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify build() {
        emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify buildPartial() {
        emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify result = new emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify other) {
        if (other == emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify.getDefaultInstance()) return this;
        if (entityMoveInfoListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify();
    }

    public static emu.grasscutter.net.newproto.SceneEntitiesMoveCombineNotifyOuterClass.SceneEntitiesMoveCombineNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\016 \003(\0132\017.EntityMoveInfoB\036\n\034emu.grasscutte" +
