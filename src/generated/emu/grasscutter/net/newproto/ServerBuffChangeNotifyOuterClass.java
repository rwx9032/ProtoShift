...
public final class ServerBuffChangeNotifyOuterClass {
  ...
  public interface ServerBuffChangeNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType getServerBuffChangeType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.internal_static_ServerBuffChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.internal_static_ServerBuffChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.class, emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.Builder.class);
    }
    ...
    public enum ServerBuffChangeType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The serverBuffChangeType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType getServerBuffChangeType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType result = emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.valueOf(serverBuffChangeType_);
      return result == null ? emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (serverBuffChangeType_ != emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.SERVER_BUFF_CHANGE_TYPE_ADD_SERVER_BUFF.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify other = (emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.internal_static_ServerBuffChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify build() {
        emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify buildPartial() {
        emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify result = new emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify other) {
        if (other == emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.getDefaultInstance()) return this;
        if (serverBuffListBuilder_ == null) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType getServerBuffChangeType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType result = emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.valueOf(serverBuffChangeType_);
        return result == null ? emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setServerBuffChangeType(emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify.ServerBuffChangeType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify();
    }

    public static emu.grasscutter.net.newproto.ServerBuffChangeNotifyOuterClass.ServerBuffChangeNotify getDefaultInstance() {
