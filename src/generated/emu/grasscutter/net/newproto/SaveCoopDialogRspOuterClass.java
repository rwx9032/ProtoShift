...
public final class SaveCoopDialogRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.internal_static_SaveCoopDialogRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.internal_static_SaveCoopDialogRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp.class, emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp other = (emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.internal_static_SaveCoopDialogRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp build() {
        emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp buildPartial() {
        emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp result = new emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp other) {
        if (other == emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp();
    }

    public static emu.grasscutter.net.newproto.SaveCoopDialogRspOuterClass.SaveCoopDialogRsp getDefaultInstance() {
