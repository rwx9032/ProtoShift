...
public final class ChallengeRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ChallengeRecordOuterClass.internal_static_ChallengeRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ChallengeRecordOuterClass.internal_static_ChallengeRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord.class, emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord other = (emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord) obj;
    ...
    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ChallengeRecordOuterClass.internal_static_ChallengeRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord build() {
        emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord buildPartial() {
        emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord result = new emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord) {
          return mergeFrom((emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord other) {
        if (other == emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord();
    }

    public static emu.grasscutter.net.newproto.ChallengeRecordOuterClass.ChallengeRecord getDefaultInstance() {
