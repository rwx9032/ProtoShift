...
public final class HomePreviewBlueprintRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.internal_static_HomePreviewBlueprintRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.internal_static_HomePreviewBlueprintRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp.class, emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp other = (emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.internal_static_HomePreviewBlueprintRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp build() {
        emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp buildPartial() {
        emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp result = new emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp other) {
        if (other == emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp();
    }

    public static emu.grasscutter.net.newproto.HomePreviewBlueprintRspOuterClass.HomePreviewBlueprintRsp getDefaultInstance() {
