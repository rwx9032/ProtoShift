...
public final class SummerTimeSprintBoatRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.internal_static_SummerTimeSprintBoatRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.internal_static_SummerTimeSprintBoatRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord.class, emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord other = (emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord) obj;
    ...
    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.internal_static_SummerTimeSprintBoatRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord build() {
        emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord buildPartial() {
        emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord result = new emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord) {
          return mergeFrom((emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord other) {
        if (other == emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord();
    }

    public static emu.grasscutter.net.newproto.SummerTimeSprintBoatRecordOuterClass.SummerTimeSprintBoatRecord getDefaultInstance() {
