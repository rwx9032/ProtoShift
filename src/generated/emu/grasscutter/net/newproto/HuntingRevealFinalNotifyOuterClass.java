...
public final class HuntingRevealFinalNotifyOuterClass {
  ...
  public interface HuntingRevealFinalNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getFinalPosition();
    /**
     * <code>.Vector final_position = 3;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.class, emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.Builder.class);
    }

    public static final int FINAL_POSITION_FIELD_NUMBER = 3;
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector finalPosition_;
    /**
     * <code>.Vector final_position = 3;</code>
     * @return Whether the finalPosition field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getFinalPosition() {
      return finalPosition_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : finalPosition_;
    }
    /**
     * <code>.Vector final_position = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify other = (emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify build() {
        emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify buildPartial() {
        emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify result = new emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify(this);
        if (finalPositionBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify other) {
        if (other == emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> finalPositionBuilder_;
      /**
       * <code>.Vector final_position = 3;</code>
       * @return Whether the finalPosition field is set.
       */
       ...
       * <code>.Vector final_position = 3;</code>
       */
      public Builder setFinalPosition(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (finalPositionBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector final_position = 3;</code>
       */
      public Builder mergeFinalPosition(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (finalPositionBuilder_ == null) {
          if (finalPosition_ != null) {
            finalPosition_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(finalPosition_).mergeFrom(value).buildPartial();
          } else {
            finalPosition_ = value;
          }
          onChanged();
       ...
       * <code>.Vector final_position = 3;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getFinalPositionBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder() {
        if (finalPositionBuilder_ != null) {
          ...
          return finalPosition_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : finalPosition_;
        }
      }
      /**
       * <code>.Vector final_position = 3;</code>
    ...
    private static final emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify();
    }

    public static emu.grasscutter.net.newproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ir\022\031\n\021finished_group_id\030\016 \001(\rB\036\n\034emu.gra" +
