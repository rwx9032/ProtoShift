...
public final class FungusFighterPlotInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.internal_static_FungusFighterPlotInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.internal_static_FungusFighterPlotInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify.class, emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify other = (emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.internal_static_FungusFighterPlotInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify build() {
        emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify result = new emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify();
    }

    public static emu.grasscutter.net.newproto.FungusFighterPlotInfoNotifyOuterClass.FungusFighterPlotInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\014 \001(\r\022\026\n\016fungus_id_list\030\010 \003(\rB\036\n\034emu.gr" +
