...
public final class WinterCampRecvItemDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.internal_static_WinterCampRecvItemData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.internal_static_WinterCampRecvItemData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.class, emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData other = (emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData) obj;
    ...
    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.internal_static_WinterCampRecvItemData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData build() {
        emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData buildPartial() {
        emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData result = new emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData) {
          return mergeFrom((emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData other) {
        if (other == emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData();
    }

    public static emu.grasscutter.net.newproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData getDefaultInstance() {
