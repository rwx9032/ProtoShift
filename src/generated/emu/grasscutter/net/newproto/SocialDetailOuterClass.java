...
public final class SocialDetailOuterClass {
  ...
  public interface SocialDetailOrBuilder extends
     ...
     * @return The birthday.
     */
    emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday getBirthday();
    /**
     * <code>.Birthday birthday = 6;</code>
     */
    emu.grasscutter.net.newproto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState();
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> 
        getShowAvatarInfoListList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index);
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
     ...
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SocialDetailOuterClass.internal_static_SocialDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.class, emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday birthday_;
    /**
     * <code>.Birthday birthday = 6;</code>
     * @return Whether the birthday field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday getBirthday() {
      return birthday_ == null ? emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.getDefaultInstance() : birthday_;
    }
    /**
     * <code>.Birthday birthday = 6;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder() {
      return getBirthday();
    }
     ...
     * @return The onlineState.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.valueOf(onlineState_);
      return result == null ? emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> showAvatarInfoList_;
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> getShowAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList() {
      return showAvatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index) {
      return showAvatarInfoList_.get(index);
    }
     ...
     * @return The friendEnterHomeOption.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption result = emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.valueOf(friendEnterHomeOption_);
      return result == null ? emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (onlineState_ != emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.FRIEND_ONLINE_STATE_DISCONNECT.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail other = (emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail) obj;
    ...
    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail build() {
        emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail buildPartial() {
        emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail result = new emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail) {
          return mergeFrom((emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail other) {
        if (other == emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 178: {
                emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.parser(),
                        extensionRegistry);
                if (showAvatarInfoListBuilder_ == null) {
                  ensureShowAvatarInfoListIsMutable();
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday, emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.Builder, emu.grasscutter.net.newproto.BirthdayOuterClass.BirthdayOrBuilder> birthdayBuilder_;
      /**
       * <code>.Birthday birthday = 6;</code>
       * @return Whether the birthday field is set.
       */
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public Builder setBirthday(emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday value) {
        if (birthdayBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setBirthday(
          emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.Builder builderForValue) {
        if (birthdayBuilder_ == null) {
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public Builder mergeBirthday(emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday value) {
        if (birthdayBuilder_ == null) {
          if (birthday_ != null) {
            birthday_ =
              emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.newBuilder(birthday_).mergeFrom(value).buildPartial();
          } else {
            birthday_ = value;
          }
          onChanged();
       ...
       * <code>.Birthday birthday = 6;</code>
       */
      public emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.Builder getBirthdayBuilder() {
      ...
      public emu.grasscutter.net.newproto.BirthdayOuterClass.BirthdayOrBuilder getBirthdayOrBuilder() {
        if (birthdayBuilder_ != null) {
          ...
          return birthday_ == null ?
              emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.getDefaultInstance() : birthday_;
        }
      }
      /**
       * <code>.Birthday birthday = 6;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday, emu.grasscutter.net.newproto.BirthdayOuterClass.Birthday.Builder, emu.grasscutter.net.newproto.BirthdayOuterClass.BirthdayOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.valueOf(onlineState_);
        return result == null ? emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setOnlineState(emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.FriendOnlineState value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureShowAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          showAvatarInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo>(showAvatarInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> showAvatarInfoListBuilder_;
      ...
      public Builder setShowAvatarInfoList(
          int index, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShowAvatarInfoList(
          int index, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public Builder addShowAvatarInfoList(emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShowAvatarInfoList(
          emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
      ...
      public Builder addAllShowAvatarInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> values) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder getShowAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder() {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder(
          int index) {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder> 
           getShowAvatarInfoListBuilderList() {
        return getShowAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption result = emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.valueOf(friendEnterHomeOption_);
        return result == null ? emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setFriendEnterHomeOption(emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail();
    }

    public static emu.grasscutter.net.newproto.SocialDetailOuterClass.SocialDetail getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.BirthdayOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.FriendEnterHomeOptionOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.FriendOnlineStateOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.ProfilePictureOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.SocialShowAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SocialDetail_descriptor =
