...
public final class FindHilichurlDetailInfoOuterClass {
  ...
  public interface FindHilichurlDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo> 
        getDayContentInfoListList();
    /**
     * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
     */
    emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo getDayContentInfoList(int index);
    /**
     * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
     */
     ...
     * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfoOrBuilder> 
        getDayContentInfoListOrBuilderList();
    /**
     * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
     */
    emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfoOrBuilder getDayContentInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.internal_static_FindHilichurlDetailInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.internal_static_FindHilichurlDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo.class, emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo> dayContentInfoList_;
    /**
     * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo> getDayContentInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfoOrBuilder> 
        getDayContentInfoListOrBuilderList() {
      return dayContentInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo getDayContentInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfoOrBuilder getDayContentInfoListOrBuilder(
        int index) {
      return dayContentInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo other = (emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.internal_static_FindHilichurlDetailInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo build() {
        emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo buildPartial() {
        emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo result = new emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo other) {
        if (other == emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.parser(),
                        extensionRegistry);
                if (dayContentInfoListBuilder_ == null) {
                  ensureDayContentInfoListIsMutable();
      ...
      private void ensureDayContentInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          dayContentInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo>(dayContentInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfoOrBuilder> dayContentInfoListBuilder_;
      ...
      public Builder setDayContentInfoList(
          int index, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo value) {
        if (dayContentInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setDayContentInfoList(
          int index, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder builderForValue) {
        if (dayContentInfoListBuilder_ == null) {
          ensureDayContentInfoListIsMutable();
       ...
       * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
       */
      public Builder addDayContentInfoList(emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo value) {
        if (dayContentInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addDayContentInfoList(
          emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder builderForValue) {
        if (dayContentInfoListBuilder_ == null) {
          ensureDayContentInfoListIsMutable();
      ...
      public Builder addAllDayContentInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo> values) {
        if (dayContentInfoListBuilder_ == null) {
          ensureDayContentInfoListIsMutable();
       ...
       * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder getDayContentInfoListBuilder(
          int index) {
       ...
       * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder addDayContentInfoListBuilder() {
        return getDayContentInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder addDayContentInfoListBuilder(
          int index) {
        return getDayContentInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .FindHilichurlDayContentInfo day_content_info_list = 4;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder> 
           getDayContentInfoListBuilderList() {
        return getDayContentInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfo.Builder, emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.FindHilichurlDayContentInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo();
    }

    public static emu.grasscutter.net.newproto.FindHilichurlDetailInfoOuterClass.FindHilichurlDetailInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ept\030\005 \001(\010\022\030\n\020player_day_index\030\016 \001(\rB\036\n\034e" +
      "mu.grasscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.FindHilichurlDayContentInfoOuterClass.getDescriptor(),
        });
    internal_static_FindHilichurlDetailInfo_descriptor =
