...
public final class LockedPersonallineDataOuterClass {
  ...
  public interface LockedPersonallineDataOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason getLockReason();
    ...
    public emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.ParamCase getParamCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.internal_static_LockedPersonallineData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.internal_static_LockedPersonallineData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.class, emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.Builder.class);
    }
    ...
    public enum LockReason
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The lockReason.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason getLockReason() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason result = emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.valueOf(lockReason_);
      return result == null ? emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (lockReason_ != emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.LOCK_REASON_LEVEL.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData other = (emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData) obj;
    ...
    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.internal_static_LockedPersonallineData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData build() {
        emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData buildPartial() {
        emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData result = new emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData) {
          return mergeFrom((emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData other) {
        if (other == emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason getLockReason() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason result = emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.valueOf(lockReason_);
        return result == null ? emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setLockReason(emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData.LockReason value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData();
    }

    public static emu.grasscutter.net.newproto.LockedPersonallineDataOuterClass.LockedPersonallineData getDefaultInstance() {
