...
public final class ExpeditionStartReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.class, emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq other = (emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq) obj;
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.internal_static_ExpeditionStartReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq build() {
        emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq buildPartial() {
        emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq result = new emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq) {
          return mergeFrom((emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq other) {
        if (other == emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq();
    }

    public static emu.grasscutter.net.newproto.ExpeditionStartReqOuterClass.ExpeditionStartReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\001(\r\022\026\n\016avatar_id_list\030\007 \003(\rB\036\n\034emu.grass" +
