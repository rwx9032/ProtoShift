...
public final class AbilityInvocationsNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.internal_static_AbilityInvocationsNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.internal_static_AbilityInvocationsNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify.class, emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify other = (emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.internal_static_AbilityInvocationsNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify build() {
        emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify buildPartial() {
        emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify result = new emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify other) {
        if (other == emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify.getDefaultInstance()) return this;
        if (invokesBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify();
    }

    public static emu.grasscutter.net.newproto.AbilityInvocationsNotifyOuterClass.AbilityInvocationsNotify getDefaultInstance() {
