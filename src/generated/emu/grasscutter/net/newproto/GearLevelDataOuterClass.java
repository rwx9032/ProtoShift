...
public final class GearLevelDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GearLevelDataOuterClass.internal_static_GearLevelData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GearLevelDataOuterClass.internal_static_GearLevelData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData.class, emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData other = (emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData) obj;
    ...
    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GearLevelDataOuterClass.internal_static_GearLevelData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData build() {
        emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData buildPartial() {
        emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData result = new emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData) {
          return mergeFrom((emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData other) {
        if (other == emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData();
    }

    public static emu.grasscutter.net.newproto.GearLevelDataOuterClass.GearLevelData getDefaultInstance() {
