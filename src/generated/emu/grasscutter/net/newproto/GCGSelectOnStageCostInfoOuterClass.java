...
public final class GCGSelectOnStageCostInfoOuterClass {
  ...
  public interface GCGSelectOnStageCostInfoOrBuilder extends
     ...
     * <code>repeated .Uint32Pair cost_map = 1;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getCostMap(int index);
    /**
     * <code>repeated .Uint32Pair cost_map = 1;</code>
     */
    int getCostMapCount();
     ...
     * <code>repeated .Uint32Pair cost_map = 1;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getCostMapOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.internal_static_GCGSelectOnStageCostInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.internal_static_GCGSelectOnStageCostInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.class, emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> costMap_;
    /**
     * <code>repeated .Uint32Pair cost_map = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> getCostMapList() {
      return costMap_;
    }
    /**
     * <code>repeated .Uint32Pair cost_map = 1;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getCostMap(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getCostMapOrBuilder(
        int index) {
      return costMap_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo other = (emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.internal_static_GCGSelectOnStageCostInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo build() {
        emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo buildPartial() {
        emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo result = new emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo other) {
        if (other == emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo.getDefaultInstance()) return this;
      ...
      private void ensureCostMapIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          costMap_ = new java.util.ArrayList<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair>(costMap_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder> costMapBuilder_;
       ...
       * <code>repeated .Uint32Pair cost_map = 1;</code>
       */
      public Builder addCostMap(emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair value) {
        if (costMapBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair cost_map = 1;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder getCostMapBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair cost_map = 1;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder addCostMapBuilder() {
    ...
    private static final emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo();
    }

    public static emu.grasscutter.net.newproto.GCGSelectOnStageCostInfoOuterClass.GCGSelectOnStageCostInfo getDefaultInstance() {
