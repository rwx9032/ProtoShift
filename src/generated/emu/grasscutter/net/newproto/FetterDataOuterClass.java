...
public final class FetterDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FetterDataOuterClass.internal_static_FetterData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FetterDataOuterClass.internal_static_FetterData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData.class, emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData other = (emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData) obj;
    ...
    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FetterDataOuterClass.FetterDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FetterDataOuterClass.internal_static_FetterData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData build() {
        emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData buildPartial() {
        emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData result = new emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData) {
          return mergeFrom((emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData other) {
        if (other == emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData();
    }

    public static emu.grasscutter.net.newproto.FetterDataOuterClass.FetterData getDefaultInstance() {
