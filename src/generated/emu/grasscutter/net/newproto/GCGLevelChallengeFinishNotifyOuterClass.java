...
public final class GCGLevelChallengeFinishNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.class, emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify other = (emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify build() {
        emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify buildPartial() {
        emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify result = new emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify other) {
        if (other == emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify();
    }

    public static emu.grasscutter.net.newproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify getDefaultInstance() {
