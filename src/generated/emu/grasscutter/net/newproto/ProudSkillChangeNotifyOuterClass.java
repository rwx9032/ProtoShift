...
public final class ProudSkillChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.class, emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify other = (emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify build() {
        emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify buildPartial() {
        emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify result = new emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify other) {
        if (other == emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify();
    }

    public static emu.grasscutter.net.newproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify getDefaultInstance() {
