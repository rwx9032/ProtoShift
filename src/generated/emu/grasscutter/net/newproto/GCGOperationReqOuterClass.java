...
public final class GCGOperationReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGOperationReqOuterClass.internal_static_GCGOperationReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGOperationReqOuterClass.internal_static_GCGOperationReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq.class, emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq other = (emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGOperationReqOuterClass.internal_static_GCGOperationReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq build() {
        emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq buildPartial() {
        emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq result = new emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq other) {
        if (other == emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq();
    }

    public static emu.grasscutter.net.newproto.GCGOperationReqOuterClass.GCGOperationReq getDefaultInstance() {
