...
public final class GCGTCTavernChallengeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.internal_static_GCGTCTavernChallengeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.internal_static_GCGTCTavernChallengeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.class, emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData other = (emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.internal_static_GCGTCTavernChallengeData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData build() {
        emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData buildPartial() {
        emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData result = new emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData other) {
        if (other == emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData();
    }

    public static emu.grasscutter.net.newproto.GCGTCTavernChallengeDataOuterClass.GCGTCTavernChallengeData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "list\030\r \003(\r\022\024\n\014character_id\030\004 \001(\rB\036\n\034emu." +
