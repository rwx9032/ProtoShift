...
public final class HomeModuleComfortInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.class, emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo other = (emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.internal_static_HomeModuleComfortInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo build() {
        emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo buildPartial() {
        emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo result = new emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo other) {
        if (other == emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo();
    }

    public static emu.grasscutter.net.newproto.HomeModuleComfortInfoOuterClass.HomeModuleComfortInfo getDefaultInstance() {
