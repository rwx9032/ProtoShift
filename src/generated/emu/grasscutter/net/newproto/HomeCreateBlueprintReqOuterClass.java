...
public final class HomeCreateBlueprintReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.internal_static_HomeCreateBlueprintReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.internal_static_HomeCreateBlueprintReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq.class, emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq other = (emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.internal_static_HomeCreateBlueprintReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq build() {
        emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq buildPartial() {
        emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq result = new emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq(this);
        if (sceneArrangementInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq other) {
        if (other == emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq();
    }

    public static emu.grasscutter.net.newproto.HomeCreateBlueprintReqOuterClass.HomeCreateBlueprintReq getDefaultInstance() {
