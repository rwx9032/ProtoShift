...
public final class HomeAvatarSummonEventInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.internal_static_HomeAvatarSummonEventInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.internal_static_HomeAvatarSummonEventInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo.class, emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo other = (emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.internal_static_HomeAvatarSummonEventInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo build() {
        emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo buildPartial() {
        emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo result = new emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo other) {
        if (other == emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo();
    }

    public static emu.grasscutter.net.newproto.HomeAvatarSummonEventInfoOuterClass.HomeAvatarSummonEventInfo getDefaultInstance() {
