...
public final class DeliveryActivityDetailInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.internal_static_DeliveryActivityDetailInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.internal_static_DeliveryActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.class, emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo other = (emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.internal_static_DeliveryActivityDetailInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo build() {
        emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo buildPartial() {
        emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo result = new emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo other) {
        if (other == emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo();
    }

    public static emu.grasscutter.net.newproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_delivery_quest_index\030\004 \003(\rB\036\n\034emu.grass" +
