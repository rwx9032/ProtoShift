...
public final class WeeklyBossResinDiscountInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.internal_static_WeeklyBossResinDiscountInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.internal_static_WeeklyBossResinDiscountInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo.class, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo other = (emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.internal_static_WeeklyBossResinDiscountInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo build() {
        emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo buildPartial() {
        emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo result = new emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo other) {
        if (other == emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo();
    }

    public static emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo getDefaultInstance() {
