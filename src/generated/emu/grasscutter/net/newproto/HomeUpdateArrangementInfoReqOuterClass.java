...
public final class HomeUpdateArrangementInfoReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.internal_static_HomeUpdateArrangementInfoReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.internal_static_HomeUpdateArrangementInfoReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq.class, emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq other = (emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.internal_static_HomeUpdateArrangementInfoReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq build() {
        emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq buildPartial() {
        emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq result = new emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq(this);
        if (sceneArrangementInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq other) {
        if (other == emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq();
    }

    public static emu.grasscutter.net.newproto.HomeUpdateArrangementInfoReqOuterClass.HomeUpdateArrangementInfoReq getDefaultInstance() {
