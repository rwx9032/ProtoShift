...
public final class ChangeMailStarNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.class, emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify other = (emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify build() {
        emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify buildPartial() {
        emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify result = new emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify other) {
        if (other == emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify();
    }

    public static emu.grasscutter.net.newproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify getDefaultInstance() {
