...
public final class UseMiracleRingReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.internal_static_UseMiracleRingReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.internal_static_UseMiracleRingReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq.class, emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq.Builder.class);
    }
    ...
    public enum MiracleRingOpType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq other = (emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq) obj;
    ...
    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.internal_static_UseMiracleRingReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq build() {
        emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq buildPartial() {
        emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq result = new emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq(this);
        if (rotBuilder_ == null) {
          result.rot_ = rot_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq) {
          return mergeFrom((emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq other) {
        if (other == emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq.getDefaultInstance()) return this;
        if (other.hasRot()) {
    ...
    private static final emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq();
    }

    public static emu.grasscutter.net.newproto.UseMiracleRingReqOuterClass.UseMiracleRingReq getDefaultInstance() {
