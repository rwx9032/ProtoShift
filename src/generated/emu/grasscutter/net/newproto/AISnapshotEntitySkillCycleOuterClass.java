...
public final class AISnapshotEntitySkillCycleOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.internal_static_AISnapshotEntitySkillCycle_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.internal_static_AISnapshotEntitySkillCycle_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.class, emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle other = (emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle) obj;
    ...
    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.internal_static_AISnapshotEntitySkillCycle_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle build() {
        emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle buildPartial() {
        emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle result = new emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle) {
          return mergeFrom((emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle other) {
        if (other == emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle();
    }

    public static emu.grasscutter.net.newproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle getDefaultInstance() {
