...
public final class HuntingOfferDataOuterClass {
  ...
  public interface HuntingOfferDataOrBuilder extends
     ...
     * @return The state.
     */
    emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState getState();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.internal_static_HuntingOfferData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.internal_static_HuntingOfferData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData.class, emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData.Builder.class);
    }
     ...
     * @return The state.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState getState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState result = emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState.valueOf(state_);
      return result == null ? emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState.HUNTING_OFFER_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData other = (emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData) obj;
    ...
    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.internal_static_HuntingOfferData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData build() {
        emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData buildPartial() {
        emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData result = new emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData) {
          return mergeFrom((emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData other) {
        if (other == emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState getState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState result = emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState.valueOf(state_);
        return result == null ? emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.HuntingOfferState value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData();
    }

    public static emu.grasscutter.net.newproto.HuntingOfferDataOuterClass.HuntingOfferData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\017\n\007city_id\030\003 \001(\rB\036\n\034emu.grasscutter.net." +
      "newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.HuntingOfferStateOuterClass.getDescriptor(),
