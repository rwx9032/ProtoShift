...
public final class AbilityBornTypeOuterClass {
  ...
  public interface AbilityBornTypeOrBuilder extends
     ...
     * @return The moveDir.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getMoveDir();
    /**
     * <code>.Vector move_dir = 3;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getMoveDirOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType.class, emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType.Builder.class);
    }

    public static final int MOVE_DIR_FIELD_NUMBER = 3;
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector moveDir_;
    /**
     * <code>.Vector move_dir = 3;</code>
     * @return Whether the moveDir field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getMoveDir() {
      return moveDir_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : moveDir_;
    }
    /**
     * <code>.Vector move_dir = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getMoveDirOrBuilder() {
      return getMoveDir();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType other = (emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornTypeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType build() {
        emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType buildPartial() {
        emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType result = new emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType(this);
        if (moveDirBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType other) {
        if (other == emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType.getDefaultInstance()) return this;
        if (other.hasMoveDir()) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> moveDirBuilder_;
      /**
       * <code>.Vector move_dir = 3;</code>
       * @return Whether the moveDir field is set.
       */
       ...
       * <code>.Vector move_dir = 3;</code>
       */
      public Builder setMoveDir(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (moveDirBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector move_dir = 3;</code>
       */
      public Builder mergeMoveDir(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (moveDirBuilder_ == null) {
          if (moveDir_ != null) {
            moveDir_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(moveDir_).mergeFrom(value).buildPartial();
          } else {
            moveDir_ = value;
          }
          onChanged();
       ...
       * <code>.Vector move_dir = 3;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getMoveDirBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getMoveDirOrBuilder() {
        if (moveDirBuilder_ != null) {
          ...
          return moveDir_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : moveDir_;
        }
      }
      /**
       * <code>.Vector move_dir = 3;</code>
    ...
    private static final emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType();
    }

    public static emu.grasscutter.net.newproto.AbilityBornTypeOuterClass.AbilityBornType getDefaultInstance() {
