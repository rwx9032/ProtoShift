...
public final class MultistageSettleWatcherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.internal_static_MultistageSettleWatcherInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.internal_static_MultistageSettleWatcherInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.class, emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo other = (emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.internal_static_MultistageSettleWatcherInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo build() {
        emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo buildPartial() {
        emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo result = new emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo other) {
        if (other == emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo();
    }

    public static emu.grasscutter.net.newproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "id\030\005 \001(\r\022\026\n\016total_progress\030\013 \001(\rB\036\n\034emu." +
