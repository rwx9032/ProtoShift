...
public final class PingReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PingReqOuterClass.internal_static_PingReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PingReqOuterClass.internal_static_PingReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PingReqOuterClass.PingReq.class, emu.grasscutter.net.newproto.PingReqOuterClass.PingReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PingReqOuterClass.PingReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PingReqOuterClass.PingReq other = (emu.grasscutter.net.newproto.PingReqOuterClass.PingReq) obj;
    ...
    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PingReqOuterClass.PingReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PingReqOuterClass.PingReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PingReqOuterClass.internal_static_PingReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PingReqOuterClass.PingReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PingReqOuterClass.PingReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PingReqOuterClass.PingReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PingReqOuterClass.PingReq build() {
        emu.grasscutter.net.newproto.PingReqOuterClass.PingReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PingReqOuterClass.PingReq buildPartial() {
        emu.grasscutter.net.newproto.PingReqOuterClass.PingReq result = new emu.grasscutter.net.newproto.PingReqOuterClass.PingReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PingReqOuterClass.PingReq) {
          return mergeFrom((emu.grasscutter.net.newproto.PingReqOuterClass.PingReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PingReqOuterClass.PingReq other) {
        if (other == emu.grasscutter.net.newproto.PingReqOuterClass.PingReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PingReqOuterClass.PingReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PingReqOuterClass.PingReq();
    }

    public static emu.grasscutter.net.newproto.PingReqOuterClass.PingReq getDefaultInstance() {
