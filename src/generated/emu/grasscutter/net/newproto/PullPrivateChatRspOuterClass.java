...
public final class PullPrivateChatRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.internal_static_PullPrivateChatRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.internal_static_PullPrivateChatRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp.class, emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp other = (emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.internal_static_PullPrivateChatRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp build() {
        emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp buildPartial() {
        emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp result = new emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp other) {
        if (other == emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp.getDefaultInstance()) return this;
        if (chatInfoBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp();
    }

    public static emu.grasscutter.net.newproto.PullPrivateChatRspOuterClass.PullPrivateChatRsp getDefaultInstance() {
