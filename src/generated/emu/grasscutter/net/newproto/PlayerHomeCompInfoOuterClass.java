...
public final class PlayerHomeCompInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.internal_static_PlayerHomeCompInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.internal_static_PlayerHomeCompInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.class, emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo other = (emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.internal_static_PlayerHomeCompInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo build() {
        emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo buildPartial() {
        emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo result = new emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo other) {
        if (other == emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo();
    }

    public static emu.grasscutter.net.newproto.PlayerHomeCompInfoOuterClass.PlayerHomeCompInfo getDefaultInstance() {
