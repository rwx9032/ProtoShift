...
public final class GCGOperationAttackOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.internal_static_GCGOperationAttack_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.internal_static_GCGOperationAttack_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack.class, emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack other = (emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttackOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.internal_static_GCGOperationAttack_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack build() {
        emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack buildPartial() {
        emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack result = new emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack other) {
        if (other == emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack();
    }

    public static emu.grasscutter.net.newproto.GCGOperationAttackOuterClass.GCGOperationAttack getDefaultInstance() {
