...
public final class ClientScriptEventNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.internal_static_ClientScriptEventNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.internal_static_ClientScriptEventNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.class, emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify other = (emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.internal_static_ClientScriptEventNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify build() {
        emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify buildPartial() {
        emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify result = new emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify other) {
        if (other == emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify();
    }

    public static emu.grasscutter.net.newproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "y_id\030\004 \001(\r\022\022\n\nparam_list\030\006 \003(\005B\036\n\034emu.gr" +
