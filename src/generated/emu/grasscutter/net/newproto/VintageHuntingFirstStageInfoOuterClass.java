...
public final class VintageHuntingFirstStageInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.internal_static_VintageHuntingFirstStageInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.internal_static_VintageHuntingFirstStageInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo.class, emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo other = (emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.internal_static_VintageHuntingFirstStageInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo build() {
        emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo buildPartial() {
        emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo result = new emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo other) {
        if (other == emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo();
    }

    public static emu.grasscutter.net.newproto.VintageHuntingFirstStageInfoOuterClass.VintageHuntingFirstStageInfo getDefaultInstance() {
