...
public final class TowerLevelStarCondDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.internal_static_TowerLevelStarCondData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.internal_static_TowerLevelStarCondData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.class, emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData other = (emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData) obj;
    ...
    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.internal_static_TowerLevelStarCondData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData build() {
        emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData buildPartial() {
        emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData result = new emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData) {
          return mergeFrom((emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData other) {
        if (other == emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData();
    }

    public static emu.grasscutter.net.newproto.TowerLevelStarCondDataOuterClass.TowerLevelStarCondData getDefaultInstance() {
