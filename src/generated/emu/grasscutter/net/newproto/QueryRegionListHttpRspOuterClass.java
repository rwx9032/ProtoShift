...
public final class QueryRegionListHttpRspOuterClass {
  ...
  public interface QueryRegionListHttpRspOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> 
        getRegionListList();
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(int index);
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
     ...
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
        getRegionListOrBuilderList();
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder getRegionListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.class, emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> regionList_;
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> getRegionListList() {
      return regionList_;
    }
    /**
     * <code>repeated .RegionSimpleInfo region_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
        getRegionListOrBuilderList() {
      return regionList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo getRegionList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder getRegionListOrBuilder(
        int index) {
      return regionList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other = (emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.internal_static_QueryRegionListHttpRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp build() {
        emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp buildPartial() {
        emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp result = new emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp other) {
        if (other == emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18: {
                emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.parser(),
                        extensionRegistry);
                if (regionListBuilder_ == null) {
                  ensureRegionListIsMutable();
                  regionList_.add(m);
      ...
      private void ensureRegionListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          regionList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo>(regionList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> regionListBuilder_;
      ...
      public Builder setRegionList(
          int index, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
        if (regionListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setRegionList(
          int index, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder builderForValue) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public Builder addRegionList(emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo value) {
        if (regionListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRegionList(
          emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder builderForValue) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
      ...
      public Builder addAllRegionList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo> values) {
        if (regionListBuilder_ == null) {
          ensureRegionListIsMutable();
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder getRegionListBuilder(
          int index) {
       ...
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder addRegionListBuilder() {
        return getRegionListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder addRegionListBuilder(
          int index) {
        return getRegionListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .RegionSimpleInfo region_list = 2;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder> 
           getRegionListBuilderList() {
        return getRegionListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfo.Builder, emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.RegionSimpleInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp();
    }

    public static emu.grasscutter.net.newproto.QueryRegionListHttpRspOuterClass.QueryRegionListHttpRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\006 \001(\014\022\027\n\017enable_login_pc\030\007 \001(\010B\036\n\034emu.gr" +
      "asscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.RegionSimpleInfoOuterClass.getDescriptor(),
        });
    internal_static_QueryRegionListHttpRsp_descriptor =
