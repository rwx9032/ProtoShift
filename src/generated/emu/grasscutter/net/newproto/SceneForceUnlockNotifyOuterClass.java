...
public final class SceneForceUnlockNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.internal_static_SceneForceUnlockNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.internal_static_SceneForceUnlockNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify.class, emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify other = (emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.internal_static_SceneForceUnlockNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify build() {
        emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify buildPartial() {
        emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify result = new emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify other) {
        if (other == emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify();
    }

    public static emu.grasscutter.net.newproto.SceneForceUnlockNotifyOuterClass.SceneForceUnlockNotify getDefaultInstance() {
