...
public final class AbilityMixinRecoverInfoOuterClass {
  ...
  public interface AbilityMixinRecoverInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> 
        getMassivePropListList();
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo getMassivePropList(int index);
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
     ...
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> 
        getMassivePropListOrBuilderList();
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder getMassivePropListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot getBreakoutSnapShot();
    /**
     * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
     */
    emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getBreakoutSnapShotOrBuilder();
    ...
    public emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.SourceCase getSourceCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.internal_static_AbilityMixinRecoverInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.internal_static_AbilityMixinRecoverInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.class, emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> massivePropList_;
    /**
     * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> getMassivePropListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> 
        getMassivePropListOrBuilderList() {
      return massivePropList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo getMassivePropList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder getMassivePropListOrBuilder(
        int index) {
      return massivePropList_.get(index);
    }

    public static final int BREAKOUT_SNAP_SHOT_FIELD_NUMBER = 7;
    private emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot breakoutSnapShot_;
    /**
     * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
     * @return Whether the breakoutSnapShot field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot getBreakoutSnapShot() {
      return breakoutSnapShot_ == null ? emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance() : breakoutSnapShot_;
    }
    /**
     * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getBreakoutSnapShotOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo other = (emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.internal_static_AbilityMixinRecoverInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo build() {
        emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo buildPartial() {
        emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo result = new emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo other) {
        if (other == emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.parser(),
                        extensionRegistry);
                if (massivePropListBuilder_ == null) {
                  ensureMassivePropListIsMutable();
      ...
      private void ensureMassivePropListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          massivePropList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo>(massivePropList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> massivePropListBuilder_;
      ...
      public Builder setMassivePropList(
          int index, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo value) {
        if (massivePropListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMassivePropList(
          int index, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder builderForValue) {
        if (massivePropListBuilder_ == null) {
          ensureMassivePropListIsMutable();
       ...
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public Builder addMassivePropList(emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo value) {
        if (massivePropListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addMassivePropList(
          emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder builderForValue) {
        if (massivePropListBuilder_ == null) {
          ensureMassivePropListIsMutable();
      ...
      public Builder addAllMassivePropList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo> values) {
        if (massivePropListBuilder_ == null) {
          ensureMassivePropListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder getMassivePropListBuilder(
          int index) {
       ...
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder addMassivePropListBuilder() {
        return getMassivePropListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder addMassivePropListBuilder(
          int index) {
        return getMassivePropListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .MassivePropSyncInfo massive_prop_list = 6;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder> 
           getMassivePropListBuilderList() {
        return getMassivePropListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfo.Builder, emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.MassivePropSyncInfoOrBuilder> 
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot, emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder, emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder> breakoutSnapShotBuilder_;
      /**
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       * @return Whether the breakoutSnapShot field is set.
       */
       ...
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      public Builder setBreakoutSnapShot(emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
        if (breakoutSnapShotBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setBreakoutSnapShot(
          emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder builderForValue) {
        if (breakoutSnapShotBuilder_ == null) {
       ...
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      public Builder mergeBreakoutSnapShot(emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot value) {
        if (breakoutSnapShotBuilder_ == null) {
          if (breakoutSnapShot_ != null) {
            breakoutSnapShot_ =
              emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.newBuilder(breakoutSnapShot_).mergeFrom(value).buildPartial();
          } else {
            breakoutSnapShot_ = value;
          }
          onChanged();
       ...
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      public emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder getBreakoutSnapShotBuilder() {
      ...
      public emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder getBreakoutSnapShotOrBuilder() {
        if (breakoutSnapShotBuilder_ != null) {
          ...
          return breakoutSnapShot_ == null ?
              emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.getDefaultInstance() : breakoutSnapShot_;
        }
      }
      /**
       * <code>.BreakoutSnapShot breakout_snap_shot = 7;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot, emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShot.Builder, emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.BreakoutSnapShotOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo();
    }

    public static emu.grasscutter.net.newproto.AbilityMixinRecoverInfoOuterClass.AbilityMixinRecoverInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.BreakoutSnapShotOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.MassivePropSyncInfoOuterClass.getDescriptor(),
        });
    internal_static_AbilityMixinRecoverInfo_descriptor =
