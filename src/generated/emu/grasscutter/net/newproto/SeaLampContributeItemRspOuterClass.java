...
public final class SeaLampContributeItemRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.internal_static_SeaLampContributeItemRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.internal_static_SeaLampContributeItemRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp.class, emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp other = (emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.internal_static_SeaLampContributeItemRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp build() {
        emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp buildPartial() {
        emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp result = new emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp other) {
        if (other == emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp();
    }

    public static emu.grasscutter.net.newproto.SeaLampContributeItemRspOuterClass.SeaLampContributeItemRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ss\030\005 \001(\r\022\033\n\023Unk3300_LPHALOGLGAL\030\t \001(\rB\036\n" +
