...
public final class MassiveGrassInfoOuterClass {
  ...
  public interface MassiveGrassInfoOrBuilder extends
     ...
     * @return The size.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getSize();
    /**
     * <code>.Vector size = 3;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getSizeOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.internal_static_MassiveGrassInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.internal_static_MassiveGrassInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo.class, emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector size_;
    /**
     * <code>.Vector size = 3;</code>
     * @return Whether the size field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getSize() {
      return size_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : size_;
    }
    /**
     * <code>.Vector size = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getSizeOrBuilder() {
      return getSize();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo other = (emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.internal_static_MassiveGrassInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo build() {
        emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo buildPartial() {
        emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo result = new emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo(this);
        result.id_ = id_;
        if (centerBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo other) {
        if (other == emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
        if (other.hasCenter()) {
      ...
      private emu.grasscutter.net.newproto.VectorOuterClass.Vector size_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> sizeBuilder_;
      /**
       * <code>.Vector size = 3;</code>
       * @return Whether the size field is set.
       */
       ...
       * <code>.Vector size = 3;</code>
       */
      public Builder setSize(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (sizeBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector size = 3;</code>
       */
      public Builder mergeSize(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (sizeBuilder_ == null) {
          if (size_ != null) {
            size_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(size_).mergeFrom(value).buildPartial();
          } else {
            size_ = value;
          }
          onChanged();
       ...
       * <code>.Vector size = 3;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getSizeBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getSizeOrBuilder() {
        if (sizeBuilder_ != null) {
          ...
          return size_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : size_;
        }
      }
      /**
       * <code>.Vector size = 3;</code>
    ...
    private static final emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo();
    }

    public static emu.grasscutter.net.newproto.MassiveGrassInfoOuterClass.MassiveGrassInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\002 \001(\0132\007.Vector\022\025\n\004size\030\003 \001(\0132\007.VectorB\036" +
