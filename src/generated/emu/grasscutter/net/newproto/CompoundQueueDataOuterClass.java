...
public final class CompoundQueueDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.internal_static_CompoundQueueData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.internal_static_CompoundQueueData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData.class, emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData other = (emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData) obj;
    ...
    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.internal_static_CompoundQueueData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData build() {
        emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData buildPartial() {
        emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData result = new emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData) {
          return mergeFrom((emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData other) {
        if (other == emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData();
    }

    public static emu.grasscutter.net.newproto.CompoundQueueDataOuterClass.CompoundQueueData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "OPCPPAD\030\n \001(\r\022\023\n\013compound_id\030\014 \001(\rB\036\n\034em" +
