...
public final class CoopChapterOuterClass {
  ...
  public interface CoopChapterOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint> 
        getCoopPointListList();
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint getCoopPointList(int index);
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
     ...
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPointOrBuilder> 
        getCoopPointListOrBuilderList();
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointListOrBuilder(
        int index);
     ...
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
    emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward getCoopRewardList(int index);
    /**
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
     ...
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
    emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopRewardOrBuilder getCoopRewardListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg> 
        getCoopCgListList();
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg getCoopCgList(int index);
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
     ...
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCgOrBuilder> 
        getCoopCgListOrBuilderList();
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCgOrBuilder getCoopCgListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CoopChapterOuterClass.internal_static_CoopChapter_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.CoopChapterOuterClass.internal_static_CoopChapter_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.class, emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.Builder.class);
    }
    ...
    public enum State
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint> coopPointList_;
    /**
     * <code>repeated .CoopPoint coop_point_list = 12;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint> getCoopPointListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPointOrBuilder> 
        getCoopPointListOrBuilderList() {
      return coopPointList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint getCoopPointList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointListOrBuilder(
        int index) {
      return coopPointList_.get(index);
    }
     ...
     * @return The state.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State getState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State result = emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State.valueOf(state_);
    ...
    private java.util.List<emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward> coopRewardList_;
    /**
     * <code>repeated .CoopReward coop_reward_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward> getCoopRewardListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward getCoopRewardList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopRewardOrBuilder getCoopRewardListOrBuilder(
        int index) {
      return coopRewardList_.get(index);
    }
     ...
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg> getCoopCgListList() {
      return coopCgList_;
    }
    /**
     * <code>repeated .CoopCg coop_cg_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCgOrBuilder> 
        getCoopCgListOrBuilderList() {
      return coopCgList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg getCoopCgList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCgOrBuilder getCoopCgListOrBuilder(
        int index) {
      return coopCgList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.CoopChapterOuterClass.internal_static_CoopChapter_SeenEndingMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter other = (emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter) obj;
    ...
    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapterOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CoopChapterOuterClass.internal_static_CoopChapter_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter build() {
        emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter buildPartial() {
        emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter result = new emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter) {
          return mergeFrom((emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter other) {
        if (other == emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
        if (coopPointListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 18: {
                emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.parser(),
                        extensionRegistry);
                if (coopCgListBuilder_ == null) {
                  ensureCoopCgListIsMutable();
                  coopCgList_.add(m);
              ...
              case 98: {
                emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.parser(),
                        extensionRegistry);
                if (coopPointListBuilder_ == null) {
                  ensureCoopPointListIsMutable();
      ...
      private void ensureCoopPointListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          coopPointList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint>(coopPointList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint, emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.Builder, emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPointOrBuilder> coopPointListBuilder_;
      ...
      public Builder setCoopPointList(
          int index, emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCoopPointList(
          int index, emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.Builder builderForValue) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
       ...
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public Builder addCoopPointList(emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllCoopPointList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint> values) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
       ...
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.Builder getCoopPointListBuilder(
          int index) {
       ...
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.Builder addCoopPointListBuilder() {
        return getCoopPointListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.Builder addCoopPointListBuilder(
          int index) {
        return getCoopPointListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopPoint coop_point_list = 12;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.CoopPointOuterClass.CoopPoint.Builder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State getState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State result = emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State.valueOf(state_);
        return result == null ? emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter.State value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private void ensureCoopRewardListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          coopRewardList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward>(coopRewardList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward, emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward.Builder, emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopRewardOrBuilder> coopRewardListBuilder_;
       ...
       * <code>repeated .CoopReward coop_reward_list = 3;</code>
       */
      public Builder addCoopRewardList(emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward value) {
        if (coopRewardListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .CoopReward coop_reward_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward.Builder getCoopRewardListBuilder(
          int index) {
       ...
       * <code>repeated .CoopReward coop_reward_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.CoopRewardOuterClass.CoopReward.Builder addCoopRewardListBuilder() {
      ...
      private void ensureCoopCgListIsMutable() {
        if (!((bitField0_ & 0x00000010) != 0)) {
          coopCgList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg>(coopCgList_);
          bitField0_ |= 0x00000010;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCgOrBuilder> coopCgListBuilder_;
      ...
      public Builder setCoopCgList(
          int index, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg value) {
        if (coopCgListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCoopCgList(
          int index, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder builderForValue) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
       ...
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public Builder addCoopCgList(emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg value) {
        if (coopCgListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCoopCgList(
          emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder builderForValue) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
      ...
      public Builder addAllCoopCgList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg> values) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, coopCgList_);
       ...
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder getCoopCgListBuilder(
          int index) {
       ...
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder addCoopCgListBuilder() {
        return getCoopCgListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder addCoopCgListBuilder(
          int index) {
        return getCoopCgListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopCg coop_cg_list = 2;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder> 
           getCoopCgListBuilderList() {
        return getCoopCgListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCg.Builder, emu.grasscutter.net.newproto.CoopCgOuterClass.CoopCgOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter();
    }

    public static emu.grasscutter.net.newproto.CoopChapterOuterClass.CoopChapter getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.CoopCgOuterClass.getDescriptor(),
