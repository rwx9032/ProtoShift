...
public final class IrodoriChessMonsterInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.internal_static_IrodoriChessMonsterInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.internal_static_IrodoriChessMonsterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo.class, emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo other = (emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.internal_static_IrodoriChessMonsterInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo build() {
        emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo buildPartial() {
        emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo result = new emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo other) {
        if (other == emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo();
    }

    public static emu.grasscutter.net.newproto.IrodoriChessMonsterInfoOuterClass.IrodoriChessMonsterInfo getDefaultInstance() {
