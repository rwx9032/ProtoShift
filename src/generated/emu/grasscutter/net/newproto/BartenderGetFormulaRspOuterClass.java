...
public final class BartenderGetFormulaRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.internal_static_BartenderGetFormulaRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.internal_static_BartenderGetFormulaRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp.class, emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp other = (emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.internal_static_BartenderGetFormulaRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp build() {
        emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp buildPartial() {
        emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp result = new emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp other) {
        if (other == emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp();
    }

    public static emu.grasscutter.net.newproto.BartenderGetFormulaRspOuterClass.BartenderGetFormulaRsp getDefaultInstance() {
