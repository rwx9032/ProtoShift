...
public final class AvatarSkillChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.internal_static_AvatarSkillChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.internal_static_AvatarSkillChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.class, emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify other = (emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.internal_static_AvatarSkillChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify build() {
        emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify buildPartial() {
        emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify result = new emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify other) {
        if (other == emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify();
    }

    public static emu.grasscutter.net.newproto.AvatarSkillChangeNotifyOuterClass.AvatarSkillChangeNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r\022\027\n\017avatar_skill_id\030\013 \001(\rB\036\n\034emu.grassc" +
