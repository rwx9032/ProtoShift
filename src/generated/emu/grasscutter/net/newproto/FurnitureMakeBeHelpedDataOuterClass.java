...
public final class FurnitureMakeBeHelpedDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.class, emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData other = (emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData) obj;
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData build() {
        emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData buildPartial() {
        emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData result = new emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData) {
          return mergeFrom((emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData other) {
        if (other == emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData();
    }

    public static emu.grasscutter.net.newproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData getDefaultInstance() {
