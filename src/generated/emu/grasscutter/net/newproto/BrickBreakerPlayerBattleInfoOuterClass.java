...
public final class BrickBreakerPlayerBattleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.internal_static_BrickBreakerPlayerBattleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.internal_static_BrickBreakerPlayerBattleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo.class, emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo other = (emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.internal_static_BrickBreakerPlayerBattleInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo build() {
        emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo buildPartial() {
        emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo result = new emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo other) {
        if (other == emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo();
    }

    public static emu.grasscutter.net.newproto.BrickBreakerPlayerBattleInfoOuterClass.BrickBreakerPlayerBattleInfo getDefaultInstance() {
