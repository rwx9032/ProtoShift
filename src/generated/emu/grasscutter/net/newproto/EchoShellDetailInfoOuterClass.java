...
public final class EchoShellDetailInfoOuterClass {
  ...
  public interface EchoShellDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> 
        getSummerTimeDungeonListList();
    /**
     * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
     */
    emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo getSummerTimeDungeonList(int index);
    /**
     * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
     */
     ...
     * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> 
        getSummerTimeDungeonListOrBuilderList();
    /**
     * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
     */
    emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder getSummerTimeDungeonListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.internal_static_EchoShellDetailInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.internal_static_EchoShellDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo.class, emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> summerTimeDungeonList_;
    /**
     * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> getSummerTimeDungeonListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> 
        getSummerTimeDungeonListOrBuilderList() {
      return summerTimeDungeonList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo getSummerTimeDungeonList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder getSummerTimeDungeonListOrBuilder(
        int index) {
      return summerTimeDungeonList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo other = (emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.internal_static_EchoShellDetailInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo build() {
        emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo buildPartial() {
        emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo result = new emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo other) {
        if (other == emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 26: {
                emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.parser(),
                        extensionRegistry);
                if (summerTimeDungeonListBuilder_ == null) {
                  ensureSummerTimeDungeonListIsMutable();
      ...
      private void ensureSummerTimeDungeonListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          summerTimeDungeonList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo>(summerTimeDungeonList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> summerTimeDungeonListBuilder_;
      ...
      public Builder setSummerTimeDungeonList(
          int index, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo value) {
        if (summerTimeDungeonListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSummerTimeDungeonList(
          int index, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder builderForValue) {
        if (summerTimeDungeonListBuilder_ == null) {
          ensureSummerTimeDungeonListIsMutable();
       ...
       * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
       */
      public Builder addSummerTimeDungeonList(emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo value) {
        if (summerTimeDungeonListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSummerTimeDungeonList(
          emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder builderForValue) {
        if (summerTimeDungeonListBuilder_ == null) {
          ensureSummerTimeDungeonListIsMutable();
      ...
      public Builder addAllSummerTimeDungeonList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo> values) {
        if (summerTimeDungeonListBuilder_ == null) {
          ensureSummerTimeDungeonListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder getSummerTimeDungeonListBuilder(
          int index) {
       ...
       * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder addSummerTimeDungeonListBuilder() {
        return getSummerTimeDungeonListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder addSummerTimeDungeonListBuilder(
          int index) {
        return getSummerTimeDungeonListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SummerTimeDungeonInfo summer_time_dungeon_list = 3;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder> 
           getSummerTimeDungeonListBuilderList() {
        return getSummerTimeDungeonListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfo.Builder, emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.SummerTimeDungeonInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo();
    }

    public static emu.grasscutter.net.newproto.EchoShellDetailInfoOuterClass.EchoShellDetailInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.SummerTimeDungeonInfoOuterClass.getDescriptor(),
        });
    internal_static_EchoShellDetailInfo_descriptor =
