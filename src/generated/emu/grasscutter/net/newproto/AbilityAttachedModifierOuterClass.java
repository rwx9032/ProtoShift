...
public final class AbilityAttachedModifierOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.internal_static_AbilityAttachedModifier_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.internal_static_AbilityAttachedModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier.class, emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier other = (emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifierOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.internal_static_AbilityAttachedModifier_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier build() {
        emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier buildPartial() {
        emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier result = new emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier other) {
        if (other == emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier();
    }

    public static emu.grasscutter.net.newproto.AbilityAttachedModifierOuterClass.AbilityAttachedModifier getDefaultInstance() {
