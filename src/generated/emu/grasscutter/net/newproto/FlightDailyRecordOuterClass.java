...
public final class FlightDailyRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.internal_static_FlightDailyRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.internal_static_FlightDailyRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord.class, emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord other = (emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord) obj;
    ...
    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.internal_static_FlightDailyRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord build() {
        emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord buildPartial() {
        emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord result = new emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord) {
          return mergeFrom((emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord other) {
        if (other == emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord();
    }

    public static emu.grasscutter.net.newproto.FlightDailyRecordOuterClass.FlightDailyRecord getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\r\022\027\n\017watcher_id_list\030\007 \003(\rB\036\n\034emu.gra" +
