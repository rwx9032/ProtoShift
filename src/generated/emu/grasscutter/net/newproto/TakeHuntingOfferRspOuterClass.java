...
public final class TakeHuntingOfferRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.internal_static_TakeHuntingOfferRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.internal_static_TakeHuntingOfferRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.class, emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp other = (emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.internal_static_TakeHuntingOfferRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp build() {
        emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp buildPartial() {
        emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp result = new emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp other) {
        if (other == emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp();
    }

    public static emu.grasscutter.net.newproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp getDefaultInstance() {
