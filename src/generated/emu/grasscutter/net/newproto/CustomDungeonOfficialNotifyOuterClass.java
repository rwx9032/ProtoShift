...
public final class CustomDungeonOfficialNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.internal_static_CustomDungeonOfficialNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.internal_static_CustomDungeonOfficialNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify.class, emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify other = (emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.internal_static_CustomDungeonOfficialNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify build() {
        emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify buildPartial() {
        emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify result = new emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify other) {
        if (other == emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify.getDefaultInstance()) return this;
        if (other.tryType_ != 0) {
    ...
    private static final emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify();
    }

    public static emu.grasscutter.net.newproto.CustomDungeonOfficialNotifyOuterClass.CustomDungeonOfficialNotify getDefaultInstance() {
