...
public final class H5ActivityIdsNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.internal_static_H5ActivityIdsNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.internal_static_H5ActivityIdsNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify.class, emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.internal_static_H5ActivityIdsNotify_H5ActivityMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify other = (emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.internal_static_H5ActivityIdsNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify build() {
        emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify buildPartial() {
        emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify result = new emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify other) {
        if (other == emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify();
    }

    public static emu.grasscutter.net.newproto.H5ActivityIdsNotifyOuterClass.H5ActivityIdsNotify getDefaultInstance() {
