...
public final class ShowTemplateReminderNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.internal_static_ShowTemplateReminderNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.internal_static_ShowTemplateReminderNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify.class, emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify other = (emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.internal_static_ShowTemplateReminderNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify build() {
        emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify buildPartial() {
        emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify result = new emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify other) {
        if (other == emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify();
    }

    public static emu.grasscutter.net.newproto.ShowTemplateReminderNotifyOuterClass.ShowTemplateReminderNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "IBBBPJC\030\014 \001(\010\022\026\n\016param_uid_list\030\007 \003(\rB\036\n" +
