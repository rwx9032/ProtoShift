...
public final class PullRecentChatRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.internal_static_PullRecentChatRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.internal_static_PullRecentChatRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp.class, emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp other = (emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.internal_static_PullRecentChatRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp build() {
        emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp buildPartial() {
        emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp result = new emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp other) {
        if (other == emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp.getDefaultInstance()) return this;
        if (chatInfoBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp();
    }

    public static emu.grasscutter.net.newproto.PullRecentChatRspOuterClass.PullRecentChatRsp getDefaultInstance() {
