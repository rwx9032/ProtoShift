...
public final class HomeFurnitureCustomSuiteDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.internal_static_HomeFurnitureCustomSuiteData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.internal_static_HomeFurnitureCustomSuiteData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.class, emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData other = (emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.internal_static_HomeFurnitureCustomSuiteData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData build() {
        emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData buildPartial() {
        emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData result = new emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData other) {
        if (other == emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData();
    }

    public static emu.grasscutter.net.newproto.HomeFurnitureCustomSuiteDataOuterClass.HomeFurnitureCustomSuiteData getDefaultInstance() {
