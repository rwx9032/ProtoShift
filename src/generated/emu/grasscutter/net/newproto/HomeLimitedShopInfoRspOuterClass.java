...
public final class HomeLimitedShopInfoRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.internal_static_HomeLimitedShopInfoRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.internal_static_HomeLimitedShopInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp.class, emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp other = (emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.internal_static_HomeLimitedShopInfoRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp build() {
        emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp buildPartial() {
        emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp result = new emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp other) {
        if (other == emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp();
    }

    public static emu.grasscutter.net.newproto.HomeLimitedShopInfoRspOuterClass.HomeLimitedShopInfoRsp getDefaultInstance() {
