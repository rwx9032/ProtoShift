...
public final class EntityFightPropUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.class, emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Float> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Float>newDefaultInstance(
                  emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_FightPropMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify other = (emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.internal_static_EntityFightPropUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify build() {
        emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify buildPartial() {
        emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify result = new emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify other) {
        if (other == emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify();
    }

    public static emu.grasscutter.net.newproto.EntityFightPropUpdateNotifyOuterClass.EntityFightPropUpdateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e\030\002 \001(\002:\0028\001B\036\n\034emu.grasscutter.net.newpr" +
      "otob\006proto3"
    };
