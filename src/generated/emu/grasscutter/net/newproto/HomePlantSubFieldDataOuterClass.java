...
public final class HomePlantSubFieldDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.class, emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.Builder.class);
    }
     ...
     * @return The fieldStatus.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus getFieldStatus() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus result = emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.valueOf(fieldStatus_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (fieldStatus_ != emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.HOME_PLANT_FIELD_STATUS_STATUE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData)) {
    ...
    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.internal_static_HomePlantSubFieldData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData build() {
        emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData buildPartial() {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData) {
          return mergeFrom((emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData other) {
        if (other == emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus getFieldStatus() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus result = emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.valueOf(fieldStatus_);
        return result == null ? emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setFieldStatus(emu.grasscutter.net.newproto.HomePlantFieldStatusOuterClass.HomePlantFieldStatus value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData();
    }

    public static emu.grasscutter.net.newproto.HomePlantSubFieldDataOuterClass.HomePlantSubFieldData getDefaultInstance() {
