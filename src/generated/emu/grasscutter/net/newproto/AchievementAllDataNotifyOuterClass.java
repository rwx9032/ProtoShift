...
public final class AchievementAllDataNotifyOuterClass {
  ...
  public interface AchievementAllDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.AchievementOuterClass.Achievement> 
        getAchievementListList();
    /**
     * <code>repeated .Achievement achievement_list = 8;</code>
     */
    emu.grasscutter.net.newproto.AchievementOuterClass.Achievement getAchievementList(int index);
    /**
     * <code>repeated .Achievement achievement_list = 8;</code>
     */
     ...
     * <code>repeated .Achievement achievement_list = 8;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder> 
        getAchievementListOrBuilderList();
    /**
     * <code>repeated .Achievement achievement_list = 8;</code>
     */
    emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder getAchievementListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.class, emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.AchievementOuterClass.Achievement> achievementList_;
    /**
     * <code>repeated .Achievement achievement_list = 8;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.AchievementOuterClass.Achievement> getAchievementListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder> 
        getAchievementListOrBuilderList() {
      return achievementList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement getAchievementList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder getAchievementListOrBuilder(
        int index) {
      return achievementList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other = (emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify build() {
        emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify buildPartial() {
        emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = new emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other) {
        if (other == emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 66: {
                emu.grasscutter.net.newproto.AchievementOuterClass.Achievement m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.parser(),
                        extensionRegistry);
                if (achievementListBuilder_ == null) {
                  ensureAchievementListIsMutable();
      ...
      private void ensureAchievementListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          achievementList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.AchievementOuterClass.Achievement>(achievementList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.AchievementOuterClass.Achievement, emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder, emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder> achievementListBuilder_;
      ...
      public Builder setAchievementList(
          int index, emu.grasscutter.net.newproto.AchievementOuterClass.Achievement value) {
        if (achievementListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAchievementList(
          int index, emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder builderForValue) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
       ...
       * <code>repeated .Achievement achievement_list = 8;</code>
       */
      public Builder addAchievementList(emu.grasscutter.net.newproto.AchievementOuterClass.Achievement value) {
        if (achievementListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAchievementList(
          emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder builderForValue) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
      ...
      public Builder addAllAchievementList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.AchievementOuterClass.Achievement> values) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .Achievement achievement_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder getAchievementListBuilder(
          int index) {
       ...
       * <code>repeated .Achievement achievement_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder addAchievementListBuilder() {
        return getAchievementListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.getDefaultInstance());
      }
      /**
       * <code>repeated .Achievement achievement_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder addAchievementListBuilder(
          int index) {
        return getAchievementListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.getDefaultInstance());
      }
      /**
       * <code>repeated .Achievement achievement_list = 8;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder> 
           getAchievementListBuilderList() {
        return getAchievementListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.AchievementOuterClass.Achievement, emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder, emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify();
    }

    public static emu.grasscutter.net.newproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "hievement_list\030\010 \003(\0132\014.AchievementB\036\n\034em" +
      "u.grasscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.AchievementOuterClass.getDescriptor(),
        });
    internal_static_AchievementAllDataNotify_descriptor =
