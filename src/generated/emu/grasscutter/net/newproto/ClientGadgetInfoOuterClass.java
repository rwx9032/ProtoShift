...
public final class ClientGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.class, emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo other = (emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo build() {
        emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo buildPartial() {
        emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo result = new emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo other) {
        if (other == emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo();
    }

    public static emu.grasscutter.net.newproto.ClientGadgetInfoOuterClass.ClientGadgetInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\025target_entity_id_list\030\010 \003(\rB\036\n\034emu.gra" +
