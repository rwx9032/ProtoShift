...
public final class FungusFighterTrainingSettleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.internal_static_FungusFighterTrainingSettleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.internal_static_FungusFighterTrainingSettleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo.class, emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo other = (emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.internal_static_FungusFighterTrainingSettleInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo build() {
        emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo buildPartial() {
        emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo result = new emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo other) {
        if (other == emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo();
    }

    public static emu.grasscutter.net.newproto.FungusFighterTrainingSettleInfoOuterClass.FungusFighterTrainingSettleInfo getDefaultInstance() {
