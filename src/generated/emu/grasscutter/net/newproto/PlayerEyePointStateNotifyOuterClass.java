...
public final class PlayerEyePointStateNotifyOuterClass {
  ...
  public interface PlayerEyePointStateNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getEyePointPos();
    /**
     * <code>.Vector eye_point_pos = 12;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getEyePointPosOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getCubicSize();
    /**
     * <code>.Vector cubic_size = 1362;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getCubicSizeOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize getCylinderSize();
    /**
     * <code>.CylinderRegionSize cylinder_size = 1250;</code>
     */
    emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSizeOrBuilder getCylinderSizeOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize getPolygonSize();
    /**
     * <code>.PolygonRegionSize polygon_size = 608;</code>
     */
    emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSizeOrBuilder getPolygonSizeOrBuilder();

    public emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify.RegionSizeCase getRegionSizeCase();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.internal_static_PlayerEyePointStateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.internal_static_PlayerEyePointStateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify.class, emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector eyePointPos_;
    /**
     * <code>.Vector eye_point_pos = 12;</code>
     * @return Whether the eyePointPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getEyePointPos() {
      return eyePointPos_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : eyePointPos_;
    }
    /**
     * <code>.Vector eye_point_pos = 12;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getEyePointPosOrBuilder() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getCubicSize() {
      if (regionSizeCase_ == 1362) {
         return (emu.grasscutter.net.newproto.VectorOuterClass.Vector) regionSize_;
      }
      return emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance();
    }
    /**
     * <code>.Vector cubic_size = 1362;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getCubicSizeOrBuilder() {
      if (regionSizeCase_ == 1362) {
         return (emu.grasscutter.net.newproto.VectorOuterClass.Vector) regionSize_;
      }
      return emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize getCylinderSize() {
      if (regionSizeCase_ == 1250) {
         return (emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize) regionSize_;
      }
      return emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.getDefaultInstance();
    }
    /**
     * <code>.CylinderRegionSize cylinder_size = 1250;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSizeOrBuilder getCylinderSizeOrBuilder() {
      if (regionSizeCase_ == 1250) {
         return (emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize) regionSize_;
      }
      return emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize getPolygonSize() {
      if (regionSizeCase_ == 608) {
         return (emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize) regionSize_;
      }
      return emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.getDefaultInstance();
    }
    /**
     * <code>.PolygonRegionSize polygon_size = 608;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSizeOrBuilder getPolygonSizeOrBuilder() {
      if (regionSizeCase_ == 608) {
         return (emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize) regionSize_;
      }
      return emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (regionSizeCase_ == 608) {
        output.writeMessage(608, (emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize) regionSize_);
      }
      if (regionSizeCase_ == 1250) {
        output.writeMessage(1250, (emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize) regionSize_);
      }
      if (regionSizeCase_ == 1362) {
        output.writeMessage(1362, (emu.grasscutter.net.newproto.VectorOuterClass.Vector) regionSize_);
      }
      if (regionSizeCase_ == 1413) {
        output.writeFloat(
    ...
    public int getSerializedSize() {
      ...
      if (regionSizeCase_ == 608) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(608, (emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize) regionSize_);
      }
      if (regionSizeCase_ == 1250) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1250, (emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize) regionSize_);
      }
      if (regionSizeCase_ == 1362) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1362, (emu.grasscutter.net.newproto.VectorOuterClass.Vector) regionSize_);
      }
      if (regionSizeCase_ == 1413) {
        size += com.google.protobuf.CodedOutputStream
          .computeFloatSize(
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify other = (emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.internal_static_PlayerEyePointStateNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify build() {
        emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify buildPartial() {
        emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify result = new emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify(this);
        if (eyePointPosBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify other) {
        if (other == emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> eyePointPosBuilder_;
      /**
       * <code>.Vector eye_point_pos = 12;</code>
       * @return Whether the eyePointPos field is set.
       */
       ...
       * <code>.Vector eye_point_pos = 12;</code>
       */
      public Builder setEyePointPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (eyePointPosBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector eye_point_pos = 12;</code>
       */
      public Builder mergeEyePointPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (eyePointPosBuilder_ == null) {
          if (eyePointPos_ != null) {
            eyePointPos_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(eyePointPos_).mergeFrom(value).buildPartial();
          } else {
            eyePointPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector eye_point_pos = 12;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getEyePointPosBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getEyePointPosOrBuilder() {
        if (eyePointPosBuilder_ != null) {
          ...
          return eyePointPos_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : eyePointPos_;
        }
      }
      /**
       * <code>.Vector eye_point_pos = 12;</code>
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> cubicSizeBuilder_;
      /**
       * <code>.Vector cubic_size = 1362;</code>
       * @return Whether the cubicSize field is set.
       */
       ...
       * <code>.Vector cubic_size = 1362;</code>
       */
      public Builder setCubicSize(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (cubicSizeBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector cubic_size = 1362;</code>
       */
      public Builder mergeCubicSize(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (cubicSizeBuilder_ == null) {
          if (regionSizeCase_ == 1362 &&
              regionSize_ != emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance()) {
            regionSize_ = emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder((emu.grasscutter.net.newproto.VectorOuterClass.Vector) regionSize_)
       ...
       * <code>.Vector cubic_size = 1362;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getCubicSizeBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (cubicSizeBuilder_ == null) {
          ...
          cubicSizeBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder>(
                  (emu.grasscutter.net.newproto.VectorOuterClass.Vector) regionSize_,
                  getParentForChildren(),
                  isClean());
          regionSize_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize, emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.Builder, emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSizeOrBuilder> cylinderSizeBuilder_;
      /**
       * <code>.CylinderRegionSize cylinder_size = 1250;</code>
       * @return Whether the cylinderSize field is set.
       */
       ...
       * <code>.CylinderRegionSize cylinder_size = 1250;</code>
       */
      public Builder setCylinderSize(emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize value) {
        if (cylinderSizeBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setCylinderSize(
          emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.Builder builderForValue) {
        if (cylinderSizeBuilder_ == null) {
          regionSize_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.CylinderRegionSize cylinder_size = 1250;</code>
       */
      public Builder mergeCylinderSize(emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize value) {
        if (cylinderSizeBuilder_ == null) {
          if (regionSizeCase_ == 1250 &&
              regionSize_ != emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.getDefaultInstance()) {
            regionSize_ = emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.newBuilder((emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize) regionSize_)
                .mergeFrom(value).buildPartial();
          } else {
            regionSize_ = value;
          }
       ...
       * <code>.CylinderRegionSize cylinder_size = 1250;</code>
       */
      public emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.Builder getCylinderSizeBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize, emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.Builder, emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSizeOrBuilder> 
        ...
        if (cylinderSizeBuilder_ == null) {
          ...
          cylinderSizeBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize, emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize.Builder, emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSizeOrBuilder>(
                  (emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.CylinderRegionSize) regionSize_,
                  getParentForChildren(),
                  isClean());
          regionSize_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize, emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.Builder, emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSizeOrBuilder> polygonSizeBuilder_;
      /**
       * <code>.PolygonRegionSize polygon_size = 608;</code>
       * @return Whether the polygonSize field is set.
       */
       ...
       * <code>.PolygonRegionSize polygon_size = 608;</code>
       */
      public Builder setPolygonSize(emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize value) {
        if (polygonSizeBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setPolygonSize(
          emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.Builder builderForValue) {
        if (polygonSizeBuilder_ == null) {
          regionSize_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.PolygonRegionSize polygon_size = 608;</code>
       */
      public Builder mergePolygonSize(emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize value) {
        if (polygonSizeBuilder_ == null) {
          if (regionSizeCase_ == 608 &&
              regionSize_ != emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.getDefaultInstance()) {
            regionSize_ = emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.newBuilder((emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize) regionSize_)
                .mergeFrom(value).buildPartial();
          } else {
            regionSize_ = value;
          }
       ...
       * <code>.PolygonRegionSize polygon_size = 608;</code>
       */
      public emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.Builder getPolygonSizeBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize, emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.Builder, emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSizeOrBuilder> 
        ...
        if (polygonSizeBuilder_ == null) {
          ...
          polygonSizeBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize, emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize.Builder, emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSizeOrBuilder>(
                  (emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.PolygonRegionSize) regionSize_,
                  getParentForChildren(),
                  isClean());
          regionSize_ = null;
        }
    ...
    private static final emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify();
    }

    public static emu.grasscutter.net.newproto.PlayerEyePointStateNotifyOuterClass.PlayerEyePointStateNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.CylinderRegionSizeOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.PolygonRegionSizeOuterClass.getDescriptor(),
