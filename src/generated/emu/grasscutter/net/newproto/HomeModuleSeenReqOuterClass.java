...
public final class HomeModuleSeenReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.internal_static_HomeModuleSeenReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.internal_static_HomeModuleSeenReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq.class, emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq other = (emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.internal_static_HomeModuleSeenReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq build() {
        emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq buildPartial() {
        emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq result = new emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq other) {
        if (other == emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq();
    }

    public static emu.grasscutter.net.newproto.HomeModuleSeenReqOuterClass.HomeModuleSeenReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eenReq\022\033\n\023seen_module_id_list\030\t \003(\rB\036\n\034e" +
