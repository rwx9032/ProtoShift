...
public final class IrodoriChessMysteryInfoOuterClass {
  ...
  public interface IrodoriChessMysteryInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo getEntranceDetailInfo();
    /**
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
     */
    emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfoOrBuilder getEntranceDetailInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.internal_static_IrodoriChessMysteryInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.internal_static_IrodoriChessMysteryInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo.class, emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo.Builder.class);
    }

    public static final int ENTRANCE_DETAIL_INFO_FIELD_NUMBER = 3;
    private emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo entranceDetailInfo_;
    /**
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
     * @return Whether the entranceDetailInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo getEntranceDetailInfo() {
      return entranceDetailInfo_ == null ? emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo.getDefaultInstance() : entranceDetailInfo_;
    }
    /**
     * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfoOrBuilder getEntranceDetailInfoOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo other = (emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.internal_static_IrodoriChessMysteryInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo build() {
        emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo buildPartial() {
        emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo result = new emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo other) {
        if (other == emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo, emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo.Builder, emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfoOrBuilder> entranceDetailInfoBuilder_;
      /**
       * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
       * @return Whether the entranceDetailInfo field is set.
       */
       ...
       * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
       */
      public Builder setEntranceDetailInfo(emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo value) {
        if (entranceDetailInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setEntranceDetailInfo(
          emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo.Builder builderForValue) {
        if (entranceDetailInfoBuilder_ == null) {
       ...
       * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
       */
      public Builder mergeEntranceDetailInfo(emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo value) {
        if (entranceDetailInfoBuilder_ == null) {
          if (entranceDetailInfo_ != null) {
            entranceDetailInfo_ =
              emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo.newBuilder(entranceDetailInfo_).mergeFrom(value).buildPartial();
          } else {
            entranceDetailInfo_ = value;
          }
          onChanged();
       ...
       * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
       */
      public emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo.Builder getEntranceDetailInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfoOrBuilder getEntranceDetailInfoOrBuilder() {
        if (entranceDetailInfoBuilder_ != null) {
          ...
          return entranceDetailInfo_ == null ?
              emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.IrodoriChessEntranceDetailInfo.getDefaultInstance() : entranceDetailInfo_;
        }
      }
      /**
       * <code>.IrodoriChessEntranceDetailInfo entrance_detail_info = 3;</code>
    ...
    private static final emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo();
    }

    public static emu.grasscutter.net.newproto.IrodoriChessMysteryInfoOuterClass.IrodoriChessMysteryInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_point_id_list\030\013 \003(\rB\036\n\034emu.grasscutter." +
      "net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.IrodoriChessEntranceDetailInfoOuterClass.getDescriptor(),
        });
    internal_static_IrodoriChessMysteryInfo_descriptor =
