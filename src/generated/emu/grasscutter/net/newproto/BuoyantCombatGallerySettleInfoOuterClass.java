...
public final class BuoyantCombatGallerySettleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.internal_static_BuoyantCombatGallerySettleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.internal_static_BuoyantCombatGallerySettleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo.class, emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo other = (emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.internal_static_BuoyantCombatGallerySettleInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo build() {
        emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo buildPartial() {
        emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo result = new emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo other) {
        if (other == emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo();
    }

    public static emu.grasscutter.net.newproto.BuoyantCombatGallerySettleInfoOuterClass.BuoyantCombatGallerySettleInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\013final_score\030\014 \001(\rB\036\n\034emu.grasscutter.n" +
