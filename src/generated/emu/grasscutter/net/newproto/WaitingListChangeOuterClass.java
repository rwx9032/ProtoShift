...
public final class WaitingListChangeOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WaitingListChangeOuterClass.internal_static_WaitingListChange_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WaitingListChangeOuterClass.internal_static_WaitingListChange_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange.class, emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange other = (emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange) obj;
    ...
    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChangeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WaitingListChangeOuterClass.internal_static_WaitingListChange_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange build() {
        emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange buildPartial() {
        emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange result = new emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange) {
          return mergeFrom((emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange other) {
        if (other == emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange();
    }

    public static emu.grasscutter.net.newproto.WaitingListChangeOuterClass.WaitingListChange getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nk3150_OHFNJOJKNOK\030\007 \001(\rB\036\n\034emu.grasscut" +
