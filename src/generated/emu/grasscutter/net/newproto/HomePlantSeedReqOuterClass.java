...
public final class HomePlantSeedReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.internal_static_HomePlantSeedReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.internal_static_HomePlantSeedReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq.class, emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq other = (emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq) obj;
    ...
    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.internal_static_HomePlantSeedReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq build() {
        emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq buildPartial() {
        emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq result = new emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq) {
          return mergeFrom((emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq other) {
        if (other == emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq();
    }

    public static emu.grasscutter.net.newproto.HomePlantSeedReqOuterClass.HomePlantSeedReq getDefaultInstance() {
