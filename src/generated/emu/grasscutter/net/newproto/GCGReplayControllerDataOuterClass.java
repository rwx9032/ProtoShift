...
public final class GCGReplayControllerDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.internal_static_GCGReplayControllerData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.internal_static_GCGReplayControllerData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData.class, emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData other = (emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.internal_static_GCGReplayControllerData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData build() {
        emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData buildPartial() {
        emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData result = new emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData other) {
        if (other == emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData();
    }

    public static emu.grasscutter.net.newproto.GCGReplayControllerDataOuterClass.GCGReplayControllerData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\025\n\rcontroller_id\030\006 \001(\rB\036\n\034emu.grasscutt" +
