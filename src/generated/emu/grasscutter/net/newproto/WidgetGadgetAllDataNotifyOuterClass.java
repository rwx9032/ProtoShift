...
public final class WidgetGadgetAllDataNotifyOuterClass {
  ...
  public interface WidgetGadgetAllDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData> 
        getWidgetGadgetDataList();
    /**
     * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
     */
    emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData getWidgetGadgetData(int index);
    /**
     * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
     */
     ...
     * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetDataOrBuilder> 
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.internal_static_WidgetGadgetAllDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.internal_static_WidgetGadgetAllDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify.class, emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify.Builder.class);
    }

    public static final int WIDGET_GADGET_DATA_FIELD_NUMBER = 1;
    private java.util.List<emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData> widgetGadgetData_;
    /**
     * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData> getWidgetGadgetDataList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetDataOrBuilder> 
        getWidgetGadgetDataOrBuilderList() {
      return widgetGadgetData_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData getWidgetGadgetData(int index) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify other = (emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.internal_static_WidgetGadgetAllDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify build() {
        emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify buildPartial() {
        emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify result = new emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify other) {
        if (other == emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify.getDefaultInstance()) return this;
        if (widgetGadgetDataBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.parser(),
                        extensionRegistry);
                if (widgetGadgetDataBuilder_ == null) {
                  ensureWidgetGadgetDataIsMutable();
      ...
      private void ensureWidgetGadgetDataIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          widgetGadgetData_ = new java.util.ArrayList<emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData>(widgetGadgetData_);
      ...
      public Builder setWidgetGadgetData(
          int index, emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData value) {
        if (widgetGadgetDataBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setWidgetGadgetData(
          int index, emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.Builder builderForValue) {
        if (widgetGadgetDataBuilder_ == null) {
          ensureWidgetGadgetDataIsMutable();
       ...
       * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
       */
      public Builder addWidgetGadgetData(emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData value) {
        if (widgetGadgetDataBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllWidgetGadgetData(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData> values) {
        if (widgetGadgetDataBuilder_ == null) {
          ensureWidgetGadgetDataIsMutable();
       ...
       * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
       */
      public emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.Builder addWidgetGadgetDataBuilder() {
        return getWidgetGadgetDataFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.getDefaultInstance());
      }
      /**
       * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
       */
      public emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.Builder addWidgetGadgetDataBuilder(
          int index) {
        return getWidgetGadgetDataFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.getDefaultInstance());
      }
      /**
       * <code>repeated .WidgetGadgetData widget_gadget_data = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.WidgetGadgetDataOuterClass.WidgetGadgetData.Builder> 
    ...
    private static final emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify();
    }

    public static emu.grasscutter.net.newproto.WidgetGadgetAllDataNotifyOuterClass.WidgetGadgetAllDataNotify getDefaultInstance() {
