...
public final class BossChestInfoOuterClass {
  ...
  public interface BossChestInfoOrBuilder extends
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo>
    getUidDiscountMap();
    /**
     * <code>map&lt;uint32, .WeeklyBossResinDiscountInfo&gt; uid_discount_map = 5;</code>
     */
    ...
    /* nullable */
emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo getUidDiscountMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo defaultValue);
    /**
     * <code>map&lt;uint32, .WeeklyBossResinDiscountInfo&gt; uid_discount_map = 5;</code>
     */

    emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo getUidDiscountMapOrThrow(
        int key);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BossChestInfoOuterClass.internal_static_BossChestInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.BossChestInfoOuterClass.internal_static_BossChestInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo.class, emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo.Builder.class);
    }
    ...
    private static final class UidDiscountMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo>newDefaultInstance(
                  emu.grasscutter.net.newproto.BossChestInfoOuterClass.internal_static_BossChestInfo_UidDiscountMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> uidDiscountMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> getUidDiscountMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> getUidDiscountMapMap() {
    ...
    public emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo getUidDiscountMapOrDefault(
        int key,
        emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> map =
    ...
    public emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo getUidDiscountMapOrThrow(
        int key) {
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> entry
           : internalGetUidDiscountMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo other = (emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BossChestInfoOuterClass.internal_static_BossChestInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo build() {
        emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo buildPartial() {
        emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo result = new emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo other) {
        if (other == emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo>
      ...
      public Builder putUidDiscountMap(
          int key,
          emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllUidDiscountMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.WeeklyBossResinDiscountInfoOuterClass.WeeklyBossResinDiscountInfo> values) {
        internalGetMutableUidDiscountMap().getMutableMap()
            .putAll(values);
        return this;
      }
    ...
    private static final emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo();
    }

    public static emu.grasscutter.net.newproto.BossChestInfoOuterClass.BossChestInfo getDefaultInstance() {
