...
public final class SeaLampFlyLampNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.internal_static_SeaLampFlyLampNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.internal_static_SeaLampFlyLampNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify.class, emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify other = (emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.internal_static_SeaLampFlyLampNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify build() {
        emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify buildPartial() {
        emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify result = new emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify other) {
        if (other == emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify();
    }

    public static emu.grasscutter.net.newproto.SeaLampFlyLampNotifyOuterClass.SeaLampFlyLampNotify getDefaultInstance() {
