...
public final class HomeModuleSeenRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.internal_static_HomeModuleSeenRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.internal_static_HomeModuleSeenRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.class, emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp other = (emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.internal_static_HomeModuleSeenRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp build() {
        emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp buildPartial() {
        emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp result = new emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp other) {
        if (other == emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp();
    }

    public static emu.grasscutter.net.newproto.HomeModuleSeenRspOuterClass.HomeModuleSeenRsp getDefaultInstance() {
