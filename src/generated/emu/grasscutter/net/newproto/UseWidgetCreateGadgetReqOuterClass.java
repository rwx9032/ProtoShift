...
public final class UseWidgetCreateGadgetReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.class, emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq other = (emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq) obj;
    ...
    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq build() {
        emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq buildPartial() {
        emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result = new emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq(this);
        if (rotBuilder_ == null) {
          result.rot_ = rot_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq) {
          return mergeFrom((emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq other) {
        if (other == emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.getDefaultInstance()) return this;
        if (other.hasRot()) {
    ...
    private static final emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq();
    }

    public static emu.grasscutter.net.newproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq getDefaultInstance() {
