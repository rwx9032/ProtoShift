...
public final class FurnitureMakeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.internal_static_FurnitureMakeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.internal_static_FurnitureMakeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData.class, emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData other = (emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData) obj;
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.internal_static_FurnitureMakeData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData build() {
        emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData buildPartial() {
        emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData result = new emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData) {
          return mergeFrom((emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData other) {
        if (other == emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData();
    }

    public static emu.grasscutter.net.newproto.FurnitureMakeDataOuterClass.FurnitureMakeData getDefaultInstance() {
