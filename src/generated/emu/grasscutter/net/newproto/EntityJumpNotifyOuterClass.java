...
public final class EntityJumpNotifyOuterClass {
  ...
  public interface EntityJumpNotifyOrBuilder extends
     ...
     * @return The jumpType.
     */
    emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type getJumpType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.internal_static_EntityJumpNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.internal_static_EntityJumpNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.class, emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Builder.class);
    }
    ...
    public enum Type
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The jumpType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type getJumpType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type result = emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type.valueOf(jumpType_);
      return result == null ? emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (jumpType_ != emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type.TYPE_NULL.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify other = (emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.internal_static_EntityJumpNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify build() {
        emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify buildPartial() {
        emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify result = new emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify other) {
        if (other == emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.getDefaultInstance()) return this;
        if (other.hasPos()) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type getJumpType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type result = emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type.valueOf(jumpType_);
        return result == null ? emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setJumpType(emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify.Type value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify();
    }

    public static emu.grasscutter.net.newproto.EntityJumpNotifyOuterClass.EntityJumpNotify getDefaultInstance() {
