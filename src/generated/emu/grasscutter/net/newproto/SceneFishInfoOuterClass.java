...
public final class SceneFishInfoOuterClass {
  ...
  public interface SceneFishInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getFishPoolPos();
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.class, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector fishPoolPos_;
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     * @return Whether the fishPoolPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getFishPoolPos() {
      return fishPoolPos_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
    }
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo other = (emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo build() {
        emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo buildPartial() {
        emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo result = new emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo other) {
        if (other == emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> fishPoolPosBuilder_;
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
       * @return Whether the fishPoolPos field is set.
       */
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder setFishPoolPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder mergeFishPoolPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (fishPoolPos_ != null) {
            fishPoolPos_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(fishPoolPos_).mergeFrom(value).buildPartial();
          } else {
            fishPoolPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getFishPoolPosBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
        if (fishPoolPosBuilder_ != null) {
          ...
          return fishPoolPos_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
        }
      }
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
    ...
    private static final emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo();
    }

    public static emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\027\n\017last_shock_time\030\005 \001(\rB\036\n\034emu.grasscu" +
