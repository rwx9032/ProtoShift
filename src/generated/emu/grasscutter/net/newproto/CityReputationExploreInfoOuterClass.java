...
public final class CityReputationExploreInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.internal_static_CityReputationExploreInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.internal_static_CityReputationExploreInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.class, emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo other = (emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.internal_static_CityReputationExploreInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo build() {
        emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo buildPartial() {
        emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo result = new emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo other) {
        if (other == emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo();
    }

    public static emu.grasscutter.net.newproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo getDefaultInstance() {
