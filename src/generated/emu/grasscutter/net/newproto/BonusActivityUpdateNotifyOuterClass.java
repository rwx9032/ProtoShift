...
public final class BonusActivityUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.internal_static_BonusActivityUpdateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.internal_static_BonusActivityUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify.class, emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify other = (emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.internal_static_BonusActivityUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify build() {
        emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify buildPartial() {
        emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify result = new emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify other) {
        if (other == emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify.getDefaultInstance()) return this;
        if (bonusActivityInfoListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify();
    }

    public static emu.grasscutter.net.newproto.BonusActivityUpdateNotifyOuterClass.BonusActivityUpdateNotify getDefaultInstance() {
