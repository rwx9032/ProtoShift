...
public final class EvtCompensatePosDiffInfoOuterClass {
  ...
  public interface EvtCompensatePosDiffInfoOrBuilder extends
     ...
     * @return The curPos.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getCurPos();
    /**
     * <code>.Vector cur_pos = 6;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getCurPosOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.internal_static_EvtCompensatePosDiffInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.internal_static_EvtCompensatePosDiffInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo.class, emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector curPos_;
    /**
     * <code>.Vector cur_pos = 6;</code>
     * @return Whether the curPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getCurPos() {
      return curPos_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : curPos_;
    }
    /**
     * <code>.Vector cur_pos = 6;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getCurPosOrBuilder() {
      return getCurPos();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo other = (emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.internal_static_EvtCompensatePosDiffInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo build() {
        emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo buildPartial() {
        emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo result = new emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo other) {
        if (other == emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> curPosBuilder_;
      /**
       * <code>.Vector cur_pos = 6;</code>
       * @return Whether the curPos field is set.
       */
       ...
       * <code>.Vector cur_pos = 6;</code>
       */
      public Builder setCurPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (curPosBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector cur_pos = 6;</code>
       */
      public Builder mergeCurPos(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (curPosBuilder_ == null) {
          if (curPos_ != null) {
            curPos_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(curPos_).mergeFrom(value).buildPartial();
          } else {
            curPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector cur_pos = 6;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getCurPosBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getCurPosOrBuilder() {
        if (curPosBuilder_ != null) {
          ...
          return curPos_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : curPos_;
        }
      }
      /**
       * <code>.Vector cur_pos = 6;</code>
    ...
    private static final emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo();
    }

    public static emu.grasscutter.net.newproto.EvtCompensatePosDiffInfoOuterClass.EvtCompensatePosDiffInfo getDefaultInstance() {
