...
public final class EntityClientDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EntityClientDataOuterClass.internal_static_EntityClientData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EntityClientDataOuterClass.internal_static_EntityClientData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData.class, emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData other = (emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData) obj;
    ...
    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EntityClientDataOuterClass.internal_static_EntityClientData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData build() {
        emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData buildPartial() {
        emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData result = new emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData) {
          return mergeFrom((emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData other) {
        if (other == emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData();
    }

    public static emu.grasscutter.net.newproto.EntityClientDataOuterClass.EntityClientData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_target_level\030\003 \001(\005B\036\n\034emu.grasscutter.n" +
