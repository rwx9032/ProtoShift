...
public final class MsgParamOuterClass {
  ...
  public interface MsgParamOrBuilder extends
    ...
    public emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam.ParamCase getParamCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MsgParamOuterClass.internal_static_MsgParam_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MsgParamOuterClass.internal_static_MsgParam_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam.class, emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam other = (emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam) obj;
    ...
    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParamOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MsgParamOuterClass.internal_static_MsgParam_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam build() {
        emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam buildPartial() {
        emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam result = new emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam(this);
        if (paramCase_ == 13) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam) {
          return mergeFrom((emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam other) {
        if (other == emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam();
    }

    public static emu.grasscutter.net.newproto.MsgParamOuterClass.MsgParam getDefaultInstance() {
