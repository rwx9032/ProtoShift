...
public final class RogueSwitchAvatarReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.internal_static_RogueSwitchAvatarReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.internal_static_RogueSwitchAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.class, emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq other = (emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq) obj;
    ...
    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.internal_static_RogueSwitchAvatarReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq build() {
        emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq buildPartial() {
        emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq result = new emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq) {
          return mergeFrom((emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq other) {
        if (other == emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq();
    }

    public static emu.grasscutter.net.newproto.RogueSwitchAvatarReqOuterClass.RogueSwitchAvatarReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\001(\r\022\027\n\017cur_avatar_guid\030\004 \001(\004B\036\n\034emu.gras" +
