...
public final class ChannelerSlabSaveAssistInfoRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.internal_static_ChannelerSlabSaveAssistInfoRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.internal_static_ChannelerSlabSaveAssistInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp.class, emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp other = (emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.internal_static_ChannelerSlabSaveAssistInfoRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp build() {
        emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp buildPartial() {
        emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp result = new emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp other) {
        if (other == emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp.getDefaultInstance()) return this;
        if (assistInfoListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp();
    }

    public static emu.grasscutter.net.newproto.ChannelerSlabSaveAssistInfoRspOuterClass.ChannelerSlabSaveAssistInfoRsp getDefaultInstance() {
