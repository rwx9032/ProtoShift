...
public final class SceneMonsterInfoOuterClass {
  ...
  public interface SceneMonsterInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo> 
        getWeaponListList();
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo getWeaponList(int index);
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
     ...
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> 
        getWeaponListOrBuilderList();
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponListOrBuilder(
        int index);
     ...
     * @return The bornType.
     */
    emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType getBornType();
     ...
     */
    emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute getMonsterRoute();
    /**
     * <code>.MonsterRoute monster_route = 18;</code>
     */
    emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRouteOrBuilder getMonsterRouteOrBuilder();
     ...
     * @return The fishInfo.
     */
    emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo getFishInfo();
    /**
     * <code>.SceneFishInfo fish_info = 50;</code>
     */
    emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder getFishInfoOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo getFishtankFishInfo();
    /**
     * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
     */
    emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder getFishtankFishInfoOrBuilder();

    public emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo.ContentCase getContentCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo.class, emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo> weaponList_;
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo> getWeaponListList() {
      return weaponList_;
    }
    /**
     * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> 
        getWeaponListOrBuilderList() {
      return weaponList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo getWeaponList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponListOrBuilder(
        int index) {
      return weaponList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_SummonTagMapEntry_descriptor, 
     ...
     * @return The bornType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType getBornType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType result = emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType.valueOf(bornType_);
      return result == null ? emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType.UNRECOGNIZED : result;
    }
    ...
    private emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute monsterRoute_;
    /**
     * <code>.MonsterRoute monster_route = 18;</code>
     * @return Whether the monsterRoute field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute getMonsterRoute() {
      return monsterRoute_ == null ? emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance() : monsterRoute_;
    }
    /**
     * <code>.MonsterRoute monster_route = 18;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRouteOrBuilder getMonsterRouteOrBuilder() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo getFishInfo() {
      if (contentCase_ == 50) {
         return (emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) content_;
      }
      return emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
    }
    /**
     * <code>.SceneFishInfo fish_info = 50;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder getFishInfoOrBuilder() {
      if (contentCase_ == 50) {
         return (emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) content_;
      }
      return emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo getFishtankFishInfo() {
      if (contentCase_ == 51) {
         return (emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo) content_;
      }
      return emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance();
    }
    /**
     * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder getFishtankFishInfoOrBuilder() {
      if (contentCase_ == 51) {
         return (emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo) content_;
      }
      return emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (bornType_ != emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType.MONSTER_BORN_TYPE_NONE.getNumber()) {
      ...
      if (contentCase_ == 50) {
        output.writeMessage(50, (emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) content_);
      }
      if (contentCase_ == 51) {
        output.writeMessage(51, (emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo) content_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (contentCase_ == 50) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(50, (emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) content_);
      }
      if (contentCase_ == 51) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(51, (emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo) content_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo other = (emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.internal_static_SceneMonsterInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo build() {
        emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo buildPartial() {
        emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo result = new emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo other) {
        if (other == emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.parser(),
                        extensionRegistry);
                if (weaponListBuilder_ == null) {
                  ensureWeaponListIsMutable();
                  weaponList_.add(m);
      ...
      private void ensureWeaponListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          weaponList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo>(weaponList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> weaponListBuilder_;
      ...
      public Builder setWeaponList(
          int index, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
        if (weaponListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setWeaponList(
          int index, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder builderForValue) {
        if (weaponListBuilder_ == null) {
          ensureWeaponListIsMutable();
       ...
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public Builder addWeaponList(emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
        if (weaponListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllWeaponList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo> values) {
        if (weaponListBuilder_ == null) {
          ensureWeaponListIsMutable();
       ...
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder getWeaponListBuilder(
          int index) {
       ...
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder addWeaponListBuilder() {
        return getWeaponListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder addWeaponListBuilder(
          int index) {
        return getWeaponListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SceneWeaponInfo weapon_list = 4;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType getBornType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType result = emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType.valueOf(bornType_);
        return result == null ? emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setBornType(emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.MonsterBornType value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute, emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.Builder, emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRouteOrBuilder> monsterRouteBuilder_;
      /**
       * <code>.MonsterRoute monster_route = 18;</code>
       * @return Whether the monsterRoute field is set.
       */
       ...
       * <code>.MonsterRoute monster_route = 18;</code>
       */
      public Builder setMonsterRoute(emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute value) {
        if (monsterRouteBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setMonsterRoute(
          emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.Builder builderForValue) {
        if (monsterRouteBuilder_ == null) {
       ...
       * <code>.MonsterRoute monster_route = 18;</code>
       */
      public Builder mergeMonsterRoute(emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute value) {
        if (monsterRouteBuilder_ == null) {
          if (monsterRoute_ != null) {
            monsterRoute_ =
              emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.newBuilder(monsterRoute_).mergeFrom(value).buildPartial();
          } else {
            monsterRoute_ = value;
          }
          onChanged();
       ...
       * <code>.MonsterRoute monster_route = 18;</code>
       */
      public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.Builder getMonsterRouteBuilder() {
      ...
      public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRouteOrBuilder getMonsterRouteOrBuilder() {
        if (monsterRouteBuilder_ != null) {
          ...
          return monsterRoute_ == null ?
              emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance() : monsterRoute_;
        }
      }
      /**
       * <code>.MonsterRoute monster_route = 18;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute, emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.Builder, emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRouteOrBuilder> 
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.Builder, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder> fishInfoBuilder_;
      /**
       * <code>.SceneFishInfo fish_info = 50;</code>
       * @return Whether the fishInfo field is set.
       */
       ...
       * <code>.SceneFishInfo fish_info = 50;</code>
       */
      public Builder setFishInfo(emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo value) {
        if (fishInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFishInfo(
          emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.Builder builderForValue) {
        if (fishInfoBuilder_ == null) {
       ...
       * <code>.SceneFishInfo fish_info = 50;</code>
       */
      public Builder mergeFishInfo(emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo value) {
        if (fishInfoBuilder_ == null) {
          if (contentCase_ == 50 &&
              content_ != emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance()) {
            content_ = emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.newBuilder((emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) content_)
       ...
       * <code>.SceneFishInfo fish_info = 50;</code>
       */
      public emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.Builder getFishInfoBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.Builder, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder> 
        ...
        if (fishInfoBuilder_ == null) {
          ...
          fishInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo.Builder, emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder>(
                  (emu.grasscutter.net.newproto.SceneFishInfoOuterClass.SceneFishInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo, emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder, emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder> fishtankFishInfoBuilder_;
      /**
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       * @return Whether the fishtankFishInfo field is set.
       */
       ...
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       */
      public Builder setFishtankFishInfo(emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo value) {
        if (fishtankFishInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFishtankFishInfo(
          emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder builderForValue) {
        if (fishtankFishInfoBuilder_ == null) {
          content_ = builderForValue.build();
          onChanged();
        } else {
       ...
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       */
      public Builder mergeFishtankFishInfo(emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo value) {
        if (fishtankFishInfoBuilder_ == null) {
          if (contentCase_ == 51 &&
              content_ != emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.getDefaultInstance()) {
            content_ = emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.newBuilder((emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo) content_)
                .mergeFrom(value).buildPartial();
          } else {
            content_ = value;
          }
       ...
       * <code>.FishtankFishInfo fishtank_fish_info = 51;</code>
       */
      public emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder getFishtankFishInfoBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo, emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder, emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder> 
        ...
        if (fishtankFishInfoBuilder_ == null) {
          ...
          fishtankFishInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo, emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo.Builder, emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfoOrBuilder>(
                  (emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.FishtankFishInfo) content_,
                  getParentForChildren(),
                  isClean());
          content_ = null;
        }
    ...
    private static final emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo();
    }

    public static emu.grasscutter.net.newproto.SceneMonsterInfoOuterClass.SceneMonsterInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.FishtankFishInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.MonsterBornTypeOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.MonsterRouteOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.SceneFishInfoOuterClass.getDescriptor(),
