...
public final class HitCollisionOuterClass {
  ...
  public interface HitCollisionOrBuilder extends
     ...
     * @return The hitDir.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getHitDir();
    /**
     * <code>.Vector hit_dir = 3;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getHitDirOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HitCollisionOuterClass.internal_static_HitCollision_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HitCollisionOuterClass.internal_static_HitCollision_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision.class, emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector hitDir_;
    /**
     * <code>.Vector hit_dir = 3;</code>
     * @return Whether the hitDir field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getHitDir() {
      return hitDir_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : hitDir_;
    }
    /**
     * <code>.Vector hit_dir = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getHitDirOrBuilder() {
      return getHitDir();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision other = (emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision) obj;
    ...
    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollisionOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HitCollisionOuterClass.internal_static_HitCollision_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision build() {
        emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision buildPartial() {
        emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision result = new emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision) {
          return mergeFrom((emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision other) {
        if (other == emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> hitDirBuilder_;
      /**
       * <code>.Vector hit_dir = 3;</code>
       * @return Whether the hitDir field is set.
       */
       ...
       * <code>.Vector hit_dir = 3;</code>
       */
      public Builder setHitDir(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (hitDirBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector hit_dir = 3;</code>
       */
      public Builder mergeHitDir(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (hitDirBuilder_ == null) {
          if (hitDir_ != null) {
            hitDir_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(hitDir_).mergeFrom(value).buildPartial();
          } else {
            hitDir_ = value;
          }
          onChanged();
       ...
       * <code>.Vector hit_dir = 3;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getHitDirBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getHitDirOrBuilder() {
        if (hitDirBuilder_ != null) {
          ...
          return hitDir_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : hitDir_;
        }
      }
      /**
       * <code>.Vector hit_dir = 3;</code>
    ...
    private static final emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision();
    }

    public static emu.grasscutter.net.newproto.HitCollisionOuterClass.HitCollision getDefaultInstance() {
