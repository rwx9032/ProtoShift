...
public final class GetQuestTalkHistoryRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.internal_static_GetQuestTalkHistoryRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.internal_static_GetQuestTalkHistoryRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp.class, emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp other = (emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.internal_static_GetQuestTalkHistoryRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp build() {
        emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp buildPartial() {
        emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp result = new emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp other) {
        if (other == emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp();
    }

    public static emu.grasscutter.net.newproto.GetQuestTalkHistoryRspOuterClass.GetQuestTalkHistoryRsp getDefaultInstance() {
