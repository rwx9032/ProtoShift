...
public final class CombatInvokeEntryOuterClass {
  ...
  public interface CombatInvokeEntryOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument getArgumentType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.internal_static_CombatInvokeEntry_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.internal_static_CombatInvokeEntry_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry.class, emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry.Builder.class);
    }
     ...
     * @return The argumentType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument getArgumentType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument result = emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument.valueOf(argumentType_);
      return result == null ? emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (argumentType_ != emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument.COMBAT_TYPE_ARGUMENT_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry other = (emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry) obj;
    ...
    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.internal_static_CombatInvokeEntry_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry build() {
        emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry buildPartial() {
        emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry result = new emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry) {
          return mergeFrom((emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry other) {
        if (other == emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument getArgumentType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument result = emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument.valueOf(argumentType_);
        return result == null ? emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setArgumentType(emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.CombatTypeArgument value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry();
    }

    public static emu.grasscutter.net.newproto.CombatInvokeEntryOuterClass.CombatInvokeEntry getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ypeArgument\022\023\n\013combat_data\030\007 \001(\014B\036\n\034emu." +
      "grasscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.CombatTypeArgumentOuterClass.getDescriptor(),
