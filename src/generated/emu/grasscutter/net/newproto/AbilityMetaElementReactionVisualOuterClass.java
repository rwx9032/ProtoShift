...
public final class AbilityMetaElementReactionVisualOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.internal_static_AbilityMetaElementReactionVisual_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.internal_static_AbilityMetaElementReactionVisual_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual.class, emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual other = (emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisualOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.internal_static_AbilityMetaElementReactionVisual_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual build() {
        emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual buildPartial() {
        emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual result = new emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual other) {
        if (other == emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual();
    }

    public static emu.grasscutter.net.newproto.AbilityMetaElementReactionVisualOuterClass.AbilityMetaElementReactionVisual getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "k3300_OGILJCJPHPB\030\002 \001(\rB\036\n\034emu.grasscutt" +
