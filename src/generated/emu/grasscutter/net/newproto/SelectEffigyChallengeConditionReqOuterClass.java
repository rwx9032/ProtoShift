...
public final class SelectEffigyChallengeConditionReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.internal_static_SelectEffigyChallengeConditionReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.internal_static_SelectEffigyChallengeConditionReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq.class, emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq other = (emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq) obj;
    ...
    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.internal_static_SelectEffigyChallengeConditionReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq build() {
        emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq buildPartial() {
        emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq result = new emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq) {
          return mergeFrom((emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq other) {
        if (other == emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq();
    }

    public static emu.grasscutter.net.newproto.SelectEffigyChallengeConditionReqOuterClass.SelectEffigyChallengeConditionReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\001 \003(\r\022\025\n\rdifficulty_id\030\013 \001(\rB\036\n\034emu.gr" +
