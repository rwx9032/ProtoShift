...
public final class ChessMonsterInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.internal_static_ChessMonsterInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.internal_static_ChessMonsterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.class, emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo other = (emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.internal_static_ChessMonsterInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo build() {
        emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo buildPartial() {
        emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo result = new emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo other) {
        if (other == emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo();
    }

    public static emu.grasscutter.net.newproto.ChessMonsterInfoOuterClass.ChessMonsterInfo getDefaultInstance() {
