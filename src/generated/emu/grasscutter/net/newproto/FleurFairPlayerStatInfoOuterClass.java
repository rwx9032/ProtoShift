...
public final class FleurFairPlayerStatInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.internal_static_FleurFairPlayerStatInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.internal_static_FleurFairPlayerStatInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo.class, emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo other = (emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.internal_static_FleurFairPlayerStatInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo build() {
        emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo buildPartial() {
        emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo result = new emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo(this);
        if (profilePictureBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo other) {
        if (other == emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo();
    }

    public static emu.grasscutter.net.newproto.FleurFairPlayerStatInfoOuterClass.FleurFairPlayerStatInfo getDefaultInstance() {
