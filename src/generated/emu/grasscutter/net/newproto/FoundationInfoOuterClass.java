...
public final class FoundationInfoOuterClass {
  ...
  public interface FoundationInfoOrBuilder extends
     ...
     * @return The status.
     */
    emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus getStatus();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FoundationInfoOuterClass.internal_static_FoundationInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FoundationInfoOuterClass.internal_static_FoundationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo.class, emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo.Builder.class);
    }
     ...
     * @return The status.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus getStatus() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus result = emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus.valueOf(status_);
      return result == null ? emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (status_ != emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus.FOUNDATION_STATUS_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo other = (emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FoundationInfoOuterClass.internal_static_FoundationInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo build() {
        emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo buildPartial() {
        emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo result = new emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo other) {
        if (other == emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo.getDefaultInstance()) return this;
        if (other.status_ != 0) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus getStatus() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus result = emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus.valueOf(status_);
        return result == null ? emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setStatus(emu.grasscutter.net.newproto.FoundationStatusOuterClass.FoundationStatus value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo();
    }

    public static emu.grasscutter.net.newproto.FoundationInfoOuterClass.FoundationInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "uid\030\004 \001(\rB\036\n\034emu.grasscutter.net.newprot" +
      "ob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.FoundationStatusOuterClass.getDescriptor(),
        });
    internal_static_FoundationInfo_descriptor =
