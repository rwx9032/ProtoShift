...
public final class WorktopInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WorktopInfoOuterClass.internal_static_WorktopInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WorktopInfoOuterClass.internal_static_WorktopInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo.class, emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo other = (emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WorktopInfoOuterClass.internal_static_WorktopInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo build() {
        emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo buildPartial() {
        emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo result = new emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo other) {
        if (other == emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo();
    }

    public static emu.grasscutter.net.newproto.WorktopInfoOuterClass.WorktopInfo getDefaultInstance() {
