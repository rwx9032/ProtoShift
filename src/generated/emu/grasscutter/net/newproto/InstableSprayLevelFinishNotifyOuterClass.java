...
public final class InstableSprayLevelFinishNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.internal_static_InstableSprayLevelFinishNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.internal_static_InstableSprayLevelFinishNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify.class, emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify other = (emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.internal_static_InstableSprayLevelFinishNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify build() {
        emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify buildPartial() {
        emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify result = new emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify other) {
        if (other == emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify.getDefaultInstance()) return this;
        if (other.getRound() != 0) {
    ...
    private static final emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify();
    }

    public static emu.grasscutter.net.newproto.InstableSprayLevelFinishNotifyOuterClass.InstableSprayLevelFinishNotify getDefaultInstance() {
