...
public final class SkyCrystalDetectorDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.internal_static_SkyCrystalDetectorData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.internal_static_SkyCrystalDetectorData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData.class, emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData other = (emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData) obj;
    ...
    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.internal_static_SkyCrystalDetectorData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData build() {
        emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData buildPartial() {
        emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData result = new emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData) {
          return mergeFrom((emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData other) {
        if (other == emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData();
    }

    public static emu.grasscutter.net.newproto.SkyCrystalDetectorDataOuterClass.SkyCrystalDetectorData getDefaultInstance() {
