...
public final class ActivityReadPushTipsReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.internal_static_ActivityReadPushTipsReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.internal_static_ActivityReadPushTipsReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.class, emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq other = (emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq) obj;
    ...
    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.internal_static_ActivityReadPushTipsReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq build() {
        emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq buildPartial() {
        emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq result = new emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq) {
          return mergeFrom((emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq other) {
        if (other == emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq();
    }

    public static emu.grasscutter.net.newproto.ActivityReadPushTipsReqOuterClass.ActivityReadPushTipsReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_id_list\030\001 \003(\r\022\023\n\013activity_id\030\014 \001(\rB\036\n\034e" +
