...
public final class CreateEntityInfoOuterClass {
  ...
  public interface CreateEntityInfoOrBuilder extends
     ...
     * @return The gadget.
     */
    emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo getGadget();
    /**
     * <code>.CreateGadgetInfo gadget = 13;</code>
     */
    emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder getGadgetOrBuilder();

    public emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.EntityCase getEntityCase();

    public emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.EntityCreateInfoCase getEntityCreateInfoCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.internal_static_CreateEntityInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.internal_static_CreateEntityInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.class, emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo getGadget() {
      if (entityCreateInfoCase_ == 13) {
         return (emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_;
      }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder getGadgetOrBuilder() {
      if (entityCreateInfoCase_ == 13) {
         return (emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_;
      }
      return emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityCreateInfoCase_ == 13) {
        output.writeMessage(13, (emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (entityCreateInfoCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo other = (emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.internal_static_CreateEntityInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo build() {
        emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo buildPartial() {
        emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo result = new emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo other) {
        if (other == emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo.getDefaultInstance()) return this;
        if (other.getLevel() != 0) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder> gadgetBuilder_;
      /**
       * <code>.CreateGadgetInfo gadget = 13;</code>
       * @return Whether the gadget field is set.
       */
       ...
       * <code>.CreateGadgetInfo gadget = 13;</code>
       */
      public Builder setGadget(emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo value) {
        if (gadgetBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setGadget(
          emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder builderForValue) {
        if (gadgetBuilder_ == null) {
       ...
       * <code>.CreateGadgetInfo gadget = 13;</code>
       */
      public Builder mergeGadget(emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo value) {
        if (gadgetBuilder_ == null) {
          if (entityCreateInfoCase_ == 13 &&
              entityCreateInfo_ != emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.getDefaultInstance()) {
            entityCreateInfo_ = emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.newBuilder((emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_)
       ...
       * <code>.CreateGadgetInfo gadget = 13;</code>
       */
      public emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder getGadgetBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder> 
        ...
        if (gadgetBuilder_ == null) {
          ...
          gadgetBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder>(
                  (emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_,
                  getParentForChildren(),
                  isClean());
          entityCreateInfo_ = null;
        }
    ...
    private static final emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo();
    }

    public static emu.grasscutter.net.newproto.CreateEntityInfoOuterClass.CreateEntityInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.CreateGadgetInfoOuterClass.getDescriptor(),
