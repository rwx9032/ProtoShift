...
public final class GadgetPlayInfoOuterClass {
  ...
  public interface GadgetPlayInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo getCrucibleInfo();
    /**
     * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
     */
    emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder getCrucibleInfoOrBuilder();

    public emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.PlayInfoCase getPlayInfoCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.class, emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo getCrucibleInfo() {
      if (playInfoCase_ == 21) {
         return (emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_;
      }
      return emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.getDefaultInstance();
    }
    /**
     * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder getCrucibleInfoOrBuilder() {
      if (playInfoCase_ == 21) {
         return (emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_;
      }
      return emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (playInfoCase_ == 21) {
        output.writeMessage(21, (emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (playInfoCase_ == 21) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(21, (emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo other = (emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.internal_static_GadgetPlayInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo build() {
        emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo buildPartial() {
        emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo result = new emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo other) {
        if (other == emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo, emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder, emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder> crucibleInfoBuilder_;
      /**
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       * @return Whether the crucibleInfo field is set.
       */
       ...
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       */
      public Builder setCrucibleInfo(emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo value) {
        if (crucibleInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setCrucibleInfo(
          emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder builderForValue) {
        if (crucibleInfoBuilder_ == null) {
       ...
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       */
      public Builder mergeCrucibleInfo(emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo value) {
        if (crucibleInfoBuilder_ == null) {
          if (playInfoCase_ == 21 &&
              playInfo_ != emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.getDefaultInstance()) {
            playInfo_ = emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.newBuilder((emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_)
       ...
       * <code>.GadgetCrucibleInfo crucible_info = 21;</code>
       */
      public emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder getCrucibleInfoBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo, emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder, emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder> 
        ...
        if (crucibleInfoBuilder_ == null) {
          ...
          crucibleInfoBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo, emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo.Builder, emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfoOrBuilder>(
                  (emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.GadgetCrucibleInfo) playInfo_,
    ...
    private static final emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo();
    }

    public static emu.grasscutter.net.newproto.GadgetPlayInfoOuterClass.GadgetPlayInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.GadgetCrucibleInfoOuterClass.getDescriptor(),
        });
    internal_static_GadgetPlayInfo_descriptor =
