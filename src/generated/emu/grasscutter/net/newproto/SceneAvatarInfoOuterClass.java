...
public final class SceneAvatarInfoOuterClass {
  ...
  public interface SceneAvatarInfoOrBuilder extends
     ...
     * @return The weapon.
     */
    emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo getWeapon();
    /**
     * <code>.SceneWeaponInfo weapon = 8;</code>
     */
    emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponOrBuilder();

    /**
     * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
     */
    java.util.List<emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo> 
        getReliquaryListList();
    /**
     * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
     */
    emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo getReliquaryList(int index);
    /**
     * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
     */
     ...
     * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder> 
        getReliquaryListOrBuilderList();
    /**
     * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
     */
    emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder getReliquaryListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo getCurVehicleInfo();
    /**
     * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
     */
    emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfoOrBuilder getCurVehicleInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo.class, emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo weapon_;
    /**
     * <code>.SceneWeaponInfo weapon = 8;</code>
     * @return Whether the weapon field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo getWeapon() {
      return weapon_ == null ? emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.getDefaultInstance() : weapon_;
    }
    /**
     * <code>.SceneWeaponInfo weapon = 8;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponOrBuilder() {
      return getWeapon();
    }

    public static final int RELIQUARY_LIST_FIELD_NUMBER = 9;
    private java.util.List<emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo> reliquaryList_;
    /**
     * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo> getReliquaryListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder> 
        getReliquaryListOrBuilderList() {
      return reliquaryList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo getReliquaryList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder getReliquaryListOrBuilder(
        int index) {
      return reliquaryList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_SkillLevelMapEntry_descriptor, 
    ...
    private static final class ProudSkillExtraLevelMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_ProudSkillExtraLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    private emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo curVehicleInfo_;
    /**
     * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
     * @return Whether the curVehicleInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo getCurVehicleInfo() {
      return curVehicleInfo_ == null ? emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.getDefaultInstance() : curVehicleInfo_;
    }
    /**
     * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfoOrBuilder getCurVehicleInfoOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo other = (emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.internal_static_SceneAvatarInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo build() {
        emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo buildPartial() {
        emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo result = new emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo other) {
        if (other == emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74: {
                emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.parser(),
                        extensionRegistry);
                if (reliquaryListBuilder_ == null) {
                  ensureReliquaryListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> weaponBuilder_;
      /**
       * <code>.SceneWeaponInfo weapon = 8;</code>
       * @return Whether the weapon field is set.
       */
       ...
       * <code>.SceneWeaponInfo weapon = 8;</code>
       */
      public Builder setWeapon(emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
        if (weaponBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setWeapon(
          emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder builderForValue) {
        if (weaponBuilder_ == null) {
       ...
       * <code>.SceneWeaponInfo weapon = 8;</code>
       */
      public Builder mergeWeapon(emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo value) {
        if (weaponBuilder_ == null) {
          if (weapon_ != null) {
            weapon_ =
              emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.newBuilder(weapon_).mergeFrom(value).buildPartial();
          } else {
            weapon_ = value;
          }
          onChanged();
       ...
       * <code>.SceneWeaponInfo weapon = 8;</code>
       */
      public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder getWeaponBuilder() {
      ...
      public emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder getWeaponOrBuilder() {
        if (weaponBuilder_ != null) {
          ...
          return weapon_ == null ?
              emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.getDefaultInstance() : weapon_;
        }
      }
      /**
       * <code>.SceneWeaponInfo weapon = 8;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfo.Builder, emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.SceneWeaponInfoOrBuilder> 
      ...
      private void ensureReliquaryListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          reliquaryList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo>(reliquaryList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder> reliquaryListBuilder_;
      ...
      public Builder setReliquaryList(
          int index, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo value) {
        if (reliquaryListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setReliquaryList(
          int index, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder builderForValue) {
        if (reliquaryListBuilder_ == null) {
          ensureReliquaryListIsMutable();
       ...
       * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
       */
      public Builder addReliquaryList(emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo value) {
        if (reliquaryListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addReliquaryList(
          emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder builderForValue) {
        if (reliquaryListBuilder_ == null) {
          ensureReliquaryListIsMutable();
      ...
      public Builder addAllReliquaryList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo> values) {
        if (reliquaryListBuilder_ == null) {
          ensureReliquaryListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
       */
      public emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder getReliquaryListBuilder(
          int index) {
       ...
       * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
       */
      public emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder addReliquaryListBuilder() {
        return getReliquaryListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
       */
      public emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder addReliquaryListBuilder(
          int index) {
        return getReliquaryListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SceneReliquaryInfo reliquary_list = 9;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder> 
           getReliquaryListBuilderList() {
        return getReliquaryListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfo.Builder, emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.SceneReliquaryInfoOrBuilder> 
      ...
      private emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo curVehicleInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo, emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.Builder, emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfoOrBuilder> curVehicleInfoBuilder_;
      /**
       * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
       * @return Whether the curVehicleInfo field is set.
       */
       ...
       * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
       */
      public Builder setCurVehicleInfo(emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo value) {
        if (curVehicleInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setCurVehicleInfo(
          emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.Builder builderForValue) {
        if (curVehicleInfoBuilder_ == null) {
       ...
       * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
       */
      public Builder mergeCurVehicleInfo(emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo value) {
        if (curVehicleInfoBuilder_ == null) {
          if (curVehicleInfo_ != null) {
            curVehicleInfo_ =
              emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.newBuilder(curVehicleInfo_).mergeFrom(value).buildPartial();
          } else {
            curVehicleInfo_ = value;
          }
          onChanged();
       ...
       * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
       */
      public emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.Builder getCurVehicleInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfoOrBuilder getCurVehicleInfoOrBuilder() {
        if (curVehicleInfoBuilder_ != null) {
          ...
          return curVehicleInfo_ == null ?
              emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.getDefaultInstance() : curVehicleInfo_;
        }
      }
      /**
       * <code>.CurVehicleInfo cur_vehicle_info = 20;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo, emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfo.Builder, emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.CurVehicleInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo();
    }

    public static emu.grasscutter.net.newproto.SceneAvatarInfoOuterClass.SceneAvatarInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.newproto.CurVehicleInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.SceneReliquaryInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.SceneWeaponInfoOuterClass.getDescriptor(),
