...
public final class ParkourLevelInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.internal_static_ParkourLevelInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.internal_static_ParkourLevelInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo.class, emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo other = (emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.internal_static_ParkourLevelInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo build() {
        emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo buildPartial() {
        emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo result = new emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo other) {
        if (other == emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo();
    }

    public static emu.grasscutter.net.newproto.ParkourLevelInfoOuterClass.ParkourLevelInfo getDefaultInstance() {
