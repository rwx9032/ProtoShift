...
public final class ReunionPrivilegeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.internal_static_ReunionPrivilegeInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.internal_static_ReunionPrivilegeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo.class, emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo other = (emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.internal_static_ReunionPrivilegeInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo build() {
        emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo buildPartial() {
        emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo result = new emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo other) {
        if (other == emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo();
    }

    public static emu.grasscutter.net.newproto.ReunionPrivilegeInfoOuterClass.ReunionPrivilegeInfo getDefaultInstance() {
