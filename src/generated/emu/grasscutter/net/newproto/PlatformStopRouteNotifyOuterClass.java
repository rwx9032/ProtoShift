...
public final class PlatformStopRouteNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.internal_static_PlatformStopRouteNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.internal_static_PlatformStopRouteNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify.class, emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify other = (emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.internal_static_PlatformStopRouteNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify build() {
        emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify buildPartial() {
        emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify result = new emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify(this);
        if (platformBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify other) {
        if (other == emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify();
    }

    public static emu.grasscutter.net.newproto.PlatformStopRouteNotifyOuterClass.PlatformStopRouteNotify getDefaultInstance() {
