...
public final class BlossomBriefInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.internal_static_BlossomBriefInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.internal_static_BlossomBriefInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo.class, emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo other = (emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.internal_static_BlossomBriefInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo build() {
        emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo buildPartial() {
        emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo result = new emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo other) {
        if (other == emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo();
    }

    public static emu.grasscutter.net.newproto.BlossomBriefInfoOuterClass.BlossomBriefInfo getDefaultInstance() {
