...
public final class BrickBreakerLevelInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.class, emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo other = (emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.internal_static_BrickBreakerLevelInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo build() {
        emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo buildPartial() {
        emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo result = new emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo other) {
        if (other == emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo();
    }

    public static emu.grasscutter.net.newproto.BrickBreakerLevelInfoOuterClass.BrickBreakerLevelInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\016 \003(\r\022\024\n\014is_can_start\030\001 \001(\010B\036\n\034emu.gras" +
