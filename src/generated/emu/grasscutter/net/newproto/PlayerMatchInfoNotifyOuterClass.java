...
public final class PlayerMatchInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.internal_static_PlayerMatchInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.internal_static_PlayerMatchInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.class, emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify other = (emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.internal_static_PlayerMatchInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify build() {
        emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify result = new emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify();
    }

    public static emu.grasscutter.net.newproto.PlayerMatchInfoNotifyOuterClass.PlayerMatchInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tch_param_list\030\013 \003(\rB\036\n\034emu.grasscutter." +
