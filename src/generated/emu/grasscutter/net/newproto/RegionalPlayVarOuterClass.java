...
public final class RegionalPlayVarOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.internal_static_RegionalPlayVar_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.internal_static_RegionalPlayVar_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar.class, emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar other = (emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar) obj;
    ...
    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVarOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.internal_static_RegionalPlayVar_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar build() {
        emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar buildPartial() {
        emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar result = new emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar(this);
        result.type_ = type_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar) {
          return mergeFrom((emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar other) {
        if (other == emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar.getDefaultInstance()) return this;
        if (other.getType() != 0) {
    ...
    private static final emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar();
    }

    public static emu.grasscutter.net.newproto.RegionalPlayVarOuterClass.RegionalPlayVar getDefaultInstance() {
