...
public final class AvatarExpeditionGetRewardRspOuterClass {
  ...
  public interface AvatarExpeditionGetRewardRspOrBuilder extends
     ...
     * <code>repeated .ItemParam extra_item_list = 11;</code>
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getExtraItemList(int index);
    /**
     * <code>repeated .ItemParam extra_item_list = 11;</code>
     */
     ...
     * <code>repeated .ItemParam extra_item_list = 11;</code>
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getExtraItemListOrBuilder(
        int index);
    ...
    java.util.Map<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo>
    ...
    /* nullable */
emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo getExpeditionInfoMapOrDefault(
        long key,
        /* nullable */
emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo defaultValue);
    /**
     * <code>map&lt;uint64, .AvatarExpeditionInfo&gt; expedition_info_map = 13;</code>
     */

    emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo getExpeditionInfoMapOrThrow(
        long key);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.internal_static_AvatarExpeditionGetRewardRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.internal_static_AvatarExpeditionGetRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp.class, emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam> extraItemList_;
    /**
     * <code>repeated .ItemParam extra_item_list = 11;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam> getExtraItemListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getExtraItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getExtraItemListOrBuilder(
        int index) {
      return extraItemList_.get(index);
    }
    ...
    private static final class ExpeditionInfoMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo>newDefaultInstance(
                  emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.internal_static_AvatarExpeditionGetRewardRsp_ExpeditionInfoMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT64,
                  0L,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> expeditionInfoMap_;
    private com.google.protobuf.MapField<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> getExpeditionInfoMap() {
    ...
    public java.util.Map<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> getExpeditionInfoMapMap() {
    ...
    public emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo getExpeditionInfoMapOrDefault(
        long key,
        emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo defaultValue) {
      
      java.util.Map<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> map =
    ...
    public emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo getExpeditionInfoMapOrThrow(
        long key) {
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> entry
           : internalGetExpeditionInfoMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp other = (emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.internal_static_AvatarExpeditionGetRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp build() {
        emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp buildPartial() {
        emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp result = new emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp other) {
        if (other == emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
      ...
      private void ensureExtraItemListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          extraItemList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam>(extraItemList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder> extraItemListBuilder_;
       ...
       * <code>repeated .ItemParam extra_item_list = 11;</code>
       */
      public Builder addExtraItemList(emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam value) {
        if (extraItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam extra_item_list = 11;</code>
       */
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder getExtraItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam extra_item_list = 11;</code>
       */
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder addExtraItemListBuilder() {
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo>
      ...
      public Builder putExpeditionInfoMap(
          long key,
          emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllExpeditionInfoMap(
          java.util.Map<java.lang.Long, emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.AvatarExpeditionInfo> values) {
        internalGetMutableExpeditionInfoMap().getMutableMap()
            .putAll(values);
        return this;
      }
    ...
    private static final emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp();
    }

    public static emu.grasscutter.net.newproto.AvatarExpeditionGetRewardRspOuterClass.AvatarExpeditionGetRewardRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.AvatarExpeditionInfoOuterClass.getDescriptor(),
