...
public final class HomeBlockSubFieldDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.internal_static_HomeBlockSubFieldData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.internal_static_HomeBlockSubFieldData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData.class, emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData other = (emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.internal_static_HomeBlockSubFieldData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData build() {
        emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData buildPartial() {
        emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData result = new emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData other) {
        if (other == emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData();
    }

    public static emu.grasscutter.net.newproto.HomeBlockSubFieldDataOuterClass.HomeBlockSubFieldData getDefaultInstance() {
