...
public final class DungeonCandidateTeamInfoNotifyOuterClass {
  ...
  public interface DungeonCandidateTeamInfoNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar> 
        getAvatarListList();
    /**
     * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
     */
    emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar getAvatarList(int index);
    /**
     * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
     */
     ...
     * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatarOrBuilder> 
        getAvatarListOrBuilderList();
    /**
     * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
     */
    emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatarOrBuilder getAvatarListOrBuilder(
        int index);
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState>
    getPlayerStateMap();
    /**
     * <code>map&lt;uint32, .DungeonCandidateTeamPlayerState&gt; player_state_map = 10;</code>
     */
     ...
     */
    /* nullable */
emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState getPlayerStateMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState         defaultValue);
    /**
     * <code>map&lt;uint32, .DungeonCandidateTeamPlayerState&gt; player_state_map = 10;</code>
     */
    emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState getPlayerStateMapOrThrow(
        int key);
    /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.internal_static_DungeonCandidateTeamInfoNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.internal_static_DungeonCandidateTeamInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify.class, emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar> avatarList_;
    /**
     * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar> getAvatarListList() {
      return avatarList_;
    }
    /**
     * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatarOrBuilder> 
        getAvatarListOrBuilderList() {
      return avatarList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar getAvatarList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatarOrBuilder getAvatarListOrBuilder(
        int index) {
      return avatarList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.internal_static_DungeonCandidateTeamInfoNotify_PlayerStateMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.ENUM,
                  emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState.DUNGEON_CANDIDATE_TEAM_PLAYER_STATE_IDLE.getNumber());
    }
    ...
    com.google.protobuf.Internal.MapAdapter.Converter<
        java.lang.Integer, emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState> playerStateMapValueConverter =
            com.google.protobuf.Internal.MapAdapter.newEnumConverter(
                emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState.internalGetValueMap(),
                emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState.UNRECOGNIZED);
    private static final java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState>
    internalGetAdaptedPlayerStateMapMap(
        java.util.Map<java.lang.Integer, java.lang.Integer> map) {
      return new com.google.protobuf.Internal.MapAdapter<
          java.lang.Integer, emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState, java.lang.Integer>(
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState>
    getPlayerStateMap() {
...
emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState defaultValue) {
    ...
    public emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState getPlayerStateMapOrThrow(
        int key) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify other = (emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.internal_static_DungeonCandidateTeamInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify build() {
        emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify result = new emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.parser(),
                        extensionRegistry);
                if (avatarListBuilder_ == null) {
                  ensureAvatarListIsMutable();
                  avatarList_.add(m);
      ...
      private void ensureAvatarListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          avatarList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar>(avatarList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatarOrBuilder> avatarListBuilder_;
      ...
      public Builder setAvatarList(
          int index, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar value) {
        if (avatarListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarList(
          int index, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder builderForValue) {
        if (avatarListBuilder_ == null) {
          ensureAvatarListIsMutable();
       ...
       * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
       */
      public Builder addAvatarList(emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar value) {
        if (avatarListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarList(
          emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder builderForValue) {
        if (avatarListBuilder_ == null) {
          ensureAvatarListIsMutable();
      ...
      public Builder addAllAvatarList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar> values) {
        if (avatarListBuilder_ == null) {
          ensureAvatarListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, avatarList_);
       ...
       * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
       */
      public emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder getAvatarListBuilder(
          int index) {
       ...
       * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
       */
      public emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder addAvatarListBuilder() {
        return getAvatarListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.getDefaultInstance());
      }
      /**
       * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
       */
      public emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder addAvatarListBuilder(
          int index) {
        return getAvatarListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.getDefaultInstance());
      }
      /**
       * <code>repeated .DungeonCandidateTeamAvatar avatar_list = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder> 
           getAvatarListBuilderList() {
        return getAvatarListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatar.Builder, emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.DungeonCandidateTeamAvatarOrBuilder> 
...
emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState defaultValue) {
      ...
      public Builder putPlayerStateMap(
          int key,
          emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState value) {
      ...
      public Builder putAllPlayerStateMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.DungeonCandidateTeamPlayerState> values) {
        internalGetAdaptedPlayerStateMapMap(
            internalGetMutablePlayerStateMap().getMutableMap())
                .putAll(values);
        return this;
    ...
    private static final emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify();
    }

    public static emu.grasscutter.net.newproto.DungeonCandidateTeamInfoNotifyOuterClass.DungeonCandidateTeamInfoNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.DungeonCandidateTeamAvatarOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.DungeonCandidateTeamPlayerStateOuterClass.getDescriptor(),
        });
    internal_static_DungeonCandidateTeamInfoNotify_descriptor =
