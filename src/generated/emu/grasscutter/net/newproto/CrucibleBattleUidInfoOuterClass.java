...
public final class CrucibleBattleUidInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.internal_static_CrucibleBattleUidInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.internal_static_CrucibleBattleUidInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.class, emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo other = (emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.internal_static_CrucibleBattleUidInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo build() {
        emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo buildPartial() {
        emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo result = new emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo(this);
        if (profilePictureBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo other) {
        if (other == emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo();
    }

    public static emu.grasscutter.net.newproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo getDefaultInstance() {
