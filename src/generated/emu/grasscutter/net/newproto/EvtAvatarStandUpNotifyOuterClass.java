...
public final class EvtAvatarStandUpNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.internal_static_EvtAvatarStandUpNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.internal_static_EvtAvatarStandUpNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify.class, emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify other = (emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.internal_static_EvtAvatarStandUpNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify build() {
        emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify buildPartial() {
        emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify result = new emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify other) {
        if (other == emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify();
    }

    public static emu.grasscutter.net.newproto.EvtAvatarStandUpNotifyOuterClass.EvtAvatarStandUpNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\033\n\023Unk3300_IMNGNLLMEFJ\030\013 \001(\005B\036\n\034emu.g" +
