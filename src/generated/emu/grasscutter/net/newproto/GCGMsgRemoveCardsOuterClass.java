...
public final class GCGMsgRemoveCardsOuterClass {
  ...
  public interface GCGMsgRemoveCardsOrBuilder extends
     ...
     * @return The zone.
     */
    emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType getZone();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.internal_static_GCGMsgRemoveCards_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.internal_static_GCGMsgRemoveCards_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards.class, emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards.Builder.class);
    }
     ...
     * @return The zone.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType getZone() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType result = emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType.valueOf(zone_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (zone_ != emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType.GCG_ZONE_TYPE_INVALID.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards other = (emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCardsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.internal_static_GCGMsgRemoveCards_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards build() {
        emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards buildPartial() {
        emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards result = new emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards other) {
        if (other == emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType getZone() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType result = emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType.valueOf(zone_);
        return result == null ? emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setZone(emu.grasscutter.net.newproto.GCGZoneTypeOuterClass.GCGZoneType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards();
    }

    public static emu.grasscutter.net.newproto.GCGMsgRemoveCardsOuterClass.GCGMsgRemoveCards getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\004zone\030\017 \001(\0162\014.GCGZoneTypeB\036\n\034emu.grasscu" +
