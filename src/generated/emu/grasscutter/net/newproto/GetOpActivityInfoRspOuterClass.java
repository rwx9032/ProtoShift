...
public final class GetOpActivityInfoRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.internal_static_GetOpActivityInfoRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.internal_static_GetOpActivityInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp.class, emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp other = (emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.internal_static_GetOpActivityInfoRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp build() {
        emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp buildPartial() {
        emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp result = new emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp other) {
        if (other == emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp();
    }

    public static emu.grasscutter.net.newproto.GetOpActivityInfoRspOuterClass.GetOpActivityInfoRsp getDefaultInstance() {
