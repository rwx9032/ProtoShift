...
public final class TowerCurLevelRecordOuterClass {
  ...
  public interface TowerCurLevelRecordOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam> 
        getTowerTeamListList();
    /**
     * <code>repeated .TowerTeam tower_team_list = 8;</code>
     */
    emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam getTowerTeamList(int index);
    /**
     * <code>repeated .TowerTeam tower_team_list = 8;</code>
     */
     ...
     * <code>repeated .TowerTeam tower_team_list = 8;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeamOrBuilder> 
        getTowerTeamListOrBuilderList();
    /**
     * <code>repeated .TowerTeam tower_team_list = 8;</code>
     */
    emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeamOrBuilder getTowerTeamListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.internal_static_TowerCurLevelRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.internal_static_TowerCurLevelRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.class, emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam> towerTeamList_;
    /**
     * <code>repeated .TowerTeam tower_team_list = 8;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam> getTowerTeamListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeamOrBuilder> 
        getTowerTeamListOrBuilderList() {
      return towerTeamList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam getTowerTeamList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeamOrBuilder getTowerTeamListOrBuilder(
        int index) {
      return towerTeamList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord other = (emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord) obj;
    ...
    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.internal_static_TowerCurLevelRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord build() {
        emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord buildPartial() {
        emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord result = new emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord) {
          return mergeFrom((emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord other) {
        if (other == emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 66: {
                emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.parser(),
                        extensionRegistry);
                if (towerTeamListBuilder_ == null) {
                  ensureTowerTeamListIsMutable();
      ...
      private void ensureTowerTeamListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          towerTeamList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam>(towerTeamList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeamOrBuilder> towerTeamListBuilder_;
      ...
      public Builder setTowerTeamList(
          int index, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam value) {
        if (towerTeamListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTowerTeamList(
          int index, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder builderForValue) {
        if (towerTeamListBuilder_ == null) {
          ensureTowerTeamListIsMutable();
       ...
       * <code>repeated .TowerTeam tower_team_list = 8;</code>
       */
      public Builder addTowerTeamList(emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam value) {
        if (towerTeamListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTowerTeamList(
          emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder builderForValue) {
        if (towerTeamListBuilder_ == null) {
          ensureTowerTeamListIsMutable();
      ...
      public Builder addAllTowerTeamList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam> values) {
        if (towerTeamListBuilder_ == null) {
          ensureTowerTeamListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .TowerTeam tower_team_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder getTowerTeamListBuilder(
          int index) {
       ...
       * <code>repeated .TowerTeam tower_team_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder addTowerTeamListBuilder() {
        return getTowerTeamListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.getDefaultInstance());
      }
      /**
       * <code>repeated .TowerTeam tower_team_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder addTowerTeamListBuilder(
          int index) {
        return getTowerTeamListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.getDefaultInstance());
      }
      /**
       * <code>repeated .TowerTeam tower_team_list = 8;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder> 
           getTowerTeamListBuilderList() {
        return getTowerTeamListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeam.Builder, emu.grasscutter.net.newproto.TowerTeamOuterClass.TowerTeamOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord();
    }

    public static emu.grasscutter.net.newproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord getDefaultInstance() {
