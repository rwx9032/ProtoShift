...
public final class OneoffGatherPointDetectorDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.internal_static_OneoffGatherPointDetectorData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.internal_static_OneoffGatherPointDetectorData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData.class, emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData other = (emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData) obj;
    ...
    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.internal_static_OneoffGatherPointDetectorData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData build() {
        emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData buildPartial() {
        emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData result = new emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData) {
          return mergeFrom((emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData other) {
        if (other == emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData();
    }

    public static emu.grasscutter.net.newproto.OneoffGatherPointDetectorDataOuterClass.OneoffGatherPointDetectorData getDefaultInstance() {
