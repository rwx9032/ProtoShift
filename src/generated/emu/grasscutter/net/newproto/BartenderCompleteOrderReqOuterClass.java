...
public final class BartenderCompleteOrderReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.internal_static_BartenderCompleteOrderReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.internal_static_BartenderCompleteOrderReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq.class, emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq other = (emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq) obj;
    ...
    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.internal_static_BartenderCompleteOrderReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq build() {
        emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq buildPartial() {
        emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq result = new emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq) {
          return mergeFrom((emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq other) {
        if (other == emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq();
    }

    public static emu.grasscutter.net.newproto.BartenderCompleteOrderReqOuterClass.BartenderCompleteOrderReq getDefaultInstance() {
