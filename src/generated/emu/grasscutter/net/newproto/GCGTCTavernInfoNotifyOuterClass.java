...
public final class GCGTCTavernInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.internal_static_GCGTCTavernInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.internal_static_GCGTCTavernInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.class, emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify other = (emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.internal_static_GCGTCTavernInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify build() {
        emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify result = new emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify();
    }

    public static emu.grasscutter.net.newproto.GCGTCTavernInfoNotifyOuterClass.GCGTCTavernInfoNotify getDefaultInstance() {
