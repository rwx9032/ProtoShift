...
public final class AchievementOuterClass {
  ...
  public interface AchievementOrBuilder extends
     ...
     * @return The status.
     */
    emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status getStatus();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AchievementOuterClass.internal_static_Achievement_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AchievementOuterClass.internal_static_Achievement_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.class, emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Builder.class);
    }
    ...
    public enum Status
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The status.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status getStatus() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status result = emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status.valueOf(status_);
      return result == null ? emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (status_ != emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status.STATUS_INVALID.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AchievementOuterClass.Achievement)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AchievementOuterClass.Achievement other = (emu.grasscutter.net.newproto.AchievementOuterClass.Achievement) obj;
    ...
    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AchievementOuterClass.Achievement prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AchievementOuterClass.AchievementOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AchievementOuterClass.internal_static_Achievement_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement build() {
        emu.grasscutter.net.newproto.AchievementOuterClass.Achievement result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement buildPartial() {
        emu.grasscutter.net.newproto.AchievementOuterClass.Achievement result = new emu.grasscutter.net.newproto.AchievementOuterClass.Achievement(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AchievementOuterClass.Achievement) {
          return mergeFrom((emu.grasscutter.net.newproto.AchievementOuterClass.Achievement)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AchievementOuterClass.Achievement other) {
        if (other == emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status getStatus() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status result = emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status.valueOf(status_);
        return result == null ? emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setStatus(emu.grasscutter.net.newproto.AchievementOuterClass.Achievement.Status value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.newproto.AchievementOuterClass.Achievement DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AchievementOuterClass.Achievement();
    }

    public static emu.grasscutter.net.newproto.AchievementOuterClass.Achievement getDefaultInstance() {
