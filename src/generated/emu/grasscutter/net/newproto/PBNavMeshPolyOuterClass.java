...
public final class PBNavMeshPolyOuterClass {
  ...
  public interface PBNavMeshPolyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> getEdgeTypesList();
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 5;</code>
     ...
     */
    emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType getEdgeTypes(int index);
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 5;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.class, emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.Builder.class);
    }
    ...
    public enum EdgeType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private static final com.google.protobuf.Internal.ListAdapter.Converter<
        java.lang.Integer, emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> edgeTypes_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
                java.lang.Integer, emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType>() {
              public emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType convert(java.lang.Integer from) {
                @SuppressWarnings("deprecation")
                emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType result = emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType.valueOf(from);
                return result == null ? emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType.UNRECOGNIZED : result;
              }
            };
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 5;</code>
     ...
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> getEdgeTypesList() {
      return new com.google.protobuf.Internal.ListAdapter<
          java.lang.Integer, emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType>(edgeTypes_, edgeTypes_converter_);
    }
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 5;</code>
     * @return The count of edgeTypes.
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType getEdgeTypes(int index) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly other = (emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly) obj;
    ...
    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPolyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly build() {
        emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly buildPartial() {
        emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result = new emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly) {
          return mergeFrom((emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly other) {
        if (other == emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDefaultInstance()) return this;
        if (other.getArea() != 0) {
      ...
      public Builder setEdgeTypes(
          int index, emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value) {
        if (value == null) {
       ...
       * @return This builder for chaining.
       */
      public Builder addEdgeTypes(emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureEdgeTypesIsMutable();
      ...
      public Builder addAllEdgeTypes(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> values) {
        ensureEdgeTypesIsMutable();
        for (emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value : values) {
          edgeTypes_.add(value.getNumber());
        }
        onChanged();
        return this;
    ...
    private static final emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly();
    }

    public static emu.grasscutter.net.newproto.PBNavMeshPolyOuterClass.PBNavMeshPoly getDefaultInstance() {
