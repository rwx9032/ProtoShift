...
public final class GCGGrowthLevelRewardNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.internal_static_GCGGrowthLevelRewardNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.internal_static_GCGGrowthLevelRewardNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.class, emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify other = (emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.internal_static_GCGGrowthLevelRewardNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify build() {
        emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify buildPartial() {
        emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify result = new emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify other) {
        if (other == emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify();
    }

    public static emu.grasscutter.net.newproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_taken_list\030\002 \003(\rB\036\n\034emu.grasscutter.net" +
      ".newprotob\006proto3"
    };
