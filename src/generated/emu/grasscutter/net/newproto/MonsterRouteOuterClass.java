...
public final class MonsterRouteOuterClass {
  ...
  public interface MonsterRouteOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint> 
        getRoutePointsList();
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint getRoutePoints(int index);
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
     ...
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder> 
        getRoutePointsOrBuilderList();
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder getRoutePointsOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MonsterRouteOuterClass.internal_static_MonsterRoute_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MonsterRouteOuterClass.internal_static_MonsterRoute_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.class, emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.Builder.class);
    }

    public static final int ROUTE_POINTS_FIELD_NUMBER = 1;
    private java.util.List<emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint> routePoints_;
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint> getRoutePointsList() {
      return routePoints_;
    }
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder> 
        getRoutePointsOrBuilderList() {
      return routePoints_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint getRoutePoints(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder getRoutePointsOrBuilder(
        int index) {
      return routePoints_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute other = (emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute) obj;
    ...
    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRouteOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MonsterRouteOuterClass.internal_static_MonsterRoute_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute build() {
        emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute buildPartial() {
        emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute result = new emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute) {
          return mergeFrom((emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute other) {
        if (other == emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance()) return this;
        if (routePointsBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.parser(),
                        extensionRegistry);
                if (routePointsBuilder_ == null) {
                  ensureRoutePointsIsMutable();
                  routePoints_.add(m);
      ...
      private void ensureRoutePointsIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          routePoints_ = new java.util.ArrayList<emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint>(routePoints_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder> routePointsBuilder_;
      ...
      public Builder setRoutePoints(
          int index, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint value) {
        if (routePointsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setRoutePoints(
          int index, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder builderForValue) {
        if (routePointsBuilder_ == null) {
          ensureRoutePointsIsMutable();
       ...
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public Builder addRoutePoints(emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint value) {
        if (routePointsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRoutePoints(
          emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder builderForValue) {
        if (routePointsBuilder_ == null) {
          ensureRoutePointsIsMutable();
      ...
      public Builder addAllRoutePoints(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint> values) {
        if (routePointsBuilder_ == null) {
          ensureRoutePointsIsMutable();
       ...
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder getRoutePointsBuilder(
          int index) {
       ...
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder addRoutePointsBuilder() {
        return getRoutePointsFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.getDefaultInstance());
      }
      /**
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder addRoutePointsBuilder(
          int index) {
        return getRoutePointsFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.getDefaultInstance());
      }
      /**
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder> 
           getRoutePointsBuilderList() {
        return getRoutePointsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute();
    }

    public static emu.grasscutter.net.newproto.MonsterRouteOuterClass.MonsterRoute getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "type\030\003 \001(\r\022\024\n\014arrive_range\030\004 \001(\002B\036\n\034emu." +
      "grasscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.RoutePointOuterClass.getDescriptor(),
        });
    internal_static_MonsterRoute_descriptor =
