...
public final class InstableSprayRestartDungeonReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.internal_static_InstableSprayRestartDungeonReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.internal_static_InstableSprayRestartDungeonReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq.class, emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq other = (emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq) obj;
    ...
    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.internal_static_InstableSprayRestartDungeonReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq build() {
        emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq buildPartial() {
        emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq result = new emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq) {
          return mergeFrom((emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq other) {
        if (other == emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq.getDefaultInstance()) return this;
        if (avatarInfoListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq();
    }

    public static emu.grasscutter.net.newproto.InstableSprayRestartDungeonReqOuterClass.InstableSprayRestartDungeonReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ist\030\017 \003(\0132\030.InstableSprayAvatarInfoB\036\n\034e" +
