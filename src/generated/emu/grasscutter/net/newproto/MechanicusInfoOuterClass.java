...
public final class MechanicusInfoOuterClass {
  ...
  public interface MechanicusInfoOrBuilder extends
     ...
     * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getGearLevelPairList(int index);
    /**
     * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
     */
     ...
     * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getGearLevelPairListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MechanicusInfoOuterClass.internal_static_MechanicusInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MechanicusInfoOuterClass.internal_static_MechanicusInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo.class, emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> gearLevelPairList_;
    /**
     * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> getGearLevelPairListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getGearLevelPairList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getGearLevelPairListOrBuilder(
        int index) {
      return gearLevelPairList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo other = (emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MechanicusInfoOuterClass.internal_static_MechanicusInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo build() {
        emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo buildPartial() {
        emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo result = new emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo other) {
        if (other == emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo.getDefaultInstance()) return this;
      ...
      private void ensureGearLevelPairListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          gearLevelPairList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair>(gearLevelPairList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder> gearLevelPairListBuilder_;
       ...
       * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
       */
      public Builder addGearLevelPairList(emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair value) {
        if (gearLevelPairListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder getGearLevelPairListBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair gear_level_pair_list = 13;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder addGearLevelPairListBuilder() {
    ...
    private static final emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo();
    }

    public static emu.grasscutter.net.newproto.MechanicusInfoOuterClass.MechanicusInfo getDefaultInstance() {
