...
public final class AttackResultCreateCountOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.internal_static_AttackResultCreateCount_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.internal_static_AttackResultCreateCount_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount.class, emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount other = (emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount) obj;
    ...
    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCountOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.internal_static_AttackResultCreateCount_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount build() {
        emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount buildPartial() {
        emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount result = new emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount) {
          return mergeFrom((emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount other) {
        if (other == emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount();
    }

    public static emu.grasscutter.net.newproto.AttackResultCreateCountOuterClass.AttackResultCreateCount getDefaultInstance() {
