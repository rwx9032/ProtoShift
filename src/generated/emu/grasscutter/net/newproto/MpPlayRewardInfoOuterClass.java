...
public final class MpPlayRewardInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.internal_static_MpPlayRewardInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.internal_static_MpPlayRewardInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo.class, emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo other = (emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.internal_static_MpPlayRewardInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo build() {
        emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo buildPartial() {
        emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo result = new emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo other) {
        if (other == emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
    ...
    private static final emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo();
    }

    public static emu.grasscutter.net.newproto.MpPlayRewardInfoOuterClass.MpPlayRewardInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \003(\r\022\030\n\020qualify_uid_list\030\003 \003(\rB\036\n\034emu.gr" +
