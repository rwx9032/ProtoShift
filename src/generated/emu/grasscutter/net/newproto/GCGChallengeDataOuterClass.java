...
public final class GCGChallengeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.internal_static_GCGChallengeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.internal_static_GCGChallengeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData.class, emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData other = (emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.internal_static_GCGChallengeData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData build() {
        emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData buildPartial() {
        emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData result = new emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData other) {
        if (other == emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData();
    }

    public static emu.grasscutter.net.newproto.GCGChallengeDataOuterClass.GCGChallengeData getDefaultInstance() {
