...
public final class EvtCreateGadgetNotifyOuterClass {
  ...
  public interface EvtCreateGadgetNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getInitEulerAngles();
    /**
     * <code>.Vector init_euler_angles = 12;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getInitEulerAnglesOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.internal_static_EvtCreateGadgetNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.internal_static_EvtCreateGadgetNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify.class, emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.VectorOuterClass.Vector initEulerAngles_;
    /**
     * <code>.Vector init_euler_angles = 12;</code>
     * @return Whether the initEulerAngles field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getInitEulerAngles() {
      return initEulerAngles_ == null ? emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : initEulerAngles_;
    }
    /**
     * <code>.Vector init_euler_angles = 12;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getInitEulerAnglesOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify other = (emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.internal_static_EvtCreateGadgetNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify build() {
        emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify buildPartial() {
        emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify result = new emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify other) {
        if (other == emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify.getDefaultInstance()) return this;
      ...
      private emu.grasscutter.net.newproto.VectorOuterClass.Vector initEulerAngles_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> initEulerAnglesBuilder_;
      /**
       * <code>.Vector init_euler_angles = 12;</code>
       * @return Whether the initEulerAngles field is set.
       */
       ...
       * <code>.Vector init_euler_angles = 12;</code>
       */
      public Builder setInitEulerAngles(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (initEulerAnglesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector init_euler_angles = 12;</code>
       */
      public Builder mergeInitEulerAngles(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (initEulerAnglesBuilder_ == null) {
          if (initEulerAngles_ != null) {
            initEulerAngles_ =
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder(initEulerAngles_).mergeFrom(value).buildPartial();
          } else {
            initEulerAngles_ = value;
          }
          onChanged();
       ...
       * <code>.Vector init_euler_angles = 12;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getInitEulerAnglesBuilder() {
      ...
      public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getInitEulerAnglesOrBuilder() {
        if (initEulerAnglesBuilder_ != null) {
          ...
          return initEulerAngles_ == null ?
              emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance() : initEulerAngles_;
        }
      }
      /**
       * <code>.Vector init_euler_angles = 12;</code>
    ...
    private static final emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify();
    }

    public static emu.grasscutter.net.newproto.EvtCreateGadgetNotifyOuterClass.EvtCreateGadgetNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ity_id\030\001 \001(\r\022\030\n\020target_entity_id\030\013 \001(\rB\036" +
