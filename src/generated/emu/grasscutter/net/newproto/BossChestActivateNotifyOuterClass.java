...
public final class BossChestActivateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.internal_static_BossChestActivateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.internal_static_BossChestActivateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.class, emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify other = (emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.internal_static_BossChestActivateNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify build() {
        emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify buildPartial() {
        emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify result = new emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify other) {
        if (other == emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify();
    }

    public static emu.grasscutter.net.newproto.BossChestActivateNotifyOuterClass.BossChestActivateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\020qualify_uid_list\030\007 \003(\rB\036\n\034emu.grasscutt" +
