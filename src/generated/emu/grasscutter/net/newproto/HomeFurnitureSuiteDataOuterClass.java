...
public final class HomeFurnitureSuiteDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.internal_static_HomeFurnitureSuiteData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.internal_static_HomeFurnitureSuiteData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.class, emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData other = (emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.internal_static_HomeFurnitureSuiteData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData build() {
        emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData buildPartial() {
        emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData result = new emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData other) {
        if (other == emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData();
    }

    public static emu.grasscutter.net.newproto.HomeFurnitureSuiteDataOuterClass.HomeFurnitureSuiteData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "included_furniture_index_list\030\013 \003(\005B\036\n\034e" +
