...
public final class GCGSkillPreviewTokenInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.internal_static_GCGSkillPreviewTokenInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.internal_static_GCGSkillPreviewTokenInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo.class, emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo other = (emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.internal_static_GCGSkillPreviewTokenInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo build() {
        emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo buildPartial() {
        emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo result = new emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo other) {
        if (other == emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo();
    }

    public static emu.grasscutter.net.newproto.GCGSkillPreviewTokenInfoOuterClass.GCGSkillPreviewTokenInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_IKICJMEFEON\030\003 \001(\rB\036\n\034emu.grasscutter.ne" +
