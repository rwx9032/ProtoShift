...
public final class BargainSnapshotOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BargainSnapshotOuterClass.internal_static_BargainSnapshot_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BargainSnapshotOuterClass.internal_static_BargainSnapshot_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot.class, emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot other = (emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot) obj;
    ...
    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshotOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BargainSnapshotOuterClass.internal_static_BargainSnapshot_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot build() {
        emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot buildPartial() {
        emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot result = new emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot) {
          return mergeFrom((emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot other) {
        if (other == emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot();
    }

    public static emu.grasscutter.net.newproto.BargainSnapshotOuterClass.BargainSnapshot getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\020\n\010cur_mood\030\010 \001(\005B\036\n\034emu.grasscutter.ne" +
