...
public final class EntityAiSyncNotifyOuterClass {
  ...
  public interface EntityAiSyncNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo> 
        getInfoListList();
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo getInfoList(int index);
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
     ...
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList();
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.class, emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.Builder.class);
    }

    public static final int INFO_LIST_FIELD_NUMBER = 14;
    private java.util.List<emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo> infoList_;
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo> getInfoListList() {
      return infoList_;
    }
    /**
     * <code>repeated .AiSyncInfo info_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList() {
      return infoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo getInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index) {
      return infoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other = (emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify build() {
        emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify buildPartial() {
        emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = new emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other) {
        if (other == emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance()) return this;
        if (infoListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 114: {
                emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.parser(),
                        extensionRegistry);
                if (infoListBuilder_ == null) {
                  ensureInfoListIsMutable();
                  infoList_.add(m);
      ...
      private void ensureInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          infoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo>(infoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> infoListBuilder_;
      ...
      public Builder setInfoList(
          int index, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setInfoList(
          int index, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
       ...
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public Builder addInfoList(emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addInfoList(
          emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
      ...
      public Builder addAllInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo> values) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
       ...
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder getInfoListBuilder(
          int index) {
       ...
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder() {
        return getInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder(
          int index) {
        return getInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo info_list = 14;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder> 
           getInfoListBuilderList() {
        return getInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfo.Builder, emu.grasscutter.net.newproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify();
    }

    public static emu.grasscutter.net.newproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ed_monster_list\030\r \003(\rB\036\n\034emu.grasscutter" +
      ".net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.AiSyncInfoOuterClass.getDescriptor(),
        });
    internal_static_EntityAiSyncNotify_descriptor =
