...
public final class HomeLimitedShopGoodsOuterClass {
  ...
  public interface HomeLimitedShopGoodsOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getGoodsItem();
    /**
     * <code>.ItemParam goods_item = 2;</code>
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getGoodsItemOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.internal_static_HomeLimitedShopGoods_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.internal_static_HomeLimitedShopGoods_fieldAccessorTable
    ...
    private emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam goodsItem_;
    /**
     * <code>.ItemParam goods_item = 2;</code>
     * @return Whether the goodsItem field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getGoodsItem() {
      return goodsItem_ == null ? emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : goodsItem_;
    }
    /**
     * <code>.ItemParam goods_item = 2;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getGoodsItemOrBuilder() {
      return getGoodsItem();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods)) {
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoodsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.internal_static_HomeLimitedShopGoods_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods build() {
        emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods result = buildPartial();
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods)other);
        } else {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder> goodsItemBuilder_;
      /**
       * <code>.ItemParam goods_item = 2;</code>
       * @return Whether the goodsItem field is set.
       */
       ...
       * <code>.ItemParam goods_item = 2;</code>
       */
      public Builder setGoodsItem(emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam value) {
        if (goodsItemBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.ItemParam goods_item = 2;</code>
       */
      public Builder mergeGoodsItem(emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam value) {
        if (goodsItemBuilder_ == null) {
          if (goodsItem_ != null) {
            goodsItem_ =
              emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.newBuilder(goodsItem_).mergeFrom(value).buildPartial();
          } else {
            goodsItem_ = value;
          }
          onChanged();
       ...
       * <code>.ItemParam goods_item = 2;</code>
       */
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder getGoodsItemBuilder() {
      ...
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getGoodsItemOrBuilder() {
        if (goodsItemBuilder_ != null) {
          ...
          return goodsItem_ == null ?
              emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : goodsItem_;
        }
      }
      /**
       * <code>.ItemParam goods_item = 2;</code>
    ...
    private static final emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods();
    }

    public static emu.grasscutter.net.newproto.HomeLimitedShopGoodsOuterClass.HomeLimitedShopGoods getDefaultInstance() {
