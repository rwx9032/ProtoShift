...
public final class ClientTransmitReqOuterClass {
  ...
  public interface ClientTransmitReqOrBuilder extends
     ...
     * @return The reason.
     */
    emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason getReason();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.internal_static_ClientTransmitReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.internal_static_ClientTransmitReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq.class, emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq.Builder.class);
    }
     ...
     * @return The reason.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason getReason() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason result = emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason.valueOf(reason_);
      return result == null ? emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (reason_ != emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason.TRANSMIT_REASON_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq other = (emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq) obj;
    ...
    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.internal_static_ClientTransmitReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq build() {
        emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq buildPartial() {
        emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq result = new emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq) {
          return mergeFrom((emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq other) {
        if (other == emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason getReason() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason result = emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason.valueOf(reason_);
        return result == null ? emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.grasscutter.net.newproto.TransmitReasonOuterClass.TransmitReason value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq();
    }

    public static emu.grasscutter.net.newproto.ClientTransmitReqOuterClass.ClientTransmitReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "os\030\004 \001(\0132\007.VectorB\036\n\034emu.grasscutter.net" +
      ".newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.TransmitReasonOuterClass.getDescriptor(),
