...
public final class ClientAbilityInitFinishNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.internal_static_ClientAbilityInitFinishNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.internal_static_ClientAbilityInitFinishNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify.class, emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify other = (emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.internal_static_ClientAbilityInitFinishNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify build() {
        emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify buildPartial() {
        emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify result = new emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify other) {
        if (other == emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify();
    }

    public static emu.grasscutter.net.newproto.ClientAbilityInitFinishNotifyOuterClass.ClientAbilityInitFinishNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nvokes\030\t \003(\0132\023.AbilityInvokeEntryB\036\n\034emu" +
