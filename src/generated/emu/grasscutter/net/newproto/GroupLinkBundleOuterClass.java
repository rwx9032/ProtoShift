...
public final class GroupLinkBundleOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.internal_static_GroupLinkBundle_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.internal_static_GroupLinkBundle_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle.class, emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle other = (emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle) obj;
    ...
    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.internal_static_GroupLinkBundle_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle build() {
        emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle buildPartial() {
        emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle result = new emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle) {
          return mergeFrom((emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle other) {
        if (other == emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle();
    }

    public static emu.grasscutter.net.newproto.GroupLinkBundleOuterClass.GroupLinkBundle getDefaultInstance() {
