...
public final class DungeonReviseLevelNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.internal_static_DungeonReviseLevelNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.internal_static_DungeonReviseLevelNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify.class, emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify other = (emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.internal_static_DungeonReviseLevelNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify build() {
        emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify buildPartial() {
        emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify result = new emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify other) {
        if (other == emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify();
    }

    public static emu.grasscutter.net.newproto.DungeonReviseLevelNotifyOuterClass.DungeonReviseLevelNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_DKIMMKIHDCK\030\017 \001(\rB\036\n\034emu.grasscutter.ne" +
