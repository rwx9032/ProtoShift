...
public final class RoguelikeSettleCoinInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.internal_static_RoguelikeSettleCoinInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.internal_static_RoguelikeSettleCoinInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo.class, emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo other = (emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.internal_static_RoguelikeSettleCoinInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo build() {
        emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo buildPartial() {
        emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo result = new emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo other) {
        if (other == emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo();
    }

    public static emu.grasscutter.net.newproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo getDefaultInstance() {
