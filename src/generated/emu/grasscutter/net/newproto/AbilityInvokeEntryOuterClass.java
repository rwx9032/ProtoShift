...
public final class AbilityInvokeEntryOuterClass {
  ...
  public interface AbilityInvokeEntryOrBuilder extends
     ...
     * @return The head.
     */
    emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead getHead();
    /**
     * <code>.AbilityInvokeEntryHead head = 3;</code>
     */
    emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder getHeadOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument getArgumentType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.internal_static_AbilityInvokeEntry_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.internal_static_AbilityInvokeEntry_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry.class, emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead head_;
    /**
     * <code>.AbilityInvokeEntryHead head = 3;</code>
     * @return Whether the head field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead getHead() {
      return head_ == null ? emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.getDefaultInstance() : head_;
    }
    /**
     * <code>.AbilityInvokeEntryHead head = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder getHeadOrBuilder() {
      return getHead();
    }
     ...
     * @return The argumentType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument getArgumentType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument result = emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.valueOf(argumentType_);
      return result == null ? emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (argumentType_ != emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.ABILITY_INVOKE_ARGUMENT_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry other = (emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.internal_static_AbilityInvokeEntry_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry build() {
        emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry buildPartial() {
        emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry result = new emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry other) {
        if (other == emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead, emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder, emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder> headBuilder_;
      /**
       * <code>.AbilityInvokeEntryHead head = 3;</code>
       * @return Whether the head field is set.
       */
       ...
       * <code>.AbilityInvokeEntryHead head = 3;</code>
       */
      public Builder setHead(emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead value) {
        if (headBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setHead(
          emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder builderForValue) {
        if (headBuilder_ == null) {
       ...
       * <code>.AbilityInvokeEntryHead head = 3;</code>
       */
      public Builder mergeHead(emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead value) {
        if (headBuilder_ == null) {
          if (head_ != null) {
            head_ =
              emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.newBuilder(head_).mergeFrom(value).buildPartial();
          } else {
            head_ = value;
          }
          onChanged();
       ...
       * <code>.AbilityInvokeEntryHead head = 3;</code>
       */
      public emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder getHeadBuilder() {
      ...
      public emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder getHeadOrBuilder() {
        if (headBuilder_ != null) {
          ...
          return head_ == null ?
              emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.getDefaultInstance() : head_;
        }
      }
      /**
       * <code>.AbilityInvokeEntryHead head = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead, emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder, emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder> 
          getHeadFieldBuilder() {
        if (headBuilder_ == null) {
    ...
    throw new NullPointerException();
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument getArgumentType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument result = emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.valueOf(argumentType_);
        return result == null ? emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setArgumentType(emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.AbilityInvokeArgument value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry();
    }

    public static emu.grasscutter.net.newproto.AbilityInvokeEntryOuterClass.AbilityInvokeEntry getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "s_ignore_auth\030\014 \001(\010B\036\n\034emu.grasscutter.n" +
      "et.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.AbilityInvokeArgumentOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.AbilityInvokeEntryHeadOuterClass.getDescriptor(),
