...
public final class GadgetChangeLevelTagReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.internal_static_GadgetChangeLevelTagReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.internal_static_GadgetChangeLevelTagReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq.class, emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq other = (emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq) obj;
    ...
    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.internal_static_GadgetChangeLevelTagReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq build() {
        emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq buildPartial() {
        emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq result = new emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq) {
          return mergeFrom((emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq other) {
        if (other == emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq();
    }

    public static emu.grasscutter.net.newproto.GadgetChangeLevelTagReqOuterClass.GadgetChangeLevelTagReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "2\025.CustomGadgetTreeInfoB\036\n\034emu.grasscutt" +
