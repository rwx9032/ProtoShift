...
public final class SumoTeamDataOuterClass {
  ...
  public interface SumoTeamDataOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> 
        getAvatarInfoListList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index);
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
     ...
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData.class, emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> avatarInfoList_;
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData other = (emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData) obj;
    ...
    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData build() {
        emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData buildPartial() {
        emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData result = new emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData) {
          return mergeFrom((emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData other) {
        if (other == emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 34: {
                emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.parser(),
                        extensionRegistry);
                if (avatarInfoListBuilder_ == null) {
                  ensureAvatarInfoListIsMutable();
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo>(avatarInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public Builder addAvatarInfoList(emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarInfoList(
          emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder getAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 4;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData();
    }

    public static emu.grasscutter.net.newproto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.SumoAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SumoTeamData_descriptor =
