...
public final class TreasureMapHostInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.internal_static_TreasureMapHostInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.internal_static_TreasureMapHostInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify.class, emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify other = (emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.internal_static_TreasureMapHostInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify build() {
        emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify result = new emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify();
    }

    public static emu.grasscutter.net.newproto.TreasureMapHostInfoNotifyOuterClass.TreasureMapHostInfoNotify getDefaultInstance() {
