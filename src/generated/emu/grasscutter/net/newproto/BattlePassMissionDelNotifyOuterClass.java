...
public final class BattlePassMissionDelNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.internal_static_BattlePassMissionDelNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.internal_static_BattlePassMissionDelNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify.class, emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify other = (emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.internal_static_BattlePassMissionDelNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify build() {
        emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify buildPartial() {
        emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify result = new emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify other) {
        if (other == emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify();
    }

    public static emu.grasscutter.net.newproto.BattlePassMissionDelNotifyOuterClass.BattlePassMissionDelNotify getDefaultInstance() {
