...
public final class GCGCardOuterClass {
  ...
  public interface GCGCardOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken> 
        getTokenListList();
    /**
     * <code>repeated .GCGToken token_list = 8;</code>
     */
    emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken getTokenList(int index);
    /**
     * <code>repeated .GCGToken token_list = 8;</code>
     */
     ...
     * <code>repeated .GCGToken token_list = 8;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
        getTokenListOrBuilderList();
    /**
     * <code>repeated .GCGToken token_list = 8;</code>
     */
    emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGTokenOrBuilder getTokenListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo> 
        getSkillLimitsListList();
    /**
     * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
     */
    emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo getSkillLimitsList(int index);
    /**
     * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
     */
     ...
     * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfoOrBuilder> 
        getSkillLimitsListOrBuilderList();
    /**
     * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
     */
    emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfoOrBuilder getSkillLimitsListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGCardOuterClass.internal_static_GCGCard_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGCardOuterClass.internal_static_GCGCard_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard.class, emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken> tokenList_;
    /**
     * <code>repeated .GCGToken token_list = 8;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken> getTokenListList() {
      return tokenList_;
    }
    /**
     * <code>repeated .GCGToken token_list = 8;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
        getTokenListOrBuilderList() {
      return tokenList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken getTokenList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGTokenOrBuilder getTokenListOrBuilder(
        int index) {
      return tokenList_.get(index);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo> skillLimitsList_;
    /**
     * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo> getSkillLimitsListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfoOrBuilder> 
        getSkillLimitsListOrBuilderList() {
      return skillLimitsList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo getSkillLimitsList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfoOrBuilder getSkillLimitsListOrBuilder(
        int index) {
      return skillLimitsList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard other = (emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCardOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGCardOuterClass.internal_static_GCGCard_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard build() {
        emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard buildPartial() {
        emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard result = new emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard other) {
        if (other == emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.parser(),
                        extensionRegistry);
                if (skillLimitsListBuilder_ == null) {
                  ensureSkillLimitsListIsMutable();
              ...
              case 66: {
                emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.parser(),
                        extensionRegistry);
                if (tokenListBuilder_ == null) {
                  ensureTokenListIsMutable();
                  tokenList_.add(m);
      ...
      private void ensureTokenListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          tokenList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken>(tokenList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGTokenOrBuilder> tokenListBuilder_;
      ...
      public Builder setTokenList(
          int index, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken value) {
        if (tokenListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTokenList(
          int index, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder builderForValue) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
       ...
       * <code>repeated .GCGToken token_list = 8;</code>
       */
      public Builder addTokenList(emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken value) {
        if (tokenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTokenList(
          emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder builderForValue) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
      ...
      public Builder addAllTokenList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken> values) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, tokenList_);
       ...
       * <code>repeated .GCGToken token_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder getTokenListBuilder(
          int index) {
       ...
       * <code>repeated .GCGToken token_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder addTokenListBuilder() {
        return getTokenListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGToken token_list = 8;</code>
       */
      public emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder addTokenListBuilder(
          int index) {
        return getTokenListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGToken token_list = 8;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder> 
           getTokenListBuilderList() {
        return getTokenListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGToken.Builder, emu.grasscutter.net.newproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
      ...
      private void ensureSkillLimitsListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          skillLimitsList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo>(skillLimitsList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfoOrBuilder> skillLimitsListBuilder_;
      ...
      public Builder setSkillLimitsList(
          int index, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo value) {
        if (skillLimitsListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setSkillLimitsList(
          int index, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder builderForValue) {
        if (skillLimitsListBuilder_ == null) {
          ensureSkillLimitsListIsMutable();
       ...
       * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
       */
      public Builder addSkillLimitsList(emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo value) {
        if (skillLimitsListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSkillLimitsList(
          emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder builderForValue) {
        if (skillLimitsListBuilder_ == null) {
          ensureSkillLimitsListIsMutable();
      ...
      public Builder addAllSkillLimitsList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo> values) {
        if (skillLimitsListBuilder_ == null) {
          ensureSkillLimitsListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder getSkillLimitsListBuilder(
          int index) {
       ...
       * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder addSkillLimitsListBuilder() {
        return getSkillLimitsListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder addSkillLimitsListBuilder(
          int index) {
        return getSkillLimitsListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGSkillLimitsInfo skill_limits_list = 3;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder> 
           getSkillLimitsListBuilderList() {
        return getSkillLimitsListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfo.Builder, emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.GCGSkillLimitsInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard();
    }

    public static emu.grasscutter.net.newproto.GCGCardOuterClass.GCGCard getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\n\002id\030\006 \001(\r\022\025\n\rcontroller_id\030\005 \001(\rB\036\n\034em" +
      "u.grasscutter.net.newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.GCGSkillLimitsInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.GCGTokenOuterClass.getDescriptor(),
        });
    internal_static_GCGCard_descriptor =
