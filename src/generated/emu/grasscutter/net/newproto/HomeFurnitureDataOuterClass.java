...
public final class HomeFurnitureDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.internal_static_HomeFurnitureData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.internal_static_HomeFurnitureData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData.class, emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData other = (emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData) obj;
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.internal_static_HomeFurnitureData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData build() {
        emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData buildPartial() {
        emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData result = new emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData) {
          return mergeFrom((emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData other) {
        if (other == emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData();
    }

    public static emu.grasscutter.net.newproto.HomeFurnitureDataOuterClass.HomeFurnitureData getDefaultInstance() {
