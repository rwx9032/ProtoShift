...
public final class RoutePointOuterClass {
  ...
  public interface RoutePointOrBuilder extends
     ...
     * @return The rotation.
     */
    emu.grasscutter.net.newproto.VectorOuterClass.Vector getRotation();
    /**
     * <code>.Vector rotation = 21;</code>
     */
    emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getRotationOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion getRotationSpeed();
    /**
     * <code>.MathQuaternion rotation_speed = 22;</code>
     */
    emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder getRotationSpeedOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion getAxisSpeed();
    /**
     * <code>.MathQuaternion axis_speed = 23;</code>
     */
    emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder getAxisSpeedOrBuilder();

    public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.MoveParamsCase getMoveParamsCase();

    public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.RotateParamsCase getRotateParamsCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.RoutePointOuterClass.internal_static_RoutePoint_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.RoutePointOuterClass.internal_static_RoutePoint_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.class, emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.Vector getRotation() {
      if (rotateParamsCase_ == 21) {
         return (emu.grasscutter.net.newproto.VectorOuterClass.Vector) rotateParams_;
      }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder getRotationOrBuilder() {
      if (rotateParamsCase_ == 21) {
         return (emu.grasscutter.net.newproto.VectorOuterClass.Vector) rotateParams_;
      }
      return emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion getRotationSpeed() {
      if (rotateParamsCase_ == 22) {
         return (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_;
      }
      return emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance();
    }
    /**
     * <code>.MathQuaternion rotation_speed = 22;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder getRotationSpeedOrBuilder() {
      if (rotateParamsCase_ == 22) {
         return (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_;
      }
      return emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance();
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion getAxisSpeed() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder getAxisSpeedOrBuilder() {
      if (rotateParamsCase_ == 23) {
         return (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_;
      }
      return emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (rotateParamsCase_ == 21) {
        output.writeMessage(21, (emu.grasscutter.net.newproto.VectorOuterClass.Vector) rotateParams_);
      }
      if (rotateParamsCase_ == 22) {
        output.writeMessage(22, (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
      }
      if (rotateParamsCase_ == 23) {
        output.writeMessage(23, (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (rotateParamsCase_ == 21) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(21, (emu.grasscutter.net.newproto.VectorOuterClass.Vector) rotateParams_);
      }
      if (rotateParamsCase_ == 22) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(22, (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
      }
      if (rotateParamsCase_ == 23) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(23, (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint other = (emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint) obj;
    ...
    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint parseFrom(
    ...
    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePointOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.RoutePointOuterClass.internal_static_RoutePoint_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint build() {
        emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint buildPartial() {
        emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint result = new emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint(this);
        if (positionBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint) {
          return mergeFrom((emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint other) {
        if (other == emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder> rotationBuilder_;
      /**
       * <code>.Vector rotation = 21;</code>
       * @return Whether the rotation field is set.
       */
       ...
       * <code>.Vector rotation = 21;</code>
       */
      public Builder setRotation(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (rotationBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector rotation = 21;</code>
       */
      public Builder mergeRotation(emu.grasscutter.net.newproto.VectorOuterClass.Vector value) {
        if (rotationBuilder_ == null) {
          if (rotateParamsCase_ == 21 &&
              rotateParams_ != emu.grasscutter.net.newproto.VectorOuterClass.Vector.getDefaultInstance()) {
            rotateParams_ = emu.grasscutter.net.newproto.VectorOuterClass.Vector.newBuilder((emu.grasscutter.net.newproto.VectorOuterClass.Vector) rotateParams_)
       ...
       * <code>.Vector rotation = 21;</code>
       */
      public emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder getRotationBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (rotationBuilder_ == null) {
          ...
          rotationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.VectorOuterClass.Vector, emu.grasscutter.net.newproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.newproto.VectorOuterClass.VectorOrBuilder>(
                  (emu.grasscutter.net.newproto.VectorOuterClass.Vector) rotateParams_,
                  getParentForChildren(),
                  isClean());
          rotateParams_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion, emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.Builder, emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder> rotationSpeedBuilder_;
      /**
       * <code>.MathQuaternion rotation_speed = 22;</code>
       * @return Whether the rotationSpeed field is set.
       */
       ...
       * <code>.MathQuaternion rotation_speed = 22;</code>
       */
      public Builder setRotationSpeed(emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion value) {
        if (rotationSpeedBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.MathQuaternion rotation_speed = 22;</code>
       */
      public Builder mergeRotationSpeed(emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion value) {
        if (rotationSpeedBuilder_ == null) {
          if (rotateParamsCase_ == 22 &&
              rotateParams_ != emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance()) {
            rotateParams_ = emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.newBuilder((emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_)
                .mergeFrom(value).buildPartial();
          } else {
            rotateParams_ = value;
          }
       ...
       * <code>.MathQuaternion rotation_speed = 22;</code>
       */
      public emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.Builder getRotationSpeedBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
        ...
        if (rotationSpeedBuilder_ == null) {
          ...
          rotationSpeedBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion, emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.Builder, emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder>(
                  (emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_,
                  getParentForChildren(),
                  isClean());
          rotateParams_ = null;
        }
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion, emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.Builder, emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternionOrBuilder> axisSpeedBuilder_;
      /**
       * <code>.MathQuaternion axis_speed = 23;</code>
       * @return Whether the axisSpeed field is set.
       */
       ...
       * <code>.MathQuaternion axis_speed = 23;</code>
       */
      public Builder setAxisSpeed(emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion value) {
        if (axisSpeedBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.MathQuaternion axis_speed = 23;</code>
       */
      public Builder mergeAxisSpeed(emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion value) {
        if (axisSpeedBuilder_ == null) {
          if (rotateParamsCase_ == 23 &&
              rotateParams_ != emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.getDefaultInstance()) {
            rotateParams_ = emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.newBuilder((emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion) rotateParams_)
       ...
       * <code>.MathQuaternion axis_speed = 23;</code>
       */
      public emu.grasscutter.net.newproto.MathQuaternionOuterClass.MathQuaternion.Builder getAxisSpeedBuilder() {
    ...
    private static final emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint();
    }

    public static emu.grasscutter.net.newproto.RoutePointOuterClass.RoutePoint getDefaultInstance() {
