...
public final class MailChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.internal_static_MailChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.internal_static_MailChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify.class, emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify other = (emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.internal_static_MailChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify build() {
        emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify buildPartial() {
        emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify result = new emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify other) {
        if (other == emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify();
    }

    public static emu.grasscutter.net.newproto.MailChangeNotifyOuterClass.MailChangeNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\017 \003(\r\022\034\n\tmail_list\030\002 \003(\0132\t.MailDataB\036\n\034" +
