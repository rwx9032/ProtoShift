...
public final class FishEscapeNotifyOuterClass {
  ...
  public interface FishEscapeNotifyOrBuilder extends
     ...
     * @return The reason.
     */
    emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason getReason();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.internal_static_FishEscapeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.internal_static_FishEscapeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify.class, emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify.Builder.class);
    }
     ...
     * @return The reason.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason getReason() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason result = emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason.valueOf(reason_);
      return result == null ? emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (reason_ != emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason.FISH_ESCAPE_REASON_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify other = (emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.internal_static_FishEscapeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify build() {
        emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify buildPartial() {
        emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify result = new emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify other) {
        if (other == emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        if (other.hasPos()) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason getReason() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason result = emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason.valueOf(reason_);
        return result == null ? emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.FishEscapeReason value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify();
    }

    public static emu.grasscutter.net.newproto.FishEscapeNotifyOuterClass.FishEscapeNotify getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.FishEscapeReasonOuterClass.getDescriptor(),
