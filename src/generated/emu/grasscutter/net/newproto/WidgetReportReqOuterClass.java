...
public final class WidgetReportReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WidgetReportReqOuterClass.internal_static_WidgetReportReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WidgetReportReqOuterClass.internal_static_WidgetReportReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq.class, emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq other = (emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq) obj;
    ...
    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WidgetReportReqOuterClass.internal_static_WidgetReportReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq build() {
        emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq buildPartial() {
        emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq result = new emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq) {
          return mergeFrom((emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq other) {
        if (other == emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq();
    }

    public static emu.grasscutter.net.newproto.WidgetReportReqOuterClass.WidgetReportReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\033\n\023Unk3300_EFBCLDDKMIM\030\016 \001(\010B\036\n\034emu.gras" +
