...
public final class FungusCultivateReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.internal_static_FungusCultivateReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.internal_static_FungusCultivateReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq.class, emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq other = (emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq) obj;
    ...
    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.internal_static_FungusCultivateReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq build() {
        emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq buildPartial() {
        emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq result = new emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq) {
          return mergeFrom((emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq other) {
        if (other == emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq();
    }

    public static emu.grasscutter.net.newproto.FungusCultivateReqOuterClass.FungusCultivateReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "0_AEGCNHLOPEP\030\010 \001(\rB\036\n\034emu.grasscutter.n" +
