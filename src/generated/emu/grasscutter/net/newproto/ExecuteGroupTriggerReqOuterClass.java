...
public final class ExecuteGroupTriggerReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.internal_static_ExecuteGroupTriggerReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.internal_static_ExecuteGroupTriggerReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq.class, emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq other = (emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq) obj;
    ...
    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.internal_static_ExecuteGroupTriggerReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq build() {
        emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq buildPartial() {
        emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq result = new emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq) {
          return mergeFrom((emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq other) {
        if (other == emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq();
    }

    public static emu.grasscutter.net.newproto.ExecuteGroupTriggerReqOuterClass.ExecuteGroupTriggerReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\016\n\006param2\030\004 \001(\005B\036\n\034emu.grasscutter.ne" +
