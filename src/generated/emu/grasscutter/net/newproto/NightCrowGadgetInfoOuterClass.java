...
public final class NightCrowGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.internal_static_NightCrowGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.internal_static_NightCrowGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.class, emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo other = (emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.internal_static_NightCrowGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo build() {
        emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo buildPartial() {
        emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo result = new emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo other) {
        if (other == emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo();
    }

    public static emu.grasscutter.net.newproto.NightCrowGadgetInfoOuterClass.NightCrowGadgetInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "GadgetInfo\022\025\n\rargument_list\030\001 \003(\rB\036\n\034emu" +
