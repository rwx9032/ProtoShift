...
public final class GCGMsgUpdateControllerOuterClass {
  ...
  public interface GCGMsgUpdateControllerOrBuilder extends
     ...
     * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getAllowControllerMap(int index);
    /**
     * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
     */
     ...
     * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
     */
    emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getAllowControllerMapOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.internal_static_GCGMsgUpdateController_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.internal_static_GCGMsgUpdateController_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController.class, emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController.Builder.class);
    }

    public static final int ALLOW_CONTROLLER_MAP_FIELD_NUMBER = 10;
    private java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> allowControllerMap_;
    /**
     * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair> getAllowControllerMapList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair getAllowControllerMap(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder getAllowControllerMapOrBuilder(
        int index) {
      return allowControllerMap_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController other = (emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateControllerOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.internal_static_GCGMsgUpdateController_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController build() {
        emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController buildPartial() {
        emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController result = new emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController other) {
        if (other == emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController.getDefaultInstance()) return this;
        if (allowControllerMapBuilder_ == null) {
      ...
      private void ensureAllowControllerMapIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          allowControllerMap_ = new java.util.ArrayList<emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair>(allowControllerMap_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder, emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32PairOrBuilder> allowControllerMapBuilder_;
       ...
       * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
       */
      public Builder addAllowControllerMap(emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair value) {
        if (allowControllerMapBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder getAllowControllerMapBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair allow_controller_map = 10;</code>
       */
      public emu.grasscutter.net.newproto.Uint32PairOuterClass.Uint32Pair.Builder addAllowControllerMapBuilder() {
    ...
    private static final emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController();
    }

    public static emu.grasscutter.net.newproto.GCGMsgUpdateControllerOuterClass.GCGMsgUpdateController getDefaultInstance() {
