...
public final class GetHuntingOfferRewardRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.internal_static_GetHuntingOfferRewardRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.internal_static_GetHuntingOfferRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp.class, emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp other = (emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.internal_static_GetHuntingOfferRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp build() {
        emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp buildPartial() {
        emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp result = new emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp other) {
        if (other == emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp();
    }

    public static emu.grasscutter.net.newproto.GetHuntingOfferRewardRspOuterClass.GetHuntingOfferRewardRsp getDefaultInstance() {
