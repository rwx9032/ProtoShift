...
public final class GadgetGeneralRewardInfoOuterClass {
  ...
  public interface GadgetGeneralRewardInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getItemParam();
    /**
     * <code>.ItemParam item_param = 5;</code>
     */
    emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.class, emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam itemParam_;
    /**
     * <code>.ItemParam item_param = 5;</code>
     * @return Whether the itemParam field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam getItemParam() {
      return itemParam_ == null ? emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
    }
    /**
     * <code>.ItemParam item_param = 5;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder() {
      return getItemParam();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo other = (emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.internal_static_GadgetGeneralRewardInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo build() {
        emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo buildPartial() {
        emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo result = new emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo other) {
        if (other == emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo.getDefaultInstance()) return this;
        if (other.getResin() != 0) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder> itemParamBuilder_;
      /**
       * <code>.ItemParam item_param = 5;</code>
       * @return Whether the itemParam field is set.
       */
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public Builder setItemParam(emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam value) {
        if (itemParamBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public Builder mergeItemParam(emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam value) {
        if (itemParamBuilder_ == null) {
          if (itemParam_ != null) {
            itemParam_ =
              emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.newBuilder(itemParam_).mergeFrom(value).buildPartial();
          } else {
            itemParam_ = value;
          }
          onChanged();
       ...
       * <code>.ItemParam item_param = 5;</code>
       */
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.Builder getItemParamBuilder() {
      ...
      public emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParamOrBuilder getItemParamOrBuilder() {
        if (itemParamBuilder_ != null) {
          ...
          return itemParam_ == null ?
              emu.grasscutter.net.newproto.ItemParamOuterClass.ItemParam.getDefaultInstance() : itemParam_;
        }
      }
      /**
       * <code>.ItemParam item_param = 5;</code>
    ...
    private static final emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo();
    }

    public static emu.grasscutter.net.newproto.GadgetGeneralRewardInfoOuterClass.GadgetGeneralRewardInfo getDefaultInstance() {
