...
public final class CustomDungeonSettingOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.internal_static_CustomDungeonSetting_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.internal_static_CustomDungeonSetting_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting.class, emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting other = (emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting) obj;
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSettingOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.internal_static_CustomDungeonSetting_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting build() {
        emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting buildPartial() {
        emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting result = new emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting) {
          return mergeFrom((emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting other) {
        if (other == emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting();
    }

    public static emu.grasscutter.net.newproto.CustomDungeonSettingOuterClass.CustomDungeonSetting getDefaultInstance() {
