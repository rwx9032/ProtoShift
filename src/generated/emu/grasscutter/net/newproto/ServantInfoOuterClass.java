...
public final class ServantInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ServantInfoOuterClass.internal_static_ServantInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ServantInfoOuterClass.internal_static_ServantInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo.class, emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo other = (emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ServantInfoOuterClass.internal_static_ServantInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo build() {
        emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo buildPartial() {
        emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo result = new emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo other) {
        if (other == emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo();
    }

    public static emu.grasscutter.net.newproto.ServantInfoOuterClass.ServantInfo getDefaultInstance() {
