...
public final class TrialAvatarGrantRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.internal_static_TrialAvatarGrantRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.internal_static_TrialAvatarGrantRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.class, emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder.class);
    }
    ...
    public enum GrantReason
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDescriptor().getEnumTypes().get(0);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord other = (emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord) obj;
    ...
    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.internal_static_TrialAvatarGrantRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord build() {
        emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord buildPartial() {
        emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord result = new emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord) {
          return mergeFrom((emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord other) {
        if (other == emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord();
    }

    public static emu.grasscutter.net.newproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord getDefaultInstance() {
