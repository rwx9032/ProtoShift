...
public final class IrodoriChessMapDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.internal_static_IrodoriChessMapData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.internal_static_IrodoriChessMapData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData.class, emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData other = (emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData) obj;
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.internal_static_IrodoriChessMapData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData build() {
        emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData buildPartial() {
        emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData result = new emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData) {
          return mergeFrom((emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData other) {
        if (other == emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData.getDefaultInstance()) return this;
        if (other.getMapId() != 0) {
    ...
    private static final emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData();
    }

    public static emu.grasscutter.net.newproto.IrodoriChessMapDataOuterClass.IrodoriChessMapData getDefaultInstance() {
