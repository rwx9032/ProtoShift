...
public final class AbilityActionCreateGadgetOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.internal_static_AbilityActionCreateGadget_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.internal_static_AbilityActionCreateGadget_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget.class, emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget other = (emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadgetOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.internal_static_AbilityActionCreateGadget_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget build() {
        emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget buildPartial() {
        emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget result = new emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget other) {
        if (other == emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget();
    }

    public static emu.grasscutter.net.newproto.AbilityActionCreateGadgetOuterClass.AbilityActionCreateGadget getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "os\030\010 \001(\0132\007.VectorB\036\n\034emu.grasscutter.net" +
      ".newprotob\006proto3"
    };
