...
public final class CustomDungeonAbstractOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.internal_static_CustomDungeonAbstract_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.internal_static_CustomDungeonAbstract_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.class, emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.internal_static_CustomDungeonAbstract_BrickStatisticsMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract other = (emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract) obj;
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.internal_static_CustomDungeonAbstract_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract build() {
        emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract buildPartial() {
        emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract result = new emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract) {
          return mergeFrom((emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract other) {
        if (other == emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract();
    }

    public static emu.grasscutter.net.newproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract getDefaultInstance() {
