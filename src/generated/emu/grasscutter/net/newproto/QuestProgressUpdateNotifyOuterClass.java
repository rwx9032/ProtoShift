...
public final class QuestProgressUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.class, emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify other = (emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.internal_static_QuestProgressUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify build() {
        emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify buildPartial() {
        emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify result = new emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify other) {
        if (other == emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify();
    }

    public static emu.grasscutter.net.newproto.QuestProgressUpdateNotifyOuterClass.QuestProgressUpdateNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rogress_list\030\017 \003(\rB\036\n\034emu.grasscutter.ne" +
