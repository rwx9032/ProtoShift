...
public final class MiracleRingDeliverItemRspOuterClass {
  ...
  public interface MiracleRingDeliverItemRspOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType getInteractType();
  }
  /**
   * <pre>
   * enum CmdId {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.internal_static_MiracleRingDeliverItemRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.internal_static_MiracleRingDeliverItemRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.class, emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.Builder.class);
    }
     ...
     * @return The interactType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType getInteractType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType result = emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType.valueOf(interactType_);
      return result == null ? emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (interactType_ != emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType.INTERACT_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp other = (emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.internal_static_MiracleRingDeliverItemRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp build() {
        emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp buildPartial() {
        emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp result = new emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp other) {
        if (other == emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType getInteractType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType result = emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType.valueOf(interactType_);
        return result == null ? emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setInteractType(emu.grasscutter.net.newproto.InteractTypeOuterClass.InteractType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp();
    }

    public static emu.grasscutter.net.newproto.MiracleRingDeliverItemRspOuterClass.MiracleRingDeliverItemRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "nteract_type\030\014 \001(\0162\r.InteractTypeB\036\n\034emu" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.newproto.InteractTypeOuterClass.getDescriptor(),
        });
    internal_static_MiracleRingDeliverItemRsp_descriptor =
