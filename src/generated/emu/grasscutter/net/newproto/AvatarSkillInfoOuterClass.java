...
public final class AvatarSkillInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.class, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo other = (emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo build() {
        emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo buildPartial() {
        emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result = new emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo other) {
        if (other == emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo();
    }

    public static emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getDefaultInstance() {
