...
public final class TreasureSeelieRegionDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.internal_static_TreasureSeelieRegionData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.internal_static_TreasureSeelieRegionData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData.class, emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData other = (emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData) obj;
    ...
    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.internal_static_TreasureSeelieRegionData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData build() {
        emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData buildPartial() {
        emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData result = new emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData) {
          return mergeFrom((emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData other) {
        if (other == emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData();
    }

    public static emu.grasscutter.net.newproto.TreasureSeelieRegionDataOuterClass.TreasureSeelieRegionData getDefaultInstance() {
