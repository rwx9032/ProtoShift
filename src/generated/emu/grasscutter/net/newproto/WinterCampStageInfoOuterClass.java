...
public final class WinterCampStageInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.internal_static_WinterCampStageInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.internal_static_WinterCampStageInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo.class, emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo other = (emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.internal_static_WinterCampStageInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo build() {
        emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo buildPartial() {
        emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo result = new emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo other) {
        if (other == emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo();
    }

    public static emu.grasscutter.net.newproto.WinterCampStageInfoOuterClass.WinterCampStageInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ctor\022\023\n\013is_finished\030\010 \001(\010B\036\n\034emu.grasscu" +
