...
public final class GCGLevelDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGLevelDataOuterClass.internal_static_GCGLevelData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGLevelDataOuterClass.internal_static_GCGLevelData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData.class, emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData other = (emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGLevelDataOuterClass.internal_static_GCGLevelData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData build() {
        emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData buildPartial() {
        emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData result = new emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData other) {
        if (other == emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData();
    }

    public static emu.grasscutter.net.newproto.GCGLevelDataOuterClass.GCGLevelData getDefaultInstance() {
