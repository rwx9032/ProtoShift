...
public final class PlayerStartMatchReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.internal_static_PlayerStartMatchReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.internal_static_PlayerStartMatchReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq.class, emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq other = (emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.internal_static_PlayerStartMatchReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq build() {
        emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq buildPartial() {
        emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq result = new emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq other) {
        if (other == emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq();
    }

    public static emu.grasscutter.net.newproto.PlayerStartMatchReqOuterClass.PlayerStartMatchReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tch_param_list\030\003 \003(\rB\036\n\034emu.grasscutter." +
