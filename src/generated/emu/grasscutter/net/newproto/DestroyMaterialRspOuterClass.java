...
public final class DestroyMaterialRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.internal_static_DestroyMaterialRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.internal_static_DestroyMaterialRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.class, emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp other = (emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.internal_static_DestroyMaterialRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp build() {
        emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp buildPartial() {
        emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp result = new emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp other) {
        if (other == emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp();
    }

    public static emu.grasscutter.net.newproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp getDefaultInstance() {
