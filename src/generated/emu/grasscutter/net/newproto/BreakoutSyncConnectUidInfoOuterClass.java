...
public final class BreakoutSyncConnectUidInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.class, emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo other = (emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.internal_static_BreakoutSyncConnectUidInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo build() {
        emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo buildPartial() {
        emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo result = new emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo other) {
        if (other == emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    private static final emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo();
    }

    public static emu.grasscutter.net.newproto.BreakoutSyncConnectUidInfoOuterClass.BreakoutSyncConnectUidInfo getDefaultInstance() {
