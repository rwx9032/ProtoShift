...
public final class ReadMailNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.internal_static_ReadMailNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.internal_static_ReadMailNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify.class, emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify other = (emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.internal_static_ReadMailNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify build() {
        emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify buildPartial() {
        emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify result = new emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify other) {
        if (other == emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify();
    }

    public static emu.grasscutter.net.newproto.ReadMailNotifyOuterClass.ReadMailNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\024\n\014mail_id_list\030\007 \003(\rB\036\n\034emu.grasscutte" +
