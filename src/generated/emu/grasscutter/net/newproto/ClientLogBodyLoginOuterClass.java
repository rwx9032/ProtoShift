...
public final class ClientLogBodyLoginOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.internal_static_ClientLogBodyLogin_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.internal_static_ClientLogBodyLogin_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin.class, emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin other = (emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin) obj;
    ...
    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLoginOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.internal_static_ClientLogBodyLogin_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin build() {
        emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin buildPartial() {
        emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin result = new emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin) {
          return mergeFrom((emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin other) {
        if (other == emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin();
    }

    public static emu.grasscutter.net.newproto.ClientLogBodyLoginOuterClass.ClientLogBodyLogin getDefaultInstance() {
