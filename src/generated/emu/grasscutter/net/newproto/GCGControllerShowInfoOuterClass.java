...
public final class GCGControllerShowInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.internal_static_GCGControllerShowInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.internal_static_GCGControllerShowInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo.class, emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo other = (emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.internal_static_GCGControllerShowInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo build() {
        emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo buildPartial() {
        emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo result = new emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo other) {
        if (other == emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo();
    }

    public static emu.grasscutter.net.newproto.GCGControllerShowInfoOuterClass.GCGControllerShowInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "rofilePicture\022\025\n\rcontroller_id\030\013 \001(\rB\036\n\034" +
