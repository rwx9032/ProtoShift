...
public final class GCGMsgModifyRemoveOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.internal_static_GCGMsgModifyRemove_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.internal_static_GCGMsgModifyRemove_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove.class, emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove other = (emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemoveOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.internal_static_GCGMsgModifyRemove_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove build() {
        emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove buildPartial() {
        emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove result = new emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove other) {
        if (other == emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove();
    }

    public static emu.grasscutter.net.newproto.GCGMsgModifyRemoveOuterClass.GCGMsgModifyRemove getDefaultInstance() {
