...
public final class ExpeditionStartRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.class, emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp other = (emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp build() {
        emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp buildPartial() {
        emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp result = new emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp other) {
        if (other == emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp();
    }

    public static emu.grasscutter.net.newproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp getDefaultInstance() {
