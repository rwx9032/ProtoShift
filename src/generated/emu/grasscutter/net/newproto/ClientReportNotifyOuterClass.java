...
public final class ClientReportNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.internal_static_ClientReportNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.internal_static_ClientReportNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify.class, emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify other = (emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.internal_static_ClientReportNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify build() {
        emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify buildPartial() {
        emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify result = new emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify other) {
        if (other == emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify();
    }

    public static emu.grasscutter.net.newproto.ClientReportNotifyOuterClass.ClientReportNotify getDefaultInstance() {
