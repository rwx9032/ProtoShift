...
public final class ArenaChallengeActivityDetailInfoOuterClass {
  ...
  public interface ArenaChallengeActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel> 
        getLevelListList();
    /**
     * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
     */
    emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel getLevelList(int index);
    /**
     * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
     */
     ...
     * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevelOrBuilder> 
        getLevelListOrBuilderList();
    /**
     * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
     */
    emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevelOrBuilder getLevelListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.internal_static_ArenaChallengeActivityDetailInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.internal_static_ArenaChallengeActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo.class, emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo.Builder.class);
    }

    public static final int LEVEL_LIST_FIELD_NUMBER = 15;
    private java.util.List<emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel> levelList_;
    /**
     * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel> getLevelListList() {
      return levelList_;
    }
    /**
     * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevelOrBuilder> 
        getLevelListOrBuilderList() {
      return levelList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel getLevelList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevelOrBuilder getLevelListOrBuilder(
        int index) {
      return levelList_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.internal_static_ArenaChallengeActivityDetailInfo_LevelOpenTimeMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo other = (emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.internal_static_ArenaChallengeActivityDetailInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo build() {
        emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo buildPartial() {
        emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo result = new emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo other) {
        if (other == emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo.getDefaultInstance()) return this;
        if (levelListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 122: {
                emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.parser(),
                        extensionRegistry);
                if (levelListBuilder_ == null) {
                  ensureLevelListIsMutable();
                  levelList_.add(m);
      ...
      private void ensureLevelListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          levelList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel>(levelList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevelOrBuilder> levelListBuilder_;
      ...
      public Builder setLevelList(
          int index, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel value) {
        if (levelListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setLevelList(
          int index, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder builderForValue) {
        if (levelListBuilder_ == null) {
          ensureLevelListIsMutable();
       ...
       * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
       */
      public Builder addLevelList(emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel value) {
        if (levelListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addLevelList(
          emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder builderForValue) {
        if (levelListBuilder_ == null) {
          ensureLevelListIsMutable();
      ...
      public Builder addAllLevelList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel> values) {
        if (levelListBuilder_ == null) {
          ensureLevelListIsMutable();
       ...
       * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
       */
      public emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder getLevelListBuilder(
          int index) {
       ...
       * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
       */
      public emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder addLevelListBuilder() {
        return getLevelListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.getDefaultInstance());
      }
      /**
       * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
       */
      public emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder addLevelListBuilder(
          int index) {
        return getLevelListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.getDefaultInstance());
      }
      /**
       * <code>repeated .ArenaChallengeMonsterLevel level_list = 15;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder> 
           getLevelListBuilderList() {
        return getLevelListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevel.Builder, emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.ArenaChallengeMonsterLevelOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo();
    }

    public static emu.grasscutter.net.newproto.ArenaChallengeActivityDetailInfoOuterClass.ArenaChallengeActivityDetailInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.ArenaChallengeMonsterLevelOuterClass.getDescriptor(),
        });
    internal_static_ArenaChallengeActivityDetailInfo_descriptor =
