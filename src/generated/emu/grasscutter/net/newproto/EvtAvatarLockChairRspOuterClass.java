...
public final class EvtAvatarLockChairRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.internal_static_EvtAvatarLockChairRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.internal_static_EvtAvatarLockChairRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp.class, emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp other = (emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.internal_static_EvtAvatarLockChairRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp build() {
        emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp buildPartial() {
        emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp result = new emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp other) {
        if (other == emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp();
    }

    public static emu.grasscutter.net.newproto.EvtAvatarLockChairRspOuterClass.EvtAvatarLockChairRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\031\n\010position\030\017 \001(\0132\007.VectorB\036\n\034emu.gra" +
