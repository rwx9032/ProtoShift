...
public final class WidgetUpdateExtraCDReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.internal_static_WidgetUpdateExtraCDReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.internal_static_WidgetUpdateExtraCDReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq.class, emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq other = (emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq) obj;
    ...
    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.internal_static_WidgetUpdateExtraCDReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq build() {
        emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq buildPartial() {
        emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq result = new emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq) {
          return mergeFrom((emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq other) {
        if (other == emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq();
    }

    public static emu.grasscutter.net.newproto.WidgetUpdateExtraCDReqOuterClass.WidgetUpdateExtraCDReq getDefaultInstance() {
