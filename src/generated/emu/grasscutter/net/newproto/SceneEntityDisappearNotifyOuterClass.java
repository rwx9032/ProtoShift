...
public final class SceneEntityDisappearNotifyOuterClass {
  ...
  public interface SceneEntityDisappearNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType getDisappearType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.internal_static_SceneEntityDisappearNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.internal_static_SceneEntityDisappearNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.class, emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.Builder.class);
    }
     ...
     * @return The disappearType.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType getDisappearType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType result = emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType.valueOf(disappearType_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (disappearType_ != emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType.VISION_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify other = (emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.internal_static_SceneEntityDisappearNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify build() {
        emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify buildPartial() {
        emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify result = new emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify other) {
        if (other == emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.getDefaultInstance()) return this;
        if (other.getParam() != 0) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType getDisappearType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType result = emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType.valueOf(disappearType_);
        return result == null ? emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setDisappearType(emu.grasscutter.net.newproto.VisionTypeOuterClass.VisionType value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify();
    }

    public static emu.grasscutter.net.newproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\0162\013.VisionType\022\023\n\013entity_list\030\r \003(\rB\036\n\034e" +
