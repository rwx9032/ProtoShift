...
public final class ActivityWatcherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.class, emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo other = (emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo build() {
        emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo buildPartial() {
        emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo result = new emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo other) {
        if (other == emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo();
    }

    public static emu.grasscutter.net.newproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo getDefaultInstance() {
