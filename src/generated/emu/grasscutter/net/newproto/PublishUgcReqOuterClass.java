...
public final class PublishUgcReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PublishUgcReqOuterClass.internal_static_PublishUgcReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PublishUgcReqOuterClass.internal_static_PublishUgcReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq.class, emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq other = (emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq) obj;
    ...
    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PublishUgcReqOuterClass.internal_static_PublishUgcReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq build() {
        emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq buildPartial() {
        emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq result = new emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq) {
          return mergeFrom((emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq other) {
        if (other == emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq();
    }

    public static emu.grasscutter.net.newproto.PublishUgcReqOuterClass.PublishUgcReq getDefaultInstance() {
