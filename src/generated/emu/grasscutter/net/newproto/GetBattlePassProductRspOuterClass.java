...
public final class GetBattlePassProductRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.internal_static_GetBattlePassProductRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.internal_static_GetBattlePassProductRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp.class, emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp other = (emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.internal_static_GetBattlePassProductRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp build() {
        emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp buildPartial() {
        emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp result = new emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp other) {
        if (other == emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp();
    }

    public static emu.grasscutter.net.newproto.GetBattlePassProductRspOuterClass.GetBattlePassProductRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\t\022\017\n\007retcode\030\n \001(\005\022%\n\035battle_pass_pro" +
      "duct_play_type\030\017 \001(\rB\036\n\034emu.grasscutter." +
