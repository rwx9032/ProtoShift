...
public final class BreakoutPhysicalObjectModifierOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.class, emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier other = (emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier) obj;
    ...
    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifierOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.internal_static_BreakoutPhysicalObjectModifier_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier build() {
        emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier buildPartial() {
        emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier result = new emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier(this);
        result.type_ = type_;
        result.id_ = id_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier) {
          return mergeFrom((emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier other) {
        if (other == emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier.getDefaultInstance()) return this;
        if (other.getType() != 0) {
    ...
    private static final emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier();
    }

    public static emu.grasscutter.net.newproto.BreakoutPhysicalObjectModifierOuterClass.BreakoutPhysicalObjectModifier getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ose_player_count\030\020 \001(\rB\036\n\034emu.grasscutte" +
