...
public final class TaskVarOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TaskVarOuterClass.internal_static_TaskVar_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TaskVarOuterClass.internal_static_TaskVar_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar.class, emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar other = (emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar) obj;
    ...
    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVarOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TaskVarOuterClass.internal_static_TaskVar_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar build() {
        emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar buildPartial() {
        emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar result = new emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar) {
          return mergeFrom((emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar other) {
        if (other == emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar.getDefaultInstance()) return this;
        if (other.getKey() != 0) {
          setKey(other.getKey());
        }
    ...
    private static final emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar();
    }

    public static emu.grasscutter.net.newproto.TaskVarOuterClass.TaskVar getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\n\nvalue_list\030\007 \003(\005B\036\n\034emu.grasscutter.n" +
