...
public final class BattlePassScheduleOuterClass {
  ...
  public interface BattlePassScheduleOrBuilder extends
     ...
     * @return The curCycle.
     */
    emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle getCurCycle();
    /**
     * <code>.BattlePassCycle cur_cycle = 11;</code>
     */
    emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder getCurCycleOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus getUnlockStatus();
     ...
     */
    emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct getProductInfo();
    /**
     * <code>.BattlePassProduct product_info = 10;</code>
     */
    emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProductOrBuilder getProductInfoOrBuilder();
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> 
        getRewardTakenListList();
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
     */
    emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag getRewardTakenList(int index);
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
     */
     ...
     * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> 
        getRewardTakenListOrBuilderList();
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
     */
    emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder getRewardTakenListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.internal_static_BattlePassSchedule_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.internal_static_BattlePassSchedule_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule.class, emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle curCycle_;
    /**
     * <code>.BattlePassCycle cur_cycle = 11;</code>
     * @return Whether the curCycle field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle getCurCycle() {
      return curCycle_ == null ? emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.getDefaultInstance() : curCycle_;
    }
    /**
     * <code>.BattlePassCycle cur_cycle = 11;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder getCurCycleOrBuilder() {
      return getCurCycle();
    }
     ...
     * @return The unlockStatus.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus getUnlockStatus() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus result = emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.valueOf(unlockStatus_);
      return result == null ? emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.UNRECOGNIZED : result;
    }

    public static final int PRODUCT_INFO_FIELD_NUMBER = 10;
    private emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct productInfo_;
    /**
     * <code>.BattlePassProduct product_info = 10;</code>
     * @return Whether the productInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct getProductInfo() {
      return productInfo_ == null ? emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.getDefaultInstance() : productInfo_;
    }
    /**
     * <code>.BattlePassProduct product_info = 10;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProductOrBuilder getProductInfoOrBuilder() {
    ...
    private java.util.List<emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> rewardTakenList_;
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> getRewardTakenListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> 
        getRewardTakenListOrBuilderList() {
      return rewardTakenList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag getRewardTakenList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder getRewardTakenListOrBuilder(
        int index) {
      return rewardTakenList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule other = (emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule) obj;
    ...
    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(
    ...
    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassScheduleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.internal_static_BattlePassSchedule_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule build() {
        emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule buildPartial() {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule) {
          return mergeFrom((emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule other) {
        if (other == emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.parser(),
                        extensionRegistry);
                if (rewardTakenListBuilder_ == null) {
                  ensureRewardTakenListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle, emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.Builder, emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder> curCycleBuilder_;
      /**
       * <code>.BattlePassCycle cur_cycle = 11;</code>
       * @return Whether the curCycle field is set.
       */
       ...
       * <code>.BattlePassCycle cur_cycle = 11;</code>
       */
      public Builder setCurCycle(emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle value) {
        if (curCycleBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setCurCycle(
          emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.Builder builderForValue) {
        if (curCycleBuilder_ == null) {
       ...
       * <code>.BattlePassCycle cur_cycle = 11;</code>
       */
      public Builder mergeCurCycle(emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle value) {
        if (curCycleBuilder_ == null) {
          if (curCycle_ != null) {
            curCycle_ =
              emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.newBuilder(curCycle_).mergeFrom(value).buildPartial();
          } else {
            curCycle_ = value;
          }
          onChanged();
       ...
       * <code>.BattlePassCycle cur_cycle = 11;</code>
       */
      public emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.Builder getCurCycleBuilder() {
      ...
      public emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder getCurCycleOrBuilder() {
        if (curCycleBuilder_ != null) {
          ...
          return curCycle_ == null ?
              emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.getDefaultInstance() : curCycle_;
        }
      }
      /**
       * <code>.BattlePassCycle cur_cycle = 11;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle, emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycle.Builder, emu.grasscutter.net.newproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus getUnlockStatus() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus result = emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.valueOf(unlockStatus_);
        return result == null ? emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setUnlockStatus(emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct productInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct, emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.Builder, emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProductOrBuilder> productInfoBuilder_;
      /**
       * <code>.BattlePassProduct product_info = 10;</code>
       * @return Whether the productInfo field is set.
       */
       ...
       * <code>.BattlePassProduct product_info = 10;</code>
       */
      public Builder setProductInfo(emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct value) {
        if (productInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setProductInfo(
          emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.Builder builderForValue) {
        if (productInfoBuilder_ == null) {
       ...
       * <code>.BattlePassProduct product_info = 10;</code>
       */
      public Builder mergeProductInfo(emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct value) {
        if (productInfoBuilder_ == null) {
          if (productInfo_ != null) {
            productInfo_ =
              emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.newBuilder(productInfo_).mergeFrom(value).buildPartial();
          } else {
            productInfo_ = value;
          }
          onChanged();
       ...
       * <code>.BattlePassProduct product_info = 10;</code>
       */
      public emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.Builder getProductInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProductOrBuilder getProductInfoOrBuilder() {
        if (productInfoBuilder_ != null) {
          ...
          return productInfo_ == null ?
              emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.getDefaultInstance() : productInfo_;
        }
      }
      /**
       * <code>.BattlePassProduct product_info = 10;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct, emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProduct.Builder, emu.grasscutter.net.newproto.BattlePassProductOuterClass.BattlePassProductOrBuilder> 
      ...
      private void ensureRewardTakenListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          rewardTakenList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag>(rewardTakenList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag, emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder, emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> rewardTakenListBuilder_;
      ...
      public Builder setRewardTakenList(
          int index, emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag value) {
        if (rewardTakenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setRewardTakenList(
          int index, emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder builderForValue) {
        if (rewardTakenListBuilder_ == null) {
          ensureRewardTakenListIsMutable();
       ...
       * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
       */
      public Builder addRewardTakenList(emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag value) {
        if (rewardTakenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllRewardTakenList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> values) {
        if (rewardTakenListBuilder_ == null) {
          ensureRewardTakenListIsMutable();
       ...
       * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder getRewardTakenListBuilder(
          int index) {
       ...
       * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder addRewardTakenListBuilder() {
        return getRewardTakenListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.getDefaultInstance());
      }
      /**
       * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
       */
      public emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder addRewardTakenListBuilder(
          int index) {
        return getRewardTakenListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.getDefaultInstance());
      }
      /**
       * <code>repeated .BattlePassRewardTag reward_taken_list = 3;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder> 
    ...
    private static final emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule();
    }

    public static emu.grasscutter.net.newproto.BattlePassScheduleOuterClass.BattlePassSchedule getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.newproto.BattlePassUnlockStatusOuterClass.getDescriptor(),
        });
    internal_static_BattlePassSchedule_descriptor =
