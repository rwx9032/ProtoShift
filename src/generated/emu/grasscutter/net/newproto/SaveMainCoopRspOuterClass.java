...
public final class SaveMainCoopRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.internal_static_SaveMainCoopRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.internal_static_SaveMainCoopRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp.class, emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp other = (emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp) obj;
    ...
    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp parseFrom(
    ...
    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.internal_static_SaveMainCoopRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp build() {
        emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp buildPartial() {
        emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp result = new emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp) {
          return mergeFrom((emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp other) {
        if (other == emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
    ...
    private static final emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp();
    }

    public static emu.grasscutter.net.newproto.SaveMainCoopRspOuterClass.SaveMainCoopRsp getDefaultInstance() {
