...
public final class GCGZoneOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGZoneOuterClass.internal_static_GCGZone_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGZoneOuterClass.internal_static_GCGZone_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone.class, emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone other = (emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZoneOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGZoneOuterClass.internal_static_GCGZone_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone build() {
        emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone buildPartial() {
        emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone result = new emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone other) {
        if (other == emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone();
    }

    public static emu.grasscutter.net.newproto.GCGZoneOuterClass.GCGZone getDefaultInstance() {
