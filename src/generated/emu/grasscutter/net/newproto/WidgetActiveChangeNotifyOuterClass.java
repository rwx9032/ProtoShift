...
public final class WidgetActiveChangeNotifyOuterClass {
  ...
  public interface WidgetActiveChangeNotifyOrBuilder extends
     ...
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
    emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData getWidgetDataList(int index);
    /**
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
     ...
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
    emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotDataOrBuilder getWidgetDataListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.internal_static_WidgetActiveChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.internal_static_WidgetActiveChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.class, emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.Builder.class);
    }

    public static final int WIDGET_DATA_LIST_FIELD_NUMBER = 15;
    private java.util.List<emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData> widgetDataList_;
    /**
     * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData> getWidgetDataListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData getWidgetDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotDataOrBuilder getWidgetDataListOrBuilder(
        int index) {
      return widgetDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify other = (emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.internal_static_WidgetActiveChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify build() {
        emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify buildPartial() {
        emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify result = new emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify other) {
        if (other == emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify.getDefaultInstance()) return this;
        if (widgetDataListBuilder_ == null) {
      ...
      private void ensureWidgetDataListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          widgetDataList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData>(widgetDataList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData, emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData.Builder, emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotDataOrBuilder> widgetDataListBuilder_;
       ...
       * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
       */
      public Builder addWidgetDataList(emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData value) {
        if (widgetDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
       */
      public emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData.Builder getWidgetDataListBuilder(
          int index) {
       ...
       * <code>repeated .WidgetSlotData widget_data_list = 15;</code>
       */
      public emu.grasscutter.net.newproto.WidgetSlotDataOuterClass.WidgetSlotData.Builder addWidgetDataListBuilder() {
    ...
    private static final emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify();
    }

    public static emu.grasscutter.net.newproto.WidgetActiveChangeNotifyOuterClass.WidgetActiveChangeNotify getDefaultInstance() {
