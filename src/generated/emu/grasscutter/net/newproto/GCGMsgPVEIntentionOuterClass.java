...
public final class GCGMsgPVEIntentionOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.internal_static_GCGMsgPVEIntention_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.internal_static_GCGMsgPVEIntention_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention.class, emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention other = (emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntentionOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.internal_static_GCGMsgPVEIntention_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention build() {
        emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention buildPartial() {
        emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention result = new emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention other) {
        if (other == emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention();
    }

    public static emu.grasscutter.net.newproto.GCGMsgPVEIntentionOuterClass.GCGMsgPVEIntention getDefaultInstance() {
