...
public final class PotionDungeonResultInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.internal_static_PotionDungeonResultInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.internal_static_PotionDungeonResultInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo.class, emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo other = (emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.internal_static_PotionDungeonResultInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo build() {
        emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo buildPartial() {
        emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo result = new emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo other) {
        if (other == emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo();
    }

    public static emu.grasscutter.net.newproto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "iculty_level\030\010 \001(\rB\036\n\034emu.grasscutter.ne" +
