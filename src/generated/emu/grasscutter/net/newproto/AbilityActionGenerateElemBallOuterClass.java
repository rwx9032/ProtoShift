...
public final class AbilityActionGenerateElemBallOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.internal_static_AbilityActionGenerateElemBall_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.internal_static_AbilityActionGenerateElemBall_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall.class, emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall other = (emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall) obj;
    ...
    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBallOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.internal_static_AbilityActionGenerateElemBall_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall build() {
        emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall buildPartial() {
        emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall result = new emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall) {
          return mergeFrom((emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall other) {
        if (other == emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall();
    }

    public static emu.grasscutter.net.newproto.AbilityActionGenerateElemBallOuterClass.AbilityActionGenerateElemBall getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tor\022\024\n\003pos\030\016 \001(\0132\007.VectorB\036\n\034emu.grasscu" +
