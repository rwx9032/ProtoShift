...
public final class InBattleChessInfoOuterClass {
  ...
  public interface InBattleChessInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo getMysteryInfo();
    /**
     * <code>.ChessMysteryInfo mystery_info = 6;</code>
     */
    emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder();
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    getPlayerInfoMap();
    /**
     * <code>map&lt;uint32, .ChessPlayerInfo&gt; player_info_map = 15;</code>
     */
    ...
    /* nullable */
emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo defaultValue);
    /**
     * <code>map&lt;uint32, .ChessPlayerInfo&gt; player_info_map = 15;</code>
     */

    emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrThrow(
        int key);
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo> 
        getSelectedCardInfoListList();
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo getSelectedCardInfoList(int index);
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
     ...
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
        getSelectedCardInfoListOrBuilderList();
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder getSelectedCardInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo.class, emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo mysteryInfo_;
    /**
     * <code>.ChessMysteryInfo mystery_info = 6;</code>
     * @return Whether the mysteryInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo getMysteryInfo() {
      return mysteryInfo_ == null ? emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : mysteryInfo_;
    }
    /**
     * <code>.ChessMysteryInfo mystery_info = 6;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder() {
    ...
    private static final class PlayerInfoMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>newDefaultInstance(
                  emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_PlayerInfoMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> playerInfoMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getPlayerInfoMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getPlayerInfoMapMap() {
    ...
    public emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrDefault(
        int key,
        emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> map =
    ...
    public emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrThrow(
        int key) {
    ...
    private java.util.List<emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo> selectedCardInfoList_;
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo> getSelectedCardInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
        getSelectedCardInfoListOrBuilderList() {
      return selectedCardInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo getSelectedCardInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder getSelectedCardInfoListOrBuilder(
        int index) {
      return selectedCardInfoList_.get(index);
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> entry
           : internalGetPlayerInfoMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo other = (emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo build() {
        emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo buildPartial() {
        emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo result = new emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo other) {
        if (other == emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo.getDefaultInstance()) return this;
        if (other.getRound() != 0) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.parser(),
                        extensionRegistry);
                if (selectedCardInfoListBuilder_ == null) {
                  ensureSelectedCardInfoListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> mysteryInfoBuilder_;
      /**
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       * @return Whether the mysteryInfo field is set.
       */
       ...
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       */
      public Builder setMysteryInfo(emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (mysteryInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setMysteryInfo(
          emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder builderForValue) {
        if (mysteryInfoBuilder_ == null) {
       ...
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       */
      public Builder mergeMysteryInfo(emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (mysteryInfoBuilder_ == null) {
          if (mysteryInfo_ != null) {
            mysteryInfo_ =
              emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.newBuilder(mysteryInfo_).mergeFrom(value).buildPartial();
          } else {
            mysteryInfo_ = value;
          }
          onChanged();
       ...
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       */
      public emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder getMysteryInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder() {
        if (mysteryInfoBuilder_ != null) {
          ...
          return mysteryInfo_ == null ?
              emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : mysteryInfo_;
        }
      }
      /**
       * <code>.ChessMysteryInfo mystery_info = 6;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> 
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
      ...
      public Builder putPlayerInfoMap(
          int key,
          emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllPlayerInfoMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> values) {
        internalGetMutablePlayerInfoMap().getMutableMap()
            .putAll(values);
        return this;
      }
      ...
      private void ensureSelectedCardInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          selectedCardInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo>(selectedCardInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> selectedCardInfoListBuilder_;
      ...
      public Builder setSelectedCardInfoList(
          int index, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo value) {
        if (selectedCardInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setSelectedCardInfoList(
          int index, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder builderForValue) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public Builder addSelectedCardInfoList(emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo value) {
        if (selectedCardInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSelectedCardInfoList(
          emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder builderForValue) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
      ...
      public Builder addAllSelectedCardInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo> values) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder getSelectedCardInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder addSelectedCardInfoListBuilder() {
        return getSelectedCardInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder addSelectedCardInfoListBuilder(
          int index) {
        return getSelectedCardInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessCardInfo selected_card_info_list = 4;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder> 
           getSelectedCardInfoListBuilderList() {
        return getSelectedCardInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfo.Builder, emu.grasscutter.net.newproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo();
    }

    public static emu.grasscutter.net.newproto.InBattleChessInfoOuterClass.InBattleChessInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.ChessCardInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.ChessMysteryInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.ChessPlayerInfoOuterClass.getDescriptor(),
        });
    internal_static_InBattleChessInfo_descriptor =
