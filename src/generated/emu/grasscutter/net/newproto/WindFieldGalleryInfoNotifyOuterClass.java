...
public final class WindFieldGalleryInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.class, emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify other = (emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.internal_static_WindFieldGalleryInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify build() {
        emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify result = new emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify();
    }

    public static emu.grasscutter.net.newproto.WindFieldGalleryInfoNotifyOuterClass.WindFieldGalleryInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "GLNHBJJJINK\030\002 \001(\rB\036\n\034emu.grasscutter.net" +
      ".newprotob\006proto3"
    };
