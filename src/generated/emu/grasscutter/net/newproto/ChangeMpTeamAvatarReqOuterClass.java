...
public final class ChangeMpTeamAvatarReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.internal_static_ChangeMpTeamAvatarReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.internal_static_ChangeMpTeamAvatarReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq.class, emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq other = (emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq) obj;
    ...
    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.internal_static_ChangeMpTeamAvatarReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq build() {
        emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq buildPartial() {
        emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq result = new emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq) {
          return mergeFrom((emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq other) {
        if (other == emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq();
    }

    public static emu.grasscutter.net.newproto.ChangeMpTeamAvatarReqOuterClass.ChangeMpTeamAvatarReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\n\020avatar_guid_list\030\016 \003(\004B\036\n\034emu.grasscu" +
