...
public final class GCGOperationOnStageSelectOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.internal_static_GCGOperationOnStageSelect_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.internal_static_GCGOperationOnStageSelect_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.class, emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect other = (emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelectOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.internal_static_GCGOperationOnStageSelect_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect build() {
        emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect buildPartial() {
        emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect result = new emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect other) {
        if (other == emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect();
    }

    public static emu.grasscutter.net.newproto.GCGOperationOnStageSelectOuterClass.GCGOperationOnStageSelect getDefaultInstance() {
