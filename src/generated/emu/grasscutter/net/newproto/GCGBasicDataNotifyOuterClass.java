...
public final class GCGBasicDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.internal_static_GCGBasicDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.internal_static_GCGBasicDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify.class, emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify other = (emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.internal_static_GCGBasicDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify build() {
        emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify buildPartial() {
        emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify result = new emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify other) {
        if (other == emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify.getDefaultInstance()) return this;
        if (other.getLevel() != 0) {
    ...
    private static final emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify();
    }

    public static emu.grasscutter.net.newproto.GCGBasicDataNotifyOuterClass.GCGBasicDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "level_reward_taken_list\030\016 \003(\rB\036\n\034emu.gra" +
