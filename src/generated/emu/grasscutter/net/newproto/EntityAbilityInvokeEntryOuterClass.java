...
public final class EntityAbilityInvokeEntryOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.internal_static_EntityAbilityInvokeEntry_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.internal_static_EntityAbilityInvokeEntry_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry.class, emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry other = (emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry) obj;
    ...
    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry parseFrom(
    ...
    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntryOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.internal_static_EntityAbilityInvokeEntry_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry build() {
        emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry buildPartial() {
        emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry result = new emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry) {
          return mergeFrom((emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry other) {
        if (other == emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry.getDefaultInstance()) return this;
        if (invokesBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry();
    }

    public static emu.grasscutter.net.newproto.EntityAbilityInvokeEntryOuterClass.EntityAbilityInvokeEntry getDefaultInstance() {
