...
public final class CharAmusementAvatarInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.internal_static_CharAmusementAvatarInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.internal_static_CharAmusementAvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.class, emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo other = (emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.internal_static_CharAmusementAvatarInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo build() {
        emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo buildPartial() {
        emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo result = new emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo other) {
        if (other == emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
    ...
    private static final emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo();
    }

    public static emu.grasscutter.net.newproto.CharAmusementAvatarInfoOuterClass.CharAmusementAvatarInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "r_id_list\030\004 \003(\r\022\023\n\013punish_time\030\005 \001(\rB\036\n\034" +
