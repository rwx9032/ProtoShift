...
emu.grasscutter.net.newproto.PropValueOuterClass.PropValue defaultValue);
     ...
     */
    emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo getTrialAvatarInfo();
    /**
     * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
     */
    emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder getTrialAvatarInfoOrBuilder();
     ...
     */
    @java.lang.Deprecated
    java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
    getSkillMap();
    /**
     * <code>map&lt;uint32, .AvatarSkillInfo&gt; skill_map = 10;</code>
     */
    ...
    /* nullable */
emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo defaultValue);
    /**
     * <code>map&lt;uint32, .AvatarSkillInfo&gt; skill_map = 10;</code>
     */

    emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrThrow(
        int key);
     ...
     */
    emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo getFetterInfo();
    /**
     * <code>.AvatarFetterInfo fetter_info = 12;</code>
     */
    emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder getFetterInfoOrBuilder();
     ...
     */
    emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState getExpeditionState();
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> 
        getEquipAffixListList();
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo getEquipAffixList(int index);
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
     ...
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> 
        getEquipAffixListOrBuilderList();
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder getEquipAffixListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo getExcelInfo();
    /**
     * <code>.AvatarExcelInfo excel_info = 26;</code>
     */
    emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder getExcelInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo.class, emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.newproto.PropValueOuterClass.PropValue> defaultEntry =
              ...
              .<java.lang.Integer, emu.grasscutter.net.newproto.PropValueOuterClass.PropValue>newDefaultInstance(
                  emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_PropMapEntry_descriptor, 
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Float> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Float>newDefaultInstance(
                  emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_FightPropMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
    ...
    private emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo trialAvatarInfo_;
    /**
     * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
     * @return Whether the trialAvatarInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo getTrialAvatarInfo() {
      return trialAvatarInfo_ == null ? emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance() : trialAvatarInfo_;
    }
    /**
     * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder getTrialAvatarInfoOrBuilder() {
    ...
    private static final class SkillMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>newDefaultInstance(
                  emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_SkillMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> skillMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
    internalGetSkillMap() {
      if (skillMap_ == null) {
        return com.google.protobuf.MapField.emptyMapField(
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> getSkillMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> getSkillMapMap() {
    ...
    public emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrDefault(
        int key,
        emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> map =
    ...
    public emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getSkillMapOrThrow(
        int key) {
    ...
    private emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo fetterInfo_;
    /**
     * <code>.AvatarFetterInfo fetter_info = 12;</code>
     * @return Whether the fetterInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo getFetterInfo() {
      return fetterInfo_ == null ? emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance() : fetterInfo_;
    }
    /**
     * <code>.AvatarFetterInfo fetter_info = 12;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder getFetterInfoOrBuilder() {
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_SkillLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
     ...
     * @return The expeditionState.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState getExpeditionState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState result = emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.valueOf(expeditionState_);
      return result == null ? emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.UNRECOGNIZED : result;
    }
    ...
    private static final class ProudSkillExtraLevelMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_ProudSkillExtraLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    private java.util.List<emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> equipAffixList_;
    /**
     * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> getEquipAffixListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> 
        getEquipAffixListOrBuilderList() {
      return equipAffixList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo getEquipAffixList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder getEquipAffixListOrBuilder(
        int index) {
      return equipAffixList_.get(index);
    }
    ...
    private emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo excelInfo_;
    /**
     * <code>.AvatarExcelInfo excel_info = 26;</code>
     * @return Whether the excelInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo getExcelInfo() {
      return excelInfo_ == null ? emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance() : excelInfo_;
    }
    /**
     * <code>.AvatarExcelInfo excel_info = 26;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder getExcelInfoOrBuilder() {
      return getExcelInfo();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      com.google.protobuf.GeneratedMessageV3
        .serializeIntegerMapTo(
          ...
          SkillLevelMapDefaultEntryHolder.defaultEntry,
          15);
      if (expeditionState_ != emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.AVATAR_EXPEDITION_STATE_NONE.getNumber()) {
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> entry
           : internalGetSkillMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo other = (emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.AvatarInfoOuterClass.internal_static_AvatarInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo build() {
        emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo buildPartial() {
        emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo result = new emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo other) {
        if (other == emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 178: {
                emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.parser(),
                        extensionRegistry);
                if (equipAffixListBuilder_ == null) {
                  ensureEquipAffixListIsMutable();
  ...
  throw new NullPointerException("map value");
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo, emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder, emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder> trialAvatarInfoBuilder_;
      /**
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       * @return Whether the trialAvatarInfo field is set.
       */
       ...
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      public Builder setTrialAvatarInfo(emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo value) {
        if (trialAvatarInfoBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setTrialAvatarInfo(
          emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder builderForValue) {
        if (trialAvatarInfoBuilder_ == null) {
       ...
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      public Builder mergeTrialAvatarInfo(emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo value) {
        if (trialAvatarInfoBuilder_ == null) {
          if (trialAvatarInfo_ != null) {
            trialAvatarInfo_ =
              emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.newBuilder(trialAvatarInfo_).mergeFrom(value).buildPartial();
          } else {
            trialAvatarInfo_ = value;
          }
          onChanged();
       ...
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      public emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder getTrialAvatarInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder getTrialAvatarInfoOrBuilder() {
        if (trialAvatarInfoBuilder_ != null) {
          ...
          return trialAvatarInfo_ == null ?
              emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance() : trialAvatarInfo_;
        }
      }
      /**
       * <code>.TrialAvatarInfo trial_avatar_info = 9;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo, emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder, emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder> 
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo>
      getMutableSkillMap() {
      ...
      public Builder putSkillMap(
          int key,
          emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllSkillMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.AvatarSkillInfo> values) {
        internalGetMutableSkillMap().getMutableMap()
            .putAll(values);
        return this;
      }
      ...
      private emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo fetterInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo, emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder, emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder> fetterInfoBuilder_;
      /**
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       * @return Whether the fetterInfo field is set.
       */
       ...
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      public Builder setFetterInfo(emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo value) {
        if (fetterInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setFetterInfo(
          emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder builderForValue) {
        if (fetterInfoBuilder_ == null) {
       ...
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      public Builder mergeFetterInfo(emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo value) {
        if (fetterInfoBuilder_ == null) {
          if (fetterInfo_ != null) {
            fetterInfo_ =
              emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.newBuilder(fetterInfo_).mergeFrom(value).buildPartial();
          } else {
            fetterInfo_ = value;
          }
          onChanged();
       ...
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      public emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder getFetterInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder getFetterInfoOrBuilder() {
        if (fetterInfoBuilder_ != null) {
          ...
          return fetterInfo_ == null ?
              emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance() : fetterInfo_;
        }
      }
      /**
       * <code>.AvatarFetterInfo fetter_info = 12;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo, emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder, emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState getExpeditionState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState result = emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.valueOf(expeditionState_);
        return result == null ? emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setExpeditionState(emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.AvatarExpeditionState value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private void ensureEquipAffixListIsMutable() {
        if (!((bitField0_ & 0x00000200) != 0)) {
          equipAffixList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo>(equipAffixList_);
          bitField0_ |= 0x00000200;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> equipAffixListBuilder_;
      ...
      public Builder setEquipAffixList(
          int index, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo value) {
        if (equipAffixListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setEquipAffixList(
          int index, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder builderForValue) {
        if (equipAffixListBuilder_ == null) {
          ensureEquipAffixListIsMutable();
       ...
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public Builder addEquipAffixList(emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo value) {
        if (equipAffixListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addEquipAffixList(
          emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder builderForValue) {
        if (equipAffixListBuilder_ == null) {
          ensureEquipAffixListIsMutable();
      ...
      public Builder addAllEquipAffixList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo> values) {
        if (equipAffixListBuilder_ == null) {
          ensureEquipAffixListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder getEquipAffixListBuilder(
          int index) {
       ...
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder addEquipAffixListBuilder() {
        return getEquipAffixListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder addEquipAffixListBuilder(
          int index) {
        return getEquipAffixListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AvatarEquipAffixInfo equip_affix_list = 22;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder> 
           getEquipAffixListBuilderList() {
        return getEquipAffixListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfo.Builder, emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.AvatarEquipAffixInfoOrBuilder> 
      ...
      private emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo excelInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo, emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder, emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder> excelInfoBuilder_;
      /**
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       * @return Whether the excelInfo field is set.
       */
       ...
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      public Builder setExcelInfo(emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo value) {
        if (excelInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setExcelInfo(
          emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder builderForValue) {
        if (excelInfoBuilder_ == null) {
       ...
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      public Builder mergeExcelInfo(emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo value) {
        if (excelInfoBuilder_ == null) {
          if (excelInfo_ != null) {
            excelInfo_ =
              emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.newBuilder(excelInfo_).mergeFrom(value).buildPartial();
          } else {
            excelInfo_ = value;
          }
          onChanged();
       ...
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      public emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder getExcelInfoBuilder() {
      ...
      public emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder getExcelInfoOrBuilder() {
        if (excelInfoBuilder_ != null) {
          ...
          return excelInfo_ == null ?
              emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.getDefaultInstance() : excelInfo_;
        }
      }
      /**
       * <code>.AvatarExcelInfo excel_info = 26;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo, emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfo.Builder, emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.AvatarExcelInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo();
    }

    public static emu.grasscutter.net.newproto.AvatarInfoOuterClass.AvatarInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.AvatarEquipAffixInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.AvatarExcelInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.AvatarExpeditionStateOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.AvatarFetterInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.AvatarSkillInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.PropValueOuterClass.getDescriptor(),
          emu.grasscutter.net.newproto.TrialAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_AvatarInfo_descriptor =
