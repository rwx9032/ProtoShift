...
public final class GCGBossChallengeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.class, emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData other = (emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData) obj;
    ...
    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData build() {
        emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData buildPartial() {
        emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result = new emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData) {
          return mergeFrom((emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData other) {
        if (other == emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData();
    }

    public static emu.grasscutter.net.newproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData getDefaultInstance() {
