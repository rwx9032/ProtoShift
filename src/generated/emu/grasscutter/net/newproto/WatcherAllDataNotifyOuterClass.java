...
public final class WatcherAllDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.internal_static_WatcherAllDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.internal_static_WatcherAllDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify.class, emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify other = (emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.internal_static_WatcherAllDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify build() {
        emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify buildPartial() {
        emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify result = new emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify other) {
        if (other == emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify();
    }

    public static emu.grasscutter.net.newproto.WatcherAllDataNotifyOuterClass.WatcherAllDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "llDataNotify\022\024\n\014watcher_list\030\r \003(\rB\036\n\034em" +
