...
public final class TriggerRoguelikeCurseNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.internal_static_TriggerRoguelikeCurseNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.internal_static_TriggerRoguelikeCurseNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.class, emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify other = (emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.internal_static_TriggerRoguelikeCurseNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify build() {
        emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify buildPartial() {
        emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify result = new emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify other) {
        if (other == emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify();
    }

    public static emu.grasscutter.net.newproto.TriggerRoguelikeCurseNotifyOuterClass.TriggerRoguelikeCurseNotify getDefaultInstance() {
