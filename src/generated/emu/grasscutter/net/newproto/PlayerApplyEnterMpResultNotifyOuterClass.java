...
public final class PlayerApplyEnterMpResultNotifyOuterClass {
  ...
  public interface PlayerApplyEnterMpResultNotifyOrBuilder extends
     ...
     * @return The reason.
     */
    emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason getReason();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.internal_static_PlayerApplyEnterMpResultNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.internal_static_PlayerApplyEnterMpResultNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.class, emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Builder.class);
    }
    ...
    public enum Reason
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The reason.
     */
    @java.lang.Override public emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason getReason() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason result = emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.valueOf(reason_);
      return result == null ? emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (reason_ != emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.REASON_PLAYER_JUDGE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify other = (emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.internal_static_PlayerApplyEnterMpResultNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify build() {
        emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify buildPartial() {
        emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify result = new emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify other) {
        if (other == emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.getDefaultInstance()) return this;
        if (other.reason_ != 0) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason getReason() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason result = emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.valueOf(reason_);
        return result == null ? emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify.Reason value) {
        if (value == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify();
    }

    public static emu.grasscutter.net.newproto.PlayerApplyEnterMpResultNotifyOuterClass.PlayerApplyEnterMpResultNotify getDefaultInstance() {
