...
public final class DelTeamEntityNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.internal_static_DelTeamEntityNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.internal_static_DelTeamEntityNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify.class, emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify other = (emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.internal_static_DelTeamEntityNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify build() {
        emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify buildPartial() {
        emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify result = new emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify other) {
        if (other == emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify();
    }

    public static emu.grasscutter.net.newproto.DelTeamEntityNotifyOuterClass.DelTeamEntityNotify getDefaultInstance() {
