...
public final class UgcNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.UgcNotifyOuterClass.internal_static_UgcNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.UgcNotifyOuterClass.internal_static_UgcNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify.class, emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify other = (emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.UgcNotifyOuterClass.internal_static_UgcNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify build() {
        emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify buildPartial() {
        emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify result = new emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify other) {
        if (other == emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify();
    }

    public static emu.grasscutter.net.newproto.UgcNotifyOuterClass.UgcNotify getDefaultInstance() {
