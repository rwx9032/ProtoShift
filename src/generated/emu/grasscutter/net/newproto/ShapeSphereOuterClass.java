...
public final class ShapeSphereOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ShapeSphereOuterClass.internal_static_ShapeSphere_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ShapeSphereOuterClass.internal_static_ShapeSphere_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere.class, emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere other = (emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere) obj;
    ...
    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphereOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ShapeSphereOuterClass.internal_static_ShapeSphere_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere build() {
        emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere buildPartial() {
        emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere result = new emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere(this);
        if (centerBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere) {
          return mergeFrom((emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere other) {
        if (other == emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere.getDefaultInstance()) return this;
        if (other.hasCenter()) {
    ...
    private static final emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere();
    }

    public static emu.grasscutter.net.newproto.ShapeSphereOuterClass.ShapeSphere getDefaultInstance() {
