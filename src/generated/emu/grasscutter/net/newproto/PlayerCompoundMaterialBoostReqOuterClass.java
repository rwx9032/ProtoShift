...
public final class PlayerCompoundMaterialBoostReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.internal_static_PlayerCompoundMaterialBoostReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.internal_static_PlayerCompoundMaterialBoostReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq.class, emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq other = (emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq) obj;
    ...
    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq parseFrom(
    ...
    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.internal_static_PlayerCompoundMaterialBoostReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq build() {
        emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq buildPartial() {
        emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq result = new emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq) {
          return mergeFrom((emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq other) {
        if (other == emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq();
    }

    public static emu.grasscutter.net.newproto.PlayerCompoundMaterialBoostReqOuterClass.PlayerCompoundMaterialBoostReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "3300_FEGPHHFLFLM\030\013 \001(\rB\036\n\034emu.grasscutte" +
