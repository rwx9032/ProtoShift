...
public final class FungusFighterTrainingInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.internal_static_FungusFighterTrainingInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.internal_static_FungusFighterTrainingInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify.class, emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify other = (emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify) obj;
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.internal_static_FungusFighterTrainingInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify build() {
        emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify buildPartial() {
        emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify result = new emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify) {
          return mergeFrom((emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify other) {
        if (other == emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify();
    }

    public static emu.grasscutter.net.newproto.FungusFighterTrainingInfoNotifyOuterClass.FungusFighterTrainingInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\021max_monster_count\030\t \001(\rB\036\n\034emu.grasscut" +
