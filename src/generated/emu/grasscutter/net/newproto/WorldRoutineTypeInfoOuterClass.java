...
public final class WorldRoutineTypeInfoOuterClass {
  ...
  public interface WorldRoutineTypeInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo> 
        getWorldRoutineInfoListList();
    /**
     * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
     */
    emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo getWorldRoutineInfoList(int index);
    /**
     * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
     */
     ...
     * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
     */
    java.util.List<? extends emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfoOrBuilder> 
        getWorldRoutineInfoListOrBuilderList();
    /**
     * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
     */
    emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfoOrBuilder getWorldRoutineInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.internal_static_WorldRoutineTypeInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.internal_static_WorldRoutineTypeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo.class, emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo> worldRoutineInfoList_;
    /**
     * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo> getWorldRoutineInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfoOrBuilder> 
        getWorldRoutineInfoListOrBuilderList() {
      return worldRoutineInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo getWorldRoutineInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfoOrBuilder getWorldRoutineInfoListOrBuilder(
        int index) {
      return worldRoutineInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo other = (emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.internal_static_WorldRoutineTypeInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo build() {
        emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo buildPartial() {
        emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo result = new emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo other) {
        if (other == emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 82: {
                emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo m =
                    input.readMessage(
                        emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.parser(),
                        extensionRegistry);
                if (worldRoutineInfoListBuilder_ == null) {
                  ensureWorldRoutineInfoListIsMutable();
      ...
      private void ensureWorldRoutineInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          worldRoutineInfoList_ = new java.util.ArrayList<emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo>(worldRoutineInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfoOrBuilder> worldRoutineInfoListBuilder_;
      ...
      public Builder setWorldRoutineInfoList(
          int index, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo value) {
        if (worldRoutineInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setWorldRoutineInfoList(
          int index, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder builderForValue) {
        if (worldRoutineInfoListBuilder_ == null) {
          ensureWorldRoutineInfoListIsMutable();
       ...
       * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
       */
      public Builder addWorldRoutineInfoList(emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo value) {
        if (worldRoutineInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addWorldRoutineInfoList(
          emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder builderForValue) {
        if (worldRoutineInfoListBuilder_ == null) {
          ensureWorldRoutineInfoListIsMutable();
      ...
      public Builder addAllWorldRoutineInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo> values) {
        if (worldRoutineInfoListBuilder_ == null) {
          ensureWorldRoutineInfoListIsMutable();
       ...
       * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
       */
      public emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder getWorldRoutineInfoListBuilder(
          int index) {
       ...
       * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
       */
      public emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder addWorldRoutineInfoListBuilder() {
        return getWorldRoutineInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
       */
      public emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder addWorldRoutineInfoListBuilder(
          int index) {
        return getWorldRoutineInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .WorldRoutineInfo world_routine_info_list = 10;</code>
       */
      public java.util.List<emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder> 
           getWorldRoutineInfoListBuilderList() {
        return getWorldRoutineInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfo.Builder, emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.WorldRoutineInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo();
    }

    public static emu.grasscutter.net.newproto.WorldRoutineTypeInfoOuterClass.WorldRoutineTypeInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "outine_type\030\002 \001(\rB\036\n\034emu.grasscutter.net" +
      ".newprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.newproto.WorldRoutineInfoOuterClass.getDescriptor(),
        });
    internal_static_WorldRoutineTypeInfo_descriptor =
