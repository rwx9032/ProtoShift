...
public final class ArenaChallengeChildChallengeInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.internal_static_ArenaChallengeChildChallengeInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.internal_static_ArenaChallengeChildChallengeInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo.class, emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo other = (emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo) obj;
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo parseFrom(
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.internal_static_ArenaChallengeChildChallengeInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo build() {
        emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo buildPartial() {
        emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo result = new emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo) {
          return mergeFrom((emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo other) {
        if (other == emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo();
    }

    public static emu.grasscutter.net.newproto.ArenaChallengeChildChallengeInfoOuterClass.ArenaChallengeChildChallengeInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ed\030\002 \001(\010\022\022\n\nis_success\030\016 \001(\010B\036\n\034emu.gras" +
