...
public final class GachaInfoOuterClass {
  ...
  public interface GachaInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo> 
        getGachaUpInfoListList();
    /**
     * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
     */
    emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo getGachaUpInfoList(int index);
    /**
     * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
     */
     ...
     * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfoOrBuilder> 
        getGachaUpInfoListOrBuilderList();
    /**
     * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
     */
    emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfoOrBuilder getGachaUpInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GachaInfoOuterClass.internal_static_GachaInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GachaInfoOuterClass.internal_static_GachaInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo.class, emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo> gachaUpInfoList_;
    /**
     * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo> getGachaUpInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfoOrBuilder> 
        getGachaUpInfoListOrBuilderList() {
      return gachaUpInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo getGachaUpInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfoOrBuilder getGachaUpInfoListOrBuilder(
        int index) {
      return gachaUpInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo other = (emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GachaInfoOuterClass.internal_static_GachaInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo build() {
        emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo buildPartial() {
        emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo result = new emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo other) {
        if (other == emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 9866: {
                emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.parser(),
                        extensionRegistry);
                if (gachaUpInfoListBuilder_ == null) {
                  ensureGachaUpInfoListIsMutable();
      ...
      private void ensureGachaUpInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          gachaUpInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo>(gachaUpInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfoOrBuilder> gachaUpInfoListBuilder_;
      ...
      public Builder setGachaUpInfoList(
          int index, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo value) {
        if (gachaUpInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setGachaUpInfoList(
          int index, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder builderForValue) {
        if (gachaUpInfoListBuilder_ == null) {
          ensureGachaUpInfoListIsMutable();
       ...
       * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
       */
      public Builder addGachaUpInfoList(emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo value) {
        if (gachaUpInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addGachaUpInfoList(
          emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder builderForValue) {
        if (gachaUpInfoListBuilder_ == null) {
          ensureGachaUpInfoListIsMutable();
      ...
      public Builder addAllGachaUpInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo> values) {
        if (gachaUpInfoListBuilder_ == null) {
          ensureGachaUpInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
       */
      public emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder getGachaUpInfoListBuilder(
          int index) {
       ...
       * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
       */
      public emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder addGachaUpInfoListBuilder() {
        return getGachaUpInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
       */
      public emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder addGachaUpInfoListBuilder(
          int index) {
        return getGachaUpInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaUpInfo gacha_up_info_list = 1233;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder> 
           getGachaUpInfoListBuilderList() {
        return getGachaUpInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfo.Builder, emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.GachaUpInfoOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo();
    }

    public static emu.grasscutter.net.oldproto.GachaInfoOuterClass.GachaInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\007 \001(\r\022\030\n\020gacha_record_url\030\014 \001(\tB\036\n\034emu." +
      "grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.GachaUpInfoOuterClass.getDescriptor(),
        });
    internal_static_GachaInfo_descriptor =
