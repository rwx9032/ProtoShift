...
public final class ChallengeRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.internal_static_ChallengeRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.internal_static_ChallengeRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord.class, emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord other = (emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.internal_static_ChallengeRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord build() {
        emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord buildPartial() {
        emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord result = new emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord other) {
        if (other == emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord();
    }

    public static emu.grasscutter.net.oldproto.ChallengeRecordOuterClass.ChallengeRecord getDefaultInstance() {
