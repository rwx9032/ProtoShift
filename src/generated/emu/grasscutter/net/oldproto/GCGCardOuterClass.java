...
public final class GCGCardOuterClass {
  ...
  public interface GCGCardOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken> 
        getTokenListList();
    /**
     * <code>repeated .GCGToken token_list = 2;</code>
     */
    emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken getTokenList(int index);
    /**
     * <code>repeated .GCGToken token_list = 2;</code>
     */
     ...
     * <code>repeated .GCGToken token_list = 2;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
        getTokenListOrBuilderList();
    /**
     * <code>repeated .GCGToken token_list = 2;</code>
     */
    emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder getTokenListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGCardOuterClass.internal_static_GCGCard_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGCardOuterClass.internal_static_GCGCard_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard.class, emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken> tokenList_;
    /**
     * <code>repeated .GCGToken token_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken> getTokenListList() {
      return tokenList_;
    }
    /**
     * <code>repeated .GCGToken token_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
        getTokenListOrBuilderList() {
      return tokenList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken getTokenList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder getTokenListOrBuilder(
        int index) {
      return tokenList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard other = (emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCardOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGCardOuterClass.internal_static_GCGCard_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard build() {
        emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard buildPartial() {
        emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard result = new emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard other) {
        if (other == emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard.getDefaultInstance()) return this;
        if (other.getGuid() != 0) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 18: {
                emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.parser(),
                        extensionRegistry);
                if (tokenListBuilder_ == null) {
                  ensureTokenListIsMutable();
                  tokenList_.add(m);
      ...
      private void ensureTokenListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          tokenList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken>(tokenList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> tokenListBuilder_;
      ...
      public Builder setTokenList(
          int index, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken value) {
        if (tokenListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTokenList(
          int index, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder builderForValue) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
       ...
       * <code>repeated .GCGToken token_list = 2;</code>
       */
      public Builder addTokenList(emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken value) {
        if (tokenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTokenList(
          emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder builderForValue) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
      ...
      public Builder addAllTokenList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken> values) {
        if (tokenListBuilder_ == null) {
          ensureTokenListIsMutable();
       ...
       * <code>repeated .GCGToken token_list = 2;</code>
       */
      public emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder getTokenListBuilder(
          int index) {
       ...
       * <code>repeated .GCGToken token_list = 2;</code>
       */
      public emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder addTokenListBuilder() {
        return getTokenListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGToken token_list = 2;</code>
       */
      public emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder addTokenListBuilder(
          int index) {
        return getTokenListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGToken token_list = 2;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder> 
           getTokenListBuilderList() {
        return getTokenListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGToken.Builder, emu.grasscutter.net.oldproto.GCGTokenOuterClass.GCGTokenOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard();
    }

    public static emu.grasscutter.net.oldproto.GCGCardOuterClass.GCGCard getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\tface_type\030\005 \001(\rB\036\n\034emu.grasscutter.net" +
      ".oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.GCGTokenOuterClass.getDescriptor(),
        });
    internal_static_GCGCard_descriptor =
