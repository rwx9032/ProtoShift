...
public final class GetShopmallDataRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.internal_static_GetShopmallDataRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.internal_static_GetShopmallDataRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp.class, emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp other = (emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.internal_static_GetShopmallDataRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp build() {
        emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp buildPartial() {
        emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp result = new emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp other) {
        if (other == emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp();
    }

    public static emu.grasscutter.net.oldproto.GetShopmallDataRspOuterClass.GetShopmallDataRsp getDefaultInstance() {
