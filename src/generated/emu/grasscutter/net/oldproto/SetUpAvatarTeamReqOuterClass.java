...
public final class SetUpAvatarTeamReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.internal_static_SetUpAvatarTeamReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.internal_static_SetUpAvatarTeamReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.class, emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq other = (emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.internal_static_SetUpAvatarTeamReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq build() {
        emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq buildPartial() {
        emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq result = new emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq other) {
        if (other == emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq();
    }

    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamReqOuterClass.SetUpAvatarTeamReq getDefaultInstance() {
