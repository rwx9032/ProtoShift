...
public final class SaveUgcRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.internal_static_SaveUgcRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.internal_static_SaveUgcRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp.class, emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp other = (emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.internal_static_SaveUgcRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp build() {
        emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp buildPartial() {
        emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp result = new emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp other) {
        if (other == emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp();
    }

    public static emu.grasscutter.net.oldproto.SaveUgcRspOuterClass.SaveUgcRsp getDefaultInstance() {
