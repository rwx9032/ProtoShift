...
public final class MultistageSettleWatcherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.internal_static_MultistageSettleWatcherInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.internal_static_MultistageSettleWatcherInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.class, emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo other = (emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.internal_static_MultistageSettleWatcherInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo build() {
        emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo buildPartial() {
        emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo result = new emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo other) {
        if (other == emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo();
    }

    public static emu.grasscutter.net.oldproto.MultistageSettleWatcherInfoOuterClass.MultistageSettleWatcherInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "her_id\030\007 \001(\r\022\022\n\nis_inverse\030\014 \001(\010B\036\n\034emu." +
