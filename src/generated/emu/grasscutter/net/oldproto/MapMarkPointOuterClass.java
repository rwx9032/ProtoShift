...
public final class MapMarkPointOuterClass {
  ...
  public interface MapMarkPointOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType getPointType();
     ...
     * @return The fromType.
     */
    emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType getFromType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MapMarkPointOuterClass.internal_static_MapMarkPoint_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MapMarkPointOuterClass.internal_static_MapMarkPoint_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint.class, emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint.Builder.class);
    }
     ...
     * @return The pointType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType getPointType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType result = emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType.valueOf(pointType_);
      return result == null ? emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType.UNRECOGNIZED : result;
    }
     ...
     * @return The fromType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType getFromType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType result = emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType.valueOf(fromType_);
      return result == null ? emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (pointType_ != emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType.MAP_MARK_POINT_TYPE_NPC.getNumber()) {
        output.writeEnum(4, pointType_);
      }
      if (monsterId_ != 0) {
        output.writeUInt32(5, monsterId_);
      }
      if (fromType_ != emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType.MAP_MARK_FROM_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint other = (emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint) obj;
    ...
    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPointOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MapMarkPointOuterClass.internal_static_MapMarkPoint_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint build() {
        emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint buildPartial() {
        emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint result = new emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint) {
          return mergeFrom((emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint other) {
        if (other == emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType getPointType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType result = emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType.valueOf(pointType_);
        return result == null ? emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setPointType(emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.MapMarkPointType value) {
        if (value == null) {
          throw new NullPointerException();
        }
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType getFromType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType result = emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType.valueOf(fromType_);
        return result == null ? emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setFromType(emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.MapMarkFromType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint();
    }

    public static emu.grasscutter.net.oldproto.MapMarkPointOuterClass.MapMarkPoint getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.MapMarkFromTypeOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.MapMarkPointTypeOuterClass.getDescriptor(),
