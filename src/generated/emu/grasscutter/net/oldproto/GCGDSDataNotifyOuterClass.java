...
public final class GCGDSDataNotifyOuterClass {
  ...
  public interface GCGDSDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData> 
        getDeckListList();
    /**
     * <code>repeated .GCGDSDeckData deck_list = 4;</code>
     */
    emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData getDeckList(int index);
    /**
     * <code>repeated .GCGDSDeckData deck_list = 4;</code>
     */
     ...
     * <code>repeated .GCGDSDeckData deck_list = 4;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckDataOrBuilder> 
        getDeckListOrBuilderList();
    /**
     * <code>repeated .GCGDSDeckData deck_list = 4;</code>
     */
    emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckDataOrBuilder getDeckListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData> 
        getCardListList();
    /**
     * <code>repeated .GCGDSCardData card_list = 3;</code>
     */
    emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData getCardList(int index);
    /**
     * <code>repeated .GCGDSCardData card_list = 3;</code>
     */
     ...
     * <code>repeated .GCGDSCardData card_list = 3;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder> 
        getCardListOrBuilderList();
    /**
     * <code>repeated .GCGDSCardData card_list = 3;</code>
     */
    emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder getCardListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.internal_static_GCGDSDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.internal_static_GCGDSDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify.class, emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify.Builder.class);
    }

    public static final int DECK_LIST_FIELD_NUMBER = 4;
    private java.util.List<emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData> deckList_;
    /**
     * <code>repeated .GCGDSDeckData deck_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData> getDeckListList() {
      return deckList_;
    }
    /**
     * <code>repeated .GCGDSDeckData deck_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckDataOrBuilder> 
        getDeckListOrBuilderList() {
      return deckList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData getDeckList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckDataOrBuilder getDeckListOrBuilder(
        int index) {
      return deckList_.get(index);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData> cardList_;
    /**
     * <code>repeated .GCGDSCardData card_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData> getCardListList() {
      return cardList_;
    }
    /**
     * <code>repeated .GCGDSCardData card_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder> 
        getCardListOrBuilderList() {
      return cardList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData getCardList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder getCardListOrBuilder(
        int index) {
      return cardList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify other = (emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.internal_static_GCGDSDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify build() {
        emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify buildPartial() {
        emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify result = new emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify other) {
        if (other == emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify.getDefaultInstance()) return this;
        if (deckListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.parser(),
                        extensionRegistry);
                if (cardListBuilder_ == null) {
                  ensureCardListIsMutable();
                  cardList_.add(m);
              ...
              case 34: {
                emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.parser(),
                        extensionRegistry);
                if (deckListBuilder_ == null) {
                  ensureDeckListIsMutable();
                  deckList_.add(m);
      ...
      private void ensureDeckListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          deckList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData>(deckList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckDataOrBuilder> deckListBuilder_;
      ...
      public Builder setDeckList(
          int index, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData value) {
        if (deckListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setDeckList(
          int index, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder builderForValue) {
        if (deckListBuilder_ == null) {
          ensureDeckListIsMutable();
       ...
       * <code>repeated .GCGDSDeckData deck_list = 4;</code>
       */
      public Builder addDeckList(emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData value) {
        if (deckListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addDeckList(
          emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder builderForValue) {
        if (deckListBuilder_ == null) {
          ensureDeckListIsMutable();
      ...
      public Builder addAllDeckList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData> values) {
        if (deckListBuilder_ == null) {
          ensureDeckListIsMutable();
       ...
       * <code>repeated .GCGDSDeckData deck_list = 4;</code>
       */
      public emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder getDeckListBuilder(
          int index) {
       ...
       * <code>repeated .GCGDSDeckData deck_list = 4;</code>
       */
      public emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder addDeckListBuilder() {
        return getDeckListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGDSDeckData deck_list = 4;</code>
       */
      public emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder addDeckListBuilder(
          int index) {
        return getDeckListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGDSDeckData deck_list = 4;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder> 
           getDeckListBuilderList() {
        return getDeckListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckData.Builder, emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.GCGDSDeckDataOrBuilder> 
      ...
      private void ensureCardListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          cardList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData>(cardList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder> cardListBuilder_;
      ...
      public Builder setCardList(
          int index, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData value) {
        if (cardListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCardList(
          int index, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder builderForValue) {
        if (cardListBuilder_ == null) {
          ensureCardListIsMutable();
       ...
       * <code>repeated .GCGDSCardData card_list = 3;</code>
       */
      public Builder addCardList(emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData value) {
        if (cardListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCardList(
          emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder builderForValue) {
        if (cardListBuilder_ == null) {
          ensureCardListIsMutable();
      ...
      public Builder addAllCardList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData> values) {
        if (cardListBuilder_ == null) {
          ensureCardListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, cardList_);
       ...
       * <code>repeated .GCGDSCardData card_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder getCardListBuilder(
          int index) {
       ...
       * <code>repeated .GCGDSCardData card_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder addCardListBuilder() {
        return getCardListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGDSCardData card_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder addCardListBuilder(
          int index) {
        return getCardListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.getDefaultInstance());
      }
      /**
       * <code>repeated .GCGDSCardData card_list = 3;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder> 
           getCardListBuilderList() {
        return getCardListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardData.Builder, emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.GCGDSCardDataOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify();
    }

    public static emu.grasscutter.net.oldproto.GCGDSDataNotifyOuterClass.GCGDSDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\033\n\023unlock_deck_id_list\030\001 \003(\rB\036\n\034emu.gra" +
      "sscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.GCGDSCardDataOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.GCGDSDeckDataOuterClass.getDescriptor(),
        });
    internal_static_GCGDSDataNotify_descriptor =
