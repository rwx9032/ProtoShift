...
public final class ChannelerSlabLoopDungeonInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.internal_static_ChannelerSlabLoopDungeonInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.internal_static_ChannelerSlabLoopDungeonInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo.class, emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo other = (emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.internal_static_ChannelerSlabLoopDungeonInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo build() {
        emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo buildPartial() {
        emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo result = new emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo other) {
        if (other == emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo.getDefaultInstance()) return this;
        if (other.getScore() != 0) {
    ...
    private static final emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo();
    }

    public static emu.grasscutter.net.oldproto.ChannelerSlabLoopDungeonInfoOuterClass.ChannelerSlabLoopDungeonInfo getDefaultInstance() {
