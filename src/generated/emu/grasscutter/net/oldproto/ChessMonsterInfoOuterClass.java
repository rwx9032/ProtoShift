...
public final class ChessMonsterInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.internal_static_ChessMonsterInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.internal_static_ChessMonsterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.class, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo other = (emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.internal_static_ChessMonsterInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo build() {
        emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo buildPartial() {
        emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo result = new emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo other) {
        if (other == emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo();
    }

    public static emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo getDefaultInstance() {
