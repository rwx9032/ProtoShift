...
public final class DestroyMaterialRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.internal_static_DestroyMaterialRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.internal_static_DestroyMaterialRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.class, emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp other = (emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.internal_static_DestroyMaterialRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp build() {
        emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp buildPartial() {
        emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp result = new emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp other) {
        if (other == emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp();
    }

    public static emu.grasscutter.net.oldproto.DestroyMaterialRspOuterClass.DestroyMaterialRsp getDefaultInstance() {
