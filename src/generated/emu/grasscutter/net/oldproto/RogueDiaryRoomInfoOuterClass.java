...
public final class RogueDiaryRoomInfoOuterClass {
  ...
  public interface RogueDiaryRoomInfoOrBuilder extends
     ...
     * <code>repeated .Uint32Pair monster_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair getMonsterList(int index);
    /**
     * <code>repeated .Uint32Pair monster_list = 1;</code>
     */
     ...
     * <code>repeated .Uint32Pair monster_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32PairOrBuilder getMonsterListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.internal_static_RogueDiaryRoomInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.internal_static_RogueDiaryRoomInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.class, emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.Builder.class);
    }

    public static final int MONSTER_LIST_FIELD_NUMBER = 1;
    private java.util.List<emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair> monsterList_;
    /**
     * <code>repeated .Uint32Pair monster_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair> getMonsterListList() {
      return monsterList_;
    }
    /**
     * <code>repeated .Uint32Pair monster_list = 1;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair getMonsterList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32PairOrBuilder getMonsterListOrBuilder(
        int index) {
      return monsterList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo other = (emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.internal_static_RogueDiaryRoomInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo build() {
        emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo buildPartial() {
        emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo result = new emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo other) {
        if (other == emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo.getDefaultInstance()) return this;
        if (monsterListBuilder_ == null) {
      ...
      private void ensureMonsterListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          monsterList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair>(monsterList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair, emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair.Builder, emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32PairOrBuilder> monsterListBuilder_;
       ...
       * <code>repeated .Uint32Pair monster_list = 1;</code>
       */
      public Builder addMonsterList(emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair value) {
        if (monsterListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair monster_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair.Builder getMonsterListBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair monster_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair.Builder addMonsterListBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo();
    }

    public static emu.grasscutter.net.oldproto.RogueDiaryRoomInfoOuterClass.RogueDiaryRoomInfo getDefaultInstance() {
