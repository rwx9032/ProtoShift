...
public final class SumoTeamDataOuterClass {
  ...
  public interface SumoTeamDataOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> 
        getAvatarInfoListList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
     */
    emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index);
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
     */
     ...
     * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
     */
    emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.class, emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> avatarInfoList_;
    /**
     * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> getAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
        getAvatarInfoListOrBuilderList() {
      return avatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo getAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder getAvatarInfoListOrBuilder(
        int index) {
      return avatarInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData other = (emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData) obj;
    ...
    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.internal_static_SumoTeamData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData build() {
        emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData buildPartial() {
        emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData result = new emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData) {
          return mergeFrom((emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData other) {
        if (other == emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 26: {
                emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.parser(),
                        extensionRegistry);
                if (avatarInfoListBuilder_ == null) {
                  ensureAvatarInfoListIsMutable();
      ...
      private void ensureAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          avatarInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo>(avatarInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> avatarInfoListBuilder_;
      ...
      public Builder setAvatarInfoList(
          int index, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAvatarInfoList(
          int index, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
       */
      public Builder addAvatarInfoList(emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo value) {
        if (avatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAvatarInfoList(
          emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder builderForValue) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
      ...
      public Builder addAllAvatarInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo> values) {
        if (avatarInfoListBuilder_ == null) {
          ensureAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder getAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder() {
        return getAvatarInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder addAvatarInfoListBuilder(
          int index) {
        return getAvatarInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SumoAvatarInfo avatar_info_list = 3;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder> 
           getAvatarInfoListBuilderList() {
        return getAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfo.Builder, emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.SumoAvatarInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData();
    }

    public static emu.grasscutter.net.oldproto.SumoTeamDataOuterClass.SumoTeamData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.SumoAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SumoTeamData_descriptor =
