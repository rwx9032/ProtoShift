...
public final class RoguelikeEffectViewReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.internal_static_RoguelikeEffectViewReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.internal_static_RoguelikeEffectViewReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq.class, emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq other = (emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.internal_static_RoguelikeEffectViewReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq build() {
        emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq buildPartial() {
        emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq result = new emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq other) {
        if (other == emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq();
    }

    public static emu.grasscutter.net.oldproto.RoguelikeEffectViewReqOuterClass.RoguelikeEffectViewReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r\022\026\n\016view_card_list\030\002 \003(\rB\036\n\034emu.grasscu" +
