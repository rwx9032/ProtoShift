...
public final class TakeHuntingOfferReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.internal_static_TakeHuntingOfferReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.internal_static_TakeHuntingOfferReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.class, emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq other = (emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.internal_static_TakeHuntingOfferReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq build() {
        emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq buildPartial() {
        emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq result = new emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq other) {
        if (other == emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq();
    }

    public static emu.grasscutter.net.oldproto.TakeHuntingOfferReqOuterClass.TakeHuntingOfferReq getDefaultInstance() {
