...
public final class CodexDataFullNotifyOuterClass {
  ...
  public interface CodexDataFullNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData> 
        getTypeDataListList();
    /**
     * <code>repeated .CodexTypeData type_data_list = 6;</code>
     */
    emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData getTypeDataList(int index);
    /**
     * <code>repeated .CodexTypeData type_data_list = 6;</code>
     */
     ...
     * <code>repeated .CodexTypeData type_data_list = 6;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> 
        getTypeDataListOrBuilderList();
    /**
     * <code>repeated .CodexTypeData type_data_list = 6;</code>
     */
    emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder getTypeDataListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.internal_static_CodexDataFullNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.internal_static_CodexDataFullNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.class, emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData> typeDataList_;
    /**
     * <code>repeated .CodexTypeData type_data_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData> getTypeDataListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> 
        getTypeDataListOrBuilderList() {
      return typeDataList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData getTypeDataList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder getTypeDataListOrBuilder(
        int index) {
      return typeDataList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify other = (emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.internal_static_CodexDataFullNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify build() {
        emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify buildPartial() {
        emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify result = new emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify other) {
        if (other == emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.parser(),
                        extensionRegistry);
                if (typeDataListBuilder_ == null) {
                  ensureTypeDataListIsMutable();
                  typeDataList_.add(m);
      ...
      private void ensureTypeDataListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          typeDataList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData>(typeDataList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> typeDataListBuilder_;
      ...
      public Builder setTypeDataList(
          int index, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData value) {
        if (typeDataListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTypeDataList(
          int index, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder builderForValue) {
        if (typeDataListBuilder_ == null) {
          ensureTypeDataListIsMutable();
       ...
       * <code>repeated .CodexTypeData type_data_list = 6;</code>
       */
      public Builder addTypeDataList(emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData value) {
        if (typeDataListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTypeDataList(
          emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder builderForValue) {
        if (typeDataListBuilder_ == null) {
          ensureTypeDataListIsMutable();
      ...
      public Builder addAllTypeDataList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData> values) {
        if (typeDataListBuilder_ == null) {
          ensureTypeDataListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .CodexTypeData type_data_list = 6;</code>
       */
      public emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder getTypeDataListBuilder(
          int index) {
       ...
       * <code>repeated .CodexTypeData type_data_list = 6;</code>
       */
      public emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder addTypeDataListBuilder() {
        return getTypeDataListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.getDefaultInstance());
      }
      /**
       * <code>repeated .CodexTypeData type_data_list = 6;</code>
       */
      public emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder addTypeDataListBuilder(
          int index) {
        return getTypeDataListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.getDefaultInstance());
      }
      /**
       * <code>repeated .CodexTypeData type_data_list = 6;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder> 
           getTypeDataListBuilderList() {
        return getTypeDataListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeData.Builder, emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.CodexTypeDataOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify();
    }

    public static emu.grasscutter.net.oldproto.CodexDataFullNotifyOuterClass.CodexDataFullNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\006 \003(\0132\016.CodexTypeDataB\036\n\034emu.grasscutte" +
      "r.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.CodexTypeDataOuterClass.getDescriptor(),
        });
    internal_static_CodexDataFullNotify_descriptor =
