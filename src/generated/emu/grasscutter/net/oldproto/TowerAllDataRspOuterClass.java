...
public final class TowerAllDataRspOuterClass {
  ...
  public interface TowerAllDataRspOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord> 
        getTowerFloorRecordListList();
    /**
     * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord getTowerFloorRecordList(int index);
    /**
     * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
     */
     ...
     * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecordOrBuilder> 
        getTowerFloorRecordListOrBuilderList();
    /**
     * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecordOrBuilder getTowerFloorRecordListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief getLastScheduleMonthlyBrief();
    /**
     * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
     */
    emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder getLastScheduleMonthlyBriefOrBuilder();
     ...
     */
    emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord getCurLevelRecord();
    /**
     * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
     */
    emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder getCurLevelRecordOrBuilder();
     ...
     */
    emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief getMonthlyBrief();
    /**
     * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
     */
    emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder getMonthlyBriefOrBuilder();
  }
  /**
   * <pre>
   * CmdId: 2473
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.internal_static_TowerAllDataRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.internal_static_TowerAllDataRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp.class, emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.internal_static_TowerAllDataRsp_SkipFloorGrantedRewardItemMapEntry_descriptor, 
    ...
    private java.util.List<emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord> towerFloorRecordList_;
    /**
     * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord> getTowerFloorRecordListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecordOrBuilder> 
        getTowerFloorRecordListOrBuilderList() {
      return towerFloorRecordList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord getTowerFloorRecordList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecordOrBuilder getTowerFloorRecordListOrBuilder(
        int index) {
      return towerFloorRecordList_.get(index);
    }
    ...
    private emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief lastScheduleMonthlyBrief_;
    /**
     * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
     * @return Whether the lastScheduleMonthlyBrief field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief getLastScheduleMonthlyBrief() {
      return lastScheduleMonthlyBrief_ == null ? emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.getDefaultInstance() : lastScheduleMonthlyBrief_;
    }
    /**
     * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder getLastScheduleMonthlyBriefOrBuilder() {
    ...
    private static final class FloorOpenTimeMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.internal_static_TowerAllDataRsp_FloorOpenTimeMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    private emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord curLevelRecord_;
    /**
     * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
     * @return Whether the curLevelRecord field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord getCurLevelRecord() {
      return curLevelRecord_ == null ? emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.getDefaultInstance() : curLevelRecord_;
    }
    /**
     * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder getCurLevelRecordOrBuilder() {
    ...
    private emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief monthlyBrief_;
    /**
     * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
     * @return Whether the monthlyBrief field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief getMonthlyBrief() {
      return monthlyBrief_ == null ? emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.getDefaultInstance() : monthlyBrief_;
    }
    /**
     * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder getMonthlyBriefOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp other = (emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.internal_static_TowerAllDataRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp build() {
        emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp buildPartial() {
        emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp result = new emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp other) {
        if (other == emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42: {
                emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.parser(),
                        extensionRegistry);
                if (towerFloorRecordListBuilder_ == null) {
                  ensureTowerFloorRecordListIsMutable();
      ...
      private void ensureTowerFloorRecordListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          towerFloorRecordList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord>(towerFloorRecordList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecordOrBuilder> towerFloorRecordListBuilder_;
      ...
      public Builder setTowerFloorRecordList(
          int index, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord value) {
        if (towerFloorRecordListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setTowerFloorRecordList(
          int index, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder builderForValue) {
        if (towerFloorRecordListBuilder_ == null) {
          ensureTowerFloorRecordListIsMutable();
       ...
       * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
       */
      public Builder addTowerFloorRecordList(emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord value) {
        if (towerFloorRecordListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addTowerFloorRecordList(
          emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder builderForValue) {
        if (towerFloorRecordListBuilder_ == null) {
          ensureTowerFloorRecordListIsMutable();
      ...
      public Builder addAllTowerFloorRecordList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord> values) {
        if (towerFloorRecordListBuilder_ == null) {
          ensureTowerFloorRecordListIsMutable();
       ...
       * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder getTowerFloorRecordListBuilder(
          int index) {
       ...
       * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder addTowerFloorRecordListBuilder() {
        return getTowerFloorRecordListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.getDefaultInstance());
      }
      /**
       * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder addTowerFloorRecordListBuilder(
          int index) {
        return getTowerFloorRecordListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.getDefaultInstance());
      }
      /**
       * <code>repeated .TowerFloorRecord tower_floor_record_list = 5;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder> 
           getTowerFloorRecordListBuilderList() {
        return getTowerFloorRecordListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecord.Builder, emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.TowerFloorRecordOrBuilder> 
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief, emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.Builder, emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder> lastScheduleMonthlyBriefBuilder_;
      /**
       * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
       * @return Whether the lastScheduleMonthlyBrief field is set.
       */
       ...
       * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
       */
      public Builder setLastScheduleMonthlyBrief(emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief value) {
        if (lastScheduleMonthlyBriefBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setLastScheduleMonthlyBrief(
          emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.Builder builderForValue) {
        if (lastScheduleMonthlyBriefBuilder_ == null) {
       ...
       * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
       */
      public Builder mergeLastScheduleMonthlyBrief(emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief value) {
        if (lastScheduleMonthlyBriefBuilder_ == null) {
          if (lastScheduleMonthlyBrief_ != null) {
            lastScheduleMonthlyBrief_ =
              emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.newBuilder(lastScheduleMonthlyBrief_).mergeFrom(value).buildPartial();
          } else {
            lastScheduleMonthlyBrief_ = value;
          }
          onChanged();
       ...
       * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
       */
      public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.Builder getLastScheduleMonthlyBriefBuilder() {
      ...
      public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder getLastScheduleMonthlyBriefOrBuilder() {
        if (lastScheduleMonthlyBriefBuilder_ != null) {
          ...
          return lastScheduleMonthlyBrief_ == null ?
              emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.getDefaultInstance() : lastScheduleMonthlyBrief_;
        }
      }
      /**
       * <code>.TowerMonthlyBrief last_schedule_monthly_brief = 1222;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief, emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.Builder, emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder> 
      ...
      private emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord curLevelRecord_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord, emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.Builder, emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder> curLevelRecordBuilder_;
      /**
       * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
       * @return Whether the curLevelRecord field is set.
       */
       ...
       * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
       */
      public Builder setCurLevelRecord(emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord value) {
        if (curLevelRecordBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setCurLevelRecord(
          emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.Builder builderForValue) {
        if (curLevelRecordBuilder_ == null) {
       ...
       * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
       */
      public Builder mergeCurLevelRecord(emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord value) {
        if (curLevelRecordBuilder_ == null) {
          if (curLevelRecord_ != null) {
            curLevelRecord_ =
              emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.newBuilder(curLevelRecord_).mergeFrom(value).buildPartial();
          } else {
            curLevelRecord_ = value;
          }
          onChanged();
       ...
       * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
       */
      public emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.Builder getCurLevelRecordBuilder() {
      ...
      public emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder getCurLevelRecordOrBuilder() {
        if (curLevelRecordBuilder_ != null) {
          ...
          return curLevelRecord_ == null ?
              emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.getDefaultInstance() : curLevelRecord_;
        }
      }
      /**
       * <code>.TowerCurLevelRecord cur_level_record = 15;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord, emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecord.Builder, emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.TowerCurLevelRecordOrBuilder> 
      ...
      private emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief monthlyBrief_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief, emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.Builder, emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder> monthlyBriefBuilder_;
      /**
       * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
       * @return Whether the monthlyBrief field is set.
       */
       ...
       * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
       */
      public Builder setMonthlyBrief(emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief value) {
        if (monthlyBriefBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
       */
      public Builder mergeMonthlyBrief(emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief value) {
        if (monthlyBriefBuilder_ == null) {
          if (monthlyBrief_ != null) {
            monthlyBrief_ =
              emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.newBuilder(monthlyBrief_).mergeFrom(value).buildPartial();
          } else {
            monthlyBrief_ = value;
          }
          onChanged();
       ...
       * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
       */
      public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.Builder getMonthlyBriefBuilder() {
      ...
      public emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBriefOrBuilder getMonthlyBriefOrBuilder() {
        if (monthlyBriefBuilder_ != null) {
          ...
          return monthlyBrief_ == null ?
              emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.TowerMonthlyBrief.getDefaultInstance() : monthlyBrief_;
        }
      }
      /**
       * <code>.TowerMonthlyBrief monthly_brief = 14;</code>
    ...
    private static final emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp();
    }

    public static emu.grasscutter.net.oldproto.TowerAllDataRspOuterClass.TowerAllDataRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.TowerCurLevelRecordOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.TowerFloorRecordOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.TowerMonthlyBriefOuterClass.getDescriptor(),
        });
    internal_static_TowerAllDataRsp_descriptor =
