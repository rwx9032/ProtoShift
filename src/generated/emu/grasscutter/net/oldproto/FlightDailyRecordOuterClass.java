...
public final class FlightDailyRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.internal_static_FlightDailyRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.internal_static_FlightDailyRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord.class, emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord other = (emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord) obj;
    ...
    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.internal_static_FlightDailyRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord build() {
        emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord buildPartial() {
        emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord result = new emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord) {
          return mergeFrom((emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord other) {
        if (other == emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord();
    }

    public static emu.grasscutter.net.oldproto.FlightDailyRecordOuterClass.FlightDailyRecord getDefaultInstance() {
