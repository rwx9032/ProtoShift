...
public final class HomeBlueprintSlotInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.internal_static_HomeBlueprintSlotInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.internal_static_HomeBlueprintSlotInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.class, emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo other = (emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.internal_static_HomeBlueprintSlotInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo build() {
        emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo buildPartial() {
        emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo result = new emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo other) {
        if (other == emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo();
    }

    public static emu.grasscutter.net.oldproto.HomeBlueprintSlotInfoOuterClass.HomeBlueprintSlotInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "copy\030\003 \001(\010\022\023\n\013create_time\030\006 \001(\rB\036\n\034emu.g" +
