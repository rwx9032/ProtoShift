...
public final class ClientGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.class, emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo other = (emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.internal_static_ClientGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo build() {
        emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo buildPartial() {
        emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo result = new emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo other) {
        if (other == emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo();
    }

    public static emu.grasscutter.net.oldproto.ClientGadgetInfoOuterClass.ClientGadgetInfo getDefaultInstance() {
