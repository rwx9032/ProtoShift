...
public final class AbilityEmbryoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.internal_static_AbilityEmbryo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.internal_static_AbilityEmbryo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo.class, emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo other = (emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.internal_static_AbilityEmbryo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo build() {
        emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo buildPartial() {
        emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo result = new emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo other) {
        if (other == emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo();
    }

    public static emu.grasscutter.net.oldproto.AbilityEmbryoOuterClass.AbilityEmbryo getDefaultInstance() {
