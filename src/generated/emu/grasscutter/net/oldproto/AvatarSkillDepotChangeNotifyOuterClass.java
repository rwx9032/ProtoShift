...
public final class AvatarSkillDepotChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.internal_static_AvatarSkillDepotChangeNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.internal_static_AvatarSkillDepotChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify.class, emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.internal_static_AvatarSkillDepotChangeNotify_ProudSkillExtraLevelMapEntry_descriptor, 
    ...
    private static final class SkillLevelMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.internal_static_AvatarSkillDepotChangeNotify_SkillLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify other = (emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.internal_static_AvatarSkillDepotChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify build() {
        emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify buildPartial() {
        emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify result = new emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify other) {
        if (other == emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify();
    }

    public static emu.grasscutter.net.oldproto.AvatarSkillDepotChangeNotifyOuterClass.AvatarSkillDepotChangeNotify getDefaultInstance() {
