...
public final class ForgeQueueManipulateRspOuterClass {
  ...
  public interface ForgeQueueManipulateRspOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType getManipulateType();
     ...
     * <code>repeated .ItemParam extra_output_item_list = 13;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getExtraOutputItemList(int index);
    /**
     * <code>repeated .ItemParam extra_output_item_list = 13;</code>
     */
     ...
     * <code>repeated .ItemParam extra_output_item_list = 13;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getExtraOutputItemListOrBuilder(
        int index);
     ...
     * <code>repeated .ItemParam return_item_list = 10;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getReturnItemList(int index);
    /**
     * <code>repeated .ItemParam return_item_list = 10;</code>
     */
     ...
     * <code>repeated .ItemParam return_item_list = 10;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getReturnItemListOrBuilder(
        int index);
     ...
     * <code>repeated .ItemParam output_item_list = 9;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getOutputItemList(int index);
    /**
     * <code>repeated .ItemParam output_item_list = 9;</code>
     */
     ...
     * <code>repeated .ItemParam output_item_list = 9;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getOutputItemListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.internal_static_ForgeQueueManipulateRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.internal_static_ForgeQueueManipulateRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp.class, emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp.Builder.class);
    }
     ...
     * @return The manipulateType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType getManipulateType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType result = emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.valueOf(manipulateType_);
      return result == null ? emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.UNRECOGNIZED : result;
    }

    public static final int EXTRA_OUTPUT_ITEM_LIST_FIELD_NUMBER = 13;
    private java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> extraOutputItemList_;
    /**
     * <code>repeated .ItemParam extra_output_item_list = 13;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> getExtraOutputItemListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getExtraOutputItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getExtraOutputItemListOrBuilder(
        int index) {
      return extraOutputItemList_.get(index);
    }

    public static final int RETURN_ITEM_LIST_FIELD_NUMBER = 10;
    private java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> returnItemList_;
    /**
     * <code>repeated .ItemParam return_item_list = 10;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> getReturnItemListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getReturnItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getReturnItemListOrBuilder(
        int index) {
      return returnItemList_.get(index);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> outputItemList_;
    /**
     * <code>repeated .ItemParam output_item_list = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> getOutputItemListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getOutputItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getOutputItemListOrBuilder(
        int index) {
      return outputItemList_.get(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (manipulateType_ != emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.FORGE_QUEUE_MANIPULATE_TYPE_RECEIVE_OUTPUT.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp other = (emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.internal_static_ForgeQueueManipulateRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp build() {
        emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp buildPartial() {
        emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp result = new emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp other) {
        if (other == emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType getManipulateType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType result = emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.valueOf(manipulateType_);
        return result == null ? emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setManipulateType(emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.ForgeQueueManipulateType value) {
        if (value == null) {
      ...
      private void ensureExtraOutputItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          extraOutputItemList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam>(extraOutputItemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> extraOutputItemListBuilder_;
       ...
       * <code>repeated .ItemParam extra_output_item_list = 13;</code>
       */
      public Builder addExtraOutputItemList(emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (extraOutputItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam extra_output_item_list = 13;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder getExtraOutputItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam extra_output_item_list = 13;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder addExtraOutputItemListBuilder() {
      ...
      private void ensureReturnItemListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          returnItemList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam>(returnItemList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> returnItemListBuilder_;
       ...
       * <code>repeated .ItemParam return_item_list = 10;</code>
       */
      public Builder addReturnItemList(emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (returnItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam return_item_list = 10;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder getReturnItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam return_item_list = 10;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder addReturnItemListBuilder() {
      ...
      private void ensureOutputItemListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          outputItemList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam>(outputItemList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> outputItemListBuilder_;
       ...
       * <code>repeated .ItemParam output_item_list = 9;</code>
       */
      public Builder addOutputItemList(emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (outputItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam output_item_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder getOutputItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam output_item_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder addOutputItemListBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp();
    }

    public static emu.grasscutter.net.oldproto.ForgeQueueManipulateRspOuterClass.ForgeQueueManipulateRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ForgeQueueManipulateTypeOuterClass.getDescriptor(),
