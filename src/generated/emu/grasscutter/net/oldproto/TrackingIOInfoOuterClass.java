...
public final class TrackingIOInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.internal_static_TrackingIOInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.internal_static_TrackingIOInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo.class, emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo other = (emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.internal_static_TrackingIOInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo build() {
        emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo buildPartial() {
        emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo result = new emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo other) {
        if (other == emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                currentCaid_ = input.readStringRequireUtf8();
              ...
              case 122: {
                cachedCaid_ = input.readStringRequireUtf8();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo();
    }

    public static emu.grasscutter.net.oldproto.TrackingIOInfoOuterClass.TrackingIOInfo getDefaultInstance() {
