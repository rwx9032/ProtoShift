...
public final class AddBlacklistRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.internal_static_AddBlacklistRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.internal_static_AddBlacklistRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp.class, emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp other = (emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.internal_static_AddBlacklistRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp build() {
        emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp buildPartial() {
        emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp result = new emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp(this);
        if (targetFriendBriefBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp other) {
        if (other == emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp();
    }

    public static emu.grasscutter.net.oldproto.AddBlacklistRspOuterClass.AddBlacklistRsp getDefaultInstance() {
