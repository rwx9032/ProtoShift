...
public final class TrialAvatarInfoOuterClass {
  ...
  public interface TrialAvatarInfoOrBuilder extends
     ...
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
    emu.grasscutter.net.oldproto.ItemOuterClass.Item getTrialEquipList(int index);
    /**
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
     ...
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
    emu.grasscutter.net.oldproto.ItemOuterClass.ItemOrBuilder getTrialEquipListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord getGrantRecord();
    /**
     * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
     */
    emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder getGrantRecordOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.internal_static_TrialAvatarInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.internal_static_TrialAvatarInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.class, emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ItemOuterClass.Item> trialEquipList_;
    /**
     * <code>repeated .Item trial_equip_list = 2;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemOuterClass.Item> getTrialEquipListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemOuterClass.Item getTrialEquipList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemOuterClass.ItemOrBuilder getTrialEquipListOrBuilder(
        int index) {
      return trialEquipList_.get(index);
    }

    public static final int GRANT_RECORD_FIELD_NUMBER = 3;
    private emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord grantRecord_;
    /**
     * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
     * @return Whether the grantRecord field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord getGrantRecord() {
      return grantRecord_ == null ? emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDefaultInstance() : grantRecord_;
    }
    /**
     * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder getGrantRecordOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo other = (emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.internal_static_TrialAvatarInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo build() {
        emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo buildPartial() {
        emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo result = new emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo other) {
        if (other == emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo.getDefaultInstance()) return this;
      ...
      private void ensureTrialEquipListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          trialEquipList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemOuterClass.Item>(trialEquipList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemOuterClass.Item, emu.grasscutter.net.oldproto.ItemOuterClass.Item.Builder, emu.grasscutter.net.oldproto.ItemOuterClass.ItemOrBuilder> trialEquipListBuilder_;
       ...
       * <code>repeated .Item trial_equip_list = 2;</code>
       */
      public Builder addTrialEquipList(emu.grasscutter.net.oldproto.ItemOuterClass.Item value) {
        if (trialEquipListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Item trial_equip_list = 2;</code>
       */
      public emu.grasscutter.net.oldproto.ItemOuterClass.Item.Builder getTrialEquipListBuilder(
          int index) {
       ...
       * <code>repeated .Item trial_equip_list = 2;</code>
       */
      public emu.grasscutter.net.oldproto.ItemOuterClass.Item.Builder addTrialEquipListBuilder() {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord, emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder, emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder> grantRecordBuilder_;
      /**
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       * @return Whether the grantRecord field is set.
       */
       ...
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      public Builder setGrantRecord(emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord value) {
        if (grantRecordBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setGrantRecord(
          emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder builderForValue) {
        if (grantRecordBuilder_ == null) {
       ...
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      public Builder mergeGrantRecord(emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord value) {
        if (grantRecordBuilder_ == null) {
          if (grantRecord_ != null) {
            grantRecord_ =
              emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.newBuilder(grantRecord_).mergeFrom(value).buildPartial();
          } else {
            grantRecord_ = value;
          }
          onChanged();
       ...
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      public emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder getGrantRecordBuilder() {
      ...
      public emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder getGrantRecordOrBuilder() {
        if (grantRecordBuilder_ != null) {
          ...
          return grantRecord_ == null ?
              emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.getDefaultInstance() : grantRecord_;
        }
      }
      /**
       * <code>.TrialAvatarGrantRecord grant_record = 3;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord, emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecord.Builder, emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.TrialAvatarGrantRecordOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo();
    }

    public static emu.grasscutter.net.oldproto.TrialAvatarInfoOuterClass.TrialAvatarInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\0132\027.TrialAvatarGrantRecordB\036\n\034emu.gra" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.oldproto.TrialAvatarGrantRecordOuterClass.getDescriptor(),
        });
    internal_static_TrialAvatarInfo_descriptor =
