...
public final class PlayerLoginRspOuterClass {
  ...
  public interface PlayerLoginRspOrBuilder extends
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo>
    getBlockInfoMap();
    /**
     * <code>map&lt;uint32, .BlockInfo&gt; block_info_map = 571;</code>
     */
    ...
    /* nullable */
emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo defaultValue);
    /**
     * <code>map&lt;uint32, .BlockInfo&gt; block_info_map = 571;</code>
     */

    emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrThrow(
        int key);
     ...
     */
    emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig getNextResVersionConfig();
    /**
     * <code>.ResVersionConfig next_res_version_config = 1573;</code>
     */
    emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getNextResVersionConfigOrBuilder();
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> 
        getShortAbilityHashMapList();
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
     */
    emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair getShortAbilityHashMap(int index);
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
     */
     ...
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> 
        getShortAbilityHashMapOrBuilderList();
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
     */
    emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder getShortAbilityHashMapOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig getResVersionConfig();
    /**
     * <code>.ResVersionConfig res_version_config = 1969;</code>
     */
    emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getResVersionConfigOrBuilder();

    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
     */
    java.util.List<emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> 
        getFeatureBlockInfoListList();
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
     */
    emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo getFeatureBlockInfoList(int index);
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
     */
     ...
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> 
        getFeatureBlockInfoListOrBuilderList();
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
     */
    emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder getFeatureBlockInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp.class, emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp.Builder.class);
    }
    ...
    private static final class BlockInfoMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo>newDefaultInstance(
                  emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_BlockInfoMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> blockInfoMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> getBlockInfoMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> getBlockInfoMapMap() {
    ...
    public emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrDefault(
        int key,
        emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> map =
    ...
    public emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo getBlockInfoMapOrThrow(
        int key) {
    ...
    private emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig nextResVersionConfig_;
    /**
     * <code>.ResVersionConfig next_res_version_config = 1573;</code>
     * @return Whether the nextResVersionConfig field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig getNextResVersionConfig() {
      return nextResVersionConfig_ == null ? emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance() : nextResVersionConfig_;
    }
    /**
     * <code>.ResVersionConfig next_res_version_config = 1573;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getNextResVersionConfigOrBuilder() {
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.String, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.String, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_AbilityHashMapEntry_descriptor, 
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> shortAbilityHashMap_;
    /**
     * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> getShortAbilityHashMapList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> 
        getShortAbilityHashMapOrBuilderList() {
      return shortAbilityHashMap_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair getShortAbilityHashMap(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder getShortAbilityHashMapOrBuilder(
        int index) {
      return shortAbilityHashMap_.get(index);
    }
    ...
    private emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig resVersionConfig_;
    /**
     * <code>.ResVersionConfig res_version_config = 1969;</code>
     * @return Whether the resVersionConfig field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig getResVersionConfig() {
      return resVersionConfig_ == null ? emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance() : resVersionConfig_;
    }
    /**
     * <code>.ResVersionConfig res_version_config = 1969;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getResVersionConfigOrBuilder() {
      return getResVersionConfig();
    }

    public static final int FEATURE_BLOCK_INFO_LIST_FIELD_NUMBER = 1352;
    private java.util.List<emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> featureBlockInfoList_;
    /**
     * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> getFeatureBlockInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> 
        getFeatureBlockInfoListOrBuilderList() {
      return featureBlockInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo getFeatureBlockInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder getFeatureBlockInfoListOrBuilder(
        int index) {
      return featureBlockInfoList_.get(index);
    }
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> entry
           : internalGetBlockInfoMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp other = (emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.internal_static_PlayerLoginRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp build() {
        emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp buildPartial() {
        emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp result = new emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp other) {
        if (other == emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 2002: {
                emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.parser(),
                        extensionRegistry);
                if (shortAbilityHashMapBuilder_ == null) {
                  ensureShortAbilityHashMapIsMutable();
              ...
              case 10818: {
                emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.parser(),
                        extensionRegistry);
                if (featureBlockInfoListBuilder_ == null) {
                  ensureFeatureBlockInfoListIsMutable();
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo>
      ...
      public Builder putBlockInfoMap(
          int key,
          emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllBlockInfoMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.BlockInfoOuterClass.BlockInfo> values) {
        internalGetMutableBlockInfoMap().getMutableMap()
            .putAll(values);
        return this;
      }
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder> nextResVersionConfigBuilder_;
      /**
       * <code>.ResVersionConfig next_res_version_config = 1573;</code>
       * @return Whether the nextResVersionConfig field is set.
       */
       ...
       * <code>.ResVersionConfig next_res_version_config = 1573;</code>
       */
      public Builder setNextResVersionConfig(emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig value) {
        if (nextResVersionConfigBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setNextResVersionConfig(
          emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder builderForValue) {
        if (nextResVersionConfigBuilder_ == null) {
       ...
       * <code>.ResVersionConfig next_res_version_config = 1573;</code>
       */
      public Builder mergeNextResVersionConfig(emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig value) {
        if (nextResVersionConfigBuilder_ == null) {
          if (nextResVersionConfig_ != null) {
            nextResVersionConfig_ =
              emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.newBuilder(nextResVersionConfig_).mergeFrom(value).buildPartial();
          } else {
            nextResVersionConfig_ = value;
          }
          onChanged();
       ...
       * <code>.ResVersionConfig next_res_version_config = 1573;</code>
       */
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder getNextResVersionConfigBuilder() {
      ...
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getNextResVersionConfigOrBuilder() {
        if (nextResVersionConfigBuilder_ != null) {
          ...
          return nextResVersionConfig_ == null ?
              emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance() : nextResVersionConfig_;
        }
      }
      /**
       * <code>.ResVersionConfig next_res_version_config = 1573;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureShortAbilityHashMapIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          shortAbilityHashMap_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair>(shortAbilityHashMap_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> shortAbilityHashMapBuilder_;
      ...
      public Builder setShortAbilityHashMap(
          int index, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair value) {
        if (shortAbilityHashMapBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShortAbilityHashMap(
          int index, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder builderForValue) {
        if (shortAbilityHashMapBuilder_ == null) {
          ensureShortAbilityHashMapIsMutable();
       ...
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
       */
      public Builder addShortAbilityHashMap(emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair value) {
        if (shortAbilityHashMapBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShortAbilityHashMap(
          emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder builderForValue) {
        if (shortAbilityHashMapBuilder_ == null) {
          ensureShortAbilityHashMapIsMutable();
      ...
      public Builder addAllShortAbilityHashMap(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair> values) {
        if (shortAbilityHashMapBuilder_ == null) {
          ensureShortAbilityHashMapIsMutable();
       ...
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
       */
      public emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder getShortAbilityHashMapBuilder(
          int index) {
       ...
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
       */
      public emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder addShortAbilityHashMapBuilder() {
        return getShortAbilityHashMapFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.getDefaultInstance());
      }
      /**
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
       */
      public emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder addShortAbilityHashMapBuilder(
          int index) {
        return getShortAbilityHashMapFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.getDefaultInstance());
      }
      /**
       * <code>repeated .ShortAbilityHashPair short_ability_hash_map = 250;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder> 
           getShortAbilityHashMapBuilderList() {
        return getShortAbilityHashMapFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPair.Builder, emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.ShortAbilityHashPairOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
      ...
      private emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig resVersionConfig_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder> resVersionConfigBuilder_;
      /**
       * <code>.ResVersionConfig res_version_config = 1969;</code>
       * @return Whether the resVersionConfig field is set.
       */
       ...
       * <code>.ResVersionConfig res_version_config = 1969;</code>
       */
      public Builder setResVersionConfig(emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig value) {
        if (resVersionConfigBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.ResVersionConfig res_version_config = 1969;</code>
       */
      public Builder mergeResVersionConfig(emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig value) {
        if (resVersionConfigBuilder_ == null) {
          if (resVersionConfig_ != null) {
            resVersionConfig_ =
              emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.newBuilder(resVersionConfig_).mergeFrom(value).buildPartial();
          } else {
            resVersionConfig_ = value;
          }
          onChanged();
       ...
       * <code>.ResVersionConfig res_version_config = 1969;</code>
       */
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder getResVersionConfigBuilder() {
      ...
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder getResVersionConfigOrBuilder() {
        if (resVersionConfigBuilder_ != null) {
          ...
          return resVersionConfig_ == null ?
              emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance() : resVersionConfig_;
        }
      }
      /**
       * <code>.ResVersionConfig res_version_config = 1969;</code>
      ...
      private void ensureFeatureBlockInfoListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          featureBlockInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo>(featureBlockInfoList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> featureBlockInfoListBuilder_;
      ...
      public Builder setFeatureBlockInfoList(
          int index, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo value) {
        if (featureBlockInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setFeatureBlockInfoList(
          int index, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder builderForValue) {
        if (featureBlockInfoListBuilder_ == null) {
          ensureFeatureBlockInfoListIsMutable();
       ...
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
       */
      public Builder addFeatureBlockInfoList(emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo value) {
        if (featureBlockInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFeatureBlockInfoList(
          emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder builderForValue) {
        if (featureBlockInfoListBuilder_ == null) {
          ensureFeatureBlockInfoListIsMutable();
      ...
      public Builder addAllFeatureBlockInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo> values) {
        if (featureBlockInfoListBuilder_ == null) {
          ensureFeatureBlockInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
       */
      public emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder getFeatureBlockInfoListBuilder(
          int index) {
       ...
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
       */
      public emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder addFeatureBlockInfoListBuilder() {
        return getFeatureBlockInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
       */
      public emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder addFeatureBlockInfoListBuilder(
          int index) {
        return getFeatureBlockInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .FeatureBlockInfo feature_block_info_list = 1352;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder> 
           getFeatureBlockInfoListBuilderList() {
        return getFeatureBlockInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfo.Builder, emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.FeatureBlockInfoOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp();
    }

    public static emu.grasscutter.net.oldproto.PlayerLoginRspOuterClass.PlayerLoginRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\001(\005:\0028\001B\036\n\034emu.grasscutter.net.oldprotob" +
      "\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.BlockInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.FeatureBlockInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.ShortAbilityHashPairOuterClass.getDescriptor(),
        });
    internal_static_PlayerLoginRsp_descriptor =
