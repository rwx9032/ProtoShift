...
public final class RoguelikeDungeonSettleInfoOuterClass {
  ...
  public interface RoguelikeDungeonSettleInfoOrBuilder extends
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo>
    ...
    /* nullable */
emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo getFinishedChallengeCellNumMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo defaultValue);
    /**
     * <code>map&lt;uint32, .RoguelikeSettleCoinInfo&gt; finished_challenge_cell_num_map = 3;</code>
     */

    emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo getFinishedChallengeCellNumMapOrThrow(
        int key);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.internal_static_RoguelikeDungeonSettleInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.internal_static_RoguelikeDungeonSettleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo.class, emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo.Builder.class);
    }
    ...
    private static final class FinishedChallengeCellNumMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo>newDefaultInstance(
                  emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.internal_static_RoguelikeDungeonSettleInfo_FinishedChallengeCellNumMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> finishedChallengeCellNumMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> getFinishedChallengeCellNumMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> getFinishedChallengeCellNumMapMap() {
    ...
    public emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo getFinishedChallengeCellNumMapOrDefault(
        int key,
        emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> map =
    ...
    public emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo getFinishedChallengeCellNumMapOrThrow(
        int key) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> entry
           : internalGetFinishedChallengeCellNumMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo other = (emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.internal_static_RoguelikeDungeonSettleInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo build() {
        emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo buildPartial() {
        emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo result = new emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo other) {
        if (other == emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo>
      ...
      public Builder putFinishedChallengeCellNumMap(
          int key,
          emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllFinishedChallengeCellNumMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.RoguelikeSettleCoinInfo> values) {
        internalGetMutableFinishedChallengeCellNumMap().getMutableMap()
            .putAll(values);
        return this;
      }
    ...
    private static final emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo();
    }

    public static emu.grasscutter.net.oldproto.RoguelikeDungeonSettleInfoOuterClass.RoguelikeDungeonSettleInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e\030\002 \001(\0132\030.RoguelikeSettleCoinInfo:\0028\001B\036\n" +
      "\034emu.grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.RoguelikeSettleCoinInfoOuterClass.getDescriptor(),
        });
    internal_static_RoguelikeDungeonSettleInfo_descriptor =
