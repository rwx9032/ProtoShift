...
public final class ReliquaryUpgradeRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.internal_static_ReliquaryUpgradeRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.internal_static_ReliquaryUpgradeRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp.class, emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp other = (emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.internal_static_ReliquaryUpgradeRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp build() {
        emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp buildPartial() {
        emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp result = new emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp other) {
        if (other == emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp();
    }

    public static emu.grasscutter.net.oldproto.ReliquaryUpgradeRspOuterClass.ReliquaryUpgradeRsp getDefaultInstance() {
