...
public final class OpenStateUpdateNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.internal_static_OpenStateUpdateNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.internal_static_OpenStateUpdateNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify.class, emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.internal_static_OpenStateUpdateNotify_OpenStateMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify other = (emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.internal_static_OpenStateUpdateNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify build() {
        emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify buildPartial() {
        emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify result = new emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify other) {
        if (other == emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify();
    }

    public static emu.grasscutter.net.oldproto.OpenStateUpdateNotifyOuterClass.OpenStateUpdateNotify getDefaultInstance() {
