...
public final class GetInvestigationMonsterReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.internal_static_GetInvestigationMonsterReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.internal_static_GetInvestigationMonsterReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq.class, emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq other = (emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.internal_static_GetInvestigationMonsterReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq build() {
        emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq buildPartial() {
        emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq result = new emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq other) {
        if (other == emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq();
    }

    public static emu.grasscutter.net.oldproto.GetInvestigationMonsterReqOuterClass.GetInvestigationMonsterReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\003 \003(\r\022\023\n\013is_for_mark\030\004 \001(\010B\036\n\034emu.grass" +
