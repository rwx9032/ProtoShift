...
public final class ObstacleModifyNotifyOuterClass {
  ...
  public interface ObstacleModifyNotifyOrBuilder extends
     ...
     * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
     */
    emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo getAddObstacles(int index);
    /**
     * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
     */
     ...
     * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
     */
    emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder getAddObstaclesOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.internal_static_ObstacleModifyNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.internal_static_ObstacleModifyNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.class, emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo> addObstacles_;
    /**
     * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo> getAddObstaclesList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo getAddObstacles(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder getAddObstaclesOrBuilder(
        int index) {
      return addObstacles_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify other = (emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.internal_static_ObstacleModifyNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify build() {
        emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify buildPartial() {
        emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify result = new emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify other) {
        if (other == emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify.getDefaultInstance()) return this;
      ...
      private void ensureAddObstaclesIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          addObstacles_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo>(addObstacles_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder> addObstaclesBuilder_;
       ...
       * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
       */
      public Builder addAddObstacles(emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo value) {
        if (addObstaclesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
       */
      public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder getAddObstaclesBuilder(
          int index) {
       ...
       * <code>repeated .ObstacleInfo add_obstacles = 6;</code>
       */
      public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder addAddObstaclesBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify();
    }

    public static emu.grasscutter.net.oldproto.ObstacleModifyNotifyOuterClass.ObstacleModifyNotify getDefaultInstance() {
