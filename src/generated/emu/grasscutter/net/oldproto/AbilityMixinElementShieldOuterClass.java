...
public final class AbilityMixinElementShieldOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.internal_static_AbilityMixinElementShield_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.internal_static_AbilityMixinElementShield_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield.class, emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield other = (emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShieldOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.internal_static_AbilityMixinElementShield_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield build() {
        emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield buildPartial() {
        emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield result = new emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield other) {
        if (other == emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield();
    }

    public static emu.grasscutter.net.oldproto.AbilityMixinElementShieldOuterClass.AbilityMixinElementShield getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\t \001(\010\022\022\n\nmax_shield\030\014 \001(\002B\036\n\034emu.grassc" +
