...
public final class ShopConcertProductOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.internal_static_ShopConcertProduct_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.internal_static_ShopConcertProduct_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct.class, emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct other = (emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct) obj;
    ...
    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProductOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.internal_static_ShopConcertProduct_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct build() {
        emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct buildPartial() {
        emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct result = new emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct) {
          return mergeFrom((emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct other) {
        if (other == emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct();
    }

    public static emu.grasscutter.net.oldproto.ShopConcertProductOuterClass.ShopConcertProduct getDefaultInstance() {
