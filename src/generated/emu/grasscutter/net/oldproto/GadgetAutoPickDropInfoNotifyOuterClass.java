...
public final class GadgetAutoPickDropInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.internal_static_GadgetAutoPickDropInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.internal_static_GadgetAutoPickDropInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify.class, emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify other = (emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.internal_static_GadgetAutoPickDropInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify build() {
        emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify buildPartial() {
        emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify result = new emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify other) {
        if (other == emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify();
    }

    public static emu.grasscutter.net.oldproto.GadgetAutoPickDropInfoNotifyOuterClass.GadgetAutoPickDropInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\030\n\titem_list\030\013 \003(\0132\005.ItemB\036\n\034emu.grassc" +
