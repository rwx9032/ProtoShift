...
public final class LuaEnvironmentEffectNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.class, emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify other = (emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.internal_static_LuaEnvironmentEffectNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify build() {
        emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify buildPartial() {
        emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify result = new emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify other) {
        if (other == emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify.getDefaultInstance()) return this;
        if (other.getType() != 0) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify();
    }

    public static emu.grasscutter.net.oldproto.LuaEnvironmentEffectNotifyOuterClass.LuaEnvironmentEffectNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\t\022\030\n\020float_param_list\030\016 \003(\002B\036\n\034emu.gr" +
