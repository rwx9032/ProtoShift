...
public final class AsterMidCampInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.internal_static_AsterMidCampInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.internal_static_AsterMidCampInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify.class, emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify other = (emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.internal_static_AsterMidCampInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify build() {
        emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify buildPartial() {
        emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify result = new emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify other) {
        if (other == emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify.getDefaultInstance()) return this;
        if (campListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify();
    }

    public static emu.grasscutter.net.oldproto.AsterMidCampInfoNotifyOuterClass.AsterMidCampInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022$\n\tcamp_list\030\005 \003(\0132\021.AsterMidCampInfoB\036" +
