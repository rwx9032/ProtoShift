...
public final class LunaRiteTakeSacrificeRewardRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.internal_static_LunaRiteTakeSacrificeRewardRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.internal_static_LunaRiteTakeSacrificeRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp.class, emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp other = (emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.internal_static_LunaRiteTakeSacrificeRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp build() {
        emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp buildPartial() {
        emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp result = new emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp other) {
        if (other == emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp.getDefaultInstance()) return this;
        if (other.getIndex() != 0) {
    ...
    private static final emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp();
    }

    public static emu.grasscutter.net.oldproto.LunaRiteTakeSacrificeRewardRspOuterClass.LunaRiteTakeSacrificeRewardRsp getDefaultInstance() {
