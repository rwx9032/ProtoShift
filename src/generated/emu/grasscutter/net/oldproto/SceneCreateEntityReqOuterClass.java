...
public final class SceneCreateEntityReqOuterClass {
  ...
  public interface SceneCreateEntityReqOrBuilder extends
     ...
     * @return The reason.
     */
    emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason getReason();
  }
  /**
   * <pre>
   * CmdId: 288
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.internal_static_SceneCreateEntityReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.internal_static_SceneCreateEntityReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq.class, emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq.Builder.class);
    }
     ...
     * @return The reason.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason getReason() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason result = emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason.valueOf(reason_);
      return result == null ? emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (reason_ != emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason.CREATE_REASON_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq other = (emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.internal_static_SceneCreateEntityReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq build() {
        emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq buildPartial() {
        emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq result = new emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq(this);
        if (entityBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq other) {
        if (other == emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq.getDefaultInstance()) return this;
        if (other.hasEntity()) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason getReason() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason result = emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason.valueOf(reason_);
        return result == null ? emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setReason(emu.grasscutter.net.oldproto.CreateReasonOuterClass.CreateReason value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq();
    }

    public static emu.grasscutter.net.oldproto.SceneCreateEntityReqOuterClass.SceneCreateEntityReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t\030\n \001(\010\022\035\n\006reason\030\003 \001(\0162\r.CreateReasonB\036" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.oldproto.CreateReasonOuterClass.getDescriptor(),
        });
    internal_static_SceneCreateEntityReq_descriptor =
