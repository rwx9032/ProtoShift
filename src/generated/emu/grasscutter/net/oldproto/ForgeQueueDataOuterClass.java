...
public final class ForgeQueueDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.internal_static_ForgeQueueData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.internal_static_ForgeQueueData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData.class, emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData other = (emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData) obj;
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.internal_static_ForgeQueueData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData build() {
        emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData buildPartial() {
        emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData result = new emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData) {
          return mergeFrom((emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData other) {
        if (other == emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData();
    }

    public static emu.grasscutter.net.oldproto.ForgeQueueDataOuterClass.ForgeQueueData getDefaultInstance() {
