...
public final class MapMarkTipsInfoOuterClass {
  ...
  public interface MapMarkTipsInfoOrBuilder extends
     ...
     * @return The tipsType.
     */
    emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType getTipsType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.internal_static_MapMarkTipsInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.internal_static_MapMarkTipsInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo.class, emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo.Builder.class);
    }
     ...
     * @return The tipsType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType getTipsType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType result = emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType.valueOf(tipsType_);
      return result == null ? emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (tipsType_ != emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType.MAP_MARK_TIPS_TYPE_DUNGEON_ELEMENT_TRIAL.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo other = (emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.internal_static_MapMarkTipsInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo build() {
        emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo buildPartial() {
        emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo result = new emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo other) {
        if (other == emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType getTipsType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType result = emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType.valueOf(tipsType_);
        return result == null ? emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setTipsType(emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.MapMarkTipsType value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo();
    }

    public static emu.grasscutter.net.oldproto.MapMarkTipsInfoOuterClass.MapMarkTipsInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.MapMarkTipsTypeOuterClass.getDescriptor(),
        });
    internal_static_MapMarkTipsInfo_descriptor =
