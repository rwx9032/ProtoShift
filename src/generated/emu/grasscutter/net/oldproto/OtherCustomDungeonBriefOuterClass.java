...
public final class OtherCustomDungeonBriefOuterClass {
  ...
  public interface OtherCustomDungeonBriefOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail getCreatorDetail();
    /**
     * <code>.SocialDetail creator_detail = 4;</code>
     */
    emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder getCreatorDetailOrBuilder();
     ...
     * @return The abstract.
     */
    emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract getAbstract();
    /**
     * <code>.CustomDungeonAbstract abstract = 2;</code>
     */
    emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder getAbstractOrBuilder();
     ...
     * @return The social.
     */
    emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial getSocial();
    /**
     * <code>.CustomDungeonSocial social = 12;</code>
     */
    emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder getSocialOrBuilder();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.internal_static_OtherCustomDungeonBrief_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.internal_static_OtherCustomDungeonBrief_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.class, emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.Builder.class);
    }

    public static final int CREATOR_DETAIL_FIELD_NUMBER = 4;
    private emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail creatorDetail_;
    /**
     * <code>.SocialDetail creator_detail = 4;</code>
     * @return Whether the creatorDetail field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail getCreatorDetail() {
      return creatorDetail_ == null ? emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance() : creatorDetail_;
    }
    /**
     * <code>.SocialDetail creator_detail = 4;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder getCreatorDetailOrBuilder() {
    ...
    private emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract abstract_;
    /**
     * <code>.CustomDungeonAbstract abstract = 2;</code>
     * @return Whether the abstract field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract getAbstract() {
      return abstract_ == null ? emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.getDefaultInstance() : abstract_;
    }
    /**
     * <code>.CustomDungeonAbstract abstract = 2;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder getAbstractOrBuilder() {
      return getAbstract();
    }
    ...
    private emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial social_;
    /**
     * <code>.CustomDungeonSocial social = 12;</code>
     * @return Whether the social field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial getSocial() {
      return social_ == null ? emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.getDefaultInstance() : social_;
    }
    /**
     * <code>.CustomDungeonSocial social = 12;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder getSocialOrBuilder() {
      return getSocial();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief other = (emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief) obj;
    ...
    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBriefOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.internal_static_OtherCustomDungeonBrief_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief build() {
        emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief buildPartial() {
        emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief result = new emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief) {
          return mergeFrom((emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief other) {
        if (other == emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail, emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.Builder, emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder> creatorDetailBuilder_;
      /**
       * <code>.SocialDetail creator_detail = 4;</code>
       * @return Whether the creatorDetail field is set.
       */
       ...
       * <code>.SocialDetail creator_detail = 4;</code>
       */
      public Builder setCreatorDetail(emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail value) {
        if (creatorDetailBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setCreatorDetail(
          emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.Builder builderForValue) {
        if (creatorDetailBuilder_ == null) {
       ...
       * <code>.SocialDetail creator_detail = 4;</code>
       */
      public Builder mergeCreatorDetail(emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail value) {
        if (creatorDetailBuilder_ == null) {
          if (creatorDetail_ != null) {
            creatorDetail_ =
              emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.newBuilder(creatorDetail_).mergeFrom(value).buildPartial();
          } else {
            creatorDetail_ = value;
          }
          onChanged();
       ...
       * <code>.SocialDetail creator_detail = 4;</code>
       */
      public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.Builder getCreatorDetailBuilder() {
      ...
      public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder getCreatorDetailOrBuilder() {
        if (creatorDetailBuilder_ != null) {
          ...
          return creatorDetail_ == null ?
              emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance() : creatorDetail_;
        }
      }
      /**
       * <code>.SocialDetail creator_detail = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail, emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.Builder, emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder> 
      ...
      private emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract abstract_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract, emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder, emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder> abstractBuilder_;
      /**
       * <code>.CustomDungeonAbstract abstract = 2;</code>
       * @return Whether the abstract field is set.
       */
       ...
       * <code>.CustomDungeonAbstract abstract = 2;</code>
       */
      public Builder setAbstract(emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract value) {
        if (abstractBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setAbstract(
          emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder builderForValue) {
        if (abstractBuilder_ == null) {
       ...
       * <code>.CustomDungeonAbstract abstract = 2;</code>
       */
      public Builder mergeAbstract(emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract value) {
        if (abstractBuilder_ == null) {
          if (abstract_ != null) {
            abstract_ =
              emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.newBuilder(abstract_).mergeFrom(value).buildPartial();
          } else {
            abstract_ = value;
          }
          onChanged();
       ...
       * <code>.CustomDungeonAbstract abstract = 2;</code>
       */
      public emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder getAbstractBuilder() {
      ...
      public emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder getAbstractOrBuilder() {
        if (abstractBuilder_ != null) {
          ...
          return abstract_ == null ?
              emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.getDefaultInstance() : abstract_;
        }
      }
      /**
       * <code>.CustomDungeonAbstract abstract = 2;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract, emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstract.Builder, emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.CustomDungeonAbstractOrBuilder> 
      ...
      private emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial social_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial, emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder, emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder> socialBuilder_;
      /**
       * <code>.CustomDungeonSocial social = 12;</code>
       * @return Whether the social field is set.
       */
       ...
       * <code>.CustomDungeonSocial social = 12;</code>
       */
      public Builder setSocial(emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial value) {
        if (socialBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setSocial(
          emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder builderForValue) {
        if (socialBuilder_ == null) {
       ...
       * <code>.CustomDungeonSocial social = 12;</code>
       */
      public Builder mergeSocial(emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial value) {
        if (socialBuilder_ == null) {
          if (social_ != null) {
            social_ =
              emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.newBuilder(social_).mergeFrom(value).buildPartial();
          } else {
            social_ = value;
          }
          onChanged();
       ...
       * <code>.CustomDungeonSocial social = 12;</code>
       */
      public emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder getSocialBuilder() {
      ...
      public emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder getSocialOrBuilder() {
        if (socialBuilder_ != null) {
          ...
          return social_ == null ?
              emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.getDefaultInstance() : social_;
        }
      }
      /**
       * <code>.CustomDungeonSocial social = 12;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial, emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocial.Builder, emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.CustomDungeonSocialOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief();
    }

    public static emu.grasscutter.net.oldproto.OtherCustomDungeonBriefOuterClass.OtherCustomDungeonBrief getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.CustomDungeonAbstractOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.CustomDungeonSettingOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.CustomDungeonSocialOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.SocialDetailOuterClass.getDescriptor(),
        });
    internal_static_OtherCustomDungeonBrief_descriptor =
