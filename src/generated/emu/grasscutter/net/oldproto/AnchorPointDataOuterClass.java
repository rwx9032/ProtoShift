...
public final class AnchorPointDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.class, emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData other = (emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData) obj;
    ...
    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.internal_static_AnchorPointData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData build() {
        emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData buildPartial() {
        emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData result = new emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData) {
          return mergeFrom((emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData other) {
        if (other == emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData();
    }

    public static emu.grasscutter.net.oldproto.AnchorPointDataOuterClass.AnchorPointData getDefaultInstance() {
