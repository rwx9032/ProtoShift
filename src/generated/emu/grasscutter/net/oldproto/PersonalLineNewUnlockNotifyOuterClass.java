...
public final class PersonalLineNewUnlockNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.internal_static_PersonalLineNewUnlockNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.internal_static_PersonalLineNewUnlockNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.class, emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify other = (emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.internal_static_PersonalLineNewUnlockNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify build() {
        emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify buildPartial() {
        emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify result = new emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify other) {
        if (other == emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify();
    }

    public static emu.grasscutter.net.oldproto.PersonalLineNewUnlockNotifyOuterClass.PersonalLineNewUnlockNotify getDefaultInstance() {
