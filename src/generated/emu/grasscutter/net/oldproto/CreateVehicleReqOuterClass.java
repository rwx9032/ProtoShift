...
public final class CreateVehicleReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.internal_static_CreateVehicleReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.internal_static_CreateVehicleReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq.class, emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq other = (emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.internal_static_CreateVehicleReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq build() {
        emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq buildPartial() {
        emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq result = new emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq other) {
        if (other == emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq();
    }

    public static emu.grasscutter.net.oldproto.CreateVehicleReqOuterClass.CreateVehicleReq getDefaultInstance() {
