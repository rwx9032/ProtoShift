...
public final class DropHintNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.internal_static_DropHintNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.internal_static_DropHintNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify.class, emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify other = (emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.internal_static_DropHintNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify build() {
        emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify buildPartial() {
        emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify result = new emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify other) {
        if (other == emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify();
    }

    public static emu.grasscutter.net.oldproto.DropHintNotifyOuterClass.DropHintNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "r\022\024\n\014item_id_list\030\016 \003(\rB\036\n\034emu.grasscutt" +
