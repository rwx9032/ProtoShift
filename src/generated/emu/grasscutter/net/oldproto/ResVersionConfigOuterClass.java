...
public final class ResVersionConfigOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.internal_static_ResVersionConfig_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.internal_static_ResVersionConfig_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.class, emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig other = (emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig) obj;
    ...
    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfigOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.internal_static_ResVersionConfig_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig build() {
        emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig buildPartial() {
        emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig result = new emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig) {
          return mergeFrom((emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig other) {
        if (other == emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig();
    }

    public static emu.grasscutter.net.oldproto.ResVersionConfigOuterClass.ResVersionConfig getDefaultInstance() {
