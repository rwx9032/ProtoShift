...
public final class AchievementAllDataNotifyOuterClass {
  ...
  public interface AchievementAllDataNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement> 
        getAchievementListList();
    /**
     * <code>repeated .Achievement achievement_list = 4;</code>
     */
    emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement getAchievementList(int index);
    /**
     * <code>repeated .Achievement achievement_list = 4;</code>
     */
     ...
     * <code>repeated .Achievement achievement_list = 4;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.AchievementOuterClass.AchievementOrBuilder> 
        getAchievementListOrBuilderList();
    /**
     * <code>repeated .Achievement achievement_list = 4;</code>
     */
    emu.grasscutter.net.oldproto.AchievementOuterClass.AchievementOrBuilder getAchievementListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.class, emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.Builder.class);
    }

    public static final int ACHIEVEMENT_LIST_FIELD_NUMBER = 4;
    private java.util.List<emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement> achievementList_;
    /**
     * <code>repeated .Achievement achievement_list = 4;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement> getAchievementListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.AchievementOuterClass.AchievementOrBuilder> 
        getAchievementListOrBuilderList() {
      return achievementList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement getAchievementList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AchievementOuterClass.AchievementOrBuilder getAchievementListOrBuilder(
        int index) {
      return achievementList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other = (emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.internal_static_AchievementAllDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify build() {
        emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify buildPartial() {
        emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify result = new emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify other) {
        if (other == emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify.getDefaultInstance()) return this;
        if (achievementListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34: {
                emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.parser(),
                        extensionRegistry);
                if (achievementListBuilder_ == null) {
                  ensureAchievementListIsMutable();
      ...
      private void ensureAchievementListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          achievementList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement>(achievementList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement, emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder, emu.grasscutter.net.oldproto.AchievementOuterClass.AchievementOrBuilder> achievementListBuilder_;
      ...
      public Builder setAchievementList(
          int index, emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement value) {
        if (achievementListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setAchievementList(
          int index, emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder builderForValue) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
       ...
       * <code>repeated .Achievement achievement_list = 4;</code>
       */
      public Builder addAchievementList(emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement value) {
        if (achievementListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addAchievementList(
          emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder builderForValue) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
      ...
      public Builder addAllAchievementList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement> values) {
        if (achievementListBuilder_ == null) {
          ensureAchievementListIsMutable();
       ...
       * <code>repeated .Achievement achievement_list = 4;</code>
       */
      public emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder getAchievementListBuilder(
          int index) {
       ...
       * <code>repeated .Achievement achievement_list = 4;</code>
       */
      public emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder addAchievementListBuilder() {
        return getAchievementListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.getDefaultInstance());
      }
      /**
       * <code>repeated .Achievement achievement_list = 4;</code>
       */
      public emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder addAchievementListBuilder(
          int index) {
        return getAchievementListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.getDefaultInstance());
      }
      /**
       * <code>repeated .Achievement achievement_list = 4;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder> 
           getAchievementListBuilderList() {
        return getAchievementListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement, emu.grasscutter.net.oldproto.AchievementOuterClass.Achievement.Builder, emu.grasscutter.net.oldproto.AchievementOuterClass.AchievementOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify();
    }

    public static emu.grasscutter.net.oldproto.AchievementAllDataNotifyOuterClass.AchievementAllDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "!\n\031reward_taken_goal_id_list\030\002 \003(\rB\036\n\034em" +
      "u.grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.AchievementOuterClass.getDescriptor(),
        });
    internal_static_AchievementAllDataNotify_descriptor =
