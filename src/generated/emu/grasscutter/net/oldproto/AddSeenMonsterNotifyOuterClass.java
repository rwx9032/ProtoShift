...
public final class AddSeenMonsterNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.internal_static_AddSeenMonsterNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.internal_static_AddSeenMonsterNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.class, emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify other = (emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.internal_static_AddSeenMonsterNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify build() {
        emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify buildPartial() {
        emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify result = new emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify other) {
        if (other == emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify();
    }

    public static emu.grasscutter.net.oldproto.AddSeenMonsterNotifyOuterClass.AddSeenMonsterNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "onsterNotify\022\027\n\017monster_id_list\030\014 \003(\rB\036\n" +
