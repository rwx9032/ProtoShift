...
public final class TakeOfferingLevelRewardRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.internal_static_TakeOfferingLevelRewardRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.internal_static_TakeOfferingLevelRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp.class, emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp other = (emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.internal_static_TakeOfferingLevelRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp build() {
        emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp buildPartial() {
        emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp result = new emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp other) {
        if (other == emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp();
    }

    public static emu.grasscutter.net.oldproto.TakeOfferingLevelRewardRspOuterClass.TakeOfferingLevelRewardRsp getDefaultInstance() {
