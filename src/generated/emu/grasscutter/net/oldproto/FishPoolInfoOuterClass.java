...
public final class FishPoolInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.internal_static_FishPoolInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.internal_static_FishPoolInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo.class, emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo other = (emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.internal_static_FishPoolInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo build() {
        emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo buildPartial() {
        emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo result = new emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo other) {
        if (other == emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo();
    }

    public static emu.grasscutter.net.oldproto.FishPoolInfoOuterClass.FishPoolInfo getDefaultInstance() {
