...
public final class AbilityArgumentOuterClass {
  ...
  public interface AbilityArgumentOrBuilder extends
    ...
    public emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument.ArgCase getArgCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.internal_static_AbilityArgument_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.internal_static_AbilityArgument_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument.class, emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument other = (emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgumentOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.internal_static_AbilityArgument_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument build() {
        emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument buildPartial() {
        emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument result = new emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument(this);
        if (argCase_ == 5) {
          result.arg_ = arg_;
        }
        if (argCase_ == 15) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument other) {
        if (other == emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument();
    }

    public static emu.grasscutter.net.oldproto.AbilityArgumentOuterClass.AbilityArgument getDefaultInstance() {
