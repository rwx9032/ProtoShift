...
public final class SetUpAvatarTeamRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.internal_static_SetUpAvatarTeamRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.internal_static_SetUpAvatarTeamRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp.class, emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp other = (emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.internal_static_SetUpAvatarTeamRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp build() {
        emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp buildPartial() {
        emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp result = new emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp other) {
        if (other == emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp();
    }

    public static emu.grasscutter.net.oldproto.SetUpAvatarTeamRspOuterClass.SetUpAvatarTeamRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_avatar_guid\030\r \001(\004B\036\n\034emu.grasscutter.ne" +
