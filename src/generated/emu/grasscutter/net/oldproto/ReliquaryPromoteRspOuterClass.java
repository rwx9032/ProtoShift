...
public final class ReliquaryPromoteRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.internal_static_ReliquaryPromoteRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.internal_static_ReliquaryPromoteRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp.class, emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp other = (emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.internal_static_ReliquaryPromoteRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp build() {
        emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp buildPartial() {
        emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp result = new emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp other) {
        if (other == emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp();
    }

    public static emu.grasscutter.net.oldproto.ReliquaryPromoteRspOuterClass.ReliquaryPromoteRsp getDefaultInstance() {
