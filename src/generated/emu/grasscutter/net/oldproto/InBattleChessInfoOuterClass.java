...
public final class InBattleChessInfoOuterClass {
  ...
  public interface InBattleChessInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo> 
        getSelectedCardInfoListList();
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
     */
    emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo getSelectedCardInfoList(int index);
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
     */
     ...
     * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
        getSelectedCardInfoListOrBuilderList();
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
     */
    emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder getSelectedCardInfoListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo getMysteryInfo();
    /**
     * <code>.ChessMysteryInfo mystery_info = 1;</code>
     */
    emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder();
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    getPlayerInfoMap();
    /**
     * <code>map&lt;uint32, .ChessPlayerInfo&gt; player_info_map = 8;</code>
     */
    ...
    /* nullable */
emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo defaultValue);
    /**
     * <code>map&lt;uint32, .ChessPlayerInfo&gt; player_info_map = 8;</code>
     */

    emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrThrow(
        int key);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo.class, emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo> selectedCardInfoList_;
    /**
     * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo> getSelectedCardInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
        getSelectedCardInfoListOrBuilderList() {
      return selectedCardInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo getSelectedCardInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder getSelectedCardInfoListOrBuilder(
        int index) {
      return selectedCardInfoList_.get(index);
    }

    public static final int MYSTERY_INFO_FIELD_NUMBER = 1;
    private emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo mysteryInfo_;
    /**
     * <code>.ChessMysteryInfo mystery_info = 1;</code>
     * @return Whether the mysteryInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo getMysteryInfo() {
      return mysteryInfo_ == null ? emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : mysteryInfo_;
    }
    /**
     * <code>.ChessMysteryInfo mystery_info = 1;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder() {
    ...
    private static final class PlayerInfoMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>newDefaultInstance(
                  emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_PlayerInfoMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.MESSAGE,
                  emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.getDefaultInstance());
    }
    private com.google.protobuf.MapField<
        java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> playerInfoMap_;
    private com.google.protobuf.MapField<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getPlayerInfoMap() {
    ...
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> getPlayerInfoMapMap() {
    ...
    public emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrDefault(
        int key,
        emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo defaultValue) {
      
      java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> map =
    ...
    public emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getPlayerInfoMapOrThrow(
        int key) {
    ...
    public int getSerializedSize() {
      ...
      for (java.util.Map.Entry<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> entry
           : internalGetPlayerInfoMap().getMap().entrySet()) {
        com.google.protobuf.MapEntry<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo other = (emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.internal_static_InBattleChessInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo build() {
        emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo buildPartial() {
        emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo result = new emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo other) {
        if (other == emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74: {
                emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.parser(),
                        extensionRegistry);
                if (selectedCardInfoListBuilder_ == null) {
                  ensureSelectedCardInfoListIsMutable();
      ...
      private void ensureSelectedCardInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          selectedCardInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo>(selectedCardInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> selectedCardInfoListBuilder_;
      ...
      public Builder setSelectedCardInfoList(
          int index, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo value) {
        if (selectedCardInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setSelectedCardInfoList(
          int index, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder builderForValue) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
       */
      public Builder addSelectedCardInfoList(emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo value) {
        if (selectedCardInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addSelectedCardInfoList(
          emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder builderForValue) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
      ...
      public Builder addAllSelectedCardInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo> values) {
        if (selectedCardInfoListBuilder_ == null) {
          ensureSelectedCardInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder getSelectedCardInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder addSelectedCardInfoListBuilder() {
        return getSelectedCardInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder addSelectedCardInfoListBuilder(
          int index) {
        return getSelectedCardInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessCardInfo selected_card_info_list = 9;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder> 
           getSelectedCardInfoListBuilderList() {
        return getSelectedCardInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfo.Builder, emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.ChessCardInfoOrBuilder> 
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> mysteryInfoBuilder_;
      /**
       * <code>.ChessMysteryInfo mystery_info = 1;</code>
       * @return Whether the mysteryInfo field is set.
       */
       ...
       * <code>.ChessMysteryInfo mystery_info = 1;</code>
       */
      public Builder setMysteryInfo(emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (mysteryInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setMysteryInfo(
          emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder builderForValue) {
        if (mysteryInfoBuilder_ == null) {
       ...
       * <code>.ChessMysteryInfo mystery_info = 1;</code>
       */
      public Builder mergeMysteryInfo(emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo value) {
        if (mysteryInfoBuilder_ == null) {
          if (mysteryInfo_ != null) {
            mysteryInfo_ =
              emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.newBuilder(mysteryInfo_).mergeFrom(value).buildPartial();
          } else {
            mysteryInfo_ = value;
          }
          onChanged();
       ...
       * <code>.ChessMysteryInfo mystery_info = 1;</code>
       */
      public emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder getMysteryInfoBuilder() {
      ...
      public emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder getMysteryInfoOrBuilder() {
        if (mysteryInfoBuilder_ != null) {
          ...
          return mysteryInfo_ == null ?
              emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.getDefaultInstance() : mysteryInfo_;
        }
      }
      /**
       * <code>.ChessMysteryInfo mystery_info = 1;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo, emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfo.Builder, emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.ChessMysteryInfoOrBuilder> 
       ...
       */
      @java.lang.Deprecated
      public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo>
      ...
      public Builder putPlayerInfoMap(
          int key,
          emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo value) {
  ...
  throw new NullPointerException("map value");
      ...
      public Builder putAllPlayerInfoMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo> values) {
        internalGetMutablePlayerInfoMap().getMutableMap()
            .putAll(values);
        return this;
      }
    ...
    private static final emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo();
    }

    public static emu.grasscutter.net.oldproto.InBattleChessInfoOuterClass.InBattleChessInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ChessCardInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.ChessMysteryInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.getDescriptor(),
        });
    internal_static_InBattleChessInfo_descriptor =
