...
public final class MiracleRingDataNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.internal_static_MiracleRingDataNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.internal_static_MiracleRingDataNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify.class, emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify other = (emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.internal_static_MiracleRingDataNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify build() {
        emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify buildPartial() {
        emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify result = new emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify other) {
        if (other == emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify();
    }

    public static emu.grasscutter.net.oldproto.MiracleRingDataNotifyOuterClass.MiracleRingDataNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_time\030\n \001(\r\022\027\n\017miracle_ring_cd\030\007 \001(\rB\036\n\034" +
