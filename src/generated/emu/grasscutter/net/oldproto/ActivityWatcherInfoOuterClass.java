...
public final class ActivityWatcherInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.class, emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo other = (emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.internal_static_ActivityWatcherInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo build() {
        emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo buildPartial() {
        emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo result = new emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo other) {
        if (other == emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo();
    }

    public static emu.grasscutter.net.oldproto.ActivityWatcherInfoOuterClass.ActivityWatcherInfo getDefaultInstance() {
