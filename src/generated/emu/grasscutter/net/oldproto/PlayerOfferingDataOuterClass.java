...
public final class PlayerOfferingDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.internal_static_PlayerOfferingData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.internal_static_PlayerOfferingData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData.class, emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData other = (emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.internal_static_PlayerOfferingData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData build() {
        emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData buildPartial() {
        emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData result = new emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData other) {
        if (other == emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData();
    }

    public static emu.grasscutter.net.oldproto.PlayerOfferingDataOuterClass.PlayerOfferingData getDefaultInstance() {
