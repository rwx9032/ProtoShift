...
public final class ChangeMailStarNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.class, emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify other = (emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.internal_static_ChangeMailStarNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify build() {
        emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify buildPartial() {
        emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify result = new emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify other) {
        if (other == emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify();
    }

    public static emu.grasscutter.net.oldproto.ChangeMailStarNotifyOuterClass.ChangeMailStarNotify getDefaultInstance() {
