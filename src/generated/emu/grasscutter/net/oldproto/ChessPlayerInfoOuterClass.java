...
public final class ChessPlayerInfoOuterClass {
  ...
  public interface ChessPlayerInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo> 
        getCandidateCardInfoListList();
    /**
     * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
     */
    emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo getCandidateCardInfoList(int index);
    /**
     * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
     */
     ...
     * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder> 
        getCandidateCardInfoListOrBuilderList();
    /**
     * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
     */
    emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder getCandidateCardInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.internal_static_ChessPlayerInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.internal_static_ChessPlayerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.class, emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo> candidateCardInfoList_;
    /**
     * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo> getCandidateCardInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder> 
        getCandidateCardInfoListOrBuilderList() {
      return candidateCardInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo getCandidateCardInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder getCandidateCardInfoListOrBuilder(
        int index) {
      return candidateCardInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo other = (emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.internal_static_ChessPlayerInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo build() {
        emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo buildPartial() {
        emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo result = new emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo other) {
        if (other == emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 26: {
                emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.parser(),
                        extensionRegistry);
                if (candidateCardInfoListBuilder_ == null) {
                  ensureCandidateCardInfoListIsMutable();
      ...
      private void ensureCandidateCardInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          candidateCardInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo>(candidateCardInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder> candidateCardInfoListBuilder_;
      ...
      public Builder setCandidateCardInfoList(
          int index, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo value) {
        if (candidateCardInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCandidateCardInfoList(
          int index, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder builderForValue) {
        if (candidateCardInfoListBuilder_ == null) {
          ensureCandidateCardInfoListIsMutable();
       ...
       * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
       */
      public Builder addCandidateCardInfoList(emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo value) {
        if (candidateCardInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCandidateCardInfoList(
          emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder builderForValue) {
        if (candidateCardInfoListBuilder_ == null) {
          ensureCandidateCardInfoListIsMutable();
      ...
      public Builder addAllCandidateCardInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo> values) {
        if (candidateCardInfoListBuilder_ == null) {
          ensureCandidateCardInfoListIsMutable();
       ...
       * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder getCandidateCardInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder addCandidateCardInfoListBuilder() {
        return getCandidateCardInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
       */
      public emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder addCandidateCardInfoListBuilder(
          int index) {
        return getCandidateCardInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessNormalCardInfo candidate_card_info_list = 3;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder> 
           getCandidateCardInfoListBuilderList() {
        return getCandidateCardInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfo.Builder, emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.ChessNormalCardInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo();
    }

    public static emu.grasscutter.net.oldproto.ChessPlayerInfoOuterClass.ChessPlayerInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r \001(\r\022\024\n\014refresh_cost\030\007 \001(\rB\036\n\034emu.grass" +
      "cutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ChessNormalCardInfoOuterClass.getDescriptor(),
        });
    internal_static_ChessPlayerInfo_descriptor =
