...
public final class UgcActivityDetailInfoOuterClass {
  ...
  public interface UgcActivityDetailInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> 
        getOfficialCustomDungeonListList();
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon getOfficialCustomDungeonList(int index);
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
     */
     ...
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> 
        getOfficialCustomDungeonListOrBuilderList();
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder getOfficialCustomDungeonListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.internal_static_UgcActivityDetailInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.internal_static_UgcActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.class, emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> officialCustomDungeonList_;
    /**
     * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> getOfficialCustomDungeonListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> 
        getOfficialCustomDungeonListOrBuilderList() {
      return officialCustomDungeonList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon getOfficialCustomDungeonList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder getOfficialCustomDungeonListOrBuilder(
        int index) {
      return officialCustomDungeonList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo other = (emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.internal_static_UgcActivityDetailInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo build() {
        emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo buildPartial() {
        emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo result = new emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo other) {
        if (other == emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 42: {
                emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.parser(),
                        extensionRegistry);
                if (officialCustomDungeonListBuilder_ == null) {
                  ensureOfficialCustomDungeonListIsMutable();
      ...
      private void ensureOfficialCustomDungeonListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          officialCustomDungeonList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon>(officialCustomDungeonList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> officialCustomDungeonListBuilder_;
      ...
      public Builder setOfficialCustomDungeonList(
          int index, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon value) {
        if (officialCustomDungeonListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setOfficialCustomDungeonList(
          int index, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder builderForValue) {
        if (officialCustomDungeonListBuilder_ == null) {
          ensureOfficialCustomDungeonListIsMutable();
       ...
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
       */
      public Builder addOfficialCustomDungeonList(emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon value) {
        if (officialCustomDungeonListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addOfficialCustomDungeonList(
          emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder builderForValue) {
        if (officialCustomDungeonListBuilder_ == null) {
          ensureOfficialCustomDungeonListIsMutable();
      ...
      public Builder addAllOfficialCustomDungeonList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon> values) {
        if (officialCustomDungeonListBuilder_ == null) {
          ensureOfficialCustomDungeonListIsMutable();
       ...
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder getOfficialCustomDungeonListBuilder(
          int index) {
       ...
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder addOfficialCustomDungeonListBuilder() {
        return getOfficialCustomDungeonListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.getDefaultInstance());
      }
      /**
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder addOfficialCustomDungeonListBuilder(
          int index) {
        return getOfficialCustomDungeonListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.getDefaultInstance());
      }
      /**
       * <code>repeated .OfficialCustomDungeon official_custom_dungeon_list = 5;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder> 
           getOfficialCustomDungeonListBuilderList() {
        return getOfficialCustomDungeonListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeon.Builder, emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.OfficialCustomDungeonOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo();
    }

    public static emu.grasscutter.net.oldproto.UgcActivityDetailInfoOuterClass.UgcActivityDetailInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tomDungeon\022\025\n\ris_enable_ugc\030\013 \001(\010B\036\n\034emu" +
      ".grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.OfficialCustomDungeonOuterClass.getDescriptor(),
        });
    internal_static_UgcActivityDetailInfo_descriptor =
