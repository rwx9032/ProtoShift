...
public final class SceneFishInfoOuterClass {
  ...
  public interface SceneFishInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.Vector getFishPoolPos();
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.class, emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.VectorOuterClass.Vector fishPoolPos_;
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     * @return Whether the fishPoolPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.Vector getFishPoolPos() {
      return fishPoolPos_ == null ? emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
    }
    /**
     * <code>.Vector fish_pool_pos = 3;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo other = (emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.internal_static_SceneFishInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo build() {
        emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo buildPartial() {
        emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo result = new emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo other) {
        if (other == emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.VectorOuterClass.Vector, emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder> fishPoolPosBuilder_;
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
       * @return Whether the fishPoolPos field is set.
       */
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder setFishPoolPos(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public Builder mergeFishPoolPos(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (fishPoolPosBuilder_ == null) {
          if (fishPoolPos_ != null) {
            fishPoolPos_ =
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.newBuilder(fishPoolPos_).mergeFrom(value).buildPartial();
          } else {
            fishPoolPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector fish_pool_pos = 3;</code>
       */
      public emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder getFishPoolPosBuilder() {
      ...
      public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getFishPoolPosOrBuilder() {
        if (fishPoolPosBuilder_ != null) {
          ...
          return fishPoolPos_ == null ?
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : fishPoolPos_;
        }
      }
      /**
       * <code>.Vector fish_pool_pos = 3;</code>
    ...
    private static final emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo();
    }

    public static emu.grasscutter.net.oldproto.SceneFishInfoOuterClass.SceneFishInfo getDefaultInstance() {
