...
public final class ParentQuestOuterClass {
  ...
  public interface ParentQuestOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo> 
        getInferencePageListList();
    /**
     * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
     */
    emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo getInferencePageList(int index);
    /**
     * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
     */
     ...
     * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfoOrBuilder> 
        getInferencePageListOrBuilderList();
    /**
     * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
     */
    emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfoOrBuilder getInferencePageListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo getRandomInfo();
    /**
     * <code>.ParentQuestRandomInfo random_info = 12;</code>
     */
    emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder getRandomInfoOrBuilder();
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest> 
        getChildQuestListList();
    /**
     * <code>repeated .ChildQuest child_quest_list = 9;</code>
     */
    emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest getChildQuestList(int index);
    /**
     * <code>repeated .ChildQuest child_quest_list = 9;</code>
     */
     ...
     * <code>repeated .ChildQuest child_quest_list = 9;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuestOrBuilder> 
        getChildQuestListOrBuilderList();
    /**
     * <code>repeated .ChildQuest child_quest_list = 9;</code>
     */
    emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuestOrBuilder getChildQuestListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ParentQuestOuterClass.internal_static_ParentQuest_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.ParentQuestOuterClass.internal_static_ParentQuest_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest.class, emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.ParentQuestOuterClass.internal_static_ParentQuest_TimeVarMapEntry_descriptor, 
    ...
    private java.util.List<emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo> inferencePageList_;
    /**
     * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo> getInferencePageListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfoOrBuilder> 
        getInferencePageListOrBuilderList() {
      return inferencePageList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo getInferencePageList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfoOrBuilder getInferencePageListOrBuilder(
        int index) {
      return inferencePageList_.get(index);
    }

    public static final int RANDOM_INFO_FIELD_NUMBER = 12;
    private emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo randomInfo_;
    /**
     * <code>.ParentQuestRandomInfo random_info = 12;</code>
     * @return Whether the randomInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo getRandomInfo() {
      return randomInfo_ == null ? emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.getDefaultInstance() : randomInfo_;
    }
    /**
     * <code>.ParentQuestRandomInfo random_info = 12;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder getRandomInfoOrBuilder() {
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest> childQuestList_;
    /**
     * <code>repeated .ChildQuest child_quest_list = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest> getChildQuestListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuestOrBuilder> 
        getChildQuestListOrBuilderList() {
      return childQuestList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest getChildQuestList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuestOrBuilder getChildQuestListOrBuilder(
        int index) {
      return childQuestList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest other = (emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest) obj;
    ...
    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuestOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ParentQuestOuterClass.internal_static_ParentQuest_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest build() {
        emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest buildPartial() {
        emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest result = new emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest) {
          return mergeFrom((emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest other) {
        if (other == emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74: {
                emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.parser(),
                        extensionRegistry);
                if (childQuestListBuilder_ == null) {
                  ensureChildQuestListIsMutable();
              ...
              case 122: {
                emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.parser(),
                        extensionRegistry);
                if (inferencePageListBuilder_ == null) {
                  ensureInferencePageListIsMutable();
      ...
      private void ensureInferencePageListIsMutable() {
        if (!((bitField0_ & 0x00000004) != 0)) {
          inferencePageList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo>(inferencePageList_);
          bitField0_ |= 0x00000004;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfoOrBuilder> inferencePageListBuilder_;
      ...
      public Builder setInferencePageList(
          int index, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo value) {
        if (inferencePageListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setInferencePageList(
          int index, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder builderForValue) {
        if (inferencePageListBuilder_ == null) {
          ensureInferencePageListIsMutable();
       ...
       * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
       */
      public Builder addInferencePageList(emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo value) {
        if (inferencePageListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addInferencePageList(
          emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder builderForValue) {
        if (inferencePageListBuilder_ == null) {
          ensureInferencePageListIsMutable();
      ...
      public Builder addAllInferencePageList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo> values) {
        if (inferencePageListBuilder_ == null) {
          ensureInferencePageListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder getInferencePageListBuilder(
          int index) {
       ...
       * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder addInferencePageListBuilder() {
        return getInferencePageListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder addInferencePageListBuilder(
          int index) {
        return getInferencePageListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .InferencePageInfo inference_page_list = 15;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder> 
           getInferencePageListBuilderList() {
        return getInferencePageListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfo.Builder, emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.InferencePageInfoOrBuilder> 
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo, emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder, emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder> randomInfoBuilder_;
      /**
       * <code>.ParentQuestRandomInfo random_info = 12;</code>
       * @return Whether the randomInfo field is set.
       */
       ...
       * <code>.ParentQuestRandomInfo random_info = 12;</code>
       */
      public Builder setRandomInfo(emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo value) {
        if (randomInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setRandomInfo(
          emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder builderForValue) {
        if (randomInfoBuilder_ == null) {
       ...
       * <code>.ParentQuestRandomInfo random_info = 12;</code>
       */
      public Builder mergeRandomInfo(emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo value) {
        if (randomInfoBuilder_ == null) {
          if (randomInfo_ != null) {
            randomInfo_ =
              emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.newBuilder(randomInfo_).mergeFrom(value).buildPartial();
          } else {
            randomInfo_ = value;
          }
          onChanged();
       ...
       * <code>.ParentQuestRandomInfo random_info = 12;</code>
       */
      public emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder getRandomInfoBuilder() {
      ...
      public emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder getRandomInfoOrBuilder() {
        if (randomInfoBuilder_ != null) {
          ...
          return randomInfo_ == null ?
              emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.getDefaultInstance() : randomInfo_;
        }
      }
      /**
       * <code>.ParentQuestRandomInfo random_info = 12;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo, emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfo.Builder, emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.ParentQuestRandomInfoOrBuilder> 
      ...
      private void ensureChildQuestListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          childQuestList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest>(childQuestList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuestOrBuilder> childQuestListBuilder_;
      ...
      public Builder setChildQuestList(
          int index, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest value) {
        if (childQuestListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setChildQuestList(
          int index, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder builderForValue) {
        if (childQuestListBuilder_ == null) {
          ensureChildQuestListIsMutable();
       ...
       * <code>repeated .ChildQuest child_quest_list = 9;</code>
       */
      public Builder addChildQuestList(emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest value) {
        if (childQuestListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addChildQuestList(
          emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder builderForValue) {
        if (childQuestListBuilder_ == null) {
          ensureChildQuestListIsMutable();
      ...
      public Builder addAllChildQuestList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest> values) {
        if (childQuestListBuilder_ == null) {
          ensureChildQuestListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .ChildQuest child_quest_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder getChildQuestListBuilder(
          int index) {
       ...
       * <code>repeated .ChildQuest child_quest_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder addChildQuestListBuilder() {
        return getChildQuestListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.getDefaultInstance());
      }
      /**
       * <code>repeated .ChildQuest child_quest_list = 9;</code>
       */
      public emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder addChildQuestListBuilder(
          int index) {
        return getChildQuestListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.getDefaultInstance());
      }
      /**
       * <code>repeated .ChildQuest child_quest_list = 9;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder> 
           getChildQuestListBuilderList() {
        return getChildQuestListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuest.Builder, emu.grasscutter.net.oldproto.ChildQuestOuterClass.ChildQuestOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest();
    }

    public static emu.grasscutter.net.oldproto.ParentQuestOuterClass.ParentQuest getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ChildQuestOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.InferencePageInfoOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.ParentQuestRandomInfoOuterClass.getDescriptor(),
        });
    internal_static_ParentQuest_descriptor =
