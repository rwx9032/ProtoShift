...
public final class PlayerStoreNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.internal_static_PlayerStoreNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.internal_static_PlayerStoreNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify.class, emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify other = (emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.internal_static_PlayerStoreNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify build() {
        emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify buildPartial() {
        emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify result = new emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify other) {
        if (other == emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify();
    }

    public static emu.grasscutter.net.oldproto.PlayerStoreNotifyOuterClass.PlayerStoreNotify getDefaultInstance() {
