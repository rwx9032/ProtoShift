...
public final class MechanicusInfoOuterClass {
  ...
  public interface MechanicusInfoOrBuilder extends
     ...
     * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
     */
    emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair getGearLevelPairList(int index);
    /**
     * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
     */
     ...
     * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
     */
    emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32PairOrBuilder getGearLevelPairListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.internal_static_MechanicusInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.internal_static_MechanicusInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo.class, emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo.Builder.class);
    }

    public static final int GEAR_LEVEL_PAIR_LIST_FIELD_NUMBER = 14;
    private java.util.List<emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair> gearLevelPairList_;
    /**
     * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair> getGearLevelPairListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair getGearLevelPairList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32PairOrBuilder getGearLevelPairListOrBuilder(
        int index) {
      return gearLevelPairList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo other = (emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.internal_static_MechanicusInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo build() {
        emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo buildPartial() {
        emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo result = new emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo other) {
        if (other == emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo.getDefaultInstance()) return this;
        if (gearLevelPairListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 104: {
                int v = input.readUInt32();
                ensureFinishDifficultLevelListIsMutable();
                finishDifficultLevelList_.addInt(v);
                break;
              } // case 104
              case 106: {
                int length = input.readRawVarint32();
      ...
      private void ensureGearLevelPairListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          gearLevelPairList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair>(gearLevelPairList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair, emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair.Builder, emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32PairOrBuilder> gearLevelPairListBuilder_;
       ...
       * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
       */
      public Builder addGearLevelPairList(emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair value) {
        if (gearLevelPairListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
       */
      public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair.Builder getGearLevelPairListBuilder(
          int index) {
       ...
       * <code>repeated .Uint32Pair gear_level_pair_list = 14;</code>
       */
      public emu.grasscutter.net.oldproto.Uint32PairOuterClass.Uint32Pair.Builder addGearLevelPairListBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo();
    }

    public static emu.grasscutter.net.oldproto.MechanicusInfoOuterClass.MechanicusInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "finish_teach_dungeon\030\004 \001(\010B\036\n\034emu.grassc" +
