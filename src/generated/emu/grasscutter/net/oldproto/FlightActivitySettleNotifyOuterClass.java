...
public final class FlightActivitySettleNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.internal_static_FlightActivitySettleNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.internal_static_FlightActivitySettleNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify.class, emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify other = (emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.internal_static_FlightActivitySettleNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify build() {
        emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify buildPartial() {
        emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify result = new emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify other) {
        if (other == emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify();
    }

    public static emu.grasscutter.net.oldproto.FlightActivitySettleNotifyOuterClass.FlightActivitySettleNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r\022\022\n\nis_success\030\004 \001(\010B\036\n\034emu.grasscutter" +
