...
public final class ActivityScheduleInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.internal_static_ActivityScheduleInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.internal_static_ActivityScheduleInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify.class, emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify other = (emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.internal_static_ActivityScheduleInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify build() {
        emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify buildPartial() {
        emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify result = new emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify other) {
        if (other == emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify.getDefaultInstance()) return this;
        if (activityScheduleListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify();
    }

    public static emu.grasscutter.net.oldproto.ActivityScheduleInfoNotifyOuterClass.ActivityScheduleInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "y_sea_lamp_num\030\006 \001(\rB\036\n\034emu.grasscutter." +
