...
public final class GCGOperationRebootOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.internal_static_GCGOperationReboot_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.internal_static_GCGOperationReboot_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot.class, emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot other = (emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationRebootOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.internal_static_GCGOperationReboot_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot build() {
        emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot buildPartial() {
        emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot result = new emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot other) {
        if (other == emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot();
    }

    public static emu.grasscutter.net.oldproto.GCGOperationRebootOuterClass.GCGOperationReboot getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\017dice_index_list\030\006 \003(\rB\036\n\034emu.grasscutte" +
