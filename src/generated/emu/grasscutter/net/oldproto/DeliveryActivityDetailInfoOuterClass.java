...
public final class DeliveryActivityDetailInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.internal_static_DeliveryActivityDetailInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.internal_static_DeliveryActivityDetailInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.class, emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo other = (emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.internal_static_DeliveryActivityDetailInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo build() {
        emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo buildPartial() {
        emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo result = new emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo other) {
        if (other == emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo();
    }

    public static emu.grasscutter.net.oldproto.DeliveryActivityDetailInfoOuterClass.DeliveryActivityDetailInfo getDefaultInstance() {
