...
public final class QuestCreateEntityRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.internal_static_QuestCreateEntityRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.internal_static_QuestCreateEntityRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp.class, emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp other = (emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.internal_static_QuestCreateEntityRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp build() {
        emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp buildPartial() {
        emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp result = new emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp other) {
        if (other == emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp();
    }

    public static emu.grasscutter.net.oldproto.QuestCreateEntityRspOuterClass.QuestCreateEntityRsp getDefaultInstance() {
