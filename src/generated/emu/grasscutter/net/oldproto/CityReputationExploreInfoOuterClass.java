...
public final class CityReputationExploreInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.internal_static_CityReputationExploreInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.internal_static_CityReputationExploreInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.class, emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo other = (emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.internal_static_CityReputationExploreInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo build() {
        emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo buildPartial() {
        emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo result = new emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo other) {
        if (other == emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo();
    }

    public static emu.grasscutter.net.oldproto.CityReputationExploreInfoOuterClass.CityReputationExploreInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "(\r\022\017\n\007is_open\030\017 \001(\010B\036\n\034emu.grasscutter.n" +
