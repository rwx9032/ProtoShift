...
public final class TakeCompoundOutputRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.internal_static_TakeCompoundOutputRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.internal_static_TakeCompoundOutputRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.class, emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp other = (emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.internal_static_TakeCompoundOutputRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp build() {
        emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp buildPartial() {
        emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp result = new emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp other) {
        if (other == emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp();
    }

    public static emu.grasscutter.net.oldproto.TakeCompoundOutputRspOuterClass.TakeCompoundOutputRsp getDefaultInstance() {
