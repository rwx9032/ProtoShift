...
public final class FurnitureMakeBeHelpedDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.class, emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData other = (emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData) obj;
    ...
    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.internal_static_FurnitureMakeBeHelpedData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData build() {
        emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData buildPartial() {
        emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData result = new emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData(this);
        result.time_ = time_;
        result.icon_ = icon_;
        result.uid_ = uid_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData) {
          return mergeFrom((emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData other) {
        if (other == emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData.getDefaultInstance()) return this;
        if (other.getTime() != 0) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData();
    }

    public static emu.grasscutter.net.oldproto.FurnitureMakeBeHelpedDataOuterClass.FurnitureMakeBeHelpedData getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "icture\030\001 \001(\0132\017.ProfilePictureB\036\n\034emu.gra" +
