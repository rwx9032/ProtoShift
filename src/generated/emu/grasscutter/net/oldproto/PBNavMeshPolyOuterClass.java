...
public final class PBNavMeshPolyOuterClass {
  ...
  public interface PBNavMeshPolyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> getEdgeTypesList();
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 10;</code>
     ...
     */
    emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType getEdgeTypes(int index);
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 10;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.class, emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.Builder.class);
    }
    ...
    public enum EdgeType
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private static final com.google.protobuf.Internal.ListAdapter.Converter<
        java.lang.Integer, emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> edgeTypes_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
                java.lang.Integer, emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType>() {
              public emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType convert(java.lang.Integer from) {
                @SuppressWarnings("deprecation")
                emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType result = emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType.valueOf(from);
                return result == null ? emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType.UNRECOGNIZED : result;
              }
            };
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 10;</code>
     ...
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> getEdgeTypesList() {
      return new com.google.protobuf.Internal.ListAdapter<
          java.lang.Integer, emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType>(edgeTypes_, edgeTypes_converter_);
    }
    /**
     * <code>repeated .PBNavMeshPoly.EdgeType edge_types = 10;</code>
     * @return The count of edgeTypes.
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType getEdgeTypes(int index) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly other = (emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly) obj;
    ...
    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPolyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.internal_static_PBNavMeshPoly_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly build() {
        emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly buildPartial() {
        emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly result = new emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly) {
          return mergeFrom((emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly other) {
        if (other == emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.getDefaultInstance()) return this;
      ...
      public Builder setEdgeTypes(
          int index, emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value) {
        if (value == null) {
       ...
       * @return This builder for chaining.
       */
      public Builder addEdgeTypes(emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value) {
        if (value == null) {
          throw new NullPointerException();
        }
        ensureEdgeTypesIsMutable();
      ...
      public Builder addAllEdgeTypes(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType> values) {
        ensureEdgeTypesIsMutable();
        for (emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly.EdgeType value : values) {
          edgeTypes_.add(value.getNumber());
        }
        onChanged();
        return this;
    ...
    private static final emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly();
    }

    public static emu.grasscutter.net.oldproto.PBNavMeshPolyOuterClass.PBNavMeshPoly getDefaultInstance() {
