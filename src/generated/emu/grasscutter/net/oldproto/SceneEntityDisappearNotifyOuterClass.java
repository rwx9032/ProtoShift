...
public final class SceneEntityDisappearNotifyOuterClass {
  ...
  public interface SceneEntityDisappearNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType getDisappearType();
  }
  /**
   * <pre>
   * CmdId: 203
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.internal_static_SceneEntityDisappearNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.internal_static_SceneEntityDisappearNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.class, emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.Builder.class);
    }
     ...
     * @return The disappearType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType getDisappearType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType result = emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType.valueOf(disappearType_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (disappearType_ != emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType.VISION_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify other = (emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.internal_static_SceneEntityDisappearNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify build() {
        emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify buildPartial() {
        emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify result = new emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify other) {
        if (other == emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify.getDefaultInstance()) return this;
        if (other.getParam() != 0) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType getDisappearType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType result = emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType.valueOf(disappearType_);
        return result == null ? emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setDisappearType(emu.grasscutter.net.oldproto.VisionTypeOuterClass.VisionType value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify();
    }

    public static emu.grasscutter.net.oldproto.SceneEntityDisappearNotifyOuterClass.SceneEntityDisappearNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\016disappear_type\030\002 \001(\0162\013.VisionTypeB\036\n\034e" +
