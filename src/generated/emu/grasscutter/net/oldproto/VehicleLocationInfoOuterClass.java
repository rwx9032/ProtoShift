...
public final class VehicleLocationInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.internal_static_VehicleLocationInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.internal_static_VehicleLocationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo.class, emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo other = (emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.internal_static_VehicleLocationInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo build() {
        emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo buildPartial() {
        emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo result = new emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo other) {
        if (other == emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo.getDefaultInstance()) return this;
        if (other.hasRot()) {
    ...
    private static final emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo();
    }

    public static emu.grasscutter.net.oldproto.VehicleLocationInfoOuterClass.VehicleLocationInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\016\n\006max_hp\030\006 \001(\002B\036\n\034emu.grasscutter.net." +
      "oldprotob\006proto3"
    };
