...
public final class TowerLevelRecordOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.internal_static_TowerLevelRecord_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.internal_static_TowerLevelRecord_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord.class, emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord other = (emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord) obj;
    ...
    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecordOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.internal_static_TowerLevelRecord_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord build() {
        emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord buildPartial() {
        emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord result = new emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord) {
          return mergeFrom((emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord other) {
        if (other == emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord();
    }

    public static emu.grasscutter.net.oldproto.TowerLevelRecordOuterClass.TowerLevelRecord getDefaultInstance() {
