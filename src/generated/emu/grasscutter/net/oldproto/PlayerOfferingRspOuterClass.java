...
public final class PlayerOfferingRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.internal_static_PlayerOfferingRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.internal_static_PlayerOfferingRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp.class, emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp other = (emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.internal_static_PlayerOfferingRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp build() {
        emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp buildPartial() {
        emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp result = new emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp other) {
        if (other == emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp();
    }

    public static emu.grasscutter.net.oldproto.PlayerOfferingRspOuterClass.PlayerOfferingRsp getDefaultInstance() {
