...
public final class GetUgcReqOuterClass {
  ...
  public interface GetUgcReqOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType getGetUgcType();
  }
  /**
   * <pre>
   * CmdId: 6326
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GetUgcReqOuterClass.internal_static_GetUgcReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GetUgcReqOuterClass.internal_static_GetUgcReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq.class, emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq.Builder.class);
    }
     ...
     * @return The getUgcType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType getGetUgcType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType result = emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType.valueOf(getUgcType_);
      return result == null ? emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (getUgcType_ != emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType.GET_UGC_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq other = (emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GetUgcReqOuterClass.internal_static_GetUgcReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq build() {
        emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq buildPartial() {
        emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq result = new emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq other) {
        if (other == emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq.getDefaultInstance()) return this;
        if (other.ugcType_ != 0) {
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType getGetUgcType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType result = emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType.valueOf(getUgcType_);
        return result == null ? emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setGetUgcType(emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.GetUgcType value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq();
    }

    public static emu.grasscutter.net.oldproto.GetUgcReqOuterClass.GetUgcReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "et_ugc_type\030\r \001(\0162\013.GetUgcTypeB\036\n\034emu.gr" +
      "asscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.GetUgcTypeOuterClass.getDescriptor(),
