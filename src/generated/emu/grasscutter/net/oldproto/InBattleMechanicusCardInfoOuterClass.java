...
public final class InBattleMechanicusCardInfoOuterClass {
  ...
  public interface InBattleMechanicusCardInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState getChallengeState();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.internal_static_InBattleMechanicusCardInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.internal_static_InBattleMechanicusCardInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo.class, emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo.Builder.class);
    }
     ...
     * @return The challengeState.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState getChallengeState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState result = emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState.valueOf(challengeState_);
      return result == null ? emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (challengeState_ != emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState.IN_BATTLE_MECHANICUS_CARD_CHALLENGE_STATE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo other = (emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.internal_static_InBattleMechanicusCardInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo build() {
        emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo buildPartial() {
        emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo result = new emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo other) {
        if (other == emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState getChallengeState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState result = emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState.valueOf(challengeState_);
        return result == null ? emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setChallengeState(emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.InBattleMechanicusCardChallengeState value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo();
    }

    public static emu.grasscutter.net.oldproto.InBattleMechanicusCardInfoOuterClass.InBattleMechanicusCardInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\007card_id\030\013 \001(\r\022\023\n\013begin_round\030\010 \001(\rB\036\n\034e" +
      "mu.grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.InBattleMechanicusCardChallengeStateOuterClass.getDescriptor(),
        });
    internal_static_InBattleMechanicusCardInfo_descriptor =
