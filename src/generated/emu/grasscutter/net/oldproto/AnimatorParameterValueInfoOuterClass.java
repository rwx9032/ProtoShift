...
public final class AnimatorParameterValueInfoOuterClass {
  ...
  public interface AnimatorParameterValueInfoOrBuilder extends
    ...
    public emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo.ParaValCase getParaValCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.internal_static_AnimatorParameterValueInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.internal_static_AnimatorParameterValueInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo.class, emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo other = (emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.internal_static_AnimatorParameterValueInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo build() {
        emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo buildPartial() {
        emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo result = new emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo other) {
        if (other == emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo();
    }

    public static emu.grasscutter.net.oldproto.AnimatorParameterValueInfoOuterClass.AnimatorParameterValueInfo getDefaultInstance() {
