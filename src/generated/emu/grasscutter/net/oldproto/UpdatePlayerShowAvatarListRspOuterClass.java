...
public final class UpdatePlayerShowAvatarListRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.internal_static_UpdatePlayerShowAvatarListRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.internal_static_UpdatePlayerShowAvatarListRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.class, emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp other = (emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.internal_static_UpdatePlayerShowAvatarListRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp build() {
        emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp buildPartial() {
        emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp result = new emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp other) {
        if (other == emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp();
    }

    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListRspOuterClass.UpdatePlayerShowAvatarListRsp getDefaultInstance() {
