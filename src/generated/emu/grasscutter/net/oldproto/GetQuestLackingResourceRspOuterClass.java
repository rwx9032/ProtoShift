...
public final class GetQuestLackingResourceRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.internal_static_GetQuestLackingResourceRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.internal_static_GetQuestLackingResourceRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp.class, emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.internal_static_GetQuestLackingResourceRsp_LackedNpcMapEntry_descriptor, 
    ...
    private static final class LackedPlaceMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.internal_static_GetQuestLackingResourceRsp_LackedPlaceMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp other = (emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.internal_static_GetQuestLackingResourceRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp build() {
        emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp buildPartial() {
        emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp result = new emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp other) {
        if (other == emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp();
    }

    public static emu.grasscutter.net.oldproto.GetQuestLackingResourceRspOuterClass.GetQuestLackingResourceRsp getDefaultInstance() {
