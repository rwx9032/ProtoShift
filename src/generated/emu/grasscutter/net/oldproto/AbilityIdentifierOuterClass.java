...
public final class AbilityIdentifierOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.internal_static_AbilityIdentifier_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.internal_static_AbilityIdentifier_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier.class, emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier other = (emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifierOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.internal_static_AbilityIdentifier_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier build() {
        emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier buildPartial() {
        emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier result = new emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier other) {
        if (other == emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier();
    }

    public static emu.grasscutter.net.oldproto.AbilityIdentifierOuterClass.AbilityIdentifier getDefaultInstance() {
