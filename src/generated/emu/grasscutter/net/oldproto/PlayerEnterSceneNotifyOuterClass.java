...
public final class PlayerEnterSceneNotifyOuterClass {
  ...
  public interface PlayerEnterSceneNotifyOrBuilder extends
     ...
     * @return The type.
     */
    emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType getType();
     ...
     * @return The prevPos.
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.Vector getPrevPos();
    /**
     * <code>.Vector prev_pos = 8;</code>
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getPrevPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.internal_static_PlayerEnterSceneNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.internal_static_PlayerEnterSceneNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify.class, emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify.Builder.class);
    }
     ...
     * @return The type.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType getType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType result = emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType.valueOf(type_);
      return result == null ? emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType.UNRECOGNIZED : result;
    }
    ...
    private emu.grasscutter.net.oldproto.VectorOuterClass.Vector prevPos_;
    /**
     * <code>.Vector prev_pos = 8;</code>
     * @return Whether the prevPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.Vector getPrevPos() {
      return prevPos_ == null ? emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : prevPos_;
    }
    /**
     * <code>.Vector prev_pos = 8;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getPrevPosOrBuilder() {
      return getPrevPos();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (type_ != emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType.ENTER_TYPE_NONE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify other = (emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.internal_static_PlayerEnterSceneNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify build() {
        emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify buildPartial() {
        emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify result = new emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify other) {
        if (other == emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType getType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType result = emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType.valueOf(type_);
        return result == null ? emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setType(emu.grasscutter.net.oldproto.EnterTypeOuterClass.EnterType value) {
        if (value == null) {
  ...
  checkByteStringIsUtf8(value);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.VectorOuterClass.Vector, emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder> prevPosBuilder_;
      /**
       * <code>.Vector prev_pos = 8;</code>
       * @return Whether the prevPos field is set.
       */
       ...
       * <code>.Vector prev_pos = 8;</code>
       */
      public Builder setPrevPos(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (prevPosBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector prev_pos = 8;</code>
       */
      public Builder mergePrevPos(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (prevPosBuilder_ == null) {
          if (prevPos_ != null) {
            prevPos_ =
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.newBuilder(prevPos_).mergeFrom(value).buildPartial();
          } else {
            prevPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector prev_pos = 8;</code>
       */
      public emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder getPrevPosBuilder() {
      ...
      public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getPrevPosOrBuilder() {
        if (prevPosBuilder_ != null) {
          ...
          return prevPos_ == null ?
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : prevPos_;
        }
      }
      /**
       * <code>.Vector prev_pos = 8;</code>
    ...
    private static final emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify();
    }

    public static emu.grasscutter.net.oldproto.PlayerEnterSceneNotifyOuterClass.PlayerEnterSceneNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      ".Vector\022\031\n\021enter_scene_token\030\002 \001(\rB\036\n\034em" +
      "u.grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.EnterTypeOuterClass.getDescriptor(),
