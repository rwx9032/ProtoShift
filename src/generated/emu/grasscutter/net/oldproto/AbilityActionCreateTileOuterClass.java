...
public final class AbilityActionCreateTileOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.internal_static_AbilityActionCreateTile_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.internal_static_AbilityActionCreateTile_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile.class, emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile other = (emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTileOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.internal_static_AbilityActionCreateTile_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile build() {
        emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile buildPartial() {
        emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile result = new emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile(this);
        if (rotBuilder_ == null) {
          result.rot_ = rot_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile other) {
        if (other == emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile.getDefaultInstance()) return this;
        if (other.hasRot()) {
    ...
    private static final emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile();
    }

    public static emu.grasscutter.net.oldproto.AbilityActionCreateTileOuterClass.AbilityActionCreateTile getDefaultInstance() {
