...
public final class HomeGroupPlayerInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.internal_static_HomeGroupPlayerInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.internal_static_HomeGroupPlayerInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.class, emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo other = (emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.internal_static_HomeGroupPlayerInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo build() {
        emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo buildPartial() {
        emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo result = new emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo other) {
        if (other == emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo();
    }

    public static emu.grasscutter.net.oldproto.HomeGroupPlayerInfoOuterClass.HomeGroupPlayerInfo getDefaultInstance() {
