...
public final class ActivityGiveFriendGiftRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.internal_static_ActivityGiveFriendGiftRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.internal_static_ActivityGiveFriendGiftRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp.class, emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp other = (emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.internal_static_ActivityGiveFriendGiftRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp build() {
        emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp buildPartial() {
        emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp result = new emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp other) {
        if (other == emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp();
    }

    public static emu.grasscutter.net.oldproto.ActivityGiveFriendGiftRspOuterClass.ActivityGiveFriendGiftRsp getDefaultInstance() {
