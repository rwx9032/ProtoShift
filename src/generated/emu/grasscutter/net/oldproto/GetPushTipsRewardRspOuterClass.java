...
public final class GetPushTipsRewardRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.internal_static_GetPushTipsRewardRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.internal_static_GetPushTipsRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp.class, emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp other = (emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.internal_static_GetPushTipsRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp build() {
        emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp buildPartial() {
        emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp result = new emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp other) {
        if (other == emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp();
    }

    public static emu.grasscutter.net.oldproto.GetPushTipsRewardRspOuterClass.GetPushTipsRewardRsp getDefaultInstance() {
