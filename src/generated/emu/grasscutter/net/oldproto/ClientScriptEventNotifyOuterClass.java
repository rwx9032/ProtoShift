...
public final class ClientScriptEventNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.internal_static_ClientScriptEventNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.internal_static_ClientScriptEventNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.class, emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify other = (emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.internal_static_ClientScriptEventNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify build() {
        emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify buildPartial() {
        emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify result = new emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify other) {
        if (other == emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify();
    }

    public static emu.grasscutter.net.oldproto.ClientScriptEventNotifyOuterClass.ClientScriptEventNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      " \001(\r\022\030\n\020target_entity_id\030\r \001(\rB\036\n\034emu.gr" +
