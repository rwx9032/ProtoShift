...
public final class DungeonCandidateTeamInviteRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.internal_static_DungeonCandidateTeamInviteRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.internal_static_DungeonCandidateTeamInviteRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp.class, emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp other = (emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.internal_static_DungeonCandidateTeamInviteRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp build() {
        emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp buildPartial() {
        emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp result = new emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp other) {
        if (other == emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp();
    }

    public static emu.grasscutter.net.oldproto.DungeonCandidateTeamInviteRspOuterClass.DungeonCandidateTeamInviteRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e\030\014 \001(\005\022\033\n\023invalid_player_uids\030\007 \003(\rB\036\n\034" +
