...
public final class EntityAiSyncNotifyOuterClass {
  ...
  public interface EntityAiSyncNotifyOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo> 
        getInfoListList();
    /**
     * <code>repeated .AiSyncInfo info_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo getInfoList(int index);
    /**
     * <code>repeated .AiSyncInfo info_list = 1;</code>
     */
     ...
     * <code>repeated .AiSyncInfo info_list = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList();
    /**
     * <code>repeated .AiSyncInfo info_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index);
  }
  /**
   * <pre>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.class, emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo> infoList_;
    /**
     * <code>repeated .AiSyncInfo info_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo> getInfoListList() {
      return infoList_;
    }
    /**
     * <code>repeated .AiSyncInfo info_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
        getInfoListOrBuilderList() {
      return infoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo getInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder getInfoListOrBuilder(
        int index) {
      return infoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other = (emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.internal_static_EntityAiSyncNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify build() {
        emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify buildPartial() {
        emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify result = new emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify other) {
        if (other == emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.parser(),
                        extensionRegistry);
                if (infoListBuilder_ == null) {
                  ensureInfoListIsMutable();
                  infoList_.add(m);
      ...
      private void ensureInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          infoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo>(infoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> infoListBuilder_;
      ...
      public Builder setInfoList(
          int index, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setInfoList(
          int index, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
       ...
       * <code>repeated .AiSyncInfo info_list = 1;</code>
       */
      public Builder addInfoList(emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo value) {
        if (infoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addInfoList(
          emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder builderForValue) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
      ...
      public Builder addAllInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo> values) {
        if (infoListBuilder_ == null) {
          ensureInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, infoList_);
       ...
       * <code>repeated .AiSyncInfo info_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder getInfoListBuilder(
          int index) {
       ...
       * <code>repeated .AiSyncInfo info_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder() {
        return getInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo info_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder addInfoListBuilder(
          int index) {
        return getInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .AiSyncInfo info_list = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder> 
           getInfoListBuilderList() {
        return getInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfo.Builder, emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.AiSyncInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify();
    }

    public static emu.grasscutter.net.oldproto.EntityAiSyncNotifyOuterClass.EntityAiSyncNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "st\030\001 \003(\0132\013.AiSyncInfoB\036\n\034emu.grasscutter" +
      ".net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.AiSyncInfoOuterClass.getDescriptor(),
        });
    internal_static_EntityAiSyncNotify_descriptor =
