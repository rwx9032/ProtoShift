...
public final class PlayerLocationInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.internal_static_PlayerLocationInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.internal_static_PlayerLocationInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo.class, emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo other = (emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.internal_static_PlayerLocationInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo build() {
        emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo buildPartial() {
        emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo result = new emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo(this);
        result.uid_ = uid_;
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo other) {
        if (other == emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo();
    }

    public static emu.grasscutter.net.oldproto.PlayerLocationInfoOuterClass.PlayerLocationInfo getDefaultInstance() {
