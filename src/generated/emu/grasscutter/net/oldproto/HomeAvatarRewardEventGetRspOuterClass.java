...
public final class HomeAvatarRewardEventGetRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.internal_static_HomeAvatarRewardEventGetRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.internal_static_HomeAvatarRewardEventGetRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp.class, emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp other = (emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.internal_static_HomeAvatarRewardEventGetRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp build() {
        emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp buildPartial() {
        emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp result = new emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp other) {
        if (other == emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp();
    }

    public static emu.grasscutter.net.oldproto.HomeAvatarRewardEventGetRspOuterClass.HomeAvatarRewardEventGetRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "tcode\030\016 \001(\005\022\020\n\010event_id\030\010 \001(\rB\036\n\034emu.gra" +
