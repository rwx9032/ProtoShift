...
public final class AbilityMetaUpdateBaseReactionDamageOuterClass {
  ...
  public interface AbilityMetaUpdateBaseReactionDamageOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString getGlobalValueKey();
    /**
     * <code>.AbilityString global_value_key = 4;</code>
     */
    emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityStringOrBuilder getGlobalValueKeyOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.internal_static_AbilityMetaUpdateBaseReactionDamage_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.internal_static_AbilityMetaUpdateBaseReactionDamage_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage.class, emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString globalValueKey_;
    /**
     * <code>.AbilityString global_value_key = 4;</code>
     * @return Whether the globalValueKey field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString getGlobalValueKey() {
      return globalValueKey_ == null ? emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString.getDefaultInstance() : globalValueKey_;
    }
    /**
     * <code>.AbilityString global_value_key = 4;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityStringOrBuilder getGlobalValueKeyOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage other = (emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamageOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.internal_static_AbilityMetaUpdateBaseReactionDamage_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage build() {
        emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage buildPartial() {
        emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage result = new emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage other) {
        if (other == emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage.getDefaultInstance()) return this;
      ...
      private emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString globalValueKey_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString, emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString.Builder, emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityStringOrBuilder> globalValueKeyBuilder_;
      /**
       * <code>.AbilityString global_value_key = 4;</code>
       * @return Whether the globalValueKey field is set.
       */
       ...
       * <code>.AbilityString global_value_key = 4;</code>
       */
      public Builder setGlobalValueKey(emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString value) {
        if (globalValueKeyBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.AbilityString global_value_key = 4;</code>
       */
      public Builder mergeGlobalValueKey(emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString value) {
        if (globalValueKeyBuilder_ == null) {
          if (globalValueKey_ != null) {
            globalValueKey_ =
              emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString.newBuilder(globalValueKey_).mergeFrom(value).buildPartial();
          } else {
            globalValueKey_ = value;
          }
          onChanged();
       ...
       * <code>.AbilityString global_value_key = 4;</code>
       */
      public emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString.Builder getGlobalValueKeyBuilder() {
      ...
      public emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityStringOrBuilder getGlobalValueKeyOrBuilder() {
        if (globalValueKeyBuilder_ != null) {
          ...
          return globalValueKey_ == null ?
              emu.grasscutter.net.oldproto.AbilityStringOuterClass.AbilityString.getDefaultInstance() : globalValueKey_;
        }
      }
      /**
       * <code>.AbilityString global_value_key = 4;</code>
    ...
    private static final emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage();
    }

    public static emu.grasscutter.net.oldproto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "lityString\022\025\n\rreaction_type\030\010 \001(\rB\036\n\034emu" +
