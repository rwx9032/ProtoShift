...
public final class WinterCampRecvItemDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.internal_static_WinterCampRecvItemData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.internal_static_WinterCampRecvItemData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.class, emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData other = (emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData) obj;
    ...
    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.internal_static_WinterCampRecvItemData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData build() {
        emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData buildPartial() {
        emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData result = new emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData) {
          return mergeFrom((emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData other) {
        if (other == emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData.getDefaultInstance()) return this;
        if (itemListBuilder_ == null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData();
    }

    public static emu.grasscutter.net.oldproto.WinterCampRecvItemDataOuterClass.WinterCampRecvItemData getDefaultInstance() {
