...
public final class OpenStateChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.internal_static_OpenStateChangeNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.internal_static_OpenStateChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify.class, emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.internal_static_OpenStateChangeNotify_OpenStateMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify other = (emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.internal_static_OpenStateChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify build() {
        emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify buildPartial() {
        emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify result = new emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify other) {
        if (other == emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify();
    }

    public static emu.grasscutter.net.oldproto.OpenStateChangeNotifyOuterClass.OpenStateChangeNotify getDefaultInstance() {
