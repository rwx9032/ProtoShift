...
public final class AddRandTaskInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.internal_static_AddRandTaskInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.internal_static_AddRandTaskInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify.class, emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify other = (emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.internal_static_AddRandTaskInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify build() {
        emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify buildPartial() {
        emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify result = new emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify other) {
        if (other == emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify();
    }

    public static emu.grasscutter.net.oldproto.AddRandTaskInfoNotifyOuterClass.AddRandTaskInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "k_id\030\005 \001(\r\022\024\n\003pos\030\r \001(\0132\007.VectorB\036\n\034emu." +
