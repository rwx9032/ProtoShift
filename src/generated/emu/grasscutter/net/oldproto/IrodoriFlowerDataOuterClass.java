...
public final class IrodoriFlowerDataOuterClass {
  ...
  public interface IrodoriFlowerDataOrBuilder extends
     ...
     * <code>repeated .ItemParam used_flower_list = 7;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getUsedFlowerList(int index);
    /**
     * <code>repeated .ItemParam used_flower_list = 7;</code>
     */
     ...
     * <code>repeated .ItemParam used_flower_list = 7;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getUsedFlowerListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.internal_static_IrodoriFlowerData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.internal_static_IrodoriFlowerData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.class, emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> usedFlowerList_;
    /**
     * <code>repeated .ItemParam used_flower_list = 7;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> getUsedFlowerListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getUsedFlowerList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getUsedFlowerListOrBuilder(
        int index) {
      return usedFlowerList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData other = (emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData) obj;
    ...
    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.internal_static_IrodoriFlowerData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData build() {
        emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData buildPartial() {
        emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData result = new emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData) {
          return mergeFrom((emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData other) {
        if (other == emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData.getDefaultInstance()) return this;
      ...
      private void ensureUsedFlowerListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          usedFlowerList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam>(usedFlowerList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> usedFlowerListBuilder_;
       ...
       * <code>repeated .ItemParam used_flower_list = 7;</code>
       */
      public Builder addUsedFlowerList(emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (usedFlowerListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam used_flower_list = 7;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder getUsedFlowerListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam used_flower_list = 7;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder addUsedFlowerListBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData();
    }

    public static emu.grasscutter.net.oldproto.IrodoriFlowerDataOuterClass.IrodoriFlowerData getDefaultInstance() {
