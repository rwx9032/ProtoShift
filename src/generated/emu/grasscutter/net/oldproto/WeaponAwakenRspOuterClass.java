...
public final class WeaponAwakenRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.internal_static_WeaponAwakenRsp_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.internal_static_WeaponAwakenRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp.class, emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.internal_static_WeaponAwakenRsp_OldAffixLevelMapEntry_descriptor, 
    ...
    private static final class CurAffixLevelMapDefaultEntryHolder {
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              com.google.protobuf.MapEntry
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.internal_static_WeaponAwakenRsp_CurAffixLevelMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0);
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp other = (emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.internal_static_WeaponAwakenRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp build() {
        emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp buildPartial() {
        emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp result = new emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp other) {
        if (other == emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp();
    }

    public static emu.grasscutter.net.oldproto.WeaponAwakenRspOuterClass.WeaponAwakenRsp getDefaultInstance() {
