...
public final class TakeResinCardDailyRewardRspOuterClass {
  ...
  public interface TakeResinCardDailyRewardRspOrBuilder extends
     ...
     * <code>repeated .ItemParam item_vec = 6;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getItemVec(int index);
    /**
     * <code>repeated .ItemParam item_vec = 6;</code>
     */
    int getItemVecCount();
     ...
     * <code>repeated .ItemParam item_vec = 6;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getItemVecOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.internal_static_TakeResinCardDailyRewardRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.internal_static_TakeResinCardDailyRewardRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.class, emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.Builder.class);
    }

    public static final int ITEM_VEC_FIELD_NUMBER = 6;
    private java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> itemVec_;
    /**
     * <code>repeated .ItemParam item_vec = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> getItemVecList() {
      return itemVec_;
    }
    /**
     * <code>repeated .ItemParam item_vec = 6;</code>
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getItemVec(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getItemVecOrBuilder(
        int index) {
      return itemVec_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp other = (emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.internal_static_TakeResinCardDailyRewardRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp build() {
        emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp buildPartial() {
        emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp result = new emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp other) {
        if (other == emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp.getDefaultInstance()) return this;
        if (itemVecBuilder_ == null) {
      ...
      private void ensureItemVecIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          itemVec_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam>(itemVec_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> itemVecBuilder_;
       ...
       * <code>repeated .ItemParam item_vec = 6;</code>
       */
      public Builder addItemVec(emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (itemVecBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam item_vec = 6;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder getItemVecBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam item_vec = 6;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder addItemVecBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp();
    }

    public static emu.grasscutter.net.oldproto.TakeResinCardDailyRewardRspOuterClass.TakeResinCardDailyRewardRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "code\030\004 \001(\005\022\031\n\021product_config_id\030\014 \001(\rB\036\n" +
