...
public final class AvatarFetterInfoOuterClass {
  ...
  public interface AvatarFetterInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData> 
        getFetterListList();
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData getFetterList(int index);
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
     ...
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder> 
        getFetterListOrBuilderList();
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder getFetterListOrBuilder(
        int index);
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.class, emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData> fetterList_;
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData> getFetterListList() {
      return fetterList_;
    }
    /**
     * <code>repeated .FetterData fetter_list = 6;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder> 
        getFetterListOrBuilderList() {
      return fetterList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData getFetterList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder getFetterListOrBuilder(
        int index) {
      return fetterList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo other = (emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.internal_static_AvatarFetterInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo build() {
        emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo buildPartial() {
        emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo result = new emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo other) {
        if (other == emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50: {
                emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.parser(),
                        extensionRegistry);
                if (fetterListBuilder_ == null) {
                  ensureFetterListIsMutable();
                  fetterList_.add(m);
      ...
      private void ensureFetterListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          fetterList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData>(fetterList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder> fetterListBuilder_;
      ...
      public Builder setFetterList(
          int index, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData value) {
        if (fetterListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFetterList(
          int index, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder builderForValue) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
       ...
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public Builder addFetterList(emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData value) {
        if (fetterListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFetterList(
          emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder builderForValue) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
      ...
      public Builder addAllFetterList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData> values) {
        if (fetterListBuilder_ == null) {
          ensureFetterListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, fetterList_);
       ...
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder getFetterListBuilder(
          int index) {
       ...
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder addFetterListBuilder() {
        return getFetterListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.getDefaultInstance());
      }
      /**
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder addFetterListBuilder(
          int index) {
        return getFetterListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.getDefaultInstance());
      }
      /**
       * <code>repeated .FetterData fetter_list = 6;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder> 
           getFetterListBuilderList() {
        return getFetterListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterData.Builder, emu.grasscutter.net.oldproto.FetterDataOuterClass.FetterDataOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo();
    }

    public static emu.grasscutter.net.oldproto.AvatarFetterInfoOuterClass.AvatarFetterInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.FetterDataOuterClass.getDescriptor(),
        });
    internal_static_AvatarFetterInfo_descriptor =
