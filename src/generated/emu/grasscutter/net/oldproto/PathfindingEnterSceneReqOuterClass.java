...
public final class PathfindingEnterSceneReqOuterClass {
  ...
  public interface PathfindingEnterSceneReqOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo> 
        getObstaclesList();
    /**
     * <code>repeated .ObstacleInfo obstacles = 13;</code>
     */
    emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo getObstacles(int index);
    /**
     * <code>repeated .ObstacleInfo obstacles = 13;</code>
     */
     ...
     * <code>repeated .ObstacleInfo obstacles = 13;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder> 
        getObstaclesOrBuilderList();
    /**
     * <code>repeated .ObstacleInfo obstacles = 13;</code>
     */
    emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder getObstaclesOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.internal_static_PathfindingEnterSceneReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.internal_static_PathfindingEnterSceneReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq.class, emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo> obstacles_;
    /**
     * <code>repeated .ObstacleInfo obstacles = 13;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo> getObstaclesList() {
      return obstacles_;
    }
    /**
     * <code>repeated .ObstacleInfo obstacles = 13;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder> 
        getObstaclesOrBuilderList() {
      return obstacles_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo getObstacles(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder getObstaclesOrBuilder(
        int index) {
      return obstacles_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq other = (emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.internal_static_PathfindingEnterSceneReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq build() {
        emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq buildPartial() {
        emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq result = new emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq other) {
        if (other == emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 106: {
                emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.parser(),
                        extensionRegistry);
                if (obstaclesBuilder_ == null) {
                  ensureObstaclesIsMutable();
                  obstacles_.add(m);
      ...
      private void ensureObstaclesIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          obstacles_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo>(obstacles_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder> obstaclesBuilder_;
      ...
      public Builder setObstacles(
          int index, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo value) {
        if (obstaclesBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setObstacles(
          int index, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder builderForValue) {
        if (obstaclesBuilder_ == null) {
          ensureObstaclesIsMutable();
       ...
       * <code>repeated .ObstacleInfo obstacles = 13;</code>
       */
      public Builder addObstacles(emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo value) {
        if (obstaclesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addObstacles(
          emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder builderForValue) {
        if (obstaclesBuilder_ == null) {
          ensureObstaclesIsMutable();
      ...
      public Builder addAllObstacles(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo> values) {
        if (obstaclesBuilder_ == null) {
          ensureObstaclesIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
              values, obstacles_);
       ...
       * <code>repeated .ObstacleInfo obstacles = 13;</code>
       */
      public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder getObstaclesBuilder(
          int index) {
       ...
       * <code>repeated .ObstacleInfo obstacles = 13;</code>
       */
      public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder addObstaclesBuilder() {
        return getObstaclesFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ObstacleInfo obstacles = 13;</code>
       */
      public emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder addObstaclesBuilder(
          int index) {
        return getObstaclesFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ObstacleInfo obstacles = 13;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder> 
           getObstaclesBuilderList() {
        return getObstaclesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfo.Builder, emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.ObstacleInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq();
    }

    public static emu.grasscutter.net.oldproto.PathfindingEnterSceneReqOuterClass.PathfindingEnterSceneReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\r.ObstacleInfo\022\022\n\npolygon_id\030\004 \001(\rB\036\n\034em" +
      "u.grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ObstacleInfoOuterClass.getDescriptor(),
        });
    internal_static_PathfindingEnterSceneReq_descriptor =
