...
public final class EntityClientExtraInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.internal_static_EntityClientExtraInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.internal_static_EntityClientExtraInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo.class, emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo other = (emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.internal_static_EntityClientExtraInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo build() {
        emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo buildPartial() {
        emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo result = new emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo(this);
        if (skillAnchorPositionBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo other) {
        if (other == emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo();
    }

    public static emu.grasscutter.net.oldproto.EntityClientExtraInfoOuterClass.EntityClientExtraInfo getDefaultInstance() {
