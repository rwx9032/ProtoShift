...
public final class CreateEntityInfoOuterClass {
  ...
  public interface CreateEntityInfoOrBuilder extends
     ...
     * @return The gadget.
     */
    emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo getGadget();
    /**
     * <code>.CreateGadgetInfo gadget = 13;</code>
     */
    emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder getGadgetOrBuilder();

    public emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.EntityCase getEntityCase();

    public emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.EntityCreateInfoCase getEntityCreateInfoCase();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.internal_static_CreateEntityInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.internal_static_CreateEntityInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.class, emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.Builder.class);
    }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo getGadget() {
      if (entityCreateInfoCase_ == 13) {
         return (emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_;
      }
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder getGadgetOrBuilder() {
      if (entityCreateInfoCase_ == 13) {
         return (emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_;
      }
      return emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.getDefaultInstance();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (entityCreateInfoCase_ == 13) {
        output.writeMessage(13, (emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (entityCreateInfoCase_ == 13) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(13, (emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo other = (emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.internal_static_CreateEntityInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo build() {
        emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo buildPartial() {
        emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo result = new emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo other) {
        if (other == emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo.getDefaultInstance()) return this;
        if (other.getLevel() != 0) {
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder> gadgetBuilder_;
      /**
       * <code>.CreateGadgetInfo gadget = 13;</code>
       * @return Whether the gadget field is set.
       */
       ...
       * <code>.CreateGadgetInfo gadget = 13;</code>
       */
      public Builder setGadget(emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo value) {
        if (gadgetBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setGadget(
          emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder builderForValue) {
        if (gadgetBuilder_ == null) {
       ...
       * <code>.CreateGadgetInfo gadget = 13;</code>
       */
      public Builder mergeGadget(emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo value) {
        if (gadgetBuilder_ == null) {
          if (entityCreateInfoCase_ == 13 &&
              entityCreateInfo_ != emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.getDefaultInstance()) {
            entityCreateInfo_ = emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.newBuilder((emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_)
       ...
       * <code>.CreateGadgetInfo gadget = 13;</code>
       */
      public emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder getGadgetBuilder() {
       ...
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder> 
        ...
        if (gadgetBuilder_ == null) {
          ...
          gadgetBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo, emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo.Builder, emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfoOrBuilder>(
                  (emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.CreateGadgetInfo) entityCreateInfo_,
                  getParentForChildren(),
                  isClean());
          entityCreateInfo_ = null;
        }
    ...
    private static final emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo();
    }

    public static emu.grasscutter.net.oldproto.CreateEntityInfoOuterClass.CreateEntityInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "B\010\n\006entityB\024\n\022entity_create_infoB\036\n\034emu." +
      "grasscutter.net.oldprotob\006proto3"
    };
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.CreateGadgetInfoOuterClass.getDescriptor(),
