...
public final class BartenderCompleteOrderRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.internal_static_BartenderCompleteOrderRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.internal_static_BartenderCompleteOrderRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.class, emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp other = (emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.internal_static_BartenderCompleteOrderRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp build() {
        emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp buildPartial() {
        emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp result = new emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp other) {
        if (other == emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp();
    }

    public static emu.grasscutter.net.oldproto.BartenderCompleteOrderRspOuterClass.BartenderCompleteOrderRsp getDefaultInstance() {
