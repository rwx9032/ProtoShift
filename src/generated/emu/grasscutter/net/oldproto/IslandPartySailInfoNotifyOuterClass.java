...
public final class IslandPartySailInfoNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.internal_static_IslandPartySailInfoNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.internal_static_IslandPartySailInfoNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.class, emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify other = (emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.internal_static_IslandPartySailInfoNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify build() {
        emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify buildPartial() {
        emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify result = new emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify(this);
        result.coin_ = coin_;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify other) {
        if (other == emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify.getDefaultInstance()) return this;
        if (other.getCoin() != 0) {
    ...
    private static final emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify();
    }

    public static emu.grasscutter.net.oldproto.IslandPartySailInfoNotifyOuterClass.IslandPartySailInfoNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ount\030\004 \001(\r\022\020\n\010progress\030\017 \001(\rB\036\n\034emu.gras" +
