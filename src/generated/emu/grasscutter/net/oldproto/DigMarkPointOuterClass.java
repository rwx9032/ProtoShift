...
public final class DigMarkPointOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DigMarkPointOuterClass.internal_static_DigMarkPoint_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DigMarkPointOuterClass.internal_static_DigMarkPoint_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint.class, emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint other = (emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint) obj;
    ...
    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPointOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DigMarkPointOuterClass.internal_static_DigMarkPoint_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint build() {
        emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint buildPartial() {
        emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint result = new emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint) {
          return mergeFrom((emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint other) {
        if (other == emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint();
    }

    public static emu.grasscutter.net.oldproto.DigMarkPointOuterClass.DigMarkPoint getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "le_id\030\r \001(\r\022\024\n\003rot\030\003 \001(\0132\007.VectorB\036\n\034emu" +
