...
public final class WidgetGadgetDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.internal_static_WidgetGadgetData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.internal_static_WidgetGadgetData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData.class, emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData other = (emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData) obj;
    ...
    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.internal_static_WidgetGadgetData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData build() {
        emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData buildPartial() {
        emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData result = new emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData) {
          return mergeFrom((emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData other) {
        if (other == emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData();
    }

    public static emu.grasscutter.net.oldproto.WidgetGadgetDataOuterClass.WidgetGadgetData getDefaultInstance() {
