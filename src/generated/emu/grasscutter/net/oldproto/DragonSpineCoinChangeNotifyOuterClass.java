...
public final class DragonSpineCoinChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.internal_static_DragonSpineCoinChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.internal_static_DragonSpineCoinChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify.class, emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify other = (emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.internal_static_DragonSpineCoinChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify build() {
        emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify buildPartial() {
        emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify result = new emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify other) {
        if (other == emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify();
    }

    public static emu.grasscutter.net.oldproto.DragonSpineCoinChangeNotifyOuterClass.DragonSpineCoinChangeNotify getDefaultInstance() {
