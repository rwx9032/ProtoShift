...
public final class ProudSkillChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.class, emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify other = (emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.internal_static_ProudSkillChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify build() {
        emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify buildPartial() {
        emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify result = new emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify other) {
        if (other == emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify();
    }

    public static emu.grasscutter.net.oldproto.ProudSkillChangeNotifyOuterClass.ProudSkillChangeNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\022\030\n\020proud_skill_list\030\014 \003(\rB\036\n\034emu.grassc" +
