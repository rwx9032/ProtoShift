...
public final class CustomDungeonSettingMuipDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.internal_static_CustomDungeonSettingMuipData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.internal_static_CustomDungeonSettingMuipData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData.class, emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData other = (emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData) obj;
    ...
    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.internal_static_CustomDungeonSettingMuipData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData build() {
        emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData buildPartial() {
        emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData result = new emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData) {
          return mergeFrom((emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData other) {
        if (other == emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData();
    }

    public static emu.grasscutter.net.oldproto.CustomDungeonSettingMuipDataOuterClass.CustomDungeonSettingMuipData getDefaultInstance() {
