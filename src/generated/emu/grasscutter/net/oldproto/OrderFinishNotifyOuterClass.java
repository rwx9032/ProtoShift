...
public final class OrderFinishNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.internal_static_OrderFinishNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.internal_static_OrderFinishNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify.class, emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify other = (emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.internal_static_OrderFinishNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify build() {
        emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify buildPartial() {
        emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify result = new emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify other) {
        if (other == emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify();
    }

    public static emu.grasscutter.net.oldproto.OrderFinishNotifyOuterClass.OrderFinishNotify getDefaultInstance() {
