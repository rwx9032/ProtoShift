...
public final class AISnapshotEntityDataOuterClass {
  ...
  public interface AISnapshotEntityDataOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> 
        getFinishedSkillCyclesList();
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
     */
    emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle getFinishedSkillCycles(int index);
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
     */
     ...
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> 
        getFinishedSkillCyclesOrBuilderList();
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
     */
    emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder getFinishedSkillCyclesOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.class, emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> finishedSkillCycles_;
    /**
     * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> getFinishedSkillCyclesList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> 
        getFinishedSkillCyclesOrBuilderList() {
      return finishedSkillCycles_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle getFinishedSkillCycles(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder getFinishedSkillCyclesOrBuilder(
        int index) {
      return finishedSkillCycles_.get(index);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_HittingAvatarsEntry_descriptor, 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (java.lang.Float.floatToRawIntBits(movedDistance_) != 0) {
        output.writeFloat(4, movedDistance_);
      }
      if (java.lang.Float.floatToRawIntBits(tickTime_) != 0) {
      ...
      if (java.lang.Float.floatToRawIntBits(distanceToPlayer_) != 0) {
        output.writeFloat(11, distanceToPlayer_);
      }
      if (aiTargetId_ != 0) {
        output.writeUInt32(13, aiTargetId_);
      }
      if (java.lang.Float.floatToRawIntBits(realTime_) != 0) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData other = (emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData) obj;
    ...
    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.internal_static_AISnapshotEntityData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData build() {
        emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData buildPartial() {
        emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData result = new emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData) {
          return mergeFrom((emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData other) {
        if (other == emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74: {
                emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.parser(),
                        extensionRegistry);
                if (finishedSkillCyclesBuilder_ == null) {
                  ensureFinishedSkillCyclesIsMutable();
      ...
      private void ensureFinishedSkillCyclesIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          finishedSkillCycles_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle>(finishedSkillCycles_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> finishedSkillCyclesBuilder_;
      ...
      public Builder setFinishedSkillCycles(
          int index, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle value) {
        if (finishedSkillCyclesBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setFinishedSkillCycles(
          int index, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder builderForValue) {
        if (finishedSkillCyclesBuilder_ == null) {
          ensureFinishedSkillCyclesIsMutable();
       ...
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
       */
      public Builder addFinishedSkillCycles(emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle value) {
        if (finishedSkillCyclesBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addFinishedSkillCycles(
          emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder builderForValue) {
        if (finishedSkillCyclesBuilder_ == null) {
          ensureFinishedSkillCyclesIsMutable();
      ...
      public Builder addAllFinishedSkillCycles(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle> values) {
        if (finishedSkillCyclesBuilder_ == null) {
          ensureFinishedSkillCyclesIsMutable();
       ...
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
       */
      public emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder getFinishedSkillCyclesBuilder(
          int index) {
       ...
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
       */
      public emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder addFinishedSkillCyclesBuilder() {
        return getFinishedSkillCyclesFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.getDefaultInstance());
      }
      /**
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
       */
      public emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder addFinishedSkillCyclesBuilder(
          int index) {
        return getFinishedSkillCyclesFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.getDefaultInstance());
      }
      /**
       * <code>repeated .AISnapshotEntitySkillCycle finished_skill_cycles = 9;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder> 
           getFinishedSkillCyclesBuilderList() {
        return getFinishedSkillCyclesFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycle.Builder, emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.AISnapshotEntitySkillCycleOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData();
    }

    public static emu.grasscutter.net.oldproto.AISnapshotEntityDataOuterClass.AISnapshotEntityData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.AISnapshotEntitySkillCycleOuterClass.getDescriptor(),
        });
    internal_static_AISnapshotEntityData_descriptor =
