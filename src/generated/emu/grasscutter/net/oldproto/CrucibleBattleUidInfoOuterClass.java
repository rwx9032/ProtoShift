...
public final class CrucibleBattleUidInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.internal_static_CrucibleBattleUidInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.internal_static_CrucibleBattleUidInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.class, emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo other = (emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.internal_static_CrucibleBattleUidInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo build() {
        emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo buildPartial() {
        emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo result = new emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo(this);
        if (profilePictureBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo other) {
        if (other == emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo();
    }

    public static emu.grasscutter.net.oldproto.CrucibleBattleUidInfoOuterClass.CrucibleBattleUidInfo getDefaultInstance() {
