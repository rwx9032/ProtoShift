...
public final class MailDataOuterClass {
  ...
  public interface MailDataOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent getMailTextContent();
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     */
    emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder();

    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    java.util.List<emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem> 
        getItemListList();
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem getItemList(int index);
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
     ...
     * <code>repeated .MailItem item_list = 7;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList();
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState getCollectState();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MailDataOuterClass.internal_static_MailData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MailDataOuterClass.internal_static_MailData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MailDataOuterClass.MailData.class, emu.grasscutter.net.oldproto.MailDataOuterClass.MailData.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent mailTextContent_;
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     * @return Whether the mailTextContent field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent getMailTextContent() {
      return mailTextContent_ == null ? emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
    }
    /**
     * <code>.MailTextContent mail_text_content = 4;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder() {
      return getMailTextContent();
    }

    public static final int ITEM_LIST_FIELD_NUMBER = 7;
    private java.util.List<emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem> itemList_;
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem> getItemListList() {
      return itemList_;
    }
    /**
     * <code>repeated .MailItem item_list = 7;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder> 
        getItemListOrBuilderList() {
      return itemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem getItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder getItemListOrBuilder(
        int index) {
      return itemList_.get(index);
    }
     ...
     * @return The collectState.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState getCollectState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState result = emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState.valueOf(collectState_);
      return result == null ? emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (collectState_ != emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState.MAIL_COLLECT_STATE_COLLECTIBLE_UNKONW.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MailDataOuterClass.MailData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MailDataOuterClass.MailData other = (emu.grasscutter.net.oldproto.MailDataOuterClass.MailData) obj;
    ...
    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MailDataOuterClass.MailData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MailDataOuterClass.MailDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MailDataOuterClass.internal_static_MailData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MailDataOuterClass.MailData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailDataOuterClass.MailData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MailDataOuterClass.MailData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailDataOuterClass.MailData build() {
        emu.grasscutter.net.oldproto.MailDataOuterClass.MailData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailDataOuterClass.MailData buildPartial() {
        emu.grasscutter.net.oldproto.MailDataOuterClass.MailData result = new emu.grasscutter.net.oldproto.MailDataOuterClass.MailData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MailDataOuterClass.MailData) {
          return mergeFrom((emu.grasscutter.net.oldproto.MailDataOuterClass.MailData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MailDataOuterClass.MailData other) {
        if (other == emu.grasscutter.net.oldproto.MailDataOuterClass.MailData.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 58: {
                emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.parser(),
                        extensionRegistry);
                if (itemListBuilder_ == null) {
                  ensureItemListIsMutable();
                  itemList_.add(m);
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent, emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder, emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder> mailTextContentBuilder_;
      /**
       * <code>.MailTextContent mail_text_content = 4;</code>
       * @return Whether the mailTextContent field is set.
       */
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public Builder setMailTextContent(emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent value) {
        if (mailTextContentBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setMailTextContent(
          emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder builderForValue) {
        if (mailTextContentBuilder_ == null) {
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public Builder mergeMailTextContent(emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent value) {
        if (mailTextContentBuilder_ == null) {
          if (mailTextContent_ != null) {
            mailTextContent_ =
              emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.newBuilder(mailTextContent_).mergeFrom(value).buildPartial();
          } else {
            mailTextContent_ = value;
          }
          onChanged();
       ...
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      public emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder getMailTextContentBuilder() {
      ...
      public emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder getMailTextContentOrBuilder() {
        if (mailTextContentBuilder_ != null) {
          ...
          return mailTextContent_ == null ?
              emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : mailTextContent_;
        }
      }
      /**
       * <code>.MailTextContent mail_text_content = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent, emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContent.Builder, emu.grasscutter.net.oldproto.MailTextContentOuterClass.MailTextContentOrBuilder> 
      ...
      private void ensureItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          itemList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem>(itemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder> itemListBuilder_;
      ...
      public Builder setItemList(
          int index, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setItemList(
          int index, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public Builder addItemList(emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem value) {
        if (itemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addItemList(
          emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder builderForValue) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
      ...
      public Builder addAllItemList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem> values) {
        if (itemListBuilder_ == null) {
          ensureItemListIsMutable();
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder getItemListBuilder(
          int index) {
       ...
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder addItemListBuilder() {
        return getItemListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder addItemListBuilder(
          int index) {
        return getItemListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.getDefaultInstance());
      }
      /**
       * <code>repeated .MailItem item_list = 7;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder> 
           getItemListBuilderList() {
        return getItemListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder> 
  ...
  checkByteStringIsUtf8(value);
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState getCollectState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState result = emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState.valueOf(collectState_);
        return result == null ? emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setCollectState(emu.grasscutter.net.oldproto.MailCollectStateOuterClass.MailCollectState value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.oldproto.MailDataOuterClass.MailData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MailDataOuterClass.MailData();
    }

    public static emu.grasscutter.net.oldproto.MailDataOuterClass.MailData getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.MailCollectStateOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.MailItemOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.MailTextContentOuterClass.getDescriptor(),
        });
    internal_static_MailData_descriptor =
