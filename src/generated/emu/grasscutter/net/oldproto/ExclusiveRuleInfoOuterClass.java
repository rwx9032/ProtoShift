...
public final class ExclusiveRuleInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.internal_static_ExclusiveRuleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.internal_static_ExclusiveRuleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo.class, emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo other = (emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.internal_static_ExclusiveRuleInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo build() {
        emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo buildPartial() {
        emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo result = new emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo other) {
        if (other == emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo();
    }

    public static emu.grasscutter.net.oldproto.ExclusiveRuleInfoOuterClass.ExclusiveRuleInfo getDefaultInstance() {
