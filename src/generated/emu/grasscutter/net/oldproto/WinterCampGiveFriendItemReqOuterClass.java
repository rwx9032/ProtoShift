...
public final class WinterCampGiveFriendItemReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.internal_static_WinterCampGiveFriendItemReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.internal_static_WinterCampGiveFriendItemReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq.class, emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq other = (emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.internal_static_WinterCampGiveFriendItemReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq build() {
        emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq buildPartial() {
        emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq result = new emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq other) {
        if (other == emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        if (itemListBuilder_ == null) {
    ...
    private static final emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq();
    }

    public static emu.grasscutter.net.oldproto.WinterCampGiveFriendItemReqOuterClass.WinterCampGiveFriendItemReq getDefaultInstance() {
