...
public final class ReunionDailyRefreshNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.internal_static_ReunionDailyRefreshNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.internal_static_ReunionDailyRefreshNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify.class, emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify other = (emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.internal_static_ReunionDailyRefreshNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify build() {
        emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify buildPartial() {
        emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify result = new emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify(this);
        if (reunionBriefInfoBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify other) {
        if (other == emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify();
    }

    public static emu.grasscutter.net.oldproto.ReunionDailyRefreshNotifyOuterClass.ReunionDailyRefreshNotify getDefaultInstance() {
