...
public final class PlayerCookReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.internal_static_PlayerCookReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.internal_static_PlayerCookReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq.class, emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq other = (emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.internal_static_PlayerCookReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq build() {
        emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq buildPartial() {
        emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq result = new emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq other) {
        if (other == emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq();
    }

    public static emu.grasscutter.net.oldproto.PlayerCookReqOuterClass.PlayerCookReq getDefaultInstance() {
