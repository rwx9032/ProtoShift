...
public final class ChatEmojiCollectionDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.internal_static_ChatEmojiCollectionData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.internal_static_ChatEmojiCollectionData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.class, emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData other = (emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.internal_static_ChatEmojiCollectionData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData build() {
        emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData buildPartial() {
        emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData result = new emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData other) {
        if (other == emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData();
    }

    public static emu.grasscutter.net.oldproto.ChatEmojiCollectionDataOuterClass.ChatEmojiCollectionData getDefaultInstance() {
