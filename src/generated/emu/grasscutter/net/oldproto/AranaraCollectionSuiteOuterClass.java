...
public final class AranaraCollectionSuiteOuterClass {
  ...
  public interface AranaraCollectionSuiteOrBuilder extends
    ...
    java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState>
     ...
     */
    /* nullable */
emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState getCollectionIdStateMapOrDefault(
        int key,
        /* nullable */
emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState         defaultValue);
    /**
     * <code>map&lt;uint32, .AranaraCollectionState&gt; collection_id_state_map = 6;</code>
     */
    emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState getCollectionIdStateMapOrThrow(
        int key);
    /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.internal_static_AranaraCollectionSuite_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.internal_static_AranaraCollectionSuite_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite.class, emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.internal_static_AranaraCollectionSuite_CollectionIdStateMapEntry_descriptor, 
                  com.google.protobuf.WireFormat.FieldType.UINT32,
                  0,
                  com.google.protobuf.WireFormat.FieldType.ENUM,
                  emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState.ARANARA_COLLECTION_STATE_NONE.getNumber());
    }
    ...
    com.google.protobuf.Internal.MapAdapter.Converter<
        java.lang.Integer, emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState> collectionIdStateMapValueConverter =
            com.google.protobuf.Internal.MapAdapter.newEnumConverter(
                emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState.internalGetValueMap(),
                emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState.UNRECOGNIZED);
    private static final java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState>
    internalGetAdaptedCollectionIdStateMapMap(
        java.util.Map<java.lang.Integer, java.lang.Integer> map) {
      return new com.google.protobuf.Internal.MapAdapter<
          java.lang.Integer, emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState, java.lang.Integer>(
    ...
    @java.lang.Override
    @java.lang.Deprecated
    public java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState>
    getCollectionIdStateMap() {
...
emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState defaultValue) {
    ...
    public emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState getCollectionIdStateMapOrThrow(
        int key) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite other = (emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite) obj;
    ...
    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuiteOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.internal_static_AranaraCollectionSuite_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite build() {
        emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite buildPartial() {
        emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite result = new emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite) {
          return mergeFrom((emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite other) {
        if (other == emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite.getDefaultInstance()) return this;
...
emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState defaultValue) {
      ...
      public Builder putCollectionIdStateMap(
          int key,
          emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState value) {
      ...
      public Builder putAllCollectionIdStateMap(
          java.util.Map<java.lang.Integer, emu.grasscutter.net.oldproto.AranaraCollectionStateOuterClass.AranaraCollectionState> values) {
        internalGetAdaptedCollectionIdStateMapMap(
            internalGetMutableCollectionIdStateMap().getMutableMap())
                .putAll(values);
        return this;
    ...
    private static final emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite();
    }

    public static emu.grasscutter.net.oldproto.AranaraCollectionSuiteOuterClass.AranaraCollectionSuite getDefaultInstance() {
