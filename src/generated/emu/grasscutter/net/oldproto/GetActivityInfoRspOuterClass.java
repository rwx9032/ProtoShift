...
public final class GetActivityInfoRspOuterClass {
  ...
  public interface GetActivityInfoRspOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo> 
        getActivityInfoListList();
    /**
     * <code>repeated .ActivityInfo activity_info_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo getActivityInfoList(int index);
    /**
     * <code>repeated .ActivityInfo activity_info_list = 5;</code>
     */
     ...
     * <code>repeated .ActivityInfo activity_info_list = 5;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> 
        getActivityInfoListOrBuilderList();
    /**
     * <code>repeated .ActivityInfo activity_info_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfoOrBuilder getActivityInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.internal_static_GetActivityInfoRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.internal_static_GetActivityInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.class, emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo> activityInfoList_;
    /**
     * <code>repeated .ActivityInfo activity_info_list = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo> getActivityInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> 
        getActivityInfoListOrBuilderList() {
      return activityInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo getActivityInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfoOrBuilder getActivityInfoListOrBuilder(
        int index) {
      return activityInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp other = (emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.internal_static_GetActivityInfoRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp build() {
        emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp buildPartial() {
        emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp result = new emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp other) {
        if (other == emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp.getDefaultInstance()) return this;
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 42: {
                emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.parser(),
                        extensionRegistry);
                if (activityInfoListBuilder_ == null) {
                  ensureActivityInfoListIsMutable();
      ...
      private void ensureActivityInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          activityInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo>(activityInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> activityInfoListBuilder_;
      ...
      public Builder setActivityInfoList(
          int index, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo value) {
        if (activityInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setActivityInfoList(
          int index, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder builderForValue) {
        if (activityInfoListBuilder_ == null) {
          ensureActivityInfoListIsMutable();
       ...
       * <code>repeated .ActivityInfo activity_info_list = 5;</code>
       */
      public Builder addActivityInfoList(emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo value) {
        if (activityInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addActivityInfoList(
          emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder builderForValue) {
        if (activityInfoListBuilder_ == null) {
          ensureActivityInfoListIsMutable();
      ...
      public Builder addAllActivityInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo> values) {
        if (activityInfoListBuilder_ == null) {
          ensureActivityInfoListIsMutable();
       ...
       * <code>repeated .ActivityInfo activity_info_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder getActivityInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ActivityInfo activity_info_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder addActivityInfoListBuilder() {
        return getActivityInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ActivityInfo activity_info_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder addActivityInfoListBuilder(
          int index) {
        return getActivityInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ActivityInfo activity_info_list = 5;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder> 
           getActivityInfoListBuilderList() {
        return getActivityInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfo.Builder, emu.grasscutter.net.oldproto.ActivityInfoOuterClass.ActivityInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp();
    }

    public static emu.grasscutter.net.oldproto.GetActivityInfoRspOuterClass.GetActivityInfoRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ActivityInfoOuterClass.getDescriptor(),
