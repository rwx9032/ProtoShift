...
public final class RequestLiveInfoRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.internal_static_RequestLiveInfoRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.internal_static_RequestLiveInfoRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp.class, emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp other = (emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.internal_static_RequestLiveInfoRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp build() {
        emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp buildPartial() {
        emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp result = new emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp other) {
        if (other == emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 98: {
                liveUrl_ = input.readStringRequireUtf8();

                break;
              } // case 98
              case 114: {
                spareLiveUrl_ = input.readStringRequireUtf8();
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp();
    }

    public static emu.grasscutter.net.oldproto.RequestLiveInfoRspOuterClass.RequestLiveInfoRsp getDefaultInstance() {
