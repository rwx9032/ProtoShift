...
public final class HuntingRevealFinalNotifyOuterClass {
  ...
  public interface HuntingRevealFinalNotifyOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.Vector getFinalPosition();
    /**
     * <code>.Vector final_position = 2;</code>
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder();
  }
  /**
   * <pre>
   * CmdId: 4344
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.class, emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.VectorOuterClass.Vector finalPosition_;
    /**
     * <code>.Vector final_position = 2;</code>
     * @return Whether the finalPosition field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.Vector getFinalPosition() {
      return finalPosition_ == null ? emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : finalPosition_;
    }
    /**
     * <code>.Vector final_position = 2;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify other = (emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.internal_static_HuntingRevealFinalNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify build() {
        emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify buildPartial() {
        emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify result = new emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify other) {
        if (other == emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify.getDefaultInstance()) return this;
      ...
      private emu.grasscutter.net.oldproto.VectorOuterClass.Vector finalPosition_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.VectorOuterClass.Vector, emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder> finalPositionBuilder_;
      /**
       * <code>.Vector final_position = 2;</code>
       * @return Whether the finalPosition field is set.
       */
       ...
       * <code>.Vector final_position = 2;</code>
       */
      public Builder setFinalPosition(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (finalPositionBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector final_position = 2;</code>
       */
      public Builder mergeFinalPosition(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (finalPositionBuilder_ == null) {
          if (finalPosition_ != null) {
            finalPosition_ =
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.newBuilder(finalPosition_).mergeFrom(value).buildPartial();
          } else {
            finalPosition_ = value;
          }
          onChanged();
       ...
       * <code>.Vector final_position = 2;</code>
       */
      public emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder getFinalPositionBuilder() {
      ...
      public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getFinalPositionOrBuilder() {
        if (finalPositionBuilder_ != null) {
          ...
          return finalPosition_ == null ?
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : finalPosition_;
        }
      }
      /**
       * <code>.Vector final_position = 2;</code>
    ...
    private static final emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify();
    }

    public static emu.grasscutter.net.oldproto.HuntingRevealFinalNotifyOuterClass.HuntingRevealFinalNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "final_position\030\002 \001(\0132\007.VectorB\036\n\034emu.gra" +
