...
public final class AbilityBornTypeOuterClass {
  ...
  public interface AbilityBornTypeOrBuilder extends
     ...
     * @return The moveDir.
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.Vector getMoveDir();
    /**
     * <code>.Vector move_dir = 14;</code>
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getMoveDirOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.class, emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.VectorOuterClass.Vector moveDir_;
    /**
     * <code>.Vector move_dir = 14;</code>
     * @return Whether the moveDir field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.Vector getMoveDir() {
      return moveDir_ == null ? emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : moveDir_;
    }
    /**
     * <code>.Vector move_dir = 14;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getMoveDirOrBuilder() {
      return getMoveDir();
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType other = (emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornTypeOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.internal_static_AbilityBornType_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType build() {
        emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType buildPartial() {
        emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType result = new emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType(this);
        if (rotBuilder_ == null) {
          result.rot_ = rot_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType other) {
        if (other == emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType.getDefaultInstance()) return this;
        if (other.hasRot()) {
      ...
      private emu.grasscutter.net.oldproto.VectorOuterClass.Vector moveDir_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.VectorOuterClass.Vector, emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder> moveDirBuilder_;
      /**
       * <code>.Vector move_dir = 14;</code>
       * @return Whether the moveDir field is set.
       */
       ...
       * <code>.Vector move_dir = 14;</code>
       */
      public Builder setMoveDir(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (moveDirBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>.Vector move_dir = 14;</code>
       */
      public Builder mergeMoveDir(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (moveDirBuilder_ == null) {
          if (moveDir_ != null) {
            moveDir_ =
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.newBuilder(moveDir_).mergeFrom(value).buildPartial();
          } else {
            moveDir_ = value;
          }
          onChanged();
       ...
       * <code>.Vector move_dir = 14;</code>
       */
      public emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder getMoveDirBuilder() {
      ...
      public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getMoveDirOrBuilder() {
        if (moveDirBuilder_ != null) {
          ...
          return moveDir_ == null ?
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : moveDir_;
        }
      }
      /**
       * <code>.Vector move_dir = 14;</code>
    ...
    private static final emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType();
    }

    public static emu.grasscutter.net.oldproto.AbilityBornTypeOuterClass.AbilityBornType getDefaultInstance() {
