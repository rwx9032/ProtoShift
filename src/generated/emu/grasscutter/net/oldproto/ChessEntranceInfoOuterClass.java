...
public final class ChessEntranceInfoOuterClass {
  ...
  public interface ChessEntranceInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo> 
        getMonsterInfoListList();
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
     */
    emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo getMonsterInfoList(int index);
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
     */
     ...
     * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> 
        getMonsterInfoListOrBuilderList();
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
     */
    emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder getMonsterInfoListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.internal_static_ChessEntranceInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.internal_static_ChessEntranceInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo.class, emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo.Builder.class);
    }

    public static final int MONSTER_INFO_LIST_FIELD_NUMBER = 14;
    private java.util.List<emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo> monsterInfoList_;
    /**
     * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo> getMonsterInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> 
        getMonsterInfoListOrBuilderList() {
      return monsterInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo getMonsterInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder getMonsterInfoListOrBuilder(
        int index) {
      return monsterInfoList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo other = (emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.internal_static_ChessEntranceInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo build() {
        emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo buildPartial() {
        emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo result = new emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo other) {
        if (other == emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo.getDefaultInstance()) return this;
        if (monsterInfoListBuilder_ == null) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 114: {
                emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.parser(),
                        extensionRegistry);
                if (monsterInfoListBuilder_ == null) {
                  ensureMonsterInfoListIsMutable();
      ...
      private void ensureMonsterInfoListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          monsterInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo>(monsterInfoList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> monsterInfoListBuilder_;
      ...
      public Builder setMonsterInfoList(
          int index, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo value) {
        if (monsterInfoListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMonsterInfoList(
          int index, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder builderForValue) {
        if (monsterInfoListBuilder_ == null) {
          ensureMonsterInfoListIsMutable();
       ...
       * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
       */
      public Builder addMonsterInfoList(emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo value) {
        if (monsterInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addMonsterInfoList(
          emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder builderForValue) {
        if (monsterInfoListBuilder_ == null) {
          ensureMonsterInfoListIsMutable();
      ...
      public Builder addAllMonsterInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo> values) {
        if (monsterInfoListBuilder_ == null) {
          ensureMonsterInfoListIsMutable();
       ...
       * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
       */
      public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder getMonsterInfoListBuilder(
          int index) {
       ...
       * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
       */
      public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder addMonsterInfoListBuilder() {
        return getMonsterInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
       */
      public emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder addMonsterInfoListBuilder(
          int index) {
        return getMonsterInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .ChessMonsterInfo monster_info_list = 14;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder> 
           getMonsterInfoListBuilderList() {
        return getMonsterInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfo.Builder, emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.ChessMonsterInfoOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo();
    }

    public static emu.grasscutter.net.oldproto.ChessEntranceInfoOuterClass.ChessEntranceInfo getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.ChessMonsterInfoOuterClass.getDescriptor(),
        });
    internal_static_ChessEntranceInfo_descriptor =
