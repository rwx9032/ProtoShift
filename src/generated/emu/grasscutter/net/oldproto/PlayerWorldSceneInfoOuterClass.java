...
public final class PlayerWorldSceneInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.internal_static_PlayerWorldSceneInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.internal_static_PlayerWorldSceneInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo.class, emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo other = (emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.internal_static_PlayerWorldSceneInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo build() {
        emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo buildPartial() {
        emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo result = new emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo other) {
        if (other == emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo();
    }

    public static emu.grasscutter.net.oldproto.PlayerWorldSceneInfoOuterClass.PlayerWorldSceneInfo getDefaultInstance() {
