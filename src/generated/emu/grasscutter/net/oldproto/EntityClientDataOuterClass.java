...
public final class EntityClientDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.EntityClientDataOuterClass.internal_static_EntityClientData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.EntityClientDataOuterClass.internal_static_EntityClientData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData.class, emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData other = (emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData) obj;
    ...
    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.EntityClientDataOuterClass.internal_static_EntityClientData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData build() {
        emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData buildPartial() {
        emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData result = new emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData) {
          return mergeFrom((emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData other) {
        if (other == emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData();
    }

    public static emu.grasscutter.net.oldproto.EntityClientDataOuterClass.EntityClientData getDefaultInstance() {
