...
public final class PlayerCookRspOuterClass {
  ...
  public interface PlayerCookRspOrBuilder extends
     ...
     * <code>repeated .ItemParam extral_item_list = 15;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getExtralItemList(int index);
    /**
     * <code>repeated .ItemParam extral_item_list = 15;</code>
     */
     ...
     * <code>repeated .ItemParam extral_item_list = 15;</code>
     */
    emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getExtralItemListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.internal_static_PlayerCookRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.internal_static_PlayerCookRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp.class, emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp.Builder.class);
    }

    public static final int EXTRAL_ITEM_LIST_FIELD_NUMBER = 15;
    private java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> extralItemList_;
    /**
     * <code>repeated .ItemParam extral_item_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam> getExtralItemListList() {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam getExtralItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder getExtralItemListOrBuilder(
        int index) {
      return extralItemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp other = (emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.internal_static_PlayerCookRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp build() {
        emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp buildPartial() {
        emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp result = new emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp other) {
        if (other == emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp.getDefaultInstance()) return this;
        if (extralItemListBuilder_ == null) {
      ...
      private void ensureExtralItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          extralItemList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam>(extralItemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder, emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParamOrBuilder> extralItemListBuilder_;
       ...
       * <code>repeated .ItemParam extral_item_list = 15;</code>
       */
      public Builder addExtralItemList(emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam value) {
        if (extralItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       * <code>repeated .ItemParam extral_item_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder getExtralItemListBuilder(
          int index) {
       ...
       * <code>repeated .ItemParam extral_item_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.ItemParamOuterClass.ItemParam.Builder addExtralItemListBuilder() {
    ...
    private static final emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp();
    }

    public static emu.grasscutter.net.oldproto.PlayerCookRspOuterClass.PlayerCookRsp getDefaultInstance() {
