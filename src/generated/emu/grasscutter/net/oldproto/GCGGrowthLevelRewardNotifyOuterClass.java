...
public final class GCGGrowthLevelRewardNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.internal_static_GCGGrowthLevelRewardNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.internal_static_GCGGrowthLevelRewardNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.class, emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify other = (emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.internal_static_GCGGrowthLevelRewardNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify build() {
        emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify buildPartial() {
        emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify result = new emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify other) {
        if (other == emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify();
    }

    public static emu.grasscutter.net.oldproto.GCGGrowthLevelRewardNotifyOuterClass.GCGGrowthLevelRewardNotify getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_taken_list\030\010 \003(\rB\036\n\034emu.grasscutter.net" +
      ".oldprotob\006proto3"
    };
