...
public final class GCGSkillPreviewCardInfoOuterClass {
  ...
  public interface GCGSkillPreviewCardInfoOrBuilder extends
     ...
     * @return The zoneType.
     */
    emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType getZoneType();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.internal_static_GCGSkillPreviewCardInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.internal_static_GCGSkillPreviewCardInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo.class, emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo.Builder.class);
    }
     ...
     * @return The zoneType.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType getZoneType() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType result = emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType.valueOf(zoneType_);
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (zoneType_ != emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType.GCG_ZONE_TYPE_INVALID.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo other = (emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.internal_static_GCGSkillPreviewCardInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo build() {
        emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo buildPartial() {
        emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo result = new emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo other) {
        if (other == emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo.getDefaultInstance()) return this;
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType getZoneType() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType result = emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType.valueOf(zoneType_);
        return result == null ? emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setZoneType(emu.grasscutter.net.oldproto.GCGZoneTypeOuterClass.GCGZoneType value) {
        if (value == null) {
    ...
    private static final emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo();
    }

    public static emu.grasscutter.net.oldproto.GCGSkillPreviewCardInfoOuterClass.GCGSkillPreviewCardInfo getDefaultInstance() {
