...
public final class PlayerStartMatchRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.internal_static_PlayerStartMatchRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.internal_static_PlayerStartMatchRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp.class, emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp other = (emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.internal_static_PlayerStartMatchRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp build() {
        emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp buildPartial() {
        emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp result = new emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp other) {
        if (other == emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp();
    }

    public static emu.grasscutter.net.oldproto.PlayerStartMatchRspOuterClass.PlayerStartMatchRsp getDefaultInstance() {
