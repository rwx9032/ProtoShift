...
public final class HomeScenePointFishFarmingInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.internal_static_HomeScenePointFishFarmingInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.internal_static_HomeScenePointFishFarmingInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo.class, emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo other = (emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.internal_static_HomeScenePointFishFarmingInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo build() {
        emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo buildPartial() {
        emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo result = new emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo other) {
        if (other == emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo();
    }

    public static emu.grasscutter.net.oldproto.HomeScenePointFishFarmingInfoOuterClass.HomeScenePointFishFarmingInfo getDefaultInstance() {
