...
public final class AbilityGadgetInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.class, emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo other = (emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.internal_static_AbilityGadgetInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo build() {
        emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo buildPartial() {
        emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo result = new emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo other) {
        if (other == emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo();
    }

    public static emu.grasscutter.net.oldproto.AbilityGadgetInfoOuterClass.AbilityGadgetInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ype\030\002 \001(\r\022\030\n\020target_entity_id\030\003 \001(\rB\036\n\034e" +
