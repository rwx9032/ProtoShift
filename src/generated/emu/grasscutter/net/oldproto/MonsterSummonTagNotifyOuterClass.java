...
public final class MonsterSummonTagNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.internal_static_MonsterSummonTagNotify_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.internal_static_MonsterSummonTagNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify.class, emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify.Builder.class);
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.internal_static_MonsterSummonTagNotify_SummonTagMapEntry_descriptor, 
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify other = (emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.internal_static_MonsterSummonTagNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify build() {
        emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify buildPartial() {
        emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify result = new emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify other) {
        if (other == emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify();
    }

    public static emu.grasscutter.net.oldproto.MonsterSummonTagNotifyOuterClass.MonsterSummonTagNotify getDefaultInstance() {
