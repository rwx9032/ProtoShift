...
public final class OneofGatherPointDetectorDataOuterClass {
  ...
  public interface OneofGatherPointDetectorDataOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.Vector getHintCenterPos();
    /**
     * <code>.Vector hint_center_pos = 7;</code>
     */
    emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getHintCenterPosOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.internal_static_OneofGatherPointDetectorData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.internal_static_OneofGatherPointDetectorData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData.class, emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData.Builder.class);
    }

    public static final int HINT_CENTER_POS_FIELD_NUMBER = 7;
    private emu.grasscutter.net.oldproto.VectorOuterClass.Vector hintCenterPos_;
    /**
     * <code>.Vector hint_center_pos = 7;</code>
     * @return Whether the hintCenterPos field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.Vector getHintCenterPos() {
      return hintCenterPos_ == null ? emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : hintCenterPos_;
    }
    /**
     * <code>.Vector hint_center_pos = 7;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getHintCenterPosOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData other = (emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData) obj;
    ...
    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.internal_static_OneofGatherPointDetectorData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData getDefaultInstanceForType() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData build() {
        emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData buildPartial() {
        emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData result = new emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData(this);
        if (hintCenterPosBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData) {
          return mergeFrom((emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData other) {
        if (other == emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.VectorOuterClass.Vector, emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder, emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder> hintCenterPosBuilder_;
      /**
       * <code>.Vector hint_center_pos = 7;</code>
       * @return Whether the hintCenterPos field is set.
       */
       ...
       * <code>.Vector hint_center_pos = 7;</code>
       */
      public Builder setHintCenterPos(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (hintCenterPosBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.Vector hint_center_pos = 7;</code>
       */
      public Builder mergeHintCenterPos(emu.grasscutter.net.oldproto.VectorOuterClass.Vector value) {
        if (hintCenterPosBuilder_ == null) {
          if (hintCenterPos_ != null) {
            hintCenterPos_ =
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.newBuilder(hintCenterPos_).mergeFrom(value).buildPartial();
          } else {
            hintCenterPos_ = value;
          }
          onChanged();
       ...
       * <code>.Vector hint_center_pos = 7;</code>
       */
      public emu.grasscutter.net.oldproto.VectorOuterClass.Vector.Builder getHintCenterPosBuilder() {
      ...
      public emu.grasscutter.net.oldproto.VectorOuterClass.VectorOrBuilder getHintCenterPosOrBuilder() {
        if (hintCenterPosBuilder_ != null) {
          ...
          return hintCenterPos_ == null ?
              emu.grasscutter.net.oldproto.VectorOuterClass.Vector.getDefaultInstance() : hintCenterPos_;
        }
      }
      /**
       * <code>.Vector hint_center_pos = 7;</code>
    ...
    private static final emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData();
    }

    public static emu.grasscutter.net.oldproto.OneofGatherPointDetectorDataOuterClass.OneofGatherPointDetectorData getDefaultInstance() {
