...
public final class GCGLevelChallengeFinishNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.class, emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify other = (emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.internal_static_GCGLevelChallengeFinishNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify build() {
        emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify buildPartial() {
        emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify result = new emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify other) {
        if (other == emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify();
    }

    public static emu.grasscutter.net.oldproto.GCGLevelChallengeFinishNotifyOuterClass.GCGLevelChallengeFinishNotify getDefaultInstance() {
