...
public final class AbilityMixinGlobalShieldOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.internal_static_AbilityMixinGlobalShield_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.internal_static_AbilityMixinGlobalShield_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.class, emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield other = (emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShieldOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.internal_static_AbilityMixinGlobalShield_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield build() {
        emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield buildPartial() {
        emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield result = new emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield other) {
        if (other == emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield();
    }

    public static emu.grasscutter.net.oldproto.AbilityMixinGlobalShieldOuterClass.AbilityMixinGlobalShield getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "eld\030\n \001(\002\022\032\n\022shield_effect_name\030\002 \001(\tB\036\n" +
