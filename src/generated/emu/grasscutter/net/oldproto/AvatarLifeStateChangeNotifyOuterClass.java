...
public final class AvatarLifeStateChangeNotifyOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.internal_static_AvatarLifeStateChangeNotify_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.internal_static_AvatarLifeStateChangeNotify_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify.class, emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify other = (emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify) obj;
    ...
    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotifyOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.internal_static_AvatarLifeStateChangeNotify_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify build() {
        emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify buildPartial() {
        emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify result = new emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify) {
          return mergeFrom((emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify other) {
        if (other == emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify();
    }

    public static emu.grasscutter.net.oldproto.AvatarLifeStateChangeNotifyOuterClass.AvatarLifeStateChangeNotify getDefaultInstance() {
