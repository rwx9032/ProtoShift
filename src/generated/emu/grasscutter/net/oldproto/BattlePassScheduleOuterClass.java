...
public final class BattlePassScheduleOuterClass {
  ...
  public interface BattlePassScheduleOrBuilder extends
     ...
     * @return The curCycle.
     */
    emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle getCurCycle();
    /**
     * <code>.BattlePassCycle cur_cycle = 4;</code>
     */
    emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder getCurCycleOrBuilder();
     ...
     */
    emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus getUnlockStatus();

    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
     */
    java.util.List<emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> 
        getRewardTakenListList();
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
     */
    emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag getRewardTakenList(int index);
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
     */
     ...
     * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> 
        getRewardTakenListOrBuilderList();
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
     */
    emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder getRewardTakenListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct getProductInfo();
    /**
     * <code>.BattlePassProduct product_info = 13;</code>
     */
    emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProductOrBuilder getProductInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.internal_static_BattlePassSchedule_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.internal_static_BattlePassSchedule_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule.class, emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle curCycle_;
    /**
     * <code>.BattlePassCycle cur_cycle = 4;</code>
     * @return Whether the curCycle field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle getCurCycle() {
      return curCycle_ == null ? emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.getDefaultInstance() : curCycle_;
    }
    /**
     * <code>.BattlePassCycle cur_cycle = 4;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder getCurCycleOrBuilder() {
      return getCurCycle();
    }
     ...
     * @return The unlockStatus.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus getUnlockStatus() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus result = emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.valueOf(unlockStatus_);
      return result == null ? emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.UNRECOGNIZED : result;
    }

    public static final int REWARD_TAKEN_LIST_FIELD_NUMBER = 11;
    private java.util.List<emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> rewardTakenList_;
    /**
     * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> getRewardTakenListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> 
        getRewardTakenListOrBuilderList() {
      return rewardTakenList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag getRewardTakenList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder getRewardTakenListOrBuilder(
        int index) {
      return rewardTakenList_.get(index);
    }
    ...
    private emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct productInfo_;
    /**
     * <code>.BattlePassProduct product_info = 13;</code>
     * @return Whether the productInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct getProductInfo() {
      return productInfo_ == null ? emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.getDefaultInstance() : productInfo_;
    }
    /**
     * <code>.BattlePassProduct product_info = 13;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProductOrBuilder getProductInfoOrBuilder() {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (unlockStatus_ != emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.BATTLE_PASS_UNLOCK_STATUS_INVALID.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule other = (emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule) obj;
    ...
    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassScheduleOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.internal_static_BattlePassSchedule_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule build() {
        emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule buildPartial() {
        emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule result = new emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule) {
          return mergeFrom((emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule other) {
        if (other == emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule.getDefaultInstance()) return this;
        if (other.getLevel() != 0) {
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 90: {
                emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.parser(),
                        extensionRegistry);
                if (rewardTakenListBuilder_ == null) {
                  ensureRewardTakenListIsMutable();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle, emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.Builder, emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder> curCycleBuilder_;
      /**
       * <code>.BattlePassCycle cur_cycle = 4;</code>
       * @return Whether the curCycle field is set.
       */
       ...
       * <code>.BattlePassCycle cur_cycle = 4;</code>
       */
      public Builder setCurCycle(emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle value) {
        if (curCycleBuilder_ == null) {
          if (value == null) {
      ...
      public Builder setCurCycle(
          emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.Builder builderForValue) {
        if (curCycleBuilder_ == null) {
       ...
       * <code>.BattlePassCycle cur_cycle = 4;</code>
       */
      public Builder mergeCurCycle(emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle value) {
        if (curCycleBuilder_ == null) {
          if (curCycle_ != null) {
            curCycle_ =
              emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.newBuilder(curCycle_).mergeFrom(value).buildPartial();
          } else {
            curCycle_ = value;
          }
          onChanged();
       ...
       * <code>.BattlePassCycle cur_cycle = 4;</code>
       */
      public emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.Builder getCurCycleBuilder() {
      ...
      public emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder getCurCycleOrBuilder() {
        if (curCycleBuilder_ != null) {
          ...
          return curCycle_ == null ?
              emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.getDefaultInstance() : curCycle_;
        }
      }
      /**
       * <code>.BattlePassCycle cur_cycle = 4;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle, emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycle.Builder, emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.BattlePassCycleOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus getUnlockStatus() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus result = emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.valueOf(unlockStatus_);
        return result == null ? emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setUnlockStatus(emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.BattlePassUnlockStatus value) {
        if (value == null) {
          throw new NullPointerException();
        }
      ...
      private void ensureRewardTakenListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          rewardTakenList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag>(rewardTakenList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> rewardTakenListBuilder_;
      ...
      public Builder setRewardTakenList(
          int index, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag value) {
        if (rewardTakenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setRewardTakenList(
          int index, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder builderForValue) {
        if (rewardTakenListBuilder_ == null) {
          ensureRewardTakenListIsMutable();
       ...
       * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
       */
      public Builder addRewardTakenList(emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag value) {
        if (rewardTakenListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRewardTakenList(
          emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder builderForValue) {
        if (rewardTakenListBuilder_ == null) {
          ensureRewardTakenListIsMutable();
      ...
      public Builder addAllRewardTakenList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag> values) {
        if (rewardTakenListBuilder_ == null) {
          ensureRewardTakenListIsMutable();
       ...
       * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
       */
      public emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder getRewardTakenListBuilder(
          int index) {
       ...
       * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
       */
      public emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder addRewardTakenListBuilder() {
        return getRewardTakenListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.getDefaultInstance());
      }
      /**
       * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
       */
      public emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder addRewardTakenListBuilder(
          int index) {
        return getRewardTakenListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.getDefaultInstance());
      }
      /**
       * <code>repeated .BattlePassRewardTag reward_taken_list = 11;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder> 
           getRewardTakenListBuilderList() {
        return getRewardTakenListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTag.Builder, emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.BattlePassRewardTagOrBuilder> 
      ...
      private emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct productInfo_;
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct, emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.Builder, emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProductOrBuilder> productInfoBuilder_;
      /**
       * <code>.BattlePassProduct product_info = 13;</code>
       * @return Whether the productInfo field is set.
       */
       ...
       * <code>.BattlePassProduct product_info = 13;</code>
       */
      public Builder setProductInfo(emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct value) {
        if (productInfoBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder setProductInfo(
          emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.Builder builderForValue) {
        if (productInfoBuilder_ == null) {
       ...
       * <code>.BattlePassProduct product_info = 13;</code>
       */
      public Builder mergeProductInfo(emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct value) {
        if (productInfoBuilder_ == null) {
          if (productInfo_ != null) {
            productInfo_ =
              emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.newBuilder(productInfo_).mergeFrom(value).buildPartial();
          } else {
            productInfo_ = value;
          }
          onChanged();
       ...
       * <code>.BattlePassProduct product_info = 13;</code>
       */
      public emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.Builder getProductInfoBuilder() {
      ...
      public emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProductOrBuilder getProductInfoOrBuilder() {
        if (productInfoBuilder_ != null) {
          ...
          return productInfo_ == null ?
              emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.getDefaultInstance() : productInfo_;
        }
      }
      /**
       * <code>.BattlePassProduct product_info = 13;</code>
       */
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct, emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProduct.Builder, emu.grasscutter.net.oldproto.BattlePassProductOuterClass.BattlePassProductOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule();
    }

    public static emu.grasscutter.net.oldproto.BattlePassScheduleOuterClass.BattlePassSchedule getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.BattlePassCycleOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.BattlePassProductOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.BattlePassRewardTagOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.BattlePassUnlockStatusOuterClass.getDescriptor(),
        });
    internal_static_BattlePassSchedule_descriptor =
