...
public final class GCGMsgAddCardsOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.internal_static_GCGMsgAddCards_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.internal_static_GCGMsgAddCards_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.class, emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards other = (emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCardsOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.internal_static_GCGMsgAddCards_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards build() {
        emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards buildPartial() {
        emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards result = new emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards other) {
        if (other == emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards.getDefaultInstance()) return this;
        if (other.getPos() != 0) {
          setPos(other.getPos());
        }
        if (other.zone_ != 0) {
    ...
    private static final emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards();
    }

    public static emu.grasscutter.net.oldproto.GCGMsgAddCardsOuterClass.GCGMsgAddCards getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_id\030\r \001(\r\022\026\n\016card_guid_list\030\016 \003(\rB\036\n\034emu" +
