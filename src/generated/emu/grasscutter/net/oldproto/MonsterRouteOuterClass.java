...
public final class MonsterRouteOuterClass {
  ...
  public interface MonsterRouteOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint> 
        getRoutePointsList();
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint getRoutePoints(int index);
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
     ...
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePointOrBuilder> 
        getRoutePointsOrBuilderList();
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePointOrBuilder getRoutePointsOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MonsterRouteOuterClass.internal_static_MonsterRoute_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MonsterRouteOuterClass.internal_static_MonsterRoute_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute.class, emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute.Builder.class);
    }

    public static final int ROUTE_POINTS_FIELD_NUMBER = 1;
    private java.util.List<emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint> routePoints_;
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint> getRoutePointsList() {
      return routePoints_;
    }
    /**
     * <code>repeated .RoutePoint route_points = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePointOrBuilder> 
        getRoutePointsOrBuilderList() {
      return routePoints_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint getRoutePoints(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePointOrBuilder getRoutePointsOrBuilder(
        int index) {
      return routePoints_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute other = (emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute) obj;
    ...
    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRouteOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MonsterRouteOuterClass.internal_static_MonsterRoute_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute build() {
        emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute buildPartial() {
        emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute result = new emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute) {
          return mergeFrom((emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute other) {
        if (other == emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute.getDefaultInstance()) return this;
        if (routePointsBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.parser(),
                        extensionRegistry);
                if (routePointsBuilder_ == null) {
                  ensureRoutePointsIsMutable();
                  routePoints_.add(m);
      ...
      private void ensureRoutePointsIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          routePoints_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint>(routePoints_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePointOrBuilder> routePointsBuilder_;
      ...
      public Builder setRoutePoints(
          int index, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint value) {
        if (routePointsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setRoutePoints(
          int index, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder builderForValue) {
        if (routePointsBuilder_ == null) {
          ensureRoutePointsIsMutable();
       ...
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public Builder addRoutePoints(emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint value) {
        if (routePointsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addRoutePoints(
          emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder builderForValue) {
        if (routePointsBuilder_ == null) {
          ensureRoutePointsIsMutable();
      ...
      public Builder addAllRoutePoints(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint> values) {
        if (routePointsBuilder_ == null) {
          ensureRoutePointsIsMutable();
       ...
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder getRoutePointsBuilder(
          int index) {
       ...
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder addRoutePointsBuilder() {
        return getRoutePointsFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.getDefaultInstance());
      }
      /**
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder addRoutePointsBuilder(
          int index) {
        return getRoutePointsFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.getDefaultInstance());
      }
      /**
       * <code>repeated .RoutePoint route_points = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder> 
           getRoutePointsBuilderList() {
        return getRoutePointsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePoint.Builder, emu.grasscutter.net.oldproto.RoutePointOuterClass.RoutePointOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute();
    }

    public static emu.grasscutter.net.oldproto.MonsterRouteOuterClass.MonsterRoute getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.RoutePointOuterClass.getDescriptor(),
        });
    internal_static_MonsterRoute_descriptor =
