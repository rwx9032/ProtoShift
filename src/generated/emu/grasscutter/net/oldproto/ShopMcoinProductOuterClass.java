...
public final class ShopMcoinProductOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.internal_static_ShopMcoinProduct_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.internal_static_ShopMcoinProduct_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.class, emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct other = (emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct) obj;
    ...
    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProductOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.internal_static_ShopMcoinProduct_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct build() {
        emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct buildPartial() {
        emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct result = new emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct) {
          return mergeFrom((emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct other) {
        if (other == emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct.getDefaultInstance()) return this;
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct();
    }

    public static emu.grasscutter.net.oldproto.ShopMcoinProductOuterClass.ShopMcoinProduct getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t_num\030\006 \001(\r\022\020\n\010is_audit\030\007 \001(\010B\036\n\034emu.gra" +
