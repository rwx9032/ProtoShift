...
public final class CoopChapterOuterClass {
  ...
  public interface CoopChapterOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg> 
        getCoopCgListList();
    /**
     * <code>repeated .CoopCg coop_cg_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg getCoopCgList(int index);
    /**
     * <code>repeated .CoopCg coop_cg_list = 1;</code>
     */
     ...
     * <code>repeated .CoopCg coop_cg_list = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCgOrBuilder> 
        getCoopCgListOrBuilderList();
    /**
     * <code>repeated .CoopCg coop_cg_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCgOrBuilder getCoopCgListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint> 
        getCoopPointListList();
    /**
     * <code>repeated .CoopPoint coop_point_list = 11;</code>
     */
    emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint getCoopPointList(int index);
    /**
     * <code>repeated .CoopPoint coop_point_list = 11;</code>
     */
     ...
     * <code>repeated .CoopPoint coop_point_list = 11;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPointOrBuilder> 
        getCoopPointListOrBuilderList();
    /**
     * <code>repeated .CoopPoint coop_point_list = 11;</code>
     */
    emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointListOrBuilder(
        int index);
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward> 
        getCoopRewardListList();
    /**
     * <code>repeated .CoopReward coop_reward_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward getCoopRewardList(int index);
    /**
     * <code>repeated .CoopReward coop_reward_list = 5;</code>
     */
     ...
     * <code>repeated .CoopReward coop_reward_list = 5;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopRewardOrBuilder> 
        getCoopRewardListOrBuilderList();
    /**
     * <code>repeated .CoopReward coop_reward_list = 5;</code>
     */
    emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopRewardOrBuilder getCoopRewardListOrBuilder(
        int index);
     ...
     * @return The state.
     */
    emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State getState();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.CoopChapterOuterClass.internal_static_CoopChapter_descriptor;
    }
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return emu.grasscutter.net.oldproto.CoopChapterOuterClass.internal_static_CoopChapter_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.class, emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.Builder.class);
    }
    ...
    public enum State
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.getDescriptor().getEnumTypes().get(0);
      }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg> coopCgList_;
    /**
     * <code>repeated .CoopCg coop_cg_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg> getCoopCgListList() {
      return coopCgList_;
    }
    /**
     * <code>repeated .CoopCg coop_cg_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCgOrBuilder> 
        getCoopCgListOrBuilderList() {
      return coopCgList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg getCoopCgList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCgOrBuilder getCoopCgListOrBuilder(
        int index) {
      return coopCgList_.get(index);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint> coopPointList_;
    /**
     * <code>repeated .CoopPoint coop_point_list = 11;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint> getCoopPointListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPointOrBuilder> 
        getCoopPointListOrBuilderList() {
      return coopPointList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint getCoopPointList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPointOrBuilder getCoopPointListOrBuilder(
        int index) {
      return coopPointList_.get(index);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward> coopRewardList_;
    /**
     * <code>repeated .CoopReward coop_reward_list = 5;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward> getCoopRewardListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopRewardOrBuilder> 
        getCoopRewardListOrBuilderList() {
      return coopRewardList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward getCoopRewardList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopRewardOrBuilder getCoopRewardListOrBuilder(
        int index) {
      return coopRewardList_.get(index);
    }
     ...
     * @return The state.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State getState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State result = emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State.valueOf(state_);
      return result == null ? emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State.UNRECOGNIZED : result;
    }
      ...
      static final com.google.protobuf.MapEntry<
          java.lang.Integer, java.lang.Integer> defaultEntry =
              ...
              .<java.lang.Integer, java.lang.Integer>newDefaultInstance(
                  emu.grasscutter.net.oldproto.CoopChapterOuterClass.internal_static_CoopChapter_SeenEndingMapEntry_descriptor, 
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (state_ != emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State.STATE_CLOSE.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter other = (emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter) obj;
    ...
    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapterOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.CoopChapterOuterClass.internal_static_CoopChapter_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter build() {
        emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter buildPartial() {
        emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter result = new emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter) {
          return mergeFrom((emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter other) {
        if (other == emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.getDefaultInstance()) return this;
        if (coopCgListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.parser(),
                        extensionRegistry);
                if (coopCgListBuilder_ == null) {
                  ensureCoopCgListIsMutable();
                  coopCgList_.add(m);
              ...
              case 42: {
                emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.parser(),
                        extensionRegistry);
                if (coopRewardListBuilder_ == null) {
                  ensureCoopRewardListIsMutable();
              ...
              case 90: {
                emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.parser(),
                        extensionRegistry);
                if (coopPointListBuilder_ == null) {
                  ensureCoopPointListIsMutable();
      ...
      private void ensureCoopCgListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          coopCgList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg>(coopCgList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCgOrBuilder> coopCgListBuilder_;
      ...
      public Builder setCoopCgList(
          int index, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg value) {
        if (coopCgListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setCoopCgList(
          int index, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder builderForValue) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
       ...
       * <code>repeated .CoopCg coop_cg_list = 1;</code>
       */
      public Builder addCoopCgList(emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg value) {
        if (coopCgListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCoopCgList(
          emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder builderForValue) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
      ...
      public Builder addAllCoopCgList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg> values) {
        if (coopCgListBuilder_ == null) {
          ensureCoopCgListIsMutable();
       ...
       * <code>repeated .CoopCg coop_cg_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder getCoopCgListBuilder(
          int index) {
       ...
       * <code>repeated .CoopCg coop_cg_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder addCoopCgListBuilder() {
        return getCoopCgListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopCg coop_cg_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder addCoopCgListBuilder(
          int index) {
        return getCoopCgListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopCg coop_cg_list = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder> 
           getCoopCgListBuilderList() {
        return getCoopCgListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCg.Builder, emu.grasscutter.net.oldproto.CoopCgOuterClass.CoopCgOrBuilder> 
      ...
      private void ensureCoopPointListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          coopPointList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint>(coopPointList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPointOrBuilder> coopPointListBuilder_;
      ...
      public Builder setCoopPointList(
          int index, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCoopPointList(
          int index, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder builderForValue) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
       ...
       * <code>repeated .CoopPoint coop_point_list = 11;</code>
       */
      public Builder addCoopPointList(emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint value) {
        if (coopPointListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCoopPointList(
          emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder builderForValue) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
      ...
      public Builder addAllCoopPointList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint> values) {
        if (coopPointListBuilder_ == null) {
          ensureCoopPointListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .CoopPoint coop_point_list = 11;</code>
       */
      public emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder getCoopPointListBuilder(
          int index) {
       ...
       * <code>repeated .CoopPoint coop_point_list = 11;</code>
       */
      public emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder addCoopPointListBuilder() {
        return getCoopPointListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopPoint coop_point_list = 11;</code>
       */
      public emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder addCoopPointListBuilder(
          int index) {
        return getCoopPointListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopPoint coop_point_list = 11;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder> 
           getCoopPointListBuilderList() {
        return getCoopPointListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPoint.Builder, emu.grasscutter.net.oldproto.CoopPointOuterClass.CoopPointOrBuilder> 
      ...
      private void ensureCoopRewardListIsMutable() {
        if (!((bitField0_ & 0x00000008) != 0)) {
          coopRewardList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward>(coopRewardList_);
          bitField0_ |= 0x00000008;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopRewardOrBuilder> coopRewardListBuilder_;
      ...
      public Builder setCoopRewardList(
          int index, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward value) {
        if (coopRewardListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setCoopRewardList(
          int index, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder builderForValue) {
        if (coopRewardListBuilder_ == null) {
          ensureCoopRewardListIsMutable();
       ...
       * <code>repeated .CoopReward coop_reward_list = 5;</code>
       */
      public Builder addCoopRewardList(emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward value) {
        if (coopRewardListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addCoopRewardList(
          emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder builderForValue) {
        if (coopRewardListBuilder_ == null) {
          ensureCoopRewardListIsMutable();
      ...
      public Builder addAllCoopRewardList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward> values) {
        if (coopRewardListBuilder_ == null) {
          ensureCoopRewardListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .CoopReward coop_reward_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder getCoopRewardListBuilder(
          int index) {
       ...
       * <code>repeated .CoopReward coop_reward_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder addCoopRewardListBuilder() {
        return getCoopRewardListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopReward coop_reward_list = 5;</code>
       */
      public emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder addCoopRewardListBuilder(
          int index) {
        return getCoopRewardListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.getDefaultInstance());
      }
      /**
       * <code>repeated .CoopReward coop_reward_list = 5;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder> 
           getCoopRewardListBuilderList() {
        return getCoopRewardListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopReward.Builder, emu.grasscutter.net.oldproto.CoopRewardOuterClass.CoopRewardOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State getState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State result = emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State.valueOf(state_);
        return result == null ? emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setState(emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter.State value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter();
    }

    public static emu.grasscutter.net.oldproto.CoopChapterOuterClass.CoopChapter getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.CoopCgOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.CoopPointOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.CoopRewardOuterClass.getDescriptor(),
        });
    internal_static_CoopChapter_descriptor =
