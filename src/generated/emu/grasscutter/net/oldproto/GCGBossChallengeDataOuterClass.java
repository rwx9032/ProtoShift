...
public final class GCGBossChallengeDataOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.class, emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData other = (emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData) obj;
    ...
    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeDataOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.internal_static_GCGBossChallengeData_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData build() {
        emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData buildPartial() {
        emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData result = new emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData) {
          return mergeFrom((emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData other) {
        if (other == emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData.getDefaultInstance()) return this;
        if (other.getId() != 0) {
          setId(other.getId());
        }
    ...
    private static final emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData();
    }

    public static emu.grasscutter.net.oldproto.GCGBossChallengeDataOuterClass.GCGBossChallengeData getDefaultInstance() {
