...
public final class SocialDetailOuterClass {
  ...
  public interface SocialDetailOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState();
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> 
        getShowAvatarInfoListList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index);
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
     ...
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList();
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index);
     ...
     */
    emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.SocialDetailOuterClass.internal_static_SocialDetail_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.class, emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.Builder.class);
    }
     ...
     * @return The onlineState.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.valueOf(onlineState_);
      return result == null ? emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> showAvatarInfoList_;
    /**
     * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> getShowAvatarInfoListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
        getShowAvatarInfoListOrBuilderList() {
      return showAvatarInfoList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo getShowAvatarInfoList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder getShowAvatarInfoListOrBuilder(
        int index) {
      return showAvatarInfoList_.get(index);
    }
     ...
     * @return The friendEnterHomeOption.
     */
    @java.lang.Override public emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption() {
      @SuppressWarnings("deprecation")
      emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption result = emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.valueOf(friendEnterHomeOption_);
      return result == null ? emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (onlineState_ != emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.FRIEND_ONLINE_STATE_FREIEND_DISCONNECT.getNumber()) {
      ...
      if (friendEnterHomeOption_ != emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.FRIEND_ENTER_HOME_OPTION_NEED_CONFIRM.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail other = (emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail) obj;
    ...
    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetailOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.SocialDetailOuterClass.internal_static_SocialDetail_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail build() {
        emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail buildPartial() {
        emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail result = new emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail) {
          return mergeFrom((emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail other) {
        if (other == emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail.getDefaultInstance()) return this;
        if (other.getUid() != 0) {
          setUid(other.getUid());
        }
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 178: {
                emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.parser(),
                        extensionRegistry);
                if (showAvatarInfoListBuilder_ == null) {
                  ensureShowAvatarInfoListIsMutable();
  ...
  checkByteStringIsUtf8(value);
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState getOnlineState() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState result = emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.valueOf(onlineState_);
        return result == null ? emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setOnlineState(emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.FriendOnlineState value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
      ...
      private void ensureShowAvatarInfoListIsMutable() {
        if (!((bitField0_ & 0x00000002) != 0)) {
          showAvatarInfoList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo>(showAvatarInfoList_);
          bitField0_ |= 0x00000002;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> showAvatarInfoListBuilder_;
      ...
      public Builder setShowAvatarInfoList(
          int index, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder setShowAvatarInfoList(
          int index, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public Builder addShowAvatarInfoList(emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo value) {
        if (showAvatarInfoListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addShowAvatarInfoList(
          emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder builderForValue) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
      ...
      public Builder addAllShowAvatarInfoList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo> values) {
        if (showAvatarInfoListBuilder_ == null) {
          ensureShowAvatarInfoListIsMutable();
          com.google.protobuf.AbstractMessageLite.Builder.addAll(
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder getShowAvatarInfoListBuilder(
          int index) {
       ...
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder() {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder addShowAvatarInfoListBuilder(
          int index) {
        return getShowAvatarInfoListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.getDefaultInstance());
      }
      /**
       * <code>repeated .SocialShowAvatarInfo show_avatar_info_list = 22;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder> 
           getShowAvatarInfoListBuilderList() {
        return getShowAvatarInfoListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfo.Builder, emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.SocialShowAvatarInfoOrBuilder> 
       ...
       */
      @java.lang.Override
      public emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption getFriendEnterHomeOption() {
        @SuppressWarnings("deprecation")
        emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption result = emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.valueOf(friendEnterHomeOption_);
        return result == null ? emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption.UNRECOGNIZED : result;
      }
       ...
       * @return This builder for chaining.
       */
      public Builder setFriendEnterHomeOption(emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.FriendEnterHomeOption value) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    private static final emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail();
    }

    public static emu.grasscutter.net.oldproto.SocialDetailOuterClass.SocialDetail getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_picture\030\031 \001(\0132\017.ProfilePictureB\036\n\034emu.g" +
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          emu.grasscutter.net.oldproto.FriendEnterHomeOptionOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.FriendOnlineStateOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.ProfilePictureOuterClass.getDescriptor(),
          emu.grasscutter.net.oldproto.SocialShowAvatarInfoOuterClass.getDescriptor(),
        });
    internal_static_SocialDetail_descriptor =
