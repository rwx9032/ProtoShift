...
public final class TakeHuntingOfferRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.internal_static_TakeHuntingOfferRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.internal_static_TakeHuntingOfferRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.class, emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp other = (emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.internal_static_TakeHuntingOfferRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp build() {
        emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp buildPartial() {
        emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp result = new emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp(this);
        if (huntingPairBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp other) {
        if (other == emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp();
    }

    public static emu.grasscutter.net.oldproto.TakeHuntingOfferRspOuterClass.TakeHuntingOfferRsp getDefaultInstance() {
