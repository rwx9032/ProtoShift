...
public final class AbilityInvokeEntryHeadOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.internal_static_AbilityInvokeEntryHead_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.internal_static_AbilityInvokeEntryHead_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.class, emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead other = (emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead) obj;
    ...
    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHeadOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.internal_static_AbilityInvokeEntryHead_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead build() {
        emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead buildPartial() {
        emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead result = new emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead) {
          return mergeFrom((emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead other) {
        if (other == emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead();
    }

    public static emu.grasscutter.net.oldproto.AbilityInvokeEntryHeadOuterClass.AbilityInvokeEntryHead getDefaultInstance() {
