...
public final class UseWidgetCreateGadgetReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.class, emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq other = (emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.internal_static_UseWidgetCreateGadgetReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq build() {
        emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq buildPartial() {
        emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq result = new emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq(this);
        if (posBuilder_ == null) {
          result.pos_ = pos_;
        } else {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq other) {
        if (other == emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq.getDefaultInstance()) return this;
        if (other.hasPos()) {
    ...
    private static final emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq();
    }

    public static emu.grasscutter.net.oldproto.UseWidgetCreateGadgetReqOuterClass.UseWidgetCreateGadgetReq getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\013material_id\030\004 \001(\rB\036\n\034emu.grasscutter.n" +
