...
public final class ExpeditionStartRspOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.class, emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp other = (emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.internal_static_ExpeditionStartRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp build() {
        emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp buildPartial() {
        emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp result = new emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp other) {
        if (other == emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp();
    }

    public static emu.grasscutter.net.oldproto.ExpeditionStartRspOuterClass.ExpeditionStartRsp getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\030\014 \001(\005\022\030\n\020assist_avatar_id\030\002 \001(\rB\036\n\034emu." +
