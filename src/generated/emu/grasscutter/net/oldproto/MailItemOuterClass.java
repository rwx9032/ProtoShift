...
public final class MailItemOuterClass {
  ...
  public interface MailItemOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam getEquipParam();
    /**
     * <code>.EquipParam equip_param = 1;</code>
     */
    emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParamOrBuilder getEquipParamOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.MailItemOuterClass.internal_static_MailItem_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.MailItemOuterClass.internal_static_MailItem_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.class, emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.Builder.class);
    }

    public static final int EQUIP_PARAM_FIELD_NUMBER = 1;
    private emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam equipParam_;
    /**
     * <code>.EquipParam equip_param = 1;</code>
     * @return Whether the equipParam field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam getEquipParam() {
      return equipParam_ == null ? emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam.getDefaultInstance() : equipParam_;
    }
    /**
     * <code>.EquipParam equip_param = 1;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParamOrBuilder getEquipParamOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem other = (emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem) obj;
    ...
    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.MailItemOuterClass.MailItemOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.MailItemOuterClass.internal_static_MailItem_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem build() {
        emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem buildPartial() {
        emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem result = new emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem(this);
        if (equipParamBuilder_ == null) {
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem) {
          return mergeFrom((emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem other) {
        if (other == emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam, emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam.Builder, emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParamOrBuilder> equipParamBuilder_;
      /**
       * <code>.EquipParam equip_param = 1;</code>
       * @return Whether the equipParam field is set.
       */
       ...
       * <code>.EquipParam equip_param = 1;</code>
       */
      public Builder setEquipParam(emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam value) {
        if (equipParamBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.EquipParam equip_param = 1;</code>
       */
      public Builder mergeEquipParam(emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam value) {
        if (equipParamBuilder_ == null) {
          if (equipParam_ != null) {
            equipParam_ =
              emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam.newBuilder(equipParam_).mergeFrom(value).buildPartial();
          } else {
            equipParam_ = value;
          }
          onChanged();
       ...
       * <code>.EquipParam equip_param = 1;</code>
       */
      public emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam.Builder getEquipParamBuilder() {
      ...
      public emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParamOrBuilder getEquipParamOrBuilder() {
        if (equipParamBuilder_ != null) {
          ...
          return equipParam_ == null ?
              emu.grasscutter.net.oldproto.EquipParamOuterClass.EquipParam.getDefaultInstance() : equipParam_;
        }
      }
      /**
       * <code>.EquipParam equip_param = 1;</code>
    ...
    private static final emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem();
    }

    public static emu.grasscutter.net.oldproto.MailItemOuterClass.MailItem getDefaultInstance() {
