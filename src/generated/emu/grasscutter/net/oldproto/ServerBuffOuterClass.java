...
public final class ServerBuffOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.ServerBuffOuterClass.internal_static_ServerBuff_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.ServerBuffOuterClass.internal_static_ServerBuff_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff.class, emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff other = (emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff) obj;
    ...
    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuffOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.ServerBuffOuterClass.internal_static_ServerBuff_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff build() {
        emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff buildPartial() {
        emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff result = new emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff) {
          return mergeFrom((emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff other) {
        if (other == emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff();
    }

    public static emu.grasscutter.net.oldproto.ServerBuffOuterClass.ServerBuff getDefaultInstance() {
