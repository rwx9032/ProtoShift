...
public final class DoGachaRspOuterClass {
  ...
  public interface DoGachaRspOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem> 
        getGachaItemListList();
    /**
     * <code>repeated .GachaItem gacha_item_list = 15;</code>
     */
    emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem getGachaItemList(int index);
    /**
     * <code>repeated .GachaItem gacha_item_list = 15;</code>
     */
     ...
     * <code>repeated .GachaItem gacha_item_list = 15;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> 
        getGachaItemListOrBuilderList();
    /**
     * <code>repeated .GachaItem gacha_item_list = 15;</code>
     */
    emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder getGachaItemListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DoGachaRspOuterClass.internal_static_DoGachaRsp_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DoGachaRspOuterClass.internal_static_DoGachaRsp_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.class, emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.Builder.class);
    }
    ...
    private java.util.List<emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem> gachaItemList_;
    /**
     * <code>repeated .GachaItem gacha_item_list = 15;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem> getGachaItemListList() {
     ...
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> 
        getGachaItemListOrBuilderList() {
      return gachaItemList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem getGachaItemList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder getGachaItemListOrBuilder(
        int index) {
      return gachaItemList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp other = (emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp) obj;
    ...
    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRspOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DoGachaRspOuterClass.internal_static_DoGachaRsp_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp build() {
        emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp buildPartial() {
        emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp result = new emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp) {
          return mergeFrom((emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp other) {
        if (other == emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp.getDefaultInstance()) return this;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 122: {
                emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.parser(),
                        extensionRegistry);
                if (gachaItemListBuilder_ == null) {
                  ensureGachaItemListIsMutable();
      ...
      private void ensureGachaItemListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          gachaItemList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem>(gachaItemList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> gachaItemListBuilder_;
      ...
      public Builder setGachaItemList(
          int index, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem value) {
        if (gachaItemListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setGachaItemList(
          int index, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder builderForValue) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
       ...
       * <code>repeated .GachaItem gacha_item_list = 15;</code>
       */
      public Builder addGachaItemList(emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem value) {
        if (gachaItemListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addGachaItemList(
          emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder builderForValue) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
      ...
      public Builder addAllGachaItemList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem> values) {
        if (gachaItemListBuilder_ == null) {
          ensureGachaItemListIsMutable();
       ...
       * <code>repeated .GachaItem gacha_item_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder getGachaItemListBuilder(
          int index) {
       ...
       * <code>repeated .GachaItem gacha_item_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder addGachaItemListBuilder() {
        return getGachaItemListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaItem gacha_item_list = 15;</code>
       */
      public emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder addGachaItemListBuilder(
          int index) {
        return getGachaItemListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.getDefaultInstance());
      }
      /**
       * <code>repeated .GachaItem gacha_item_list = 15;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder> 
           getGachaItemListBuilderList() {
        return getGachaItemListFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItem.Builder, emu.grasscutter.net.oldproto.GachaItemOuterClass.GachaItemOrBuilder> 
    ...
    private static final emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp();
    }

    public static emu.grasscutter.net.oldproto.DoGachaRspOuterClass.DoGachaRsp getDefaultInstance() {
    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          emu.grasscutter.net.oldproto.GachaItemOuterClass.getDescriptor(),
        });
    internal_static_DoGachaRsp_descriptor =
