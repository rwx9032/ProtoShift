...
public final class AvatarSkillInfoOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.class, emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo other = (emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.internal_static_AvatarSkillInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo build() {
        emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo buildPartial() {
        emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo result = new emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo other) {
        if (other == emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo();
    }

    public static emu.grasscutter.net.oldproto.AvatarSkillInfoOuterClass.AvatarSkillInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "_list\030\002 \003(\r\022\030\n\020max_charge_count\030\003 \001(\rB\036\n" +
