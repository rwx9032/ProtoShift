...
public final class VehicleInfoOuterClass {
  ...
  public interface VehicleInfoOrBuilder extends
     ...
     */
    java.util.List<emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember> 
        getMemberListList();
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember getMemberList(int index);
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
     ...
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    java.util.List<? extends emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMemberOrBuilder> 
        getMemberListOrBuilderList();
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMemberOrBuilder getMemberListOrBuilder(
        int index);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.VehicleInfoOuterClass.internal_static_VehicleInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.VehicleInfoOuterClass.internal_static_VehicleInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo.class, emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo.Builder.class);
    }

    public static final int MEMBER_LIST_FIELD_NUMBER = 1;
    private java.util.List<emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember> memberList_;
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember> getMemberListList() {
      return memberList_;
    }
    /**
     * <code>repeated .VehicleMember member_list = 1;</code>
     */
    @java.lang.Override
    public java.util.List<? extends emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMemberOrBuilder> 
        getMemberListOrBuilderList() {
      return memberList_;
    }
    /**
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember getMemberList(int index) {
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMemberOrBuilder getMemberListOrBuilder(
        int index) {
      return memberList_.get(index);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo other = (emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.VehicleInfoOuterClass.internal_static_VehicleInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo build() {
        emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo buildPartial() {
        emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo result = new emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo other) {
        if (other == emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo.getDefaultInstance()) return this;
        if (memberListBuilder_ == null) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember m =
                    input.readMessage(
                        emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.parser(),
                        extensionRegistry);
                if (memberListBuilder_ == null) {
                  ensureMemberListIsMutable();
                  memberList_.add(m);
      ...
      private void ensureMemberListIsMutable() {
        if (!((bitField0_ & 0x00000001) != 0)) {
          memberList_ = new java.util.ArrayList<emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember>(memberList_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember, emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.Builder, emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMemberOrBuilder> memberListBuilder_;
      ...
      public Builder setMemberList(
          int index, emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember value) {
        if (memberListBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setMemberList(
          int index, emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.Builder builderForValue) {
        if (memberListBuilder_ == null) {
          ensureMemberListIsMutable();
       ...
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public Builder addMemberList(emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember value) {
        if (memberListBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
      ...
      public Builder addAllMemberList(
          java.lang.Iterable<? extends emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember> values) {
        if (memberListBuilder_ == null) {
          ensureMemberListIsMutable();
       ...
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.Builder getMemberListBuilder(
          int index) {
       ...
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.Builder addMemberListBuilder() {
        return getMemberListFieldBuilder().addBuilder(
            emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.getDefaultInstance());
      }
      /**
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.Builder addMemberListBuilder(
          int index) {
        return getMemberListFieldBuilder().addBuilder(
            index, emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.getDefaultInstance());
      }
      /**
       * <code>repeated .VehicleMember member_list = 1;</code>
       */
      public java.util.List<emu.grasscutter.net.oldproto.VehicleMemberOuterClass.VehicleMember.Builder> 
    ...
    private static final emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo();
    }

    public static emu.grasscutter.net.oldproto.VehicleInfoOuterClass.VehicleInfo getDefaultInstance() {
