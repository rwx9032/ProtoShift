...
public final class UpdatePlayerShowAvatarListReqOuterClass {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.internal_static_UpdatePlayerShowAvatarListReq_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.internal_static_UpdatePlayerShowAvatarListReq_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq.class, emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq.Builder.class);
    }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq other = (emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq) obj;
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReqOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.internal_static_UpdatePlayerShowAvatarListReq_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq build() {
        emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq buildPartial() {
        emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq result = new emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq) {
          return mergeFrom((emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq other) {
        if (other == emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq.getDefaultInstance()) return this;
    ...
    private static final emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq();
    }

    public static emu.grasscutter.net.oldproto.UpdatePlayerShowAvatarListReqOuterClass.UpdatePlayerShowAvatarListReq getDefaultInstance() {
