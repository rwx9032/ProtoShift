...
public final class DailyDungeonEntryInfoOuterClass {
  ...
  public interface DailyDungeonEntryInfoOrBuilder extends
     ...
     */
    emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo getRecommendDungeonEntryInfo();
    /**
     * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
     */
    emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder getRecommendDungeonEntryInfoOrBuilder();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.internal_static_DailyDungeonEntryInfo_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.internal_static_DailyDungeonEntryInfo_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.class, emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.Builder.class);
    }
    ...
    private emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo recommendDungeonEntryInfo_;
    /**
     * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
     * @return Whether the recommendDungeonEntryInfo field is set.
     */
     ...
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo getRecommendDungeonEntryInfo() {
      return recommendDungeonEntryInfo_ == null ? emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo.getDefaultInstance() : recommendDungeonEntryInfo_;
    }
    /**
     * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder getRecommendDungeonEntryInfoOrBuilder() {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo other = (emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo) obj;
    ...
    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo parseFrom(
    ...
    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo prototype) {
    ...
    public static final class Builder extends
        ...
        emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfoOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.internal_static_DailyDungeonEntryInfo_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo getDefaultInstanceForType() {
        return emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo build() {
        emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo buildPartial() {
        emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo result = new emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo) {
          return mergeFrom((emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo other) {
        if (other == emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo.getDefaultInstance()) return this;
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo, emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo.Builder, emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder> recommendDungeonEntryInfoBuilder_;
      /**
       * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
       * @return Whether the recommendDungeonEntryInfo field is set.
       */
       ...
       * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
       */
      public Builder setRecommendDungeonEntryInfo(emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo value) {
        if (recommendDungeonEntryInfoBuilder_ == null) {
          if (value == null) {
       ...
       * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
       */
      public Builder mergeRecommendDungeonEntryInfo(emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo value) {
        if (recommendDungeonEntryInfoBuilder_ == null) {
          if (recommendDungeonEntryInfo_ != null) {
            recommendDungeonEntryInfo_ =
              emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo.newBuilder(recommendDungeonEntryInfo_).mergeFrom(value).buildPartial();
          } else {
            recommendDungeonEntryInfo_ = value;
          }
          onChanged();
       ...
       * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
       */
      public emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo.Builder getRecommendDungeonEntryInfoBuilder() {
      ...
      public emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfoOrBuilder getRecommendDungeonEntryInfoOrBuilder() {
        if (recommendDungeonEntryInfoBuilder_ != null) {
          ...
          return recommendDungeonEntryInfo_ == null ?
              emu.grasscutter.net.oldproto.DungeonEntryInfoOuterClass.DungeonEntryInfo.getDefaultInstance() : recommendDungeonEntryInfo_;
        }
      }
      /**
       * <code>.DungeonEntryInfo recommend_dungeon_entry_info = 1;</code>
    ...
    private static final emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo();
    }

    public static emu.grasscutter.net.oldproto.DailyDungeonEntryInfoOuterClass.DailyDungeonEntryInfo getDefaultInstance() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ecommend_dungeon_id\030\004 \001(\rB\036\n\034emu.grasscu" +
